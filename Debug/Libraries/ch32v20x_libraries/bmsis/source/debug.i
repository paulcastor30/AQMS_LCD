# 1 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c"
# 11 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c"
...
# 12 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c" 2

static uint8_t p_us = 0;
static uint16_t p_ms = 0;
# 23 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c"
void Delay_Init(void)
{
    p_us = SystemCoreClock / 8000000;
    p_ms = (uint16_t)p_us * 1000;
}
# 38 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c"
void Delay_Us(uint32_t n)
{
    uint32_t i;
...
# 62 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c"
void Delay_Ms(uint32_t n)
{
    uint32_t i;
...
# 86 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c"
void USART_Printf_Init(uint32_t baudrate)
{
...
# 119 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c"
...
# 139 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c"
}
# 151 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c"
...
# 179 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c"
void *_sbrk(ptrdiff_t incr)
{
    ...
    return 
# 186 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c" 3 4
          ((void *)0) 
# 186 "../Libraries/ch32v20x_libraries/bmsis/source/debug.c"
               - 1;
