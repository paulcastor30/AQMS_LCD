# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_wwdg.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_wwdg.c"
# 10 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_wwdg.c"
...
# 19 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32v20x_libraries\\ch32v208_hal\\include/ch32v20x_wwdg.h" 2
...
# 11 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_wwdg.c" 2
...
# 28 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_wwdg.c"
void WWDG_DeInit(void)
{
    RCC_APB1PeriphResetCmd(((uint32_t)0x00000800), ENABLE);
    RCC_APB1PeriphResetCmd(((uint32_t)0x00000800), DISABLE);
}
# 47 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_wwdg.c"
void WWDG_SetPrescaler(uint32_t WWDG_Prescaler)
{
    uint32_t tmpreg = 0;
...
# 65 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_wwdg.c"
void WWDG_SetWindowValue(uint8_t WindowValue)
{
...
# 83 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_wwdg.c"
void WWDG_EnableIT(void)
{
    ((WWDG_TypeDef *)((((uint32_t)0x40000000)) + 0x2C00))->CFGR |= (1 << 9);
}
# 98 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_wwdg.c"
void WWDG_SetCounter(uint8_t Counter)
{
    ((WWDG_TypeDef *)((((uint32_t)0x40000000)) + 0x2C00))->CTLR = Counter & ((uint8_t)0x7F);
}
# 112 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_wwdg.c"
void WWDG_Enable(uint8_t Counter)
{
    ((WWDG_TypeDef *)((((uint32_t)0x40000000)) + 0x2C00))->CTLR = ((uint32_t)0x00000080) | Counter;
}
# 124 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_wwdg.c"
FlagStatus WWDG_GetFlagStatus(void)
{
    return (FlagStatus)(((WWDG_TypeDef *)((((uint32_t)0x40000000)) + 0x2C00))->STATR);
}
# 136 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_wwdg.c"
void WWDG_ClearFlag(void)
{
