# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
# 10 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
...
# 19 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32v20x_libraries\\ch32v208_hal\\include/ch32v20x_rtc.h" 2
...
# 11 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c" 2


#define RTC_LSB_MASK ((uint32_t)0x0000FFFF)
#define PRLH_MSB_MASK ((uint32_t)0x000F0000)
# 28 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
void RTC_ITConfig(uint16_t RTC_IT, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 47 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
void RTC_EnterConfigMode(void)
{
    ((RTC_TypeDef *)((((uint32_t)0x40000000)) + 0x2800))->CTLRL |= ((uint8_t)0x10);
}
# 59 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
void RTC_ExitConfigMode(void)
{
    ((RTC_TypeDef *)((((uint32_t)0x40000000)) + 0x2800))->CTLRL &= (uint16_t) ~((uint16_t)((uint8_t)0x10));
}
# 71 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
uint32_t RTC_GetCounter(void)
{
...
# 98 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
void RTC_SetCounter(uint32_t CounterValue)
{
    RTC_EnterConfigMode();
...
# 115 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
void RTC_SetPrescaler(uint32_t PrescalerValue)
{
    RTC_EnterConfigMode();
...
# 132 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
void RTC_SetAlarm(uint32_t AlarmValue)
{
    RTC_EnterConfigMode();
...
# 147 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
uint32_t RTC_GetDivider(void)
{
    uint32_t tmp = 0x00;
...
# 162 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
void RTC_WaitForLastTask(void)
{
...
# 176 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
void RTC_WaitForSynchro(void)
{
...
# 198 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
FlagStatus RTC_GetFlagStatus(uint16_t RTC_FLAG)
{
...
# 225 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
void RTC_ClearFlag(uint16_t RTC_FLAG)
{
    ((RTC_TypeDef *)((((uint32_t)0x40000000)) + 0x2800))->CTLRL &= (uint16_t)~RTC_FLAG;
}
# 242 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
ITStatus RTC_GetITStatus(uint16_t RTC_IT)
{
...
# 270 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
void RTC_ClearITPendingBit(uint16_t RTC_IT)
{
    ((RTC_TypeDef *)((((uint32_t)0x40000000)) + 0x2800))->CTLRL &= (uint16_t)~RTC_IT;
}
# 288 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rtc.c"
void Calibration_LSI(Cali_LevelTypeDef cali_Lv)
{
    uint32_t i;
    int32_t cnt_offset;
