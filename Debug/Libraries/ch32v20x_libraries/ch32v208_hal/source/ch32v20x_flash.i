# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
# 10 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
...
# 19 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32v20x_libraries\\ch32v208_hal\\include/ch32v20x_flash.h" 2
...
# 11 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c" 2
...
# 68 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_Unlock(void)
{
...
# 83 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_UnlockBank1(void)
{
    ((FLASH_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x2000))->KEYR = ((uint32_t)0x45670123);
    ((FLASH_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x2000))->KEYR = ((uint32_t)0xCDEF89AB);
}
# 96 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_Lock(void)
{
    ((FLASH_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CTLR |= ((uint32_t)0x00000080);
}
# 108 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_LockBank1(void)
{
    ((FLASH_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CTLR |= ((uint32_t)0x00000080);
}
# 123 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_ErasePage(uint32_t Page_Address)
{
...
# 151 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_EraseAllPages(void)
{
    FLASH_Status status = FLASH_COMPLETE;
...
# 177 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_EraseAllBank1Pages(void)
{
    FLASH_Status status = FLASH_COMPLETE;
...
# 202 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_EraseOptionBytes(void)
{
...
# 267 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_ProgramWord(uint32_t Address, uint32_t Data)
{
    FLASH_Status status = FLASH_COMPLETE;
...
# 308 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_ProgramHalfWord(uint32_t Address, uint16_t Data)
{
    FLASH_Status status = FLASH_COMPLETE;
...
# 336 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_ProgramOptionByteData(uint32_t Address, uint8_t Data)
{
    FLASH_Status status = FLASH_COMPLETE;
...
# 386 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_EnableWriteProtection(uint32_t FLASH_Sectors)
{
...
# 444 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_ReadOutProtection(FunctionalState NewState)
{
    FLASH_Status status = FLASH_COMPLETE;
    uint32_t Addr = 0x1FFFF800;
...
# 502 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_UserOptionByteConfig(uint16_t OB_IWDG, uint16_t OB_STOP, uint16_t OB_STDBY)
{
    FLASH_Status status = FLASH_COMPLETE;
    uint32_t Addr = 0x1FFFF800;
...
# 547 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
uint32_t FLASH_GetUserOptionByte(void)
{
    return (uint32_t)(((FLASH_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x2000))->OBR >> 2);
}
# 559 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
uint32_t FLASH_GetWriteProtectionOptionByte(void)
{
    return (uint32_t)(((FLASH_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x2000))->WPR);
}
# 571 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FlagStatus FLASH_GetReadOutProtectionStatus(void)
{
...
# 597 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_ITConfig(uint32_t FLASH_IT, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 622 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FlagStatus FLASH_GetFlagStatus(uint32_t FLASH_FLAG)
{
...
# 662 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_ClearFlag(uint32_t FLASH_FLAG)
{
    ((FLASH_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x2000))->STATR = FLASH_FLAG;
}
# 675 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_GetStatus(void)
{
...
# 705 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_GetBank1Status(void)
{
    FLASH_Status flashstatus = FLASH_COMPLETE;
...
# 737 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_WaitForLastOperation(uint32_t Timeout)
{
    FLASH_Status status = FLASH_COMPLETE;
...
# 764 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
FLASH_Status FLASH_WaitForLastBank1Operation(uint32_t Timeout)
{
    FLASH_Status status = FLASH_COMPLETE;
...
# 788 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_Unlock_Fast(void)
{
...
# 806 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_Lock_Fast(void)
{
    ((FLASH_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x2000))->CTLR |= ((uint32_t)0x00000080);
}
# 820 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_ErasePage_Fast(uint32_t Page_Address)
{
...
# 840 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_EraseBlock_32K_Fast(uint32_t Block_Address)
{
...
# 860 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_EraseBlock_64K_Fast(uint32_t Block_Address)
{
...
# 880 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_ProgramPage_Fast(uint32_t Page_Address, uint32_t *pbuf)
{
    uint8_t size = 64;
...
# 915 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_Access_Clock_Cfg(uint32_t FLASH_Access_CLK)
{
...
# 931 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_Enhance_Mode(FunctionalState NewState)
{
    if(NewState)
    {
...
# 953 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_flash.c"
void FLASH_GetMACAddress(uint8_t *Buffer)
{
    uint32_t value;
