# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
# 10 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
...
# 1 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32v20x_libraries\\ch32v208_hal\\include/ch32v20x.h" 1
# 19 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32v20x_libraries\\ch32v208_hal\\include/ch32v20x_bkp.h" 2
...
# 11 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c" 2
...
# 118 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_DeInit(ADC_TypeDef *ADCx)
{
...
# 145 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_Init(ADC_TypeDef *ADCx, ADC_InitTypeDef *ADC_InitStruct)
{
    uint32_t tmpreg1 = 0;
    uint8_t tmpreg2 = 0;
...
# 180 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_StructInit(ADC_InitTypeDef *ADC_InitStruct)
{
...
# 200 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_Cmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 222 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_DMACmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 248 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_ITConfig(ADC_TypeDef *ADCx, uint16_t ADC_IT, FunctionalState NewState)
{
    uint8_t itmask = 0;
...
# 273 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_ResetCalibration(ADC_TypeDef *ADCx)
{
    ADCx->CTLR2 |= ((uint32_t)0x00000008);
}
# 287 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
FlagStatus ADC_GetResetCalibrationStatus(ADC_TypeDef *ADCx)
{
...
# 312 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_StartCalibration(ADC_TypeDef *ADCx)
{
    ADCx->CTLR2 |= ((uint32_t)0x00000004);
}
# 326 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
FlagStatus ADC_GetCalibrationStatus(ADC_TypeDef *ADCx)
{
    FlagStatus bitstatus = RESET;
...
# 352 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_SoftwareStartConvCmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 374 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
FlagStatus ADC_GetSoftwareStartConvStatus(ADC_TypeDef *ADCx)
{
    FlagStatus bitstatus = RESET;
...
# 402 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_DiscModeChannelCountConfig(ADC_TypeDef *ADCx, uint8_t Number)
{
    uint32_t tmpreg1 = 0;
    uint32_t tmpreg2 = 0;
...
# 425 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_DiscModeCmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 477 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_RegularChannelConfig(ADC_TypeDef *ADCx, uint8_t ADC_Channel, uint8_t Rank, uint8_t ADC_SampleTime)
{
...
# 539 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_ExternalTrigConvCmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 560 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
uint16_t ADC_GetConversionValue(ADC_TypeDef *ADCx)
{
    return (uint16_t)ADCx->RDATAR;
}
# 572 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
uint32_t ADC_GetDualModeConversionValue(void)
{
    return (*(volatile uint32_t *)((uint32_t)0x4001244C));
}
# 588 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_AutoInjectedConvCmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 611 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_InjectedDiscModeCmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 644 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_ExternalTrigInjectedConvConfig(ADC_TypeDef *ADCx, uint32_t ADC_ExternalTrigInjecConv)
{
    uint32_t tmpreg = 0;
...
# 665 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_ExternalTrigInjectedConvCmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 688 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_SoftwareStartInjectedConvCmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 709 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
FlagStatus ADC_GetSoftwareStartInjectedConvCmdStatus(ADC_TypeDef *ADCx)
{
    FlagStatus bitstatus = RESET;
...
# 765 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_InjectedChannelConfig(ADC_TypeDef *ADCx, uint8_t ADC_Channel, uint8_t Rank, uint8_t ADC_SampleTime)
{
...
# 808 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_InjectedSequencerLengthConfig(ADC_TypeDef *ADCx, uint8_t Length)
{
    uint32_t tmpreg1 = 0;
    uint32_t tmpreg2 = 0;
...
# 836 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_SetInjectedOffset(ADC_TypeDef *ADCx, uint8_t ADC_InjectedChannel, uint16_t Offset)
{
...
# 860 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
uint16_t ADC_GetInjectedConversionValue(ADC_TypeDef *ADCx, uint8_t ADC_InjectedChannel)
{
    volatile uint32_t tmp = 0;
...
# 895 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_AnalogWatchdogCmd(ADC_TypeDef *ADCx, uint32_t ADC_AnalogWatchdog)
{
    uint32_t tmpreg = 0;
...
# 918 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
...
# 953 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_AnalogWatchdogSingleChannelConfig(ADC_TypeDef *ADCx, uint8_t ADC_Channel)
{
    uint32_t tmpreg = 0;
...
# 972 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_TempSensorVrefintCmd(FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 999 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
FlagStatus ADC_GetFlagStatus(ADC_TypeDef *ADCx, uint8_t ADC_FLAG)
{
    FlagStatus bitstatus = RESET;
...
# 1030 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_ClearFlag(ADC_TypeDef *ADCx, uint8_t ADC_FLAG)
{
    ADCx->STATR = ~(uint32_t)ADC_FLAG;
}
# 1048 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
ITStatus ADC_GetITStatus(ADC_TypeDef *ADCx, uint16_t ADC_IT)
{
...
# 1081 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_ClearITPendingBit(ADC_TypeDef *ADCx, uint16_t ADC_IT)
{
    uint8_t itmask = 0;
...
# 1098 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
s32 TempSensor_Volt_To_Temper(s32 Value)
{
...
# 1121 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
void ADC_BufferCmd(ADC_TypeDef *ADCx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 1142 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
int16_t Get_CalibrationValue(ADC_TypeDef *ADCx)
{
...
# 1208 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_adc.c"
}
