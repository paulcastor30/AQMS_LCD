# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
# 10 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
...
# 19 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32v20x_libraries\\ch32v208_hal\\include/ch32v20x_usart.h" 2
...
# 11 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c" 2
...
# 68 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_DeInit(USART_TypeDef *USARTx)
{
...
# 105 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_Init(USART_TypeDef *USARTx, USART_InitTypeDef *USART_InitStruct)
{
...
# 178 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_StructInit(USART_InitTypeDef *USART_InitStruct)
{
...
# 201 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_ClockInit(USART_TypeDef *USARTx, USART_ClockInitTypeDef *USART_ClockInitStruct)
{
...
# 222 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_ClockStructInit(USART_ClockInitTypeDef *USART_ClockInitStruct)
{
...
# 241 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_Cmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 273 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_ITConfig(USART_TypeDef *USARTx, uint16_t USART_IT, FunctionalState NewState)
{
...
# 323 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_DMACmd(USART_TypeDef *USARTx, uint16_t USART_DMAReq, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 345 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SetAddress(USART_TypeDef *USARTx, uint8_t USART_Address)
{
    USARTx->CTLR2 &= ((uint16_t)0xFFF0);
    USARTx->CTLR2 |= USART_Address;
}
# 363 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_WakeUpConfig(USART_TypeDef *USARTx, uint16_t USART_WakeUp)
{
    USARTx->CTLR1 &= ((uint16_t)0xF7FF);
    USARTx->CTLR1 |= USART_WakeUp;
}
# 379 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_ReceiverWakeUpCmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 403 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_LINBreakDetectLengthConfig(USART_TypeDef *USARTx, uint16_t USART_LINBreakDetectLength)
{
    USARTx->CTLR2 &= ((uint16_t)0xFFDF);
    USARTx->CTLR2 |= USART_LINBreakDetectLength;
}
# 419 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_LINCmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 441 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SendData(USART_TypeDef *USARTx, uint16_t Data)
{
    USARTx->DATAR = (Data & (uint16_t)0x01FF);
}
# 455 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
uint16_t USART_ReceiveData(USART_TypeDef *USARTx)
{
    return (uint16_t)(USARTx->DATAR & (uint16_t)0x01FF);
}
# 469 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SendBreak(USART_TypeDef *USARTx)
{
    USARTx->CTLR1 |= ((uint16_t)0x0001);
}
# 484 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SetGuardTime(USART_TypeDef *USARTx, uint8_t USART_GuardTime)
{
    USARTx->GPR &= ((uint16_t)0x00FF);
    USARTx->GPR |= (uint16_t)((uint16_t)USART_GuardTime << 0x08);
}
# 500 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SetPrescaler(USART_TypeDef *USARTx, uint8_t USART_Prescaler)
{
    USARTx->GPR &= ((uint16_t)0xFF00);
    USARTx->GPR |= USART_Prescaler;
}
# 516 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SmartCardCmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 538 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SmartCardNACKCmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 560 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_HalfDuplexCmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 582 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_OverSampling8Cmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 604 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_OneBitMethodCmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 628 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_IrDAConfig(USART_TypeDef *USARTx, uint16_t USART_IrDAMode)
{
    USARTx->CTLR3 &= ((uint16_t)0xFFFB);
    USARTx->CTLR3 |= USART_IrDAMode;
}
# 644 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_IrDACmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 676 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
FlagStatus USART_GetFlagStatus(USART_TypeDef *USARTx, uint16_t USART_FLAG)
{
...
# 709 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_ClearFlag(USART_TypeDef *USARTx, uint16_t USART_FLAG)
{
...
# 739 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
ITStatus USART_GetITStatus(USART_TypeDef *USARTx, uint16_t USART_IT)
{
...
# 795 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_ClearITPendingBit(USART_TypeDef *USARTx, uint16_t USART_IT)
{
