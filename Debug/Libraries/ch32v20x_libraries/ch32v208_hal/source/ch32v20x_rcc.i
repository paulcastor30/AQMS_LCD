# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
# 10 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
...
# 18 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32v20x_libraries\\ch32v208_hal\\include/ch32v20x_rcc.h" 2
...
# 11 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c" 2
...
# 79 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_DeInit(void)
{
...
# 101 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_HSEConfig(uint32_t RCC_HSE)
{
...
# 129 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
ErrorStatus RCC_WaitForHSEStartUp(void)
{
...
# 164 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_AdjustHSICalibrationValue(uint8_t HSICalibrationValue)
{
  uint32_t tmpreg = 0;
...
# 183 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_HSICmd(FunctionalState NewState)
{
 if(NewState)
 {
...
# 225 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_PLLConfig(uint32_t RCC_PLLSource, uint32_t RCC_PLLMul)
{
  uint32_t tmpreg = 0;
...
# 245 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_PLLCmd(FunctionalState NewState)
{
 if(NewState)
 {
...
# 268 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_SYSCLKConfig(uint32_t RCC_SYSCLKSource)
{
  uint32_t tmpreg = 0;
...
# 287 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
uint8_t RCC_GetSYSCLKSource(void)
{
  return ((uint8_t)(((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR0 & ((uint32_t)0x0000000C)));
}
# 311 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_HCLKConfig(uint32_t RCC_SYSCLK)
{
  uint32_t tmpreg = 0;
...
# 336 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_PCLK1Config(uint32_t RCC_HCLK)
{
  uint32_t tmpreg = 0;
...
# 360 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_PCLK2Config(uint32_t RCC_HCLK)
{
  uint32_t tmpreg = 0;
...
# 385 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_ITConfig(uint8_t RCC_IT, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
...
# 411 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_USBCLKConfig(uint32_t RCC_USBCLKSource)
{
...
# 431 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_ADCCLKConfig(uint32_t RCC_PCLK2)
{
  uint32_t tmpreg = 0;
...
# 453 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_LSEConfig(uint8_t RCC_LSE)
{
...
# 482 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_LSICmd(FunctionalState NewState)
{
 if(NewState)
 {
...
# 505 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_RTCCLKConfig(uint32_t RCC_RTCCLKSource)
{
  ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->BDCTLR |= RCC_RTCCLKSource;
}
# 520 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_RTCCLKCmd(FunctionalState NewState)
{
 if(NewState)
 {
...
# 542 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_GetClocksFreq(RCC_ClocksTypeDef* RCC_Clocks)
{
...
# 644 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_AHBPeriphClockCmd(uint32_t RCC_AHBPeriph, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
...
# 678 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_APB2PeriphClockCmd(uint32_t RCC_APB2Periph, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
...
# 715 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_APB1PeriphClockCmd(uint32_t RCC_APB1Periph, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
...
# 749 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_APB2PeriphResetCmd(uint32_t RCC_APB2Periph, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
...
# 786 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_APB1PeriphResetCmd(uint32_t RCC_APB1Periph, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
...
# 807 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_BackupResetCmd(FunctionalState NewState)
{
 if(NewState)
 {
...
# 849 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_MCOConfig(uint8_t RCC_MCO)
{
  *(volatile uint8_t *) ((uint32_t)0x40021007) = RCC_MCO;
}
# 876 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
FlagStatus RCC_GetFlagStatus(uint8_t RCC_FLAG)
{
  uint32_t tmp = 0;
...
# 918 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_ClearFlag(void)
{
  ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->RSTSCKR |= ((uint32_t)0x01000000);
}
# 941 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
ITStatus RCC_GetITStatus(uint8_t RCC_IT)
{
...
# 974 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_ClearITPendingBit(uint8_t RCC_IT)
{
  *(volatile uint8_t *) ((uint32_t)0x4002100A) = RCC_IT;
}
# 988 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_ADCCLKADJcmd(FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
...
# 1011 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_rcc.c"
void RCC_ETHDIVConfig(uint32_t RCC_ETHPRE_Div)
{
