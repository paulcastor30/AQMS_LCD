# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
# 10 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
...
# 19 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32v20x_libraries\\ch32v208_hal\\include/ch32v20x_i2c.h" 2
...
# 11 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c" 2
...
# 100 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_DeInit(I2C_TypeDef *I2Cx)
{
...
# 125 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_Init(I2C_TypeDef *I2Cx, I2C_InitTypeDef *I2C_InitStruct)
{
...
# 198 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_StructInit(I2C_InitTypeDef *I2C_InitStruct)
{
...
# 218 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_Cmd(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 240 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_DMACmd(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 262 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_DMALastTransferCmd(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 284 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_GenerateSTART(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 306 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_GenerateSTOP(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 328 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_AcknowledgeConfig(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 350 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_OwnAddress2Config(I2C_TypeDef *I2Cx, uint8_t Address)
{
    uint16_t tmpreg = 0;
...
# 370 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_DualAddressCmd(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 392 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_GeneralCallCmd(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 418 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_ITConfig(I2C_TypeDef *I2Cx, uint16_t I2C_IT, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 440 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_SendData(I2C_TypeDef *I2Cx, uint8_t Data)
{
    I2Cx->DATAR = Data;
}
# 454 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
uint8_t I2C_ReceiveData(I2C_TypeDef *I2Cx)
{
    return (uint8_t)I2Cx->DATAR;
}
# 473 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_Send7bitAddress(I2C_TypeDef *I2Cx, uint8_t Address, uint8_t I2C_Direction)
{
...
# 506 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
uint16_t I2C_ReadRegister(I2C_TypeDef *I2Cx, uint8_t I2C_Register)
{
...
# 526 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_SoftwareResetCmd(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 552 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_NACKPositionConfig(I2C_TypeDef *I2Cx, uint16_t I2C_NACKPosition)
{
...
# 576 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_SMBusAlertConfig(I2C_TypeDef *I2Cx, uint16_t I2C_SMBusAlert)
{
...
# 598 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_TransmitPEC(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 622 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_PECPositionConfig(I2C_TypeDef *I2Cx, uint16_t I2C_PECPosition)
{
...
# 644 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_CalculatePEC(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 665 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
uint8_t I2C_GetPEC(I2C_TypeDef *I2Cx)
{
    return ((I2Cx->STAR2) >> 8);
}
# 680 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_ARPCmd(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 702 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_StretchClockCmd(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    if(NewState == DISABLE)
    {
...
# 726 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_FastModeDutyCycleConfig(I2C_TypeDef *I2Cx, uint16_t I2C_DutyCycle)
{
...
# 769 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
ErrorStatus I2C_CheckEvent(I2C_TypeDef *I2Cx, uint32_t I2C_EVENT)
{
...
# 802 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
uint32_t I2C_GetLastEvent(I2C_TypeDef *I2Cx)
{
    uint32_t lastevent = 0;
    uint32_t flag1 = 0, flag2 = 0;
...
# 848 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
FlagStatus I2C_GetFlagStatus(I2C_TypeDef *I2Cx, uint32_t I2C_FLAG)
{
...
# 896 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_ClearFlag(I2C_TypeDef *I2Cx, uint32_t I2C_FLAG)
{
    uint32_t flagpos = 0;
...
# 929 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
ITStatus I2C_GetITStatus(I2C_TypeDef *I2Cx, uint32_t I2C_IT)
{
...
# 966 "../Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
void I2C_ClearITPendingBit(I2C_TypeDef *I2Cx, uint32_t I2C_IT)
{
    uint32_t flagpos = 0;
