...
ch32_pin_get:
.LFB42:
	.file 2 "../Libraries/ch32_drivers/drv_gpio.c"
	.loc 2 97 1
	.cfi_startproc
	addi	sp,sp,-64
...
.LFB53:
	...
	.loc 2 452 5
 #APP
# 452 "../Libraries/ch32_drivers/drv_gpio.c" 1
...
.L74:
	...
	.loc 2 462 5
 #APP
# 462 "../Libraries/ch32_drivers/drv_gpio.c" 1
	csrrw sp,mscratch,sp
# 0 "" 2
	.loc 2 463 1
 #NO_APP
...
.LFB54:
	...
	.loc 2 467 5
 #APP
# 467 "../Libraries/ch32_drivers/drv_gpio.c" 1
	csrrw sp,mscratch,sp
# 0 "" 2
	.loc 2 468 5
 #NO_APP
...
.L76:
	...
	.loc 2 475 5
 #APP
# 475 "../Libraries/ch32_drivers/drv_gpio.c" 1
	csrrw sp,mscratch,sp
# 0 "" 2
	.loc 2 476 1
 #NO_APP
...
.LFB55:
	...
	.loc 2 480 5
 #APP
# 480 "../Libraries/ch32_drivers/drv_gpio.c" 1
	csrrw sp,mscratch,sp
# 0 "" 2
	.loc 2 481 5
 #NO_APP
...
.L78:
	...
	.loc 2 488 5
 #APP
# 488 "../Libraries/ch32_drivers/drv_gpio.c" 1
	csrrw sp,mscratch,sp
# 0 "" 2
	.loc 2 489 1
 #NO_APP
...
.LFB56:
	...
	.loc 2 493 5
 #APP
# 493 "../Libraries/ch32_drivers/drv_gpio.c" 1
	csrrw sp,mscratch,sp
# 0 "" 2
	.loc 2 494 5
 #NO_APP
...
.L80:
	...
	.loc 2 501 5
 #APP
# 501 "../Libraries/ch32_drivers/drv_gpio.c" 1
	csrrw sp,mscratch,sp
# 0 "" 2
	.loc 2 502 1
 #NO_APP
...
.LFB57:
	...
	.loc 2 506 5
 #APP
# 506 "../Libraries/ch32_drivers/drv_gpio.c" 1
	csrrw sp,mscratch,sp
# 0 "" 2
	.loc 2 507 5
 #NO_APP
...
.L82:
	...
	.loc 2 514 5
 #APP
# 514 "../Libraries/ch32_drivers/drv_gpio.c" 1
	csrrw sp,mscratch,sp
# 0 "" 2
	.loc 2 515 1
 #NO_APP
...
.LFB58:
	...
	.loc 2 519 5
 #APP
# 519 "../Libraries/ch32_drivers/drv_gpio.c" 1
	csrrw sp,mscratch,sp
# 0 "" 2
	.loc 2 520 5
 #NO_APP
...
.L85:
	...
	.loc 2 535 5
 #APP
# 535 "../Libraries/ch32_drivers/drv_gpio.c" 1
	csrrw sp,mscratch,sp
# 0 "" 2
	.loc 2 536 1
 #NO_APP
...
.Letext0:
	...
	.file 14 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32v20x_libraries\\ch32v208_hal\\include/ch32v20x_exti.h"
	.file 15 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32v20x_libraries\\ch32v208_hal\\include/ch32v20x_gpio.h"
	...
	.file 18 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\drivers\\include/drivers/pin.h"
	.file 19 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32_drivers/drv_gpio.h"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.file 84 "../Libraries/ch32_drivers/drv_gpio.h"
	.byte	0x3
	.byte	0xc
	.byte	0x54
	.byte	0x4
...
.LASF6116:
	.string	"../Libraries/ch32_drivers/drv_gpio.c"
.LASF5936:
	.string	"EXTI_LineCmd"
.LASF1419:
