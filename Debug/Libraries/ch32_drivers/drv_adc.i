# 1 "../Libraries/ch32_drivers/drv_adc.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32_drivers/drv_adc.c"
# 11 "../Libraries/ch32_drivers/drv_adc.c"
...
# 12 "../Libraries/ch32_drivers/drv_adc.c" 2


# 1 "../Libraries/ch32_drivers/drv_adc.h" 1
# 12 "../Libraries/ch32_drivers/drv_adc.h"
#define DRV_ADC_H__ 
typedef struct
{
...
# 15 "../Libraries/ch32_drivers/drv_adc.c" 2




#define LOG_TAG "drv.adc"
# 1 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32_drivers/drv_log.h" 1
# 18 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32_drivers/drv_log.h"
...
# 27 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32_drivers/drv_log.h" 2
# 21 "../Libraries/ch32_drivers/drv_adc.c" 2

static ADC_HandleTypeDef adc_config[] =
{

    {
        .Instance = ((ADC_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x2400)),
        .Init.ADC_Mode = ((uint32_t)0x00000000),
        .Init.ADC_ScanConvMode = DISABLE,
        .Init.ADC_ContinuousConvMode = DISABLE,
        .Init.ADC_ExternalTrigConv = ((uint32_t)0x000E0000),
        .Init.ADC_DataAlign = ((uint32_t)0x00000000),
        .Init.ADC_NbrOfChannel = 1,
    },
# 47 "../Libraries/ch32_drivers/drv_adc.c"
};
...
{
    if (!(device)) { rt_assert_handler("device", __FUNCTION__, 65); };
    return 3300;
}
...
static rt_err_t ch32_adc_enabled(struct rt_adc_device *device, rt_uint32_t channel, rt_bool_t enabled)
{
    ...
    if (!(device != 0)) { rt_assert_handler("device != RT_NULL", __FUNCTION__, 72); };
...
static rt_uint32_t ch32_adc_get_channel(rt_uint32_t channel)
{
    ...
    {
    case 0:
        ch32_channel = ((uint8_t)0x00);
        break;
    case 1:
        ch32_channel = ((uint8_t)0x01);
        break;
    case 2:
        ch32_channel = ((uint8_t)0x02);
        break;
    case 3:
        ch32_channel = ((uint8_t)0x03);
        break;
    case 4:
        ch32_channel = ((uint8_t)0x04);
        break;
    case 5:
        ch32_channel = ((uint8_t)0x05);
        break;
    case 6:
        ch32_channel = ((uint8_t)0x06);
        break;
    case 7:
        ch32_channel = ((uint8_t)0x07);
        break;
    case 8:
        ch32_channel = ((uint8_t)0x08);
        break;
    case 9:
        ch32_channel = ((uint8_t)0x09);
        break;
    case 10:
        ch32_channel = ((uint8_t)0x0A);
        break;
    case 11:
        ch32_channel = ((uint8_t)0x0B);
        break;
    case 12:
        ch32_channel = ((uint8_t)0x0C);
        break;
    case 13:
        ch32_channel = ((uint8_t)0x0D);
        break;
    case 14:
        ch32_channel = ((uint8_t)0x0E);
        break;
    case 15:
        ch32_channel = ((uint8_t)0x0F);
        break;
# 161 "../Libraries/ch32_drivers/drv_adc.c"
    }
...
static rt_err_t ch32_get_adc_value(struct rt_adc_device *device, rt_uint32_t channel, rt_uint32_t *value)
{
    ...
    if (!(device != 0)) { rt_assert_handler("device != RT_NULL", __FUNCTION__, 171); };
    if (!(value != 0)) { rt_assert_handler("value != RT_NULL", __FUNCTION__, 172); };
    ...
    if (channel == 16)
    {
        do { rt_kprintf("[" "E" "/" "drv.adc" "] "); rt_kprintf("ADC channel must not be 16."); rt_kprintf("\n"); } while (0);
        return -1;
    }
    ...
    else
    {
        ...
        do { rt_kprintf("[" "E" "/" "drv.adc" "] "); rt_kprintf("ADC channel must be between 0 and 17."); rt_kprintf("\n"); } while (0);
    ...
    ADC_ChanConf.Rank = 1;
    ADC_ChanConf.SamplingTime = ((uint8_t)0x07);
    ...
    while(!ADC_GetFlagStatus(ch32_adc_handler->Instance, ((uint8_t)0x02) ));

    *value = (rt_uint32_t)ADC_GetConversionValue(ch32_adc_handler->Instance);
    ADC_ClearFlag( ch32_adc_handler->Instance, ((uint8_t)0x02));
...
static int ch32_adc_init(void)
{
    ...
    for (i = 0; i < sizeof(adc_config) / sizeof(adc_config[0]); i++)
    {
        ...
        if (ch32_adc_obj[i].ADC_Handler.Instance == ((ADC_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x2400)))
        {
            name_buf[3] = '1';
        ...
        if (ch32_adc_obj[i].ADC_Handler.Instance == ((ADC_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x2800)))
        {
            name_buf[3] = '2';
...

        {
            ...
            if (rt_hw_adc_register(&ch32_adc_obj[i].ch32_adc_device, name_buf, &ch32_adc_ops, &ch32_adc_obj[i].ADC_Handler) == 0)
            {
                ;
            }
            else
            {
                do { rt_kprintf("[" "E" "/" "drv.adc" "] "); rt_kprintf("%s register failed", name_buf); rt_kprintf("\n"); } while (0);
                result = -1;
            }
        }
    }
...
__attribute__((used)) const init_fn_t __rt_init_ch32_adc_init __attribute__((section(".rti_fn." "3"))) = ch32_adc_init;
