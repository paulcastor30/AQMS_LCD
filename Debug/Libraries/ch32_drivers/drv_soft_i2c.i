# 1 "../Libraries/ch32_drivers/drv_soft_i2c.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32_drivers/drv_soft_i2c.c"
# 11 "../Libraries/ch32_drivers/drv_soft_i2c.c"
...
# 12 "../Libraries/ch32_drivers/drv_soft_i2c.c" 2
# 1 "../Libraries/ch32_drivers/drv_soft_i2c.h" 1
# 12 "../Libraries/ch32_drivers/drv_soft_i2c.h"
#define __DRV_I2C__ 
...
#define I2C1_BUS_CONFIG { .scl = BSP_I2C1_SCL_PIN, .sda = BSP_I2C1_SDA_PIN, .bus_name = "i2c1", }
# 51 "../Libraries/ch32_drivers/drv_soft_i2c.h"
int rt_hw_i2c_init(void);
# 13 "../Libraries/ch32_drivers/drv_soft_i2c.c" 2
...
# 19 "../Libraries/ch32_drivers/drv_soft_i2c.c" 2
...
static void ch32_i2c_gpio_init(struct ch32_i2c *i2c)
{
    ...
    rt_pin_mode(cfg->scl, 0x04);
    rt_pin_mode(cfg->sda, 0x04);

    rt_pin_write(cfg->scl, 0x01);
    rt_pin_write(cfg->sda, 0x01);
}
...
static void ch32_udelay(rt_uint32_t us)
{
    ...
    rt_uint32_t reload = ((SysTick_Type *) 0xE000F000)->CMP;

    ticks = us * reload / (1000000 / 1000);
    told = ((SysTick_Type *) 0xE000F000)->CNT;
    while (1)
    {
        tnow = ((SysTick_Type *) 0xE000F000)->CNT;
        if (tnow != told)
        {
            if (tnow > told)
            {
...
int rt_hw_i2c_init(void)
{
    ...
    for (int i = 0; i < obj_num; i++)
    {
        ...
        if (!(result == 0)) { rt_assert_handler("result == RT_EOK", __FUNCTION__, 202); };
...
__attribute__((used)) const init_fn_t __rt_init_rt_hw_i2c_init __attribute__((section(".rti_fn." "1"))) = rt_hw_i2c_init;
