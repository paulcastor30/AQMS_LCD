# 1 "../Libraries/ch32_drivers/drv_pwm.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32_drivers/drv_pwm.c"
# 13 "../Libraries/ch32_drivers/drv_pwm.c"
# 1 "../Libraries/ch32_drivers/drv_pwm.h" 1
# 12 "../Libraries/ch32_drivers/drv_pwm.h"
...
# 15 "../Libraries/ch32_drivers/drv_pwm.h" 2
...
# 21 "../Libraries/ch32_drivers/drv_pwm.h" 2
...
# 23 "../Libraries/ch32_drivers/drv_pwm.h" 2
...
# 24 "../Libraries/ch32_drivers/drv_pwm.h" 2
...
# 25 "../Libraries/ch32_drivers/drv_pwm.h" 2
...
# 14 "../Libraries/ch32_drivers/drv_pwm.c" 2
...
# 19 "../Libraries/ch32_drivers/drv_pwm.c" 2

#define ITEM_NUM(items) sizeof(items) / sizeof(items[0])

void ch32_tim_clock_init(TIM_TypeDef* timx)
{
# 81 "../Libraries/ch32_drivers/drv_pwm.c"
}
...
# 484 "../Libraries/ch32_drivers/drv_pwm.c"
}
...
{
# 730 "../Libraries/ch32_drivers/drv_pwm.c"
};
...
static rt_err_t ch32_pwm_device_enable(struct rt_device_pwm* device, struct rt_pwm_configuration* configuration, rt_bool_t enable)
{
    ...
    if (enable == 1)
    {
        ccx_state = ((uint16_t)0x0001);
    }
    else
    {
        ccx_state = ((uint16_t)0x0000);
    }
...
static rt_err_t ch32_pwm_device_set(struct rt_device_pwm* device, struct rt_pwm_configuration* configuration)
{
    ...
    TIM_TimeBaseInitType.TIM_ClockDivision = ((uint16_t)0x0000);
    TIM_TimeBaseInitType.TIM_CounterMode = ((uint16_t)0x0000);
    TIM_TimeBaseInit(pwm_device->periph, &TIM_TimeBaseInitType);

    TIM_OCStructInit(&TIM_OCInitType);
    TIM_OCInitType.TIM_OCMode = ((uint16_t)0x0060);
    TIM_OCInitType.TIM_OutputState = ((uint16_t)0x0001);
    TIM_OCInitType.TIM_Pulse = ccr_counter - 1;
    TIM_OCInitType.TIM_OCPolarity = ((uint16_t)0x0000);

    if (channel_index == 1)
    {
        TIM_OC1Init(pwm_device->periph, &TIM_OCInitType);
        TIM_OC1PreloadConfig(pwm_device->periph, ((uint16_t)0x0000));
    }
    else if (channel_index == 2)
    {
        TIM_OC2Init(pwm_device->periph, &TIM_OCInitType);
        TIM_OC2PreloadConfig(pwm_device->periph, ((uint16_t)0x0000));
    }
    else if (channel_index == 3)
    {
        TIM_OC3Init(pwm_device->periph, &TIM_OCInitType);
        TIM_OC3PreloadConfig(pwm_device->periph, ((uint16_t)0x0000));
    }
    else if (channel_index == 4)
    {
        TIM_OC4Init(pwm_device->periph, &TIM_OCInitType);
        TIM_OC4PreloadConfig(pwm_device->periph, ((uint16_t)0x0000));
    }
    else
    {
        return -10;
...
static rt_err_t drv_pwm_control(struct rt_device_pwm* device, int cmd, void* arg)
{
    ...
    switch (cmd)
    {
    case (((RT_Device_Class_PWM + 1) * 0x100) + 0):
        return ch32_pwm_device_enable(device, configuration, 1);
    case (((RT_Device_Class_PWM + 1) * 0x100) + 1):
        return ch32_pwm_device_enable(device, configuration, 0);
    case (((RT_Device_Class_PWM + 1) * 0x100) + 2):
        return ch32_pwm_device_set(device, configuration);
    case (((RT_Device_Class_PWM + 1) * 0x100) + 3):
...
static int rt_hw_pwm_init(void)
{
    ...
    for (index = 0; index < sizeof(pwm_device_list) / sizeof(pwm_device_list[0]); index++)
    {
        ...
        if (rt_device_pwm_register(&pwm_device_list[index].parent, pwm_device_list[index].name, &pwm_ops, 0) == 0)
        {
            ;
        }
        else
...
__attribute__((used)) const init_fn_t __rt_init_rt_hw_pwm_init __attribute__((section(".rti_fn." "1"))) = rt_hw_pwm_init;
