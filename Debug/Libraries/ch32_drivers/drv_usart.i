# 1 "../Libraries/ch32_drivers/drv_usart.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32_drivers/drv_usart.c"
# 11 "../Libraries/ch32_drivers/drv_usart.c"
...
# 12 "../Libraries/ch32_drivers/drv_usart.c" 2

# 1 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32_drivers/drv_usart.h" 1
# 12 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\Libraries\\ch32_drivers/drv_usart.h"
...
# 14 "../Libraries/ch32_drivers/drv_usart.c" 2
...
# 20 "../Libraries/ch32_drivers/drv_usart.c" 2
...
enum
{
    ...
    UART2_INDEX,
# 53 "../Libraries/ch32_drivers/drv_usart.c"
};
...
static struct ch32_uart_hw_config uart_hw_config[] =
{
...

    {
        ...
        ((uint32_t)0x00020000), ((uint32_t)0x00000004),

        ((GPIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0004), ((GPIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0008),


        0,
    },
# 147 "../Libraries/ch32_drivers/drv_usart.c"
};
...
# 207 "../Libraries/ch32_drivers/drv_usart.c"
};
...
static rt_err_t ch32_configure(struct rt_serial_device *serial, struct serial_configure *cfg)
{
    ...
    if (!(serial != 0)) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 216); };
    if (!(cfg != 0)) { rt_assert_handler("cfg != RT_NULL", __FUNCTION__, 217); };
...
{
    struct ch32_uart *uart;
    if (!(serial != 0)) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 300); };
    uart = (struct ch32_uart *)serial->parent.user_data;
    switch (cmd)
    {
...
{
    struct ch32_uart *uart;
    if (!(serial != 0)) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 325); };
    uart = (struct ch32_uart *)serial->parent.user_data;
...
static int ch32_getc(struct rt_serial_device *serial)
{
    int ch;
    struct ch32_uart *uart;
    if (!(serial != 0)) { rt_assert_handler("serial != RT_NULL", __FUNCTION__, 336); };
    uart = (struct ch32_uart *)serial->parent.user_data;
    ch = -1;
...
static void uart_isr(struct rt_serial_device *serial)
{
    ...
    if (!(uart != 0)) { rt_assert_handler("uart != RT_NULL", __FUNCTION__, 354); };
...
# 499 "../Libraries/ch32_drivers/drv_usart.c"
int rt_hw_usart_init(void)
{
    ...
    for (int i = 0; i < obj_num; i++)
    {
        ...
        {
            do { rt_kprintf("[" "E" "/" "drv.uart" "] "); rt_kprintf("You did not perform hardware initialization for %s", uart_obj[i].config->name); rt_kprintf("\n"); } while (0);
            continue;
        }
        ...
        result = rt_hw_serial_register(&uart_obj[i].serial, uart_obj[i].config->name,
                                       ...
                                       | 0x100
                                       , &uart_obj[i]);
        if (!(result == 0)) { rt_assert_handler("result == RT_EOK", __FUNCTION__, 529); };
    }
