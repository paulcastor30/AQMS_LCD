# 1 "../Libraries/ch32_drivers/drv_common.c"
...
# 1 "<command-line>" 2
# 1 "../Libraries/ch32_drivers/drv_common.c"
# 11 "../Libraries/ch32_drivers/drv_common.c"
...
# 12 "../Libraries/ch32_drivers/drv_common.c" 2
# 1 "../Libraries/ch32_drivers/drv_common.h" 1
# 12 "../Libraries/ch32_drivers/drv_common.h"
...
void rt_hw_us_delay(rt_uint32_t us);
# 13 "../Libraries/ch32_drivers/drv_common.c" 2
...
# 14 "../Libraries/ch32_drivers/drv_common.c" 2
...
# 19 "../Libraries/ch32_drivers/drv_common.c" 2

void rt_hw_us_delay(rt_uint32_t us)
{
    rt_uint64_t total_delay_ticks, us_ticks, start, now, delta, reload;

    start = ((SysTick_Type *) 0xE000F000)->CNT;
    reload = ((SysTick_Type *) 0xE000F000)->CMP;
    us_ticks = SystemCoreClock / 8000000UL;
    total_delay_ticks = us * us_ticks;
    if (total_delay_ticks >= reload)
    {
        do { rt_kprintf("[" "E" "/" "drv.common" "] "); rt_kprintf("rt_hw_us_delay: the us parameter exceeds the maximum limit!"); rt_kprintf("\n"); } while (0);
    }

    do {
        now = ((SysTick_Type *) 0xE000F000)->CNT;
