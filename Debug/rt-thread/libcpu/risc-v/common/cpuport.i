# 1 "../rt-thread/libcpu/risc-v/common/cpuport.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/libcpu/risc-v/common/cpuport.c"
# 13 "../rt-thread/libcpu/risc-v/common/cpuport.c"
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 14 "../rt-thread/libcpu/risc-v/common/cpuport.c" 2
...
# 15 "../rt-thread/libcpu/risc-v/common/cpuport.c" 2
...
#define LOAD lw
#define REGBYTES 4
# 17 "../rt-thread/libcpu/risc-v/common/cpuport.c" 2
...
# 18 "../rt-thread/libcpu/risc-v/common/cpuport.c" 2


volatile rt_ubase_t rt_interrupt_from_thread = 0;
volatile rt_ubase_t rt_interrupt_to_thread = 0;
volatile rt_uint32_t rt_thread_switch_interrupt_flag = 0;
# 35 "../rt-thread/libcpu/risc-v/common/cpuport.c"
...
# 87 "../rt-thread/libcpu/risc-v/common/cpuport.c"
...
__attribute__((weak)) void rt_hw_cpu_shutdown()
{
    ...
    while (level)
    {
        if (!(0)) { rt_assert_handler("0", __FUNCTION__, 110); };
    }
}
