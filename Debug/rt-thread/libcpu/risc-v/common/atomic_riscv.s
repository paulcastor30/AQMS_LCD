...
.LFB19:
	.file 1 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c"
	.loc 1 14 1
	.cfi_startproc
	addi	sp,sp,-48
	...
	lw	a4,-36(s0)
 #APP
# 17 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c" 1
	amoswap.w a5, a5, (a4)
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.LFB20:
	...
	lw	a4,-36(s0)
 #APP
# 28 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c" 1
	amoadd.w a5, a5, (a4)
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.LFB21:
	...
	lw	a4,-36(s0)
 #APP
# 40 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c" 1
	amoadd.w a5, a5, (a4)
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.LFB22:
	...
	lw	a4,-36(s0)
 #APP
# 51 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c" 1
	amoxor.w a5, a5, (a4)
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.LFB23:
	...
	lw	a4,-36(s0)
 #APP
# 62 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c" 1
	amoand.w a5, a5, (a4)
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.LFB24:
	...
	lw	a4,-36(s0)
 #APP
# 73 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c" 1
	amoor.w a5, a5, (a4)
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.LFB25:
	...
	lw	a5,-36(s0)
 #APP
# 84 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c" 1
	amoxor.w a5, x0, (a5)
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.LFB26:
	...
	lw	a4,-36(s0)
 #APP
# 95 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c" 1
	amoswap.w a5, a5, (a4)
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.LFB27:
	...
	lw	a4,-36(s0)
 #APP
# 106 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c" 1
	amoor.w a5, a5, (a4)
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.LFB28:
	...
	lw	a5,-36(s0)
 #APP
# 117 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c" 1
	amoand.w a5, x0, (a5)
# 0 "" 2
 #NO_APP
	sw	a5,-20(s0)
...
.LFB29:
	...
	lw	a5,-36(s0)
 #APP
# 128 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c" 1
	 fence iorw, ow
1: lr.w.aq  a3, (a5)
   bne      a3, a4, 2f
   sc.w.rl  a4, a2, (a5)
...
.Ldebug_macro0:
	...
	.byte	0x19
	.4byte	.LASF324
	.file 7 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD/rtconfig.h"
	.byte	0x3
	.byte	0x1b
	.byte	0x7
	.byte	0x7
	...
	.4byte	.Ldebug_macro7
	.byte	0x4
	.file 13 "c:\\rt-threadstudio\\repo\\extract\\toolchain_support_packages\\wch\\risc-v-gcc-wch\\8.2.0\\riscv-none-embed\\include\\sys\\_stdint.h"
	.byte	0x3
	.byte	0xe
	.byte	0xd
	.byte	0x7
...
.LASF1143:
	.string	"../rt-thread/libcpu/risc-v/common/atomic_riscv.c"
.LASF165:
