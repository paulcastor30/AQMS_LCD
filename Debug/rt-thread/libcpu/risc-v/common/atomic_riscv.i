# 1 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c"
# 11 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c"
...
# 12 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c" 2
...
rt_atomic_t rt_hw_atomic_compare_exchange_strong(volatile rt_atomic_t *ptr, rt_atomic_t *old, rt_atomic_t desired)
{
    ...
    asm volatile(
            ...
            : "memory");
# 158 "../rt-thread/libcpu/risc-v/common/atomic_riscv.c"
    return result;
}
