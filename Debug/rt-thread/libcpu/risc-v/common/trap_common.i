# 1 "../rt-thread/libcpu/risc-v/common/trap_common.c"
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 2 "../rt-thread/libcpu/risc-v/common/trap_common.c" 2
...
# 3 "../rt-thread/libcpu/risc-v/common/trap_common.c" 2
# 1 "../rt-thread/libcpu/risc-v/common/riscv-ops.h" 1
# 12 "../rt-thread/libcpu/risc-v/common/riscv-ops.h"
...
# 4 "../rt-thread/libcpu/risc-v/common/trap_common.c" 2
# 1 "../rt-thread/libcpu/risc-v/common/rt_hw_stack_frame.h" 1
# 12 "../rt-thread/libcpu/risc-v/common/rt_hw_stack_frame.h"
#define RISCV_STACKFRAME_H 

# 1 "../rt-thread/libcpu/risc-v/common/cpuport.h" 1
# 14 "../rt-thread/libcpu/risc-v/common/cpuport.h"
#define CPUPORT_H__ 
# 45 "../rt-thread/libcpu/risc-v/common/cpuport.h"
#define STORE sw
#define LOAD lw
#define REGBYTES 4
# 15 "../rt-thread/libcpu/risc-v/common/rt_hw_stack_frame.h" 2
...
typedef struct rt_hw_stack_frame
{
    ...
    rt_ubase_t t5;
    rt_ubase_t t6;
# 86 "../rt-thread/libcpu/risc-v/common/rt_hw_stack_frame.h"
}rt_hw_stack_frame_t;
# 5 "../rt-thread/libcpu/risc-v/common/trap_common.c" 2
...
# 46 "../rt-thread/libcpu/risc-v/common/trap_common.c"
