# 1 "../rt-thread/components/drivers/rtc/rtc.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/drivers/rtc/rtc.c"
# 17 "../rt-thread/components/drivers/rtc/rtc.c"
...
# 18 "../rt-thread/components/drivers/rtc/rtc.c" 2
...
# 19 "../rt-thread/components/drivers/rtc/rtc.c" 2
...
# 20 "../rt-thread/components/drivers/rtc/rtc.c" 2
...
# 21 "../rt-thread/components/drivers/rtc/rtc.c" 2
...
static rt_err_t rt_rtc_init(struct rt_device *dev)
{
    ...
    if (!(dev != 0)) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 32); };
...
#define TRY_DO_RTC_FUNC(rt_rtc_dev,func_name,args) rt_rtc_dev->ops->func_name ? rt_rtc_dev->ops->func_name(args) : -RT_EINVAL;
    ...
    if (!(dev != 0)) { rt_assert_handler("dev != RT_NULL", __FUNCTION__, 63); };
...
# 107 "../rt-thread/components/drivers/rtc/rtc.c"
rt_err_t rt_hw_rtc_register(rt_rtc_dev_t *rtc,
                            const char *name,
                            rt_uint32_t flag,
                            void *data)
{
    ...
    if (!(rtc != 0)) { rt_assert_handler("rtc != RT_NULL", __FUNCTION__, 113); };
...
# 146 "../rt-thread/components/drivers/rtc/rtc.c"
rt_err_t set_date(rt_uint32_t year, rt_uint32_t month, rt_uint32_t day)
{
...
# 193 "../rt-thread/components/drivers/rtc/rtc.c"
rt_err_t set_time(rt_uint32_t hour, rt_uint32_t minute, rt_uint32_t second)
{
    time_t now, old_timestamp = 0;
    struct tm tm_new = {0};
...
# 238 "../rt-thread/components/drivers/rtc/rtc.c"
rt_err_t set_timestamp(time_t timestamp)
{
    if (_rtc_device == 0)
    {
...
# 260 "../rt-thread/components/drivers/rtc/rtc.c"
rt_err_t get_timestamp(time_t *timestamp)
{
    if (_rtc_device == 0)
    {
