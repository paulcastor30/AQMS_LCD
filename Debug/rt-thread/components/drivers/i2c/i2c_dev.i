...
# 14 "../rt-thread/components/drivers/i2c/i2c_dev.c" 2
...
# 22 "../rt-thread/components/drivers/i2c/i2c_dev.c" 2
                                     ...
                                     rt_size_t count)
{
    ...
    if (!(bus != 0)) { rt_assert_handler("bus != RT_NULL", __FUNCTION__, 32); };
    if (!(buffer != 0)) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 33); };

    do { rt_kprintf("[" "D" "/" "I2C" "] "); rt_kprintf("I2C bus dev [%s] reading %u bytes.", dev->parent.name, count); rt_kprintf("\n"); } while (0);
                                      ...
                                      rt_size_t count)
{
    ...
    if (!(bus != 0)) { rt_assert_handler("bus != RT_NULL", __FUNCTION__, 52); };
    if (!(buffer != 0)) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 53); };

    do { rt_kprintf("[" "D" "/" "I2C" "] "); rt_kprintf("I2C bus dev [%s] writing %u bytes.", dev->parent.name, count); rt_kprintf("\n"); } while (0);
                                       ...
                                       void *args)
{
    ...
    if (!(bus != 0)) { rt_assert_handler("bus != RT_NULL", __FUNCTION__, 72); };
                                       ...
                                       const char *name)
{
    ...
    if (!(bus != 0)) { rt_assert_handler("bus != RT_NULL", __FUNCTION__, 122); };
