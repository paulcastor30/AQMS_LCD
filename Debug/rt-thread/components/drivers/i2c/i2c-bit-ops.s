...
i2c_delay:
.LFB24:
	.file 1 "../rt-thread/components/drivers/i2c/i2c-bit-ops.c"
	.loc 1 27 1
	.cfi_startproc
	addi	sp,sp,-32
...
.LC0:
	...
	.align	2
.LC1:
	.string	"wait %ld tick for SCL line to go high"
	.align	2
.LC2:
	.string	"\n"
	.text
...
.LC3:
	...
	.align	2
.LC4:
	.string	"I2C bus error, SCL line low"
	.align	2
.LC5:
	.string	"I2C bus error, SDA line low"
	.text
	.align	1
...
.LVL14:
	...
	lw	a5,-20(s0)
	beqz	a5,.L20
	.loc 1 125 46 is_stmt 0 discriminator 1
	lla	a5,.LC8
	j	.L21
.L20:
	.loc 1 125 46 discriminator 2
	lla	a5,.LC9
.L21:
	.loc 1 125 46 discriminator 4
	mv	a1,a5
	lla	a0,.LC10
	call	rt_kprintf
	.loc 1 125 86 is_stmt 1 discriminator 4
	lla	a0,.LC2
	call	rt_kprintf
	.loc 1 127 8 discriminator 4
	lw	a5,-36(s0)
	lw	a4,8(a5)
...
.LFE30:
	...
	.align	2
.LC11:
	.string	"i2c_writeb: 0x%02x, wait scl pin high timeout at bit %d"
	.text
	.align	1
...
.LFE31:
	...
	.align	2
.LC12:
	.string	"i2c_readb: wait scl pin high timeout at bit %d"
	.text
	.align	1
...
.LFE32:
	...
	.align	2
.LC13:
	.string	"send bytes: NACK."
	.align	2
.LC14:
	.string	"send bytes: error %d"
	.text
	.align	1
...
.L54:
	...
	.loc 1 268 50
	bnez	a5,.L49
	.loc 1 268 150 discriminator 1
	lw	a5,-28(s0)
	beqz	a5,.L50
	.loc 1 268 150 is_stmt 0 discriminator 3
	lla	a5,.LC8
	j	.L52
.L50:
	.loc 1 268 150 discriminator 4
	lla	a5,.LC9
	j	.L52
.L49:
	.loc 1 268 50 is_stmt 1 discriminator 2
	lla	a5,.LC16
.L52:
	.loc 1 268 50 is_stmt 0 discriminator 8
	mv	a2,a5
	lw	a1,-36(s0)
	lla	a0,.LC17
	call	rt_kprintf
	.loc 1 268 162 is_stmt 1 discriminator 8
	lla	a0,.LC2
	call	rt_kprintf
	.loc 1 272 21 discriminator 8
	lw	a5,-32(s0)
	andi	a5,a5,64
	.loc 1 272 12 discriminator 8
	bnez	a5,.L45
	.loc 1 274 19
	lw	a1,-28(s0)
	lw	a0,-52(s0)
...
.LFE35:
	...
	.align	2
.LC18:
	.string	"send stop condition"
	.align	2
.LC19:
	.string	"send start condition"
	.text
	.align	1
...
.L59:
	...
	lla	a0,.LC0
	call	rt_kprintf
	.loc 1 296 50 discriminator 2
	lla	a0,.LC18
	call	rt_kprintf
	.loc 1 296 85 discriminator 2
	lla	a0,.LC2
	call	rt_kprintf
	...
	lw	a0,-28(s0)
	call	i2c_delay2
	.loc 1 299 14 discriminator 2
	lla	a0,.LC0
	call	rt_kprintf
	.loc 1 299 50 discriminator 2
	lla	a0,.LC19
	call	rt_kprintf
	.loc 1 299 86 discriminator 2
	lla	a0,.LC2
	call	rt_kprintf
...
.LFE36:
	...
	.align	2
.LC20:
	.string	"addr1: %d, addr2: %d"
	.align	2
.LC21:
	.string	"NACK: sending first addr"
	.align	2
.LC22:
	.string	"NACK: sending second addr"
	.align	2
.LC23:
	.string	"send repeated start condition"
	.align	2
.LC24:
	.string	"NACK: sending repeated addr"
	.text
	.align	1
...
.LFE37:
	...
	.align	2
.LC25:
	.string	"receive NACK from device addr 0x%02x msg %d"
	.align	2
.LC26:
	.string	""
	.align	2
.LC27:
	...
	.align	2
.LC28:
	.string	"read %d byte%s"
	.align	2
.LC29:
	.string	"write %d byte%s"
	.text
	.align	1
...
.L74:
	...
	li	a5,1
	bne	a4,a5,.L80
	.loc 1 409 58 is_stmt 0 discriminator 1
	lla	a5,.LC26
	j	.L81
.L80:
	.loc 1 409 58 discriminator 2
	lla	a5,.LC27
.L81:
	.loc 1 409 58 discriminator 4
	mv	a2,a5
	lw	a1,-24(s0)
	lla	a0,.LC28
	call	rt_kprintf
	.loc 1 409 114 is_stmt 1 discriminator 4
	lla	a0,.LC2
	call	rt_kprintf
.L79:
	.loc 1 411 26
...
.L78:
	...
	li	a5,1
	bne	a4,a5,.L85
	.loc 1 423 58 is_stmt 0 discriminator 1
	lla	a5,.LC26
	j	.L86
.L85:
	.loc 1 423 58 discriminator 2
	lla	a5,.LC27
.L86:
	.loc 1 423 58 discriminator 4
	mv	a2,a5
	lw	a1,-24(s0)
	lla	a0,.LC29
	call	rt_kprintf
	.loc 1 423 115 is_stmt 1 discriminator 4
	lla	a0,.LC2
	call	rt_kprintf
.L84:
	.loc 1 425 26
...
.Letext0:
	...
	.file 14 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\drivers\\include/drivers/i2c-bit-ops.h"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.file 48 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\drivers\\include/drivers/serial.h"
	.byte	0x3
	.byte	0x3f
	.byte	0x30
	.byte	0x7
...
.LASF1647:
	.string	"../rt-thread/components/drivers/i2c/i2c-bit-ops.c"
.LASF701:
	.string	"__ptrvalue "
.LASF541:
