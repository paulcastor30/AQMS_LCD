...
.LC2:
	...
	.align	2
.LC3:
	.string	"I2C bus dev [%s] reading %u bytes."
	.align	2
.LC4:
	.string	"\n"
	.text
...
i2c_bus_device_read:
.LFB24:
	.file 1 "../rt-thread/components/drivers/i2c/i2c_dev.c"
	.loc 1 27 1
	.cfi_startproc
	addi	sp,sp,-48
...
.LFE24:
	...
	.align	2
.LC5:
	.string	"I2C bus dev [%s] writing %u bytes."
	.text
	.align	1
...
.Letext0:
	...
	.file 14 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\drivers\\include/drivers/i2c_dev.h"
...
.LASF1617:
	.string	"../rt-thread/components/drivers/i2c/i2c_dev.c"
.LASF948:
