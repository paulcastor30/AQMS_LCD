...
timeout_calc:
.LFB24:
	.file 1 "../rt-thread/components/drivers/hwtimer/hwtimer.c"
	.loc 1 19 1
	.cfi_startproc
	addi	sp,sp,-64
...
.LC2:
	...
	.align	2
.LC3:
	.string	"frequency setting out of range! It will maintain at %d Hz"
	.align	2
.LC4:
	.string	"\n"
	.text
...
.LFB31:
	...
	lw	a5,-36(s0)
	bnez	a5,.L71
	.loc 1 313 26 discriminator 1
	li	a2,313
	lla	a1,__FUNCTION__.3799
	lla	a0,.LC5
...
.LFE31:
	...
	.align	2
.LC6:
	.string	"timer->ops != RT_NULL"
	.align	2
.LC7:
	.string	"timer->info != RT_NULL"
	.text
	.align	1
...
.LASF1611:
	.string	"../rt-thread/components/drivers/hwtimer/hwtimer.c"
.LASF1208:
	.string	"DST_CAN 6"
.LASF179:
