# 1 "../rt-thread/components/drivers/misc/adc.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/drivers/misc/adc.c"
# 13 "../rt-thread/components/drivers/misc/adc.c"
...
# 14 "../rt-thread/components/drivers/misc/adc.c" 2
...
# 15 "../rt-thread/components/drivers/misc/adc.c" 2
...
# 17 "../rt-thread/components/drivers/misc/adc.c" 2
...
# 18 "../rt-thread/components/drivers/misc/adc.c" 2
...
# 22 "../rt-thread/components/drivers/misc/adc.c" 2


# 23 "../rt-thread/components/drivers/misc/adc.c"
...
# 91 "../rt-thread/components/drivers/misc/adc.c"
rt_err_t rt_hw_adc_register(rt_adc_device_t device, const char *name, const struct rt_adc_ops *ops, const void *user_data)
{
    rt_err_t result = 0;
    if (!(ops != 0 && ops->convert != 0)) { rt_assert_handler("ops != RT_NULL && ops->convert != RT_NULL", __FUNCTION__, 94); };
...
rt_uint32_t rt_adc_read(rt_adc_device_t dev, rt_int8_t channel)
{
    ...
    if (!(dev)) { rt_assert_handler("dev", __FUNCTION__, 122); };
...
rt_err_t rt_adc_enable(rt_adc_device_t dev, rt_int8_t channel)
{
    ...
    if (!(dev)) { rt_assert_handler("dev", __FUNCTION__, 133); };
...
rt_err_t rt_adc_disable(rt_adc_device_t dev, rt_int8_t channel)
{
    ...
    if (!(dev)) { rt_assert_handler("dev", __FUNCTION__, 151); };
...
rt_int16_t rt_adc_voltage(rt_adc_device_t dev, rt_int8_t channel)
{
    ...
    if (!(dev)) { rt_assert_handler("dev", __FUNCTION__, 171); };
