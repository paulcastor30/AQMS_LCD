# 1 "../rt-thread/components/drivers/spi/spi_dev.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/drivers/spi/spi_dev.c"
# 10 "../rt-thread/components/drivers/spi/spi_dev.c"
...
# 11 "../rt-thread/components/drivers/spi/spi_dev.c" 2
...
# 12 "../rt-thread/components/drivers/spi/spi_dev.c" 2
                                      ...
                                      rt_size_t size)
{
    ...
    return rt_spi_transfer(bus->owner, 0, buffer, size);
}
                                       ...
                                       rt_size_t size)
{
    ...
    return rt_spi_transfer(bus->owner, buffer, 0, size);
}
# 54 "../rt-thread/components/drivers/spi/spi_dev.c"
rt_err_t rt_spi_bus_device_init(struct rt_spi_bus *bus, const char *name)
{
    ...
    return rt_device_register(device, name, 0x003);
}
                                     ...
                                     rt_size_t size)
{
    ...
    return rt_spi_transfer(device, 0, buffer, size);
}
                                      ...
                                      rt_size_t size)
{
    ...
    return rt_spi_transfer(device, buffer, 0, size);
}
...
# 135 "../rt-thread/components/drivers/spi/spi_dev.c"
