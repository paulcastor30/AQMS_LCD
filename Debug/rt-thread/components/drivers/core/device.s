...
.LFB20:
	...
	lw	a5,-20(s0)
	bnez	a5,.L6
	.loc 1 95 24 discriminator 1
	li	a2,95
	lla	a1,__FUNCTION__.2814
	lla	a0,.LC0
...
.LFB24:
	...
	lw	a5,-36(s0)
	bnez	a5,.L20
	.loc 1 180 24 discriminator 1
	li	a2,180
	lla	a1,__FUNCTION__.2832
	lla	a0,.LC0
	call	rt_assert_handler
.L20:
	.loc 1 183 13
...
.LFB26:
	...
	lw	a5,-36(s0)
	bnez	a5,.L37
	.loc 1 287 24 discriminator 1
	li	a2,287
	lla	a1,__FUNCTION__.2843
	lla	a0,.LC0
	call	rt_assert_handler
.L37:
	.loc 1 288 11
...
.LFB28:
	...
	lw	a5,-20(s0)
	bnez	a5,.L52
	.loc 1 376 24 discriminator 1
	li	a2,376
	lla	a1,__FUNCTION__.2857
	lla	a0,.LC0
	call	rt_assert_handler
.L52:
	.loc 1 377 11
...
.LFB31:
	...
	lw	a5,-20(s0)
	bnez	a5,.L67
	.loc 1 464 24 discriminator 1
	li	a2,464
	lla	a1,__FUNCTION__.2877
	lla	a0,.LC0
	call	rt_assert_handler
.L67:
	.loc 1 465 11
...
.LFE31:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.2814, @object
	.size	__FUNCTION__.2814, 21
__FUNCTION__.2814:
	.string	"rt_device_unregister"
	.align	2
	.type	__FUNCTION__.2827, @object
	.size	__FUNCTION__.2827, 18
__FUNCTION__.2827:
	.string	"rt_device_destroy"
	.align	2
	.type	__FUNCTION__.2832, @object
	.size	__FUNCTION__.2832, 15
__FUNCTION__.2832:
	.string	"rt_device_init"
	.align	2
	.type	__FUNCTION__.2838, @object
	.size	__FUNCTION__.2838, 15
__FUNCTION__.2838:
	.string	"rt_device_open"
	.align	2
	.type	__FUNCTION__.2843, @object
	.size	__FUNCTION__.2843, 16
__FUNCTION__.2843:
	.string	"rt_device_close"
	.align	2
	.type	__FUNCTION__.2850, @object
	.size	__FUNCTION__.2850, 15
__FUNCTION__.2850:
	.string	"rt_device_read"
	.align	2
	.type	__FUNCTION__.2857, @object
	.size	__FUNCTION__.2857, 16
__FUNCTION__.2857:
	.string	"rt_device_write"
	.align	2
	.type	__FUNCTION__.2863, @object
	.size	__FUNCTION__.2863, 18
__FUNCTION__.2863:
	.string	"rt_device_control"
	.align	2
	.type	__FUNCTION__.2870, @object
	.size	__FUNCTION__.2870, 26
__FUNCTION__.2870:
	.string	"rt_device_set_rx_indicate"
	.align	2
	.type	__FUNCTION__.2877, @object
	.size	__FUNCTION__.2877, 26
__FUNCTION__.2877:
...
.Ldebug_macro0:
	...
	.byte	0x4
	.file 26 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\include/rtservice.h"
	.byte	0x3
	.byte	0x1d
	.byte	0x1a
	.byte	0x7
...
.Ldebug_macro28:
	...
	.4byte	.LASF1101
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.rtdbg.h.31.3dd4e266e5475a3cd07d707e3b2fb53f,comdat
.Ldebug_macro29:
	.2byte	0x4
	.byte	0
	.byte	0x5
