...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/drivers/ipc/pipe.c"
# 13 "../rt-thread/components/drivers/ipc/pipe.c"
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 14 "../rt-thread/components/drivers/ipc/pipe.c" 2
...
# 15 "../rt-thread/components/drivers/ipc/pipe.c" 2
...
# 17 "../rt-thread/components/drivers/ipc/pipe.c" 2
# 407 "../rt-thread/components/drivers/ipc/pipe.c"
...
# 444 "../rt-thread/components/drivers/ipc/pipe.c"
...
# 476 "../rt-thread/components/drivers/ipc/pipe.c"
rt_ssize_t rt_pipe_read(rt_device_t device, rt_off_t pos, void *buffer, rt_size_t count)
{
    ...
    {
        rt_set_errno(-
# 484 "../rt-thread/components/drivers/ipc/pipe.c" 3
                     22
# 484 "../rt-thread/components/drivers/ipc/pipe.c"
                           );
        return 0;
    }
    if (count == 0)
...
# 524 "../rt-thread/components/drivers/ipc/pipe.c"
rt_ssize_t rt_pipe_write(rt_device_t device, rt_off_t pos, const void *buffer, rt_size_t count)
{
    ...
    {
        rt_set_errno(-
# 532 "../rt-thread/components/drivers/ipc/pipe.c" 3
                     22
# 532 "../rt-thread/components/drivers/ipc/pipe.c"
                           );
        return 0;
    }
    if (count == 0)
...
# 569 "../rt-thread/components/drivers/ipc/pipe.c"
rt_err_t rt_pipe_control(rt_device_t dev, int cmd, void *args)
{
    return 0;
}
# 598 "../rt-thread/components/drivers/ipc/pipe.c"
rt_pipe_t *rt_pipe_create(const char *name, int bufsz)
{
    rt_pipe_t *pipe;
    rt_device_t dev;
    ...
    if (!(bufsz < 0xFFFF)) { rt_assert_handler("bufsz < 0xFFFF", __FUNCTION__, 617); };
    pipe->bufsz = bufsz;
...
# 663 "../rt-thread/components/drivers/ipc/pipe.c"
int rt_pipe_delete(const char *name)
{
    int result = 0;
    rt_device_t device;
    ...
    if (device)
    {
        ...
        {
            result = -
# 693 "../rt-thread/components/drivers/ipc/pipe.c" 3
                     19
# 693 "../rt-thread/components/drivers/ipc/pipe.c"
                           ;
        }
    }
    else
    {
        result = -
# 698 "../rt-thread/components/drivers/ipc/pipe.c" 3
                 19
# 698 "../rt-thread/components/drivers/ipc/pipe.c"
                       ;
    }
