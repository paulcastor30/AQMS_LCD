...
.LFB24:
	.file 2 "../rt-thread/components/drivers/ipc/workqueue.c"
	.loc 2 23 1
	.cfi_startproc
	addi	sp,sp,-48
...
.LFB25:
	...
	lw	a5,-20(s0)
	bnez	a5,.L18
	.loc 2 60 26 discriminator 1
	li	a2,60
	lla	a1,__FUNCTION__.3740
	lla	a0,.LC0
...
.LFB28:
	...
	lw	a5,-24(s0)
	bnez	a5,.L33
	.loc 2 178 26 discriminator 1
	li	a2,178
	lla	a1,__FUNCTION__.3761
	lla	a0,.LC0
	call	rt_assert_handler
.L33:
	.loc 2 180 13
...
.LFB29:
	...
	lw	a5,-20(s0)
	bnez	a5,.L38
	.loc 2 219 25 discriminator 1
	li	a2,219
	lla	a1,__FUNCTION__.3769
	lla	a0,.LC2
	call	rt_assert_handler
.L38:
	.loc 2 220 8
...
.LFB32:
	...
	lw	a5,-20(s0)
	bnez	a5,.L48
	.loc 2 299 26 discriminator 1
	li	a2,299
	lla	a1,__FUNCTION__.3784
	lla	a0,.LC0
	call	rt_assert_handler
.L48:
	.loc 2 300 8
...
.LFB34:
	...
	lw	a5,-36(s0)
	bnez	a5,.L57
	.loc 2 342 26 discriminator 1
	li	a2,342
	lla	a1,__FUNCTION__.3796
	lla	a0,.LC0
	call	rt_assert_handler
.L57:
	.loc 2 343 8
...
.LFB35:
	...
	lw	a5,-24(s0)
	bnez	a5,.L63
	.loc 2 378 25 discriminator 1
	li	a2,378
	lla	a1,__FUNCTION__.3801
	lla	a0,.LC2
	call	rt_assert_handler
.L63:
	.loc 2 379 8
...
.LFB36:
	...
	lw	a5,-20(s0)
	bnez	a5,.L67
	.loc 2 395 26 discriminator 1
	li	a2,395
	lla	a1,__FUNCTION__.3806
	lla	a0,.LC0
	call	rt_assert_handler
.L67:
	.loc 2 396 8
...
.LFB37:
	...
	lw	a5,-36(s0)
	bnez	a5,.L73
	.loc 2 422 26 discriminator 1
	li	a2,422
	lla	a1,__FUNCTION__.3811
	lla	a0,.LC0
	call	rt_assert_handler
.L73:
	.loc 2 425 5
...
.LFE37:
	...
	.comm	sys_workq,4,4
	.align	1
	.globl	rt_work_submit
	.type	rt_work_submit, @function
rt_work_submit:
.LFB38:
	.loc 2 460 1
	.cfi_startproc
	...
	.cfi_endproc
.LFE38:
	.size	rt_work_submit, .-rt_work_submit
	.align	1
	.globl	rt_work_urgent
	.type	rt_work_urgent, @function
rt_work_urgent:
.LFB39:
	.loc 2 472 1
	.cfi_startproc
	...
	.cfi_endproc
.LFE39:
	.size	rt_work_urgent, .-rt_work_urgent
	.align	1
	.globl	rt_work_cancel
	.type	rt_work_cancel, @function
rt_work_cancel:
.LFB40:
	.loc 2 485 1
	.cfi_startproc
	...
	.cfi_endproc
.LFE40:
	.size	rt_work_cancel, .-rt_work_cancel
	.section	.rodata
	.align	2
.LC6:
	.string	"sys workq"
	.align	2
.LC7:
	.string	"sys_workq != RT_NULL"
	.text
	.align	1
	.type	rt_work_sys_workqueue_init, @function
...
.L86:
	...
	.loc 2 496 8
	bnez	a5,.L88
	.loc 2 496 30 discriminator 1
	li	a2,496
	lla	a1,__FUNCTION__.3832
	lla	a0,.LC7
	call	rt_assert_handler
.L88:
	.loc 2 498 12
...
.L87:
	...
	.cfi_endproc
.LFE41:
	.size	rt_work_sys_workqueue_init, .-rt_work_sys_workqueue_init
	.globl	__rt_init_rt_work_sys_workqueue_init
	.section	.rti_fn.2,"a"
	.align	2
	.type	__rt_init_rt_work_sys_workqueue_init, @object
	.size	__rt_init_rt_work_sys_workqueue_init, 4
__rt_init_rt_work_sys_workqueue_init:
	.word	rt_work_sys_workqueue_init
	.section	.rodata
	.align	2
	.type	__FUNCTION__.3740, @object
	.size	__FUNCTION__.3740, 24
__FUNCTION__.3740:
	.string	"_workqueue_thread_entry"
	.align	2
	.type	__FUNCTION__.3761, @object
	.size	__FUNCTION__.3761, 30
__FUNCTION__.3761:
	.string	"_delayed_work_timeout_handler"
	.align	2
	.type	__FUNCTION__.3769, @object
	.size	__FUNCTION__.3769, 13
__FUNCTION__.3769:
	.string	"rt_work_init"
	.align	2
	.type	__FUNCTION__.3779, @object
	.size	__FUNCTION__.3779, 21
__FUNCTION__.3779:
	.string	"rt_workqueue_destroy"
	.align	2
	.type	__FUNCTION__.3784, @object
	.size	__FUNCTION__.3784, 20
__FUNCTION__.3784:
	.string	"rt_workqueue_dowork"
	.align	2
	.type	__FUNCTION__.3790, @object
	.size	__FUNCTION__.3790, 25
__FUNCTION__.3790:
	.string	"rt_workqueue_submit_work"
	.align	2
	.type	__FUNCTION__.3796, @object
	.size	__FUNCTION__.3796, 25
__FUNCTION__.3796:
	.string	"rt_workqueue_urgent_work"
	.align	2
	.type	__FUNCTION__.3801, @object
	.size	__FUNCTION__.3801, 25
__FUNCTION__.3801:
	.string	"rt_workqueue_cancel_work"
	.align	2
	.type	__FUNCTION__.3806, @object
	.size	__FUNCTION__.3806, 30
__FUNCTION__.3806:
	.string	"rt_workqueue_cancel_work_sync"
	.align	2
	.type	__FUNCTION__.3811, @object
	.size	__FUNCTION__.3811, 29
__FUNCTION__.3811:
	.string	"rt_workqueue_cancel_all_work"
	.align	2
	.type	__FUNCTION__.3832, @object
	.size	__FUNCTION__.3832, 27
__FUNCTION__.3832:
	.string	"rt_work_sys_workqueue_init"
	.text
.Letext0:
	...
	.file 11 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\drivers\\include/ipc/workqueue.h"
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	__rt_init_rt_work_sys_workqueue_init
	.byte	0x24
	.4byte	.LASF1584
	.byte	0x2
	.2byte	0x1e9
...
.Ldebug_macro0:
	...
	.4byte	.Ldebug_macro2
	.byte	0x4
	.file 15 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\include/rthw.h"
	.byte	0x3
	.byte	0xe
	.byte	0xf
	.byte	0x5
...
.LASF1211:
	.string	"DST_TUR 9"
.LASF1595:
	.string	"../rt-thread/components/drivers/ipc/workqueue.c"
.LASF776:
...
.LASF1440:
	.string	"desc"
.LASF1565:
	.string	"__rt_init_rt_work_sys_workqueue_init"
.LASF10:
