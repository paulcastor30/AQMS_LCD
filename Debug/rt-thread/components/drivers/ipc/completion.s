...
.L8:
	...
	beqz	a5,.L9
.LBB2:
	.loc 2 61 98 discriminator 1
	call	rt_hw_interrupt_is_disabled
	sw	a0,-28(s0)
	.loc 2 61 137 discriminator 1
	call	rt_hw_interrupt_disable
	sw	a0,-32(s0)
	.loc 2 61 168 discriminator 1
	call	rt_critical_level
	mv	a5,a0
	.loc 2 61 167 discriminator 1
	beqz	a5,.L10
	.loc 2 61 196 discriminator 2
	lla	a1,__FUNCTION__.3738
	lla	a0,.LC1
	call	rt_kprintf
	.loc 2 61 280 discriminator 2
	li	a2,61
	lla	a1,__FUNCTION__.3738
	lla	a0,.LC2
	call	rt_assert_handler
.L10:
	.loc 2 61 329 discriminator 6
	lw	a4,-28(s0)
	li	a5,1
	bne	a4,a5,.L11
	.loc 2 61 357 discriminator 7
	lla	a1,__FUNCTION__.3738
	lla	a0,.LC3
	call	rt_kprintf
	.loc 2 61 436 discriminator 7
	li	a2,61
	lla	a1,__FUNCTION__.3738
	lla	a0,.LC2
	call	rt_assert_handler
.L11:
.LBB3:
	.loc 2 61 512 discriminator 11
	call	rt_hw_interrupt_disable
	sw	a0,-36(s0)
	.loc 2 61 543 discriminator 11
	call	rt_thread_self
	mv	a5,a0
	.loc 2 61 542 discriminator 11
	bnez	a5,.L12
	.loc 2 61 568 discriminator 12
	lla	a1,__FUNCTION__.3738
	lla	a0,.LC4
	call	rt_kprintf
	.loc 2 61 665 discriminator 12
	li	a2,61
	lla	a1,__FUNCTION__.3738
	lla	a0,.LC2
	call	rt_assert_handler
.L12:
.LBB4:
	.loc 2 61 741 discriminator 16
	call	rt_hw_interrupt_disable
	sw	a0,-40(s0)
	.loc 2 61 772 discriminator 16
	call	rt_interrupt_get_nest
	mv	a5,a0
	.loc 2 61 771 discriminator 16
	beqz	a5,.L13
	.loc 2 61 804 discriminator 17
	lla	a1,__FUNCTION__.3738
	lla	a0,.LC5
	call	rt_kprintf
	.loc 2 61 885 discriminator 17
	li	a2,61
	lla	a1,__FUNCTION__.3738
	lla	a0,.LC2
	call	rt_assert_handler
.L13:
	.loc 2 61 931 discriminator 21
	lw	a0,-40(s0)
	call	rt_hw_interrupt_enable
.LBE4:
	.loc 2 61 975 discriminator 21
	lw	a0,-36(s0)
	call	rt_hw_interrupt_enable
.LBE3:
	.loc 2 61 1019 discriminator 21
	lw	a0,-32(s0)
	call	rt_hw_interrupt_enable
.L9:
.LBE2:
...
.LBB5:
	...
	.loc 2 89 73
	beqz	a5,.L18
	.loc 2 89 106 discriminator 1
	lla	a1,__FUNCTION__.3738
	lla	a0,.LC5
	call	rt_kprintf
	.loc 2 89 187 discriminator 1
	li	a2,89
	lla	a1,__FUNCTION__.3738
	lla	a0,.LC2
	call	rt_assert_handler
.L18:
	.loc 2 89 233 discriminator 5
	lw	a0,-48(s0)
	call	rt_hw_interrupt_enable
.LBE5:
	.loc 2 92 25 discriminator 5
	lw	a5,-56(s0)
	.loc 2 92 16 discriminator 5
	blez	a5,.L19
	.loc 2 95 17
	lw	a5,-44(s0)
	addi	a5,a5,88
...
.LFB26:
	...
	lw	a5,-36(s0)
	bnez	a5,.L22
	.loc 2 130 31 discriminator 1
	li	a2,130
	lla	a1,__FUNCTION__.3749
	lla	a0,.LC0
	call	rt_assert_handler
.L22:
	.loc 2 132 19
...
.LFE26:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.3730, @object
	.size	__FUNCTION__.3730, 19
__FUNCTION__.3730:
	.string	"rt_completion_init"
	.align	2
	.type	__FUNCTION__.3738, @object
	.size	__FUNCTION__.3738, 19
__FUNCTION__.3738:
	.string	"rt_completion_wait"
	.align	2
	.type	__FUNCTION__.3749, @object
	.size	__FUNCTION__.3749, 19
__FUNCTION__.3749:
