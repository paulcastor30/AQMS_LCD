...
.LFB26:
	...
	lw	a5,-20(s0)
	bnez	a5,.L27
	.loc 2 102 19 discriminator 1
	li	a2,102
	lla	a1,__FUNCTION__.3748
	lla	a0,.LC0
	call	rt_assert_handler
.L27:
	.loc 2 104 16
...
.LFE26:
	...
	.align	2
.LC3:
	.string	"blk->status == RT_RBB_BLK_UNUSED"
	.text
	.align	1
...
.LFB27:
	...
	lw	a5,-36(s0)
	bnez	a5,.L29
	.loc 2 117 19 discriminator 1
	li	a2,117
	lla	a1,__FUNCTION__.3753
	lla	a0,.LC0
	call	rt_assert_handler
.L29:
	.loc 2 119 9
...
.LFB30:
	...
	lw	a5,-52(s0)
	bnez	a5,.L41
	.loc 2 174 19 discriminator 1
	li	a2,174
	lla	a1,__FUNCTION__.3777
	lla	a0,.LC0
	call	rt_assert_handler
.L41:
	.loc 2 175 8
...
.LFB31:
	...
	lw	a5,-20(s0)
	bnez	a5,.L55
	.loc 2 272 21 discriminator 1
	li	a2,272
	lla	a1,__FUNCTION__.3781
	lla	a0,.LC5
	call	rt_assert_handler
.L55:
	.loc 2 273 16
...
.LFB32:
	...
	lw	a5,-36(s0)
	bnez	a5,.L58
	.loc 2 293 19 discriminator 1
	li	a2,293
	lla	a1,__FUNCTION__.3788
	lla	a0,.LC0
	call	rt_assert_handler
.L58:
	.loc 2 295 9
...
.LFB34:
	...
	lw	a5,-20(s0)
	bnez	a5,.L69
	.loc 2 344 21 discriminator 1
	li	a2,344
	lla	a1,__FUNCTION__.3800
	lla	a0,.LC5
	call	rt_assert_handler
.L69:
	.loc 2 346 17
...
.LFB36:
	...
	lw	a5,-52(s0)
	bnez	a5,.L76
	.loc 2 403 19 discriminator 1
	li	a2,403
	lla	a1,__FUNCTION__.3818
	lla	a0,.LC0
	call	rt_assert_handler
.L76:
	.loc 2 404 8
...
.LFB39:
	...
	lw	a5,-36(s0)
	bnez	a5,.L97
	.loc 2 513 19 discriminator 1
	li	a2,513
	lla	a1,__FUNCTION__.3844
	lla	a0,.LC0
	call	rt_assert_handler
.L97:
	.loc 2 514 8
...
.LFB40:
	...
	lw	a5,-52(s0)
	bnez	a5,.L102
	.loc 2 540 19 discriminator 1
	li	a2,540
	lla	a1,__FUNCTION__.3856
	lla	a0,.LC0
	call	rt_assert_handler
.L102:
	.loc 2 542 9
...
.LFB41:
	...
	lw	a5,-20(s0)
	bnez	a5,.L112
	.loc 2 592 19 discriminator 1
	li	a2,592
	lla	a1,__FUNCTION__.3864
	lla	a0,.LC0
	call	rt_assert_handler
.L112:
	.loc 2 594 15
...
.LFE41:
	...
	.size	__FUNCTION__.3734, 12
__FUNCTION__.3734:
	.string	"rt_rbb_init"
	.align	2
	.type	__FUNCTION__.3748, @object
	.size	__FUNCTION__.3748, 15
__FUNCTION__.3748:
	.string	"rt_rbb_destroy"
	.align	2
	.type	__FUNCTION__.3753, @object
	.size	__FUNCTION__.3753, 22
__FUNCTION__.3753:
	.string	"find_empty_blk_in_set"
	.align	2
	.type	__FUNCTION__.3777, @object
	.size	__FUNCTION__.3777, 17
__FUNCTION__.3777:
	.string	"rt_rbb_blk_alloc"
	.align	2
	.type	__FUNCTION__.3781, @object
	.size	__FUNCTION__.3781, 15
__FUNCTION__.3781:
	.string	"rt_rbb_blk_put"
	.align	2
	.type	__FUNCTION__.3788, @object
	.size	__FUNCTION__.3788, 15
__FUNCTION__.3788:
	.string	"rt_rbb_blk_get"
	.align	2
	.type	__FUNCTION__.3796, @object
	.size	__FUNCTION__.3796, 16
__FUNCTION__.3796:
	.string	"rt_rbb_blk_size"
	.align	2
	.type	__FUNCTION__.3800, @object
	.size	__FUNCTION__.3800, 15
__FUNCTION__.3800:
	.string	"rt_rbb_blk_buf"
	.align	2
	.type	__FUNCTION__.3806, @object
	.size	__FUNCTION__.3806, 16
__FUNCTION__.3806:
	.string	"rt_rbb_blk_free"
	.align	2
	.type	__FUNCTION__.3818, @object
	.size	__FUNCTION__.3818, 21
__FUNCTION__.3818:
	.string	"rt_rbb_blk_queue_get"
	.align	2
	.type	__FUNCTION__.3829, @object
	.size	__FUNCTION__.3829, 21
__FUNCTION__.3829:
	.string	"rt_rbb_blk_queue_len"
	.align	2
	.type	__FUNCTION__.3836, @object
	.size	__FUNCTION__.3836, 21
__FUNCTION__.3836:
	.string	"rt_rbb_blk_queue_buf"
	.align	2
	.type	__FUNCTION__.3844, @object
	.size	__FUNCTION__.3844, 22
__FUNCTION__.3844:
	.string	"rt_rbb_blk_queue_free"
	.align	2
	.type	__FUNCTION__.3856, @object
	.size	__FUNCTION__.3856, 26
__FUNCTION__.3856:
	.string	"rt_rbb_next_blk_queue_len"
	.align	2
	.type	__FUNCTION__.3864, @object
	.size	__FUNCTION__.3864, 20
__FUNCTION__.3864:
...
.Letext0:
	...
	.file 11 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\drivers\\include/ipc/ringblk_buf.h"
