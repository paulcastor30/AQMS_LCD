...
.LFB24:
	...
	lw	a5,-20(s0)
	bnez	a5,.L6
	.loc 2 47 26 discriminator 1
	li	a2,47
	lla	a1,__FUNCTION__.3736
	lla	a0,.LC0
...
.LFB25:
	...
	lw	a5,-52(s0)
	bnez	a5,.L11
	.loc 2 98 26 discriminator 1
	li	a2,98
	lla	a1,__FUNCTION__.3746
	lla	a0,.LC0
	call	rt_assert_handler
.L11:
	.loc 2 99 16
...
.L12:
	...
	beqz	a5,.L13
.LBB2:
	.loc 2 102 98 discriminator 1
	call	rt_hw_interrupt_is_disabled
	sw	a0,-28(s0)
	.loc 2 102 137 discriminator 1
	call	rt_hw_interrupt_disable
	sw	a0,-32(s0)
	.loc 2 102 168 discriminator 1
	call	rt_critical_level
	mv	a5,a0
	.loc 2 102 167 discriminator 1
	beqz	a5,.L14
	.loc 2 102 196 discriminator 2
	lla	a1,__FUNCTION__.3746
	lla	a0,.LC3
	call	rt_kprintf
	.loc 2 102 280 discriminator 2
	li	a2,102
	lla	a1,__FUNCTION__.3746
	lla	a0,.LC4
	call	rt_assert_handler
.L14:
	.loc 2 102 330 discriminator 6
	lw	a4,-28(s0)
	li	a5,1
	bne	a4,a5,.L15
	.loc 2 102 358 discriminator 7
	lla	a1,__FUNCTION__.3746
	lla	a0,.LC5
	call	rt_kprintf
	.loc 2 102 437 discriminator 7
	li	a2,102
	lla	a1,__FUNCTION__.3746
	lla	a0,.LC4
	call	rt_assert_handler
.L15:
.LBB3:
	.loc 2 102 514 discriminator 11
	call	rt_hw_interrupt_disable
	sw	a0,-36(s0)
	.loc 2 102 545 discriminator 11
	call	rt_thread_self
	mv	a5,a0
	.loc 2 102 544 discriminator 11
	bnez	a5,.L16
	.loc 2 102 570 discriminator 12
	lla	a1,__FUNCTION__.3746
	lla	a0,.LC6
	call	rt_kprintf
	.loc 2 102 667 discriminator 12
	li	a2,102
	lla	a1,__FUNCTION__.3746
	lla	a0,.LC4
	call	rt_assert_handler
.L16:
.LBB4:
	.loc 2 102 744 discriminator 16
	call	rt_hw_interrupt_disable
	sw	a0,-40(s0)
	.loc 2 102 775 discriminator 16
	call	rt_interrupt_get_nest
	mv	a5,a0
	.loc 2 102 774 discriminator 16
	beqz	a5,.L17
	.loc 2 102 807 discriminator 17
	lla	a1,__FUNCTION__.3746
	lla	a0,.LC7
	call	rt_kprintf
	.loc 2 102 888 discriminator 17
	li	a2,102
	lla	a1,__FUNCTION__.3746
	lla	a0,.LC4
	call	rt_assert_handler
.L17:
	.loc 2 102 935 discriminator 21
	lw	a0,-40(s0)
	call	rt_hw_interrupt_enable
.LBE4:
	.loc 2 102 979 discriminator 21
	lw	a0,-36(s0)
	call	rt_hw_interrupt_enable
.LBE3:
	.loc 2 102 1023 discriminator 21
	lw	a0,-32(s0)
	call	rt_hw_interrupt_enable
.L13:
.LBE2:
...
.LFB26:
	...
	lw	a5,-52(s0)
	bnez	a5,.L30
	.loc 2 215 26 discriminator 1
	li	a2,215
	lla	a1,__FUNCTION__.3764
	lla	a0,.LC0
	call	rt_assert_handler
.L30:
	.loc 2 216 16
...
.L33:
	...
	beqz	a5,.L34
.LBB5:
	.loc 2 221 98 discriminator 1
	call	rt_hw_interrupt_is_disabled
	sw	a0,-28(s0)
	.loc 2 221 137 discriminator 1
	call	rt_hw_interrupt_disable
	sw	a0,-32(s0)
	.loc 2 221 168 discriminator 1
	call	rt_critical_level
	mv	a5,a0
	.loc 2 221 167 discriminator 1
	beqz	a5,.L35
	.loc 2 221 196 discriminator 2
	lla	a1,__FUNCTION__.3764
	lla	a0,.LC3
	call	rt_kprintf
	.loc 2 221 280 discriminator 2
	li	a2,221
	lla	a1,__FUNCTION__.3764
	lla	a0,.LC4
	call	rt_assert_handler
.L35:
	.loc 2 221 330 discriminator 6
	lw	a4,-28(s0)
	li	a5,1
	bne	a4,a5,.L36
	.loc 2 221 358 discriminator 7
	lla	a1,__FUNCTION__.3764
	lla	a0,.LC5
	call	rt_kprintf
	.loc 2 221 437 discriminator 7
	li	a2,221
	lla	a1,__FUNCTION__.3764
	lla	a0,.LC4
	call	rt_assert_handler
.L36:
.LBB6:
	.loc 2 221 514 discriminator 11
	call	rt_hw_interrupt_disable
	sw	a0,-36(s0)
	.loc 2 221 545 discriminator 11
	call	rt_thread_self
	mv	a5,a0
	.loc 2 221 544 discriminator 11
	bnez	a5,.L37
	.loc 2 221 570 discriminator 12
	lla	a1,__FUNCTION__.3764
	lla	a0,.LC6
	call	rt_kprintf
	.loc 2 221 667 discriminator 12
	li	a2,221
	lla	a1,__FUNCTION__.3764
	lla	a0,.LC4
	call	rt_assert_handler
.L37:
.LBB7:
	.loc 2 221 744 discriminator 16
	call	rt_hw_interrupt_disable
	sw	a0,-40(s0)
	.loc 2 221 775 discriminator 16
	call	rt_interrupt_get_nest
	mv	a5,a0
	.loc 2 221 774 discriminator 16
	beqz	a5,.L38
	.loc 2 221 807 discriminator 17
	lla	a1,__FUNCTION__.3764
	lla	a0,.LC7
	call	rt_kprintf
	.loc 2 221 888 discriminator 17
	li	a2,221
	lla	a1,__FUNCTION__.3764
	lla	a0,.LC4
	call	rt_assert_handler
.L38:
	.loc 2 221 935 discriminator 21
	lw	a0,-40(s0)
	call	rt_hw_interrupt_enable
.LBE7:
	.loc 2 221 979 discriminator 21
	lw	a0,-36(s0)
	call	rt_hw_interrupt_enable
.LBE6:
	.loc 2 221 1023 discriminator 21
	lw	a0,-32(s0)
	call	rt_hw_interrupt_enable
.L34:
.LBE5:
...
.LFB28:
	...
	lw	a5,-36(s0)
	bnez	a5,.L59
	.loc 2 367 26 discriminator 1
	li	a2,367
	lla	a1,__FUNCTION__.3785
	lla	a0,.LC0
	call	rt_assert_handler
.L59:
	.loc 2 368 16
...
.LFB30:
	...
	lw	a5,-36(s0)
	bnez	a5,.L70
	.loc 2 474 26 discriminator 1
	li	a2,474
	lla	a1,__FUNCTION__.3802
	lla	a0,.LC0
	call	rt_assert_handler
.L70:
	.loc 2 475 16
...
.LFE30:
	...
	.size	__FUNCTION__.3736, 19
__FUNCTION__.3736:
	.string	"rt_data_queue_init"
	.align	2
	.type	__FUNCTION__.3746, @object
	.size	__FUNCTION__.3746, 19
__FUNCTION__.3746:
	.string	"rt_data_queue_push"
	.align	2
	.type	__FUNCTION__.3764, @object
	.size	__FUNCTION__.3764, 18
__FUNCTION__.3764:
	.string	"rt_data_queue_pop"
	.align	2
	.type	__FUNCTION__.3779, @object
	.size	__FUNCTION__.3779, 19
__FUNCTION__.3779:
	.string	"rt_data_queue_peek"
	.align	2
	.type	__FUNCTION__.3785, @object
	.size	__FUNCTION__.3785, 20
__FUNCTION__.3785:
	.string	"rt_data_queue_reset"
	.align	2
	.type	__FUNCTION__.3796, @object
	.size	__FUNCTION__.3796, 21
__FUNCTION__.3796:
	.string	"rt_data_queue_deinit"
	.align	2
	.type	__FUNCTION__.3802, @object
	.size	__FUNCTION__.3802, 18
__FUNCTION__.3802:
...
.Letext0:
	...
	.file 11 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\drivers\\include/ipc/dataqueue.h"
