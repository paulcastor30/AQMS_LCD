# 1 "../rt-thread/components/drivers/ipc/ringbuffer.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/drivers/ipc/ringbuffer.c"
# 15 "../rt-thread/components/drivers/ipc/ringbuffer.c"
...
# 16 "../rt-thread/components/drivers/ipc/ringbuffer.c" 2
...
# 17 "../rt-thread/components/drivers/ipc/ringbuffer.c" 2
...
# 18 "../rt-thread/components/drivers/ipc/ringbuffer.c" 2


# 19 "../rt-thread/components/drivers/ipc/ringbuffer.c"
...
# 38 "../rt-thread/components/drivers/ipc/ringbuffer.c"
void rt_ringbuffer_init(struct rt_ringbuffer *rb,
                        rt_uint8_t *pool,
                        rt_int32_t size)
{
    if (!(rb != 0)) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 42); };
    if (!(size > 0)) { rt_assert_handler("size > 0", __FUNCTION__, 43); };
...
;
# 64 "../rt-thread/components/drivers/ipc/ringbuffer.c"
                            ...
                            rt_uint32_t length)
{
    ...
    if (!(rb != 0)) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 70); };
...
;
# 117 "../rt-thread/components/drivers/ipc/ringbuffer.c"
                                  ...
                                  rt_uint32_t length)
{
    ...
    if (!(rb != 0)) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 123); };
...
;
# 178 "../rt-thread/components/drivers/ipc/ringbuffer.c"
                            ...
                            rt_uint32_t length)
{
    ...
    if (!(rb != 0)) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 184); };
...
;
# 232 "../rt-thread/components/drivers/ipc/ringbuffer.c"
rt_size_t rt_ringbuffer_peek(struct rt_ringbuffer *rb, rt_uint8_t **ptr)
{
    rt_size_t size;

    if (!(rb != 0)) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 236); };
...
;
# 273 "../rt-thread/components/drivers/ipc/ringbuffer.c"
rt_size_t rt_ringbuffer_putchar(struct rt_ringbuffer *rb, const rt_uint8_t ch)
{
    if (!(rb != 0)) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 275); };
...
;
# 306 "../rt-thread/components/drivers/ipc/ringbuffer.c"
rt_size_t rt_ringbuffer_putchar_force(struct rt_ringbuffer *rb, const rt_uint8_t ch)
{
    enum rt_ringbuffer_state old_state;

    if (!(rb != 0)) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 310); };
...
;
# 347 "../rt-thread/components/drivers/ipc/ringbuffer.c"
rt_size_t rt_ringbuffer_getchar(struct rt_ringbuffer *rb, rt_uint8_t *ch)
{
    if (!(rb != 0)) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 349); };
...
;
# 379 "../rt-thread/components/drivers/ipc/ringbuffer.c"
rt_size_t rt_ringbuffer_data_len(struct rt_ringbuffer *rb)
{
...
void rt_ringbuffer_reset(struct rt_ringbuffer *rb)
{
    if (!(rb != 0)) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 408); };
...
;
# 426 "../rt-thread/components/drivers/ipc/ringbuffer.c"
struct rt_ringbuffer *rt_ringbuffer_create(rt_uint32_t size)
{
    struct rt_ringbuffer *rb;
    rt_uint8_t *pool;

    if (!(size > 0)) { rt_assert_handler("size > 0", __FUNCTION__, 431); };
...
void rt_ringbuffer_destroy(struct rt_ringbuffer *rb)
{
    if (!(rb != 0)) { rt_assert_handler("rb != RT_NULL", __FUNCTION__, 460); };
