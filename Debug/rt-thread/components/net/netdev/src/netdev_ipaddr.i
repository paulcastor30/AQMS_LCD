# 1 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
# 10 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
...
# 11 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c" 2
...
# 12 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c" 2
...
# 13 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c" 2
...
# 38 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
int netdev_ip4addr_aton(const char *cp, ip4_addr_t *addr)
{
    uint32_t val;
    uint8_t base;
    ...
    for (;;)
    {
        ...
        for (;;)
        {
            ...
            {
                val = (val << 4) | (uint32_t) (c + 10 - (((uint8_t)c >= 'a' && (uint8_t)c <= 'z') ? 'a' : 'A'));
                c = *++cp;
            }
            else
            {
    ...
    case 4:
        ...
        break;
    default:
        if (!(0)) { rt_assert_handler("0", __FUNCTION__, 166); };
        break;
    }
    if (addr)
    {
        ((addr)->addr = ((uint32_t)((((val) & 0x000000ffUL) << 24) | (((val) & 0x0000ff00UL) << 8) | (((val) & 0x00ff0000UL) >> 8) | (((val) & 0xff000000UL) >> 24))));
    }
    return 1;
}
# 185 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
char *netdev_ip4addr_ntoa_r(const ip4_addr_t *addr, char *buf, int buflen)
{
    uint32_t s_addr;
    char inv[3];
    ...
    for (n = 0; n < 4; n++)
    {
        ...
        while (i--)
        {
            ...
            {
                return 
# 213 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c" 3 4
                      ((void *)0)
# 213 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
                          ;
            }
            *rp++ = inv[i];
        }
        ...
        {
            return 
# 219 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c" 3 4
                  ((void *)0)
# 219 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
                      ;
        }
        *rp++ = '.';
        ap++;
...
# 237 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
char *netdev_ip4addr_ntoa(const ip4_addr_t *addr)
{
    static char str[16];
    return netdev_ip4addr_ntoa_r(addr, str, 16);
}
# 251 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
in_addr_t netdev_ipaddr_addr(const char *cp)
{
    ip4_addr_t val;
...
# 553 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
const char *
...
#define AF_INET6 10
    ...
    const char *ret = 
# 559 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c" 3 4
                     ((void *)0)
# 559 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
                         ;
    int size_int = (int)size;
    if (size_int < 0)
    {
        return 
# 563 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c" 3 4
              ((void *)0)
# 563 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
                  ;
    }
    switch (af)
    {
...
#define AF_INET6 10
    ...
    case 2:
        ...
        break;
# 609 "../rt-thread/components/net/netdev/src/netdev_ipaddr.c"
    default:
        err = -1;
        break;
    }
