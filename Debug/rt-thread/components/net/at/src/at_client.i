# 1 "../rt-thread/components/net/at/src/at_client.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/net/at/src/at_client.c"
# 15 "../rt-thread/components/net/at/src/at_client.c"
...
# 255 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD/rtconfig.h"
...
# 301 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD/rtconfig.h"
...
# 16 "../rt-thread/components/net/at/src/at_client.c" 2
...
# 17 "../rt-thread/components/net/at/src/at_client.c" 2
...
# 18 "../rt-thread/components/net/at/src/at_client.c" 2
...
# 19 "../rt-thread/components/net/at/src/at_client.c" 2
...
# 22 "../rt-thread/components/net/at/src/at_client.c" 2
...
# 30 "../rt-thread/components/net/at/src/at_client.c"
...
# 52 "../rt-thread/components/net/at/src/at_client.c"
at_response_t at_create_resp(rt_size_t buf_size, rt_size_t line_num, rt_int32_t timeout)
{
    ...
    if (resp == 0)
    {
        do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("AT create response object failed! No memory for response object!"); rt_kprintf("\n"); } while (0);
        return 0;
    }
    ...
    if (resp->buf == 0)
    {
        do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("AT create response object failed! No memory for response buffer!"); rt_kprintf("\n"); } while (0);
        rt_free(resp);
        return 0;
    }
...
# 111 "../rt-thread/components/net/at/src/at_client.c"
at_response_t at_resp_set_info(at_response_t resp, rt_size_t buf_size, rt_size_t line_num, rt_int32_t timeout)
{
    char *p_temp;
    if (!(resp)) { rt_assert_handler("resp", __FUNCTION__, 114); };
...
# 147 "../rt-thread/components/net/at/src/at_client.c"
const char *at_resp_get_line(at_response_t resp, rt_size_t resp_line)
{
    ...
    if (!(resp)) { rt_assert_handler("resp", __FUNCTION__, 153); };

    if (resp_line > resp->line_counts || resp_line <= 0)
    {
        do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("AT response get line failed! Input response line(%d) error!", resp_line); rt_kprintf("\n"); } while (0);
        return 0;
    }
...
# 185 "../rt-thread/components/net/at/src/at_client.c"
const char *at_resp_get_line_by_kw(at_response_t resp, const char *keyword)
{
    char *resp_buf = resp->buf;
    char *resp_line_buf = 0;
    ...
    if (!(resp)) { rt_assert_handler("resp", __FUNCTION__, 191); };
    if (!(keyword)) { rt_assert_handler("keyword", __FUNCTION__, 192); };
...
# 220 "../rt-thread/components/net/at/src/at_client.c"
int at_resp_parse_line_args(at_response_t resp, rt_size_t resp_line, const char *resp_expr, ...)
{
    va_list args;
    int resp_args_num = 0;
    ...
    if (!(resp)) { rt_assert_handler("resp", __FUNCTION__, 226); };
    if (!(resp_expr)) { rt_assert_handler("resp_expr", __FUNCTION__, 227); };

    if ((resp_line_buf = at_resp_get_line(resp, resp_line)) == 0)
    {
        return -1;
    }

    
# 234 "../rt-thread/components/net/at/src/at_client.c" 3 4
   __builtin_va_start(
# 234 "../rt-thread/components/net/at/src/at_client.c"
   args
# 234 "../rt-thread/components/net/at/src/at_client.c" 3 4
   ,
# 234 "../rt-thread/components/net/at/src/at_client.c"
...
# 238 "../rt-thread/components/net/at/src/at_client.c" 3 4
   __builtin_va_end(
# 238 "../rt-thread/components/net/at/src/at_client.c"
   args
# 238 "../rt-thread/components/net/at/src/at_client.c" 3 4
   )
# 238 "../rt-thread/components/net/at/src/at_client.c"
...
# 254 "../rt-thread/components/net/at/src/at_client.c"
int at_resp_parse_line_args_by_kw(at_response_t resp, const char *keyword, const char *resp_expr, ...)
{
    va_list args;
    int resp_args_num = 0;
    ...
    if (!(resp)) { rt_assert_handler("resp", __FUNCTION__, 260); };
    if (!(resp_expr)) { rt_assert_handler("resp_expr", __FUNCTION__, 261); };

    if ((resp_line_buf = at_resp_get_line_by_kw(resp, keyword)) == 0)
    {
        return -1;
    }

    
# 268 "../rt-thread/components/net/at/src/at_client.c" 3 4
   __builtin_va_start(
# 268 "../rt-thread/components/net/at/src/at_client.c"
   args
# 268 "../rt-thread/components/net/at/src/at_client.c" 3 4
   ,
# 268 "../rt-thread/components/net/at/src/at_client.c"
...
# 272 "../rt-thread/components/net/at/src/at_client.c" 3 4
   __builtin_va_end(
# 272 "../rt-thread/components/net/at/src/at_client.c"
   args
# 272 "../rt-thread/components/net/at/src/at_client.c" 3 4
   )
# 272 "../rt-thread/components/net/at/src/at_client.c"
...
# 289 "../rt-thread/components/net/at/src/at_client.c"
int at_obj_exec_cmd(at_client_t client, at_response_t resp, const char *cmd_expr, ...)
{
    va_list args;
    ...
    if (!(cmd_expr)) { rt_assert_handler("cmd_expr", __FUNCTION__, 296); };

    if (client == 0)
    {
        do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("input AT Client object is NULL, please create or get AT Client object!"); rt_kprintf("\n"); } while (0);
        return -1;
    }
    ...
    client->resp = resp;
    rt_sem_control(client->resp_notice, 0x01, 0);

    
# 323 "../rt-thread/components/net/at/src/at_client.c" 3 4
   __builtin_va_start(
# 323 "../rt-thread/components/net/at/src/at_client.c"
   args
# 323 "../rt-thread/components/net/at/src/at_client.c" 3 4
   ,
# 323 "../rt-thread/components/net/at/src/at_client.c"
...
# 325 "../rt-thread/components/net/at/src/at_client.c" 3 4
   __builtin_va_end(
# 325 "../rt-thread/components/net/at/src/at_client.c"
   args
# 325 "../rt-thread/components/net/at/src/at_client.c" 3 4
   )
# 325 "../rt-thread/components/net/at/src/at_client.c"
    ...
    if (resp != 0)
    {
        if (rt_sem_take(client->resp_notice, resp->timeout) != 0)
        {
            cmd = at_get_last_cmd(&cmd_size);
            do { rt_kprintf("[" "W" "/" "at.clnt" "] "); rt_kprintf("execute command (%.*s) timeout (%d ticks)!", cmd_size, cmd, resp->timeout); rt_kprintf("\n"); } while (0);
        ...
        {
            cmd = at_get_last_cmd(&cmd_size);
            do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("execute command (%.*s) failed!", cmd_size, cmd); rt_kprintf("\n"); } while (0);
            result = -1;
            goto __exit;
        }
    }
...
# 364 "../rt-thread/components/net/at/src/at_client.c"
int at_client_obj_wait_connect(at_client_t client, rt_uint32_t timeout)
{
    rt_err_t result = 0;
    at_response_t resp = 0;
    ...
    if (resp == 0)
    {
        do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("no memory for AT client(%s) response object.", client_name); rt_kprintf("\n"); } while (0);
        return -5;
    }
    ...
    while (1)
    {
        ...
        {
            do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("wait AT client(%s) connect timeout(%d tick).", client_name, timeout); rt_kprintf("\n"); } while (0);
            result = -2;
            break;
        }
...
# 430 "../rt-thread/components/net/at/src/at_client.c"
rt_size_t at_client_obj_send(at_client_t client, const char *buf, rt_size_t size)
{
    rt_size_t len;

    if (!(buf)) { rt_assert_handler("buf", __FUNCTION__, 434); };
...
static rt_err_t at_client_getchar(at_client_t client, char *ch, rt_int32_t timeout)
{
    ...
    while (rt_device_read(client->device, 0, ch, 1) == 0)
    {
        ...
        rt_sem_control(client->rx_notice, 0x01, 0);
    }

    return 0;
}
# 486 "../rt-thread/components/net/at/src/at_client.c"
rt_size_t at_client_obj_recv(at_client_t client, char *buf, rt_size_t size, rt_int32_t timeout)
{
    rt_size_t len = 0;

    if (!(buf)) { rt_assert_handler("buf", __FUNCTION__, 490); };
    ...
    while (1)
    {
        ...
        if(rt_sem_take(client->rx_notice, rt_tick_from_millisecond(timeout)) != 0)
            break;
    }
...
# 550 "../rt-thread/components/net/at/src/at_client.c"
int at_obj_set_urc_table(at_client_t client, const struct at_urc *urc_table, rt_size_t table_sz)
{
    ...
    {
        if (!(urc_table[idx].cmd_prefix)) { rt_assert_handler("urc_table[idx].cmd_prefix", __FUNCTION__, 562); };
        if (!(urc_table[idx].cmd_suffix)) { rt_assert_handler("urc_table[idx].cmd_suffix", __FUNCTION__, 563); };
    }

    if (client->urc_table_size == 0)
    {
        client->urc_table = (struct at_urc_table *) rt_calloc(1, sizeof(struct at_urc_table));
        if (client->urc_table == 0)
        {
            return -5;
        }
    ...
    {
        struct at_urc_table *new_urc_table = 0;
...
# 605 "../rt-thread/components/net/at/src/at_client.c"
at_client_t at_client_get(const char *dev_name)
{
    int idx = 0;

    if (!(dev_name)) { rt_assert_handler("dev_name", __FUNCTION__, 609); };
...
static const struct at_urc *get_urc_obj(at_client_t client)
{
    ...
    rt_size_t bufsz;
    char *buffer = 0;
    const struct at_urc *urc = 0;
    struct at_urc_table *urc_table = 0;
...
static int at_recv_readline(at_client_t client)
{
    ...
    while (1)
    {
                ...
                || get_urc_obj(client))
        {
            if (is_full)
            {
                do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("read line failed. The line data length is out of buffer size(%d)!", client->recv_bufsz); rt_kprintf("\n"); } while (0);
                rt_memset(client->recv_line_buf, 0x00, client->recv_bufsz);
                client->recv_line_len = 0;
                return -3;
            }
        ...
        if (at_recv_readline(client) > 0)
        {
            ...
            else if (client->resp != 0)
            {
                ...
                else
                {
                    ...
                    do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("Read response buffer failed. The Response buffer size is out of buffer size(%d)!", resp->buf_size); rt_kprintf("\n"); } while (0);
                }
                ...
                else if (rt_memcmp(client->recv_line_buf, "OK", rt_strlen("OK")) == 0
                        && resp->line_num == 0)
                {

                    client->resp_status = AT_RESP_OK;
                }
                else if (rt_strstr(client->recv_line_buf, "ERROR")
                        || (rt_memcmp(client->recv_line_buf, "FAIL", rt_strlen("FAIL")) == 0))
                {
...
#define AT_CLIENT_THREAD_NAME "at_clnt"
    ...
    if (client->recv_line_buf == 0)
    {
        do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("AT client initialize failed! No memory for receive buffer."); rt_kprintf("\n"); } while (0);
        result = -5;
        goto __exit;
    }

    rt_snprintf(name, 8, "%s%d", "at_c", at_client_num);
    client->lock = rt_mutex_create(name, 0x01);
    if (client->lock == 0)
    {
        do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("AT client initialize failed! at_client_recv_lock create failed!"); rt_kprintf("\n"); } while (0);
        result = -5;
        goto __exit;
    }

    rt_snprintf(name, 8, "%s%d", "at_cs", at_client_num);
    client->rx_notice = rt_sem_create(name, 0, 0x00);
    if (client->rx_notice == 0)
    {
        do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("AT client initialize failed! at_client_notice semaphore create failed!"); rt_kprintf("\n"); } while (0);
        result = -5;
        goto __exit;
    }

    rt_snprintf(name, 8, "%s%d", "at_cr", at_client_num);
    client->resp_notice = rt_sem_create(name, 0, 0x00);
    if (client->resp_notice == 0)
    {
        do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("AT client initialize failed! at_client_resp semaphore create failed!"); rt_kprintf("\n"); } while (0);
        result = -5;
        goto __exit;
    }
    ...
    rt_snprintf(name, 8, "%s%d", "at_clnt", at_client_num);
...
# 929 "../rt-thread/components/net/at/src/at_client.c"
int at_client_init(const char *dev_name, rt_size_t recv_bufsz)
{
    int idx = 0;
    int result = 0;
    rt_err_t open_result = 0;
    at_client_t client = 0;

    if (!(dev_name)) { rt_assert_handler("dev_name", __FUNCTION__, 936); };
    if (!(recv_bufsz > 0)) { rt_assert_handler("recv_bufsz > 0", __FUNCTION__, 937); };

    if (at_client_get(dev_name) != 0)
    {
        return result;
    }

    for (idx = 0; idx < 1 && at_client_table[idx].device; idx++);

    if (idx >= 1)
    {
        do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("AT client initialize failed! Check the maximum number(%d) of AT client.", 1); rt_kprintf("\n"); } while (0);
        result = -3;
        goto __exit;
    }
    ...
    if (client->device)
    {
        if (!(client->device->type == RT_Device_Class_Char)) { rt_assert_handler("client->device->type == RT_Device_Class_Char", __FUNCTION__, 966); };


        open_result = rt_device_open(client->device, 0x003 | 0x200);

        if (open_result == -8)
        {
            open_result = rt_device_open(client->device, 0x003 | 0x100);
        }
        if (!(open_result == 0)) { rt_assert_handler("open_result == RT_EOK", __FUNCTION__, 975); };

        rt_device_set_rx_indicate(client->device, at_client_rx_ind);
    }
    else
    {
        do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("AT client initialize failed! Not find the device(%s).", dev_name); rt_kprintf("\n"); } while (0);
        result = -1;
        goto __exit;
    }
...
__exit:
    if (result == 0)
    {
        ...
        do { rt_kprintf("[" "I" "/" "at.clnt" "] "); rt_kprintf("AT client(V%s) on device %s initialize success.", "1.3.1", dev_name); rt_kprintf("\n"); } while (0);
    }
    else
    {
        do { rt_kprintf("[" "E" "/" "at.clnt" "] "); rt_kprintf("AT client(V%s) on device %s initialize failed(%d).", "1.3.1", dev_name, result); rt_kprintf("\n"); } while (0);
    }
