# 1 "../rt-thread/components/net/at/src/at_utils.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/net/at/src/at_utils.c"
# 12 "../rt-thread/components/net/at/src/at_utils.c"
...
# 13 "../rt-thread/components/net/at/src/at_utils.c" 2
...
# 14 "../rt-thread/components/net/at/src/at_utils.c" 2
...
# 15 "../rt-thread/components/net/at/src/at_utils.c" 2


# 16 "../rt-thread/components/net/at/src/at_utils.c"
static char send_buf[128];
static rt_size_t last_cmd_len = 0;
# 26 "../rt-thread/components/net/at/src/at_utils.c"
...
#define WIDTH_SIZE 32
    ...
    for (i = 0; i < size; i += 32)
    {
        rt_kprintf("[D/AT] %s: %04X-%04X: ", name, i, i + 32);
        for (j = 0; j < 32; j++)
        {
            if (i + j < size)
            {
...
__attribute__((weak)) rt_size_t at_utils_send(rt_device_t dev,
                                rt_off_t pos,
                                const void *buffer,
                                rt_size_t size)
{
