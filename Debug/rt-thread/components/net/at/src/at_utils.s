...
.Ltext0:
	...
	.comm	send_buf,128,4
	.local	last_cmd_len
	.comm	last_cmd_len,4,4
	.section	.rodata
	.align	2
.LC0:
	.string	"[D/AT] %s: %04X-%04X: "
	.align	2
.LC1:
	.string	"%02X "
	.align	2
...
.LC6:
	...
	.text
	.align	1
	.globl	at_print_raw_cmd
	.type	at_print_raw_cmd, @function
at_print_raw_cmd:
.LFB22:
	.file 1 "../rt-thread/components/net/at/src/at_utils.c"
	.loc 1 27 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L12:
	...
	li	a5,94
	bgtu	a4,a5,.L10
	.loc 1 56 92 discriminator 1
	lw	a4,-20(s0)
	lw	a5,-24(s0)
	add	a5,a4,a5
	.loc 1 56 89 discriminator 1
	lw	a4,-40(s0)
	add	a5,a4,a5
	lbu	a5,0(a5)
	j	.L11
.L10:
	.loc 1 56 17 discriminator 2
	li	a5,46
.L11:
	.loc 1 56 17 is_stmt 0 discriminator 4
	mv	a1,a5
	lla	a0,.LC5
	call	rt_kprintf
.L9:
	.loc 1 52 30 is_stmt 1 discriminator 2
	lw	a5,-24(s0)
	addi	a5,a5,1
	sw	a5,-24(s0)
.L8:
...
.L2:
	...
	.cfi_endproc
.LFE22:
	.size	at_print_raw_cmd, .-at_print_raw_cmd
	.align	1
	.globl	at_get_last_cmd
	.type	at_get_last_cmd, @function
at_get_last_cmd:
.LFB23:
	.loc 1 64 1
	.cfi_startproc
	...
	.cfi_endproc
.LFE23:
	.size	at_get_last_cmd, .-at_get_last_cmd
	.align	1
	.weak	at_utils_send
	.type	at_utils_send, @function
at_utils_send:
.LFB24:
	.loc 1 73 1
	.cfi_startproc
	...
	.cfi_endproc
.LFE24:
	.size	at_utils_send, .-at_utils_send
	.align	1
	.globl	at_vprintf
	.type	at_vprintf, @function
at_vprintf:
.LFB25:
	.loc 1 78 1
	.cfi_startproc
...
.L23:
	...
	.cfi_endproc
.LFE26:
	.size	at_vprintfln, .-at_vprintfln
.Letext0:
...
.Ldebug_macro0:
	...
	.byte	0x4
	.file 35 "c:\\rt-threadstudio\\repo\\extract\\toolchain_support_packages\\wch\\risc-v-gcc-wch\\8.2.0\\riscv-none-embed\\include\\stdio.h"
	.byte	0x3
	.byte	0xe
	.byte	0x23
	.byte	0x7
...
.Ldebug_macro28:
	...
	.4byte	.LASF1102
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.at.h.22.cff6b0c1de27310ceb6aa897e7e8a4ca,comdat
.Ldebug_macro29:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF1456:
	.string	"../rt-thread/components/net/at/src/at_utils.c"
.LASF645:
...
.LASF1237:
	.string	"__is_print(ch) ((unsigned int)((ch) - ' ') < 127u - ' ')"
.LASF225:
