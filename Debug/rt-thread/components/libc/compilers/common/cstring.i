# 1 "../rt-thread/components/libc/compilers/common/cstring.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/libc/compilers/common/cstring.c"
# 11 "../rt-thread/components/libc/compilers/common/cstring.c"
# 1 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\libc\\compilers\\common\\include/posix/string.h" 1
# 12 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\libc\\compilers\\common\\include/posix/string.h"
...
# 19 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\libc\\compilers\\common\\include/posix/string.h" 2
...
# 20 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\libc\\compilers\\common\\include/posix/string.h" 2


# 21 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\libc\\compilers\\common\\include/posix/string.h"
...
# 12 "../rt-thread/components/libc/compilers/common/cstring.c" 2
...
# 13 "c:\\rt-threadstudio\\repo\\extract\\toolchain_support_packages\\wch\\risc-v-gcc-wch\\8.2.0\\riscv-none-embed\\include\\ctype.h" 3
int isalnum (int __c);
int isalpha (int __c);
int iscntrl (int __c);
int isdigit (int __c);
...
# 13 "../rt-thread/components/libc/compilers/common/cstring.c" 2
...
# 14 "../rt-thread/components/libc/compilers/common/cstring.c" 2
...
# 15 "../rt-thread/components/libc/compilers/common/cstring.c" 2
# 23 "../rt-thread/components/libc/compilers/common/cstring.c"
...
# 102 "../rt-thread/components/libc/compilers/common/cstring.c"
void* memrchr(const void* ptr, int ch, size_t pos)
{
    ...
    return (*end == ch) ? (end) : (
# 111 "../rt-thread/components/libc/compilers/common/cstring.c" 3 4
                                  ((void *)0)
# 111 "../rt-thread/components/libc/compilers/common/cstring.c"
                                      );
}
...
int strcasecmp(const char* s1, const char* s2)
{
    ...
    while ((result = 
# 134 "../rt-thread/components/libc/compilers/common/cstring.c" 3
                    __extension__ ({ __typeof__ (
# 134 "../rt-thread/components/libc/compilers/common/cstring.c"
                    *u1
# 134 "../rt-thread/components/libc/compilers/common/cstring.c" 3
                    ) __x = (
# 134 "../rt-thread/components/libc/compilers/common/cstring.c"
...
int strncasecmp(const char* s1, const char* s2, size_t n)
{
    ...
    {
        result = 
# 151 "../rt-thread/components/libc/compilers/common/cstring.c" 3
                __extension__ ({ __typeof__ (
# 151 "../rt-thread/components/libc/compilers/common/cstring.c"
                *u1
# 151 "../rt-thread/components/libc/compilers/common/cstring.c" 3
                ) __x = (
# 151 "../rt-thread/components/libc/compilers/common/cstring.c"
...
__attribute__((weak)) char *strtok_r(char *str, const char *delim, char **saveptr)
{
    char *pbegin;
    char *pend = 
# 190 "../rt-thread/components/libc/compilers/common/cstring.c" 3 4
                ((void *)0)
# 190 "../rt-thread/components/libc/compilers/common/cstring.c"
                    ;
    ...
    {
        return 
# 202 "../rt-thread/components/libc/compilers/common/cstring.c" 3 4
              ((void *)0)
# 202 "../rt-thread/components/libc/compilers/common/cstring.c"
                  ;
    }

    for (;*pbegin && strchr(delim, *pbegin) != 
# 205 "../rt-thread/components/libc/compilers/common/cstring.c" 3 4
                                              ((void *)0)
# 205 "../rt-thread/components/libc/compilers/common/cstring.c"
                                                  ; pbegin++);

    if (!*pbegin)
    {
        return 
# 209 "../rt-thread/components/libc/compilers/common/cstring.c" 3 4
              ((void *)0)
# 209 "../rt-thread/components/libc/compilers/common/cstring.c"
                  ;
    }

    for (pend = pbegin + 1; *pend && strchr(delim, *pend) == 
# 212 "../rt-thread/components/libc/compilers/common/cstring.c" 3 4
                                                            ((void *)0)
# 212 "../rt-thread/components/libc/compilers/common/cstring.c"
                                                                ; pend++);
