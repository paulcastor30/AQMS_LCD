# 1 "../rt-thread/components/libc/compilers/common/cstdlib.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/libc/compilers/common/cstdlib.c"
# 11 "../rt-thread/components/libc/compilers/common/cstdlib.c"
...
# 12 "../rt-thread/components/libc/compilers/common/cstdlib.c" 2
...
# 16 "../rt-thread/components/libc/compilers/common/cstdlib.c" 2
...
void __rt_libc_exit(int status)
{
    ...
    if (self != 0)
    {
        do { rt_kprintf("[" "W" "/" "stdlib" "] "); rt_kprintf("thread:%s exit:%d!", self->parent.name, status); rt_kprintf("\n"); } while (0);
# 32 "../rt-thread/components/libc/compilers/common/cstdlib.c"
        {
...
char *ltoa(long value, char *string, int radix)
{
    ...
    if (string == 
# 62 "../rt-thread/components/libc/compilers/common/cstdlib.c" 3 4
                 ((void *)0)
# 62 "../rt-thread/components/libc/compilers/common/cstdlib.c"
                     )
    {
        return 0 ;
    }
...
char *ultoa(unsigned long value, char *string, int radix)
{
    ...
    if (string == 
# 117 "../rt-thread/components/libc/compilers/common/cstdlib.c" 3 4
                 ((void *)0)
# 117 "../rt-thread/components/libc/compilers/common/cstdlib.c"
                     )
    {
        return 0;
    }
