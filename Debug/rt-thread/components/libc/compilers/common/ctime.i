# 1 "../rt-thread/components/libc/compilers/common/ctime.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/libc/compilers/common/ctime.c"
# 24 "../rt-thread/components/libc/compilers/common/ctime.c"
...
# 16 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\libc\\compilers\\common\\include/sys/time.h" 2
...
# 17 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\libc\\compilers\\common\\include/sys/time.h" 2
...
# 18 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\components\\libc\\compilers\\common\\include/sys/time.h" 2
...
# 25 "../rt-thread/components/libc/compilers/common/ctime.c" 2
...
# 26 "../rt-thread/components/libc/compilers/common/ctime.c" 2
...
# 27 "../rt-thread/components/libc/compilers/common/ctime.c" 2
...
# 29 "../rt-thread/components/libc/compilers/common/ctime.c" 2
...
# 37 "../rt-thread/components/libc/compilers/common/ctime.c" 2
...
# 42 "../rt-thread/components/libc/compilers/common/ctime.c" 2
...
static rt_err_t get_timeval(struct timeval *tv)
{
    ...
    {
        do { rt_kprintf("[" "W" "/" "time" "] "); rt_kprintf("Cannot find a RTC device!"); rt_kprintf("\n"); } while (0);
        return -6;
    }
...
struct tm *gmtime_r(const time_t *timep, struct tm *r)
{
    ...
    {
        rt_set_errno(
# 184 "../rt-thread/components/libc/compilers/common/ctime.c" 3
                    14
# 184 "../rt-thread/components/libc/compilers/common/ctime.c"
                          );
        return 0;
    }
...
char* asctime_r(const struct tm *t, char *buf)
{
    ...
    {
        rt_set_errno(
# 263 "../rt-thread/components/libc/compilers/common/ctime.c" 3
                    14
# 263 "../rt-thread/components/libc/compilers/common/ctime.c"
                          );
        return 0;
    }
    ...
    {
        do { rt_kprintf("[" "W" "/" "time" "] "); rt_kprintf("asctime_r: the input parameters exceeded the limit, please check it."); rt_kprintf("\n"); } while (0);
        *(int*) buf = *(int*) days;
...
;
# 352 "../rt-thread/components/libc/compilers/common/ctime.c"
__attribute__((weak)) time_t time(time_t *t)
{
    ...
    {
        rt_set_errno(
# 366 "../rt-thread/components/libc/compilers/common/ctime.c" 3
                    14
# 366 "../rt-thread/components/libc/compilers/common/ctime.c"
                          );
        return ((time_t)-1);
    }
}
...
int stime(const time_t *t)
{
    ...
    {
        rt_set_errno(
# 384 "../rt-thread/components/libc/compilers/common/ctime.c" 3
                    14
# 384 "../rt-thread/components/libc/compilers/common/ctime.c"
                          );
        return -1;
    }
    ...
    {
        rt_set_errno(
# 396 "../rt-thread/components/libc/compilers/common/ctime.c" 3
                    14
# 396 "../rt-thread/components/libc/compilers/common/ctime.c"
                          );
        return -1;
    }
}
...
time_t timegm(struct tm * const t)
{
    ...
    {
        rt_set_errno(
# 410 "../rt-thread/components/libc/compilers/common/ctime.c" 3
                    14
# 410 "../rt-thread/components/libc/compilers/common/ctime.c"
                          );
        return (time_t)-1;
    }
    ...
    {
        rt_set_errno(
# 452 "../rt-thread/components/libc/compilers/common/ctime.c" 3
                    22
# 452 "../rt-thread/components/libc/compilers/common/ctime.c"
                          );
        return (time_t) -1;
    }
...
int gettimeofday(struct timeval *tv, struct timezone *tz)
{
    ...
    {
        rt_set_errno(
# 506 "../rt-thread/components/libc/compilers/common/ctime.c" 3
                    22
# 506 "../rt-thread/components/libc/compilers/common/ctime.c"
                          );
        return -1;
    }
}
...
int settimeofday(const struct timeval *tv, const struct timezone *tz)
{
    ...
    {
        rt_set_errno(
# 527 "../rt-thread/components/libc/compilers/common/ctime.c" 3
                    22
# 527 "../rt-thread/components/libc/compilers/common/ctime.c"
                          );
        return -1;
    }
}
;
# 1305 "../rt-thread/components/libc/compilers/common/ctime.c"
