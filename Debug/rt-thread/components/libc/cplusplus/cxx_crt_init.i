# 1 "../rt-thread/components/libc/cplusplus/cxx_crt_init.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/libc/cplusplus/cxx_crt_init.c"
# 14 "../rt-thread/components/libc/cplusplus/cxx_crt_init.c"
...
# 15 "../rt-thread/components/libc/cplusplus/cxx_crt_init.c" 2
# 25 "../rt-thread/components/libc/cplusplus/cxx_crt_init.c"
...
# 49 "../rt-thread/components/libc/cplusplus/cxx_crt_init.c"
__attribute__((weak)) int cplusplus_system_init(void)
{
# 69 "../rt-thread/components/libc/cplusplus/cxx_crt_init.c"
    typedef void(*pfunc)();
...
__attribute__((used)) const init_fn_t __rt_init_cplusplus_system_init __attribute__((section(".rti_fn." "4"))) = cplusplus_system_init;
