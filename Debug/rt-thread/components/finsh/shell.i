...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/finsh/shell.c"
# 21 "../rt-thread/components/finsh/shell.c"
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 22 "../rt-thread/components/finsh/shell.c" 2
...
# 23 "../rt-thread/components/finsh/shell.c" 2
...
# 24 "../rt-thread/components/finsh/shell.c" 2



# 1 "../rt-thread/components/finsh/shell.h" 1
# 12 "../rt-thread/components/finsh/shell.h"
#define __SHELL_H__ 
...
# 15 "../rt-thread/components/finsh/shell.h" 2
# 1 "../rt-thread/components/finsh/finsh.h" 1
# 16 "../rt-thread/components/finsh/shell.h" 2
# 27 "../rt-thread/components/finsh/shell.h"
#define FINSH_OPTION_ECHO 0x01

#define FINSH_PROMPT finsh_get_prompt()
const char *finsh_get_prompt(void);
int finsh_set_prompt(const char *prompt);
# 55 "../rt-thread/components/finsh/shell.h"
enum input_stat
{
    WAIT_NORMAL,
    WAIT_SPEC_KEY,
...
# 28 "../rt-thread/components/finsh/shell.c" 2
# 1 "../rt-thread/components/finsh/msh.h" 1
# 12 "../rt-thread/components/finsh/msh.h"
#define __M_SHELL__ 
...
# 29 "../rt-thread/components/finsh/shell.c" 2
# 45 "../rt-thread/components/finsh/shell.c"
    struct finsh_syscall *_syscall_table_begin = 
# 45 "../rt-thread/components/finsh/shell.c" 3 4
                                                 ((void *)0)
# 45 "../rt-thread/components/finsh/shell.c"
                                                     ;
    struct finsh_syscall *_syscall_table_end = 
# 46 "../rt-thread/components/finsh/shell.c" 3 4
                                                 ((void *)0)
# 46 "../rt-thread/components/finsh/shell.c"
                                                     ;


struct finsh_shell *shell;
static char *finsh_prompt_custom = 0;
# 66 "../rt-thread/components/finsh/shell.c"
int finsh_set_prompt(const char *prompt)
{
...
rt_uint32_t finsh_get_prompt_mode(void)
{
    if (!(shell != 0)) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 129); };
    return shell->prompt_mode;
}
# 142 "../rt-thread/components/finsh/shell.c"
void finsh_set_prompt_mode(rt_uint32_t prompt_mode)
{
    if (!(shell != 0)) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 144); };
...
# 162 "../rt-thread/components/finsh/shell.c"
    ...
    if (!(shell != 0)) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 164); };
...
{
    if (!(shell != 0)) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 195); };
...
# 210 "../rt-thread/components/finsh/shell.c"
void finsh_set_device(const char *device_name)
{
    rt_device_t dev = 0;

    if (!(shell != 0)) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 214); };
...
# 251 "../rt-thread/components/finsh/shell.c"
const char *finsh_get_device()
{
    if (!(shell != 0)) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 253); };
    return shell->device->parent.name;
}
# 267 "../rt-thread/components/finsh/shell.c"
void finsh_set_echo(rt_uint32_t echo)
{
    if (!(shell != 0)) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 269); };
    shell->echo_mode = (rt_uint8_t)echo;
}
# 280 "../rt-thread/components/finsh/shell.c"
rt_uint32_t finsh_get_echo()
{
    if (!(shell != 0)) { rt_assert_handler("shell != RT_NULL", __FUNCTION__, 282); };
...
{
# 399 "../rt-thread/components/finsh/shell.c"
    rt_kprintf("\033[2K\r");
...
# 500 "../rt-thread/components/finsh/shell.c"
        if (ch == 0x1b)
        {
...
# 731 "../rt-thread/components/finsh/shell.c"
int finsh_system_init(void)
{
    rt_err_t result = 0;
    rt_thread_t tid;
# 746 "../rt-thread/components/finsh/shell.c"
...
# 774 "../rt-thread/components/finsh/shell.c"
    ...
    tid = rt_thread_create("tshell",
                           ...
                           2048, 20, 10);
# 793 "../rt-thread/components/finsh/shell.c"
    rt_sem_init(&(shell->rx_sem), "shrx", 0, 0);
    finsh_set_prompt_mode(1);

    if (tid != 
# 796 "../rt-thread/components/finsh/shell.c" 3 4
              ((void *)0) 
