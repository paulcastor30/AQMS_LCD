# 1 "../rt-thread/components/finsh/msh_parse.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/finsh/msh_parse.c"
# 11 "../rt-thread/components/finsh/msh_parse.c"
...
# 12 "../rt-thread/components/finsh/msh_parse.c" 2
...
# 13 "../rt-thread/components/finsh/msh_parse.c" 2

#define forstrloop(str) for (; '\0' != *(str); (str)++)
# 23 "../rt-thread/components/finsh/msh_parse.c"
...
rt_bool_t msh_isint(char *strvalue)
{
    ...
    {
        if (!
# 35 "../rt-thread/components/finsh/msh_parse.c" 3
            ((((__locale_ctype_ptr ())+sizeof(""[
# 35 "../rt-thread/components/finsh/msh_parse.c"
            (int)(*strvalue)
# 35 "../rt-thread/components/finsh/msh_parse.c" 3
            ]))[(int)(
# 35 "../rt-thread/components/finsh/msh_parse.c"
...
# 50 "../rt-thread/components/finsh/msh_parse.c"
rt_bool_t msh_ishex(char *strvalue)
{
    ...
    {
        c = 
# 68 "../rt-thread/components/finsh/msh_parse.c" 3
           __extension__ ({ __typeof__ (
# 68 "../rt-thread/components/finsh/msh_parse.c"
           *strvalue
# 68 "../rt-thread/components/finsh/msh_parse.c" 3
           ) __x = (
# 68 "../rt-thread/components/finsh/msh_parse.c"
...
# 68 "../rt-thread/components/finsh/msh_parse.c"
                             ;
        if (!
# 69 "../rt-thread/components/finsh/msh_parse.c" 3
            ((((__locale_ctype_ptr ())+sizeof(""[
# 69 "../rt-thread/components/finsh/msh_parse.c"
            c
# 69 "../rt-thread/components/finsh/msh_parse.c" 3
            ]))[(int)(
# 69 "../rt-thread/components/finsh/msh_parse.c"
...
# 84 "../rt-thread/components/finsh/msh_parse.c"
int msh_strtohex(char *strvalue)
{
    ...
    for (; '\0' != *(strvalue); (strvalue)++)
    {
        value *= 16;
        c = 
# 92 "../rt-thread/components/finsh/msh_parse.c" 3
           __extension__ ({ __typeof__ (
# 92 "../rt-thread/components/finsh/msh_parse.c"
           *strvalue
# 92 "../rt-thread/components/finsh/msh_parse.c" 3
           ) __x = (
# 92 "../rt-thread/components/finsh/msh_parse.c"
...
# 92 "../rt-thread/components/finsh/msh_parse.c"
                             ;
        value += 
# 93 "../rt-thread/components/finsh/msh_parse.c" 3
                ((((__locale_ctype_ptr ())+sizeof(""[
# 93 "../rt-thread/components/finsh/msh_parse.c"
                c
# 93 "../rt-thread/components/finsh/msh_parse.c" 3
                ]))[(int)(
# 93 "../rt-thread/components/finsh/msh_parse.c"
