...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/finsh/cmd.c"
# 35 "../rt-thread/components/finsh/cmd.c"
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 36 "../rt-thread/components/finsh/cmd.c" 2
...
# 37 "../rt-thread/components/finsh/cmd.c" 2
...
# 38 "../rt-thread/components/finsh/cmd.c" 2
        ...
        next = list_get_next(next, &find_arg);
        {
            ...
            for (i = 0; i < find_arg.nr_out; i++)
            {
                ...
                thread = (struct rt_thread *)obj;
                {
                    rt_uint8_t stat;
                    rt_uint8_t *ptr;
# 212 "../rt-thread/components/finsh/cmd.c"
                    rt_kprintf("%-*.*s %3d ", maxlen, 8, thread->parent.name, thread->current_priority);
...
static void show_wait_queue(struct rt_list_node *list)
{
    ...
    for (node = list->next; node != list; node = node->next)
    {
        ...
        rt_kprintf("%.*s", 8, thread->parent.name);
...
# 740 "../rt-thread/components/finsh/cmd.c"
...
# 953 "../rt-thread/components/finsh/cmd.c"
        else if(strcmp(argv[1], "device") == 0)
        {
            list_device();
        }
# 965 "../rt-thread/components/finsh/cmd.c"
        else
        {
            goto _usage;
        }
...
# 1000 "../rt-thread/components/finsh/cmd.c"
