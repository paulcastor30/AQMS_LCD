...
# 1 "<command-line>" 2
# 1 "../rt-thread/components/finsh/msh.c"
# 12 "../rt-thread/components/finsh/msh.c"
...
# 13 "../rt-thread/components/finsh/msh.c" 2
...
# 14 "../rt-thread/components/finsh/msh.c" 2
...
# 16 "../rt-thread/components/finsh/msh.h"
int msh_exec(char *cmd, rt_size_t length);
void msh_auto_complete(char *prefix);

int msh_exec_module(const char *cmd_line, int size);
int msh_exec_script(const char *cmd_line, int size);
# 22 "../rt-thread/components/finsh/msh.c" 2
...
# 23 "../rt-thread/components/finsh/msh.c" 2
# 32 "../rt-thread/components/finsh/msh.c"
...
# 266 "../rt-thread/components/finsh/msh.c"
static int _msh_exec_cmd(char *cmd, rt_size_t length, int *retp)
{
    ...
    if (!(cmd)) { rt_assert_handler("cmd", __FUNCTION__, 273); };
    if (!(retp)) { rt_assert_handler("retp", __FUNCTION__, 274); };
...
# 484 "../rt-thread/components/finsh/msh.c"
int msh_exec(char *cmd, rt_size_t length)
{
    int cmd_ret;
...
# 532 "../rt-thread/components/finsh/msh.c"
    {
        char *tcmd;
        tcmd = cmd;
        while (*tcmd != ' ' && *tcmd != '\0')
...
# 705 "../rt-thread/components/finsh/msh.c"
void msh_auto_complete(char *prefix)
{
...
# 749 "../rt-thread/components/finsh/msh.c"
    {
    ...
    if (name_ptr != 
# 774 "../rt-thread/components/finsh/msh.c" 3 4
                   ((void *)0)
# 774 "../rt-thread/components/finsh/msh.c"
                       )
    {
