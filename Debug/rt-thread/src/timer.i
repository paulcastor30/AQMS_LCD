                   ...
                   rt_uint8_t flag)
{
    ...
    if (!(timer != 0)) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 276); };
    if (!(timeout != 0)) { rt_assert_handler("timeout != RT_NULL", __FUNCTION__, 277); };
    if (!(time < 
# 278 "../rt-thread/src/timer.c" 3
   (0xffffffffUL) 
# 278 "../rt-thread/src/timer.c"
   / 2)) { rt_assert_handler("time < RT_TICK_MAX / 2", __FUNCTION__, 278); };
...
;
# 294 "../rt-thread/src/timer.c"
rt_err_t rt_timer_detach(rt_timer_t timer)
{
    rt_base_t level;


    if (!(timer != 0)) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 299); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 300); };
    if (!(rt_object_is_systemobject(&timer->parent))) { rt_assert_handler("rt_object_is_systemobject(&timer->parent)", __FUNCTION__, 301); };
                           ...
                           rt_uint8_t flag)
{
    ...
    if (!(timeout != 0)) { rt_assert_handler("timeout != RT_NULL", __FUNCTION__, 355); };
    if (!(time < 
# 356 "../rt-thread/src/timer.c" 3
   (0xffffffffUL) 
# 356 "../rt-thread/src/timer.c"
   / 2)) { rt_assert_handler("time < RT_TICK_MAX / 2", __FUNCTION__, 356); };
...
rt_err_t rt_timer_delete(rt_timer_t timer)
{
    ...
    if (!(timer != 0)) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 383); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 384); };
    if (!(rt_object_is_systemobject(&timer->parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&timer->parent) == RT_FALSE", __FUNCTION__, 385); };
...
rt_err_t rt_timer_start(rt_timer_t timer)
{
    ...
    if (!(timer != 0)) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 422); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 423); };
...
# 472 "../rt-thread/src/timer.c" 3
                                                              (0xffffffffUL) 
# 472 "../rt-thread/src/timer.c"
                                                                          / 2)
            {
                break;
            }
...
rt_err_t rt_timer_stop(rt_timer_t timer)
{
    ...
    if (!(timer != 0)) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 545); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 546); };
...
;
# 576 "../rt-thread/src/timer.c"
rt_err_t rt_timer_control(rt_timer_t timer, int cmd, void *arg)
{
    rt_base_t level;


    if (!(timer != 0)) { rt_assert_handler("timer != RT_NULL", __FUNCTION__, 581); };
    if (!(rt_object_get_type(&timer->parent) == RT_Object_Class_Timer)) { rt_assert_handler("rt_object_get_type(&timer->parent) == RT_Object_Class_Timer", __FUNCTION__, 582); };
    ...
    case 0x0:
        if (!((*(rt_tick_t *)arg) < 
# 592 "../rt-thread/src/timer.c" 3
       (0xffffffffUL) 
# 592 "../rt-thread/src/timer.c"
       / 2)) { rt_assert_handler("(*(rt_tick_t *)arg) < RT_TICK_MAX / 2", __FUNCTION__, 592); };
...
# 727 "../rt-thread/src/timer.c" 3
                            (0xffffffffUL)
# 727 "../rt-thread/src/timer.c"
                                       ;
...
void rt_soft_timer_check(void)
{
    ...
    while (!rt_list_isempty(&_soft_timer_list[1 - 1]))
    {
        ...
        if ((current_tick - t->timeout_tick) < 
# 762 "../rt-thread/src/timer.c" 3
                                              (0xffffffffUL) 
# 762 "../rt-thread/src/timer.c"
                                                          / 2)
        {
            do {if ((rt_timer_enter_hook) != 0) rt_timer_enter_hook (t); } while (0);
...
# 836 "../rt-thread/src/timer.c" 3
                                               (0xffffffffUL) 
# 836 "../rt-thread/src/timer.c"
                                                           / 2)
            {
