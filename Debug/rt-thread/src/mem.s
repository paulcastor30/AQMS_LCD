...
.Ltext0:
	...
	.align	2
.LC0:
	.string	"(rt_uint8_t *)mem >= m->heap_ptr"
	.align	2
.LC1:
	.string	"(rt_uint8_t *)mem < (rt_uint8_t *)m->heap_end"
	.text
	.align	1
	.type	plug_holes, @function
plug_holes:
.LFB19:
	.file 1 "../rt-thread/src/mem.c"
	.loc 1 129 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L3:
	...
	lw	a5,-20(s0)
	beq	a4,a5,.L4
	.loc 1 138 75 discriminator 1
	lw	a5,-20(s0)
	lw	a5,0(a5)
	.loc 1 138 88 discriminator 1
	andi	a5,a5,1
	.loc 1 138 21 discriminator 1
	bnez	a5,.L4
	.loc 1 139 46 discriminator 2
	lw	a5,-36(s0)
	lw	a5,44(a5)
	.loc 1 138 116 discriminator 2
	lw	a4,-20(s0)
	beq	a4,a5,.L4
	.loc 1 144 14
	lw	a5,-36(s0)
...
.LFB20:
	...
	li	a5,32
	bleu	a4,a5,.L10
	.loc 1 194 21 discriminator 1
	lw	a5,-32(s0)
	addi	a5,a5,-32
	.loc 1 193 91 discriminator 1
	lw	a4,-24(s0)
	bgtu	a4,a5,.L10
	.loc 1 197 30
	lw	a4,-32(s0)
...
.LC4:
	...
	.align	2
.LC5:
	.string	"rt_object_get_type(&m->parent) == RT_Object_Class_Memory"
	.align	2
.LC6:
	.string	"rt_object_is_systemobject(&m->parent)"
	.text
	.align	1
...
.LFE21:
	...
	.align	2
.LC7:
	.string	"((small_mem->lfree == small_mem->heap_end) || (!MEM_ISUSED(small_mem->lfree)))"
	.align	2
.LC8:
	.string	"(rt_ubase_t)mem + SIZEOF_STRUCT_MEM + size <= (rt_ubase_t)small_mem->heap_end"
	.align	2
.LC9:
...
.L38:
	...
	.loc 1 324 12
	bnez	a5,.L26
	.loc 1 324 113 discriminator 1
	lw	a5,-28(s0)
	lw	a4,4(a5)
	.loc 1 324 120 discriminator 1
	lw	a5,-20(s0)
	sub	a5,a4,a5
	addi	a5,a5,-16
	.loc 1 324 106 discriminator 1
	lw	a4,-56(s0)
	bgtu	a4,a5,.L26
	.loc 1 329 20
	lw	a5,-28(s0)
...
.L32:
	...
	.loc 1 389 23
	beqz	a5,.L33
	.loc 1 389 139 discriminator 1
	lw	a5,-24(s0)
	lw	a4,48(a5)
	.loc 1 389 159 discriminator 1
	lw	a5,-24(s0)
	lw	a5,44(a5)
	.loc 1 389 127 discriminator 1
	bne	a4,a5,.L34
.L33:
	.loc 1 392 34
	lw	a5,-24(s0)
	...
	.loc 1 392 20
	beq	a4,a5,.L31
	.loc 1 392 124 discriminator 1
	lw	a5,-24(s0)
	lw	a5,48(a5)
	.loc 1 392 133 discriminator 1
	lw	a5,0(a5)
	.loc 1 392 146 discriminator 1
	andi	a5,a5,1
	.loc 1 392 21 discriminator 1
	beqz	a5,.L31
	.loc 1 392 180 discriminator 2
	li	a2,392
	lla	a1,__FUNCTION__.2847
	lla	a0,.LC7
	call	rt_assert_handler
...
.LC11:
	...
	.align	2
.LC12:
	.string	"(rt_uint8_t *)rmem >= (rt_uint8_t *)small_mem->heap_ptr"
	.align	2
.LC13:
	.string	"(rt_uint8_t *)rmem < (rt_uint8_t *)small_mem->heap_end"
	.text
	.align	1
...
.LFE23:
	...
	.align	2
.LC14:
	.string	"small_mem != RT_NULL"
	.align	2
.LC15:
	.string	"MEM_ISUSED(mem)"
	.align	2
.LC16:
	.string	"rt_object_get_type(&small_mem->parent.parent) == RT_Object_Class_Memory"
	.align	2
.LC17:
	.string	"rt_object_is_systemobject(&small_mem->parent.parent)"
	.align	2
.LC18:
	.string	"(rt_uint8_t *)rmem >= (rt_uint8_t *)small_mem->heap_ptr && (rt_uint8_t *)rmem < (rt_uint8_t *)small_mem->heap_end"
	.align	2
.LC19:
	.string	"MEM_POOL(&small_mem->heap_ptr[mem->next]) == small_mem"
	.text
	.align	1
	.globl	rt_smem_free
...
.L63:
	...
	lw	a4,-36(s0)
	bltu	a4,a5,.L64
	.loc 1 534 114 discriminator 2
	lw	a5,-24(s0)
	lw	a5,44(a5)
	.loc 1 534 9 discriminator 2
	lw	a4,-36(s0)
	bltu	a4,a5,.L65
.L64:
	.loc 1 534 129 discriminator 3
	li	a2,535
	lla	a1,__FUNCTION__.2872
	lla	a0,.LC18
	call	rt_assert_handler
...
.LFE24:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.2822, @object
	.size	__FUNCTION__.2822, 11
__FUNCTION__.2822:
	.string	"plug_holes"
	.align	2
	.type	__FUNCTION__.2837, @object
	.size	__FUNCTION__.2837, 15
__FUNCTION__.2837:
	.string	"rt_smem_detach"
	.align	2
	.type	__FUNCTION__.2847, @object
	.size	__FUNCTION__.2847, 14
__FUNCTION__.2847:
	.string	"rt_smem_alloc"
	.align	2
	.type	__FUNCTION__.2866, @object
	.size	__FUNCTION__.2866, 16
__FUNCTION__.2866:
	.string	"rt_smem_realloc"
	.align	2
	.type	__FUNCTION__.2872, @object
	.size	__FUNCTION__.2872, 13
__FUNCTION__.2872:
	.string	"rt_smem_free"
	.text
.Letext0:
...
.Ldebug_macro0:
	...
	.byte	0x3
	.4byte	.LASF315
	.file 8 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rtconfig_preinc.h"
	.byte	0x3
	.byte	0x4
	.byte	0x8
	.byte	0x7
	.4byte	.Ldebug_macro2
	.byte	0x4
	.file 9 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\include/rthw.h"
	.byte	0x3
	.byte	0x32
	.byte	0x9
	.byte	0x5
