...
.LBE2:
	...
	sw	a5,-20(s0)
.L29:
	.loc 2 375 21 discriminator 1
	lw	a5,-24(s0)
	addi	a5,a5,4
	.loc 2 374 5 discriminator 1
	lw	a4,-20(s0)
	bne	a4,a5,.L31
	.loc 2 384 5
...
.LBB3:
	...
	.loc 2 465 65
	beqz	a5,.L37
	.loc 2 465 98 discriminator 1
	lla	a1,__FUNCTION__.2910
	lla	a0,.LC3
	call	rt_kprintf
	.loc 2 465 179 discriminator 1
	li	a2,465
	lla	a1,__FUNCTION__.2910
	lla	a0,.LC4
	call	rt_assert_handler
.L37:
	.loc 2 465 226 discriminator 5
	lw	a0,-20(s0)
	call	rt_hw_interrupt_enable
.LBE3:
	.loc 2 468 19 discriminator 5
	lw	a0,-36(s0)
	call	rt_object_get_information
	sw	a0,-24(s0)
	.loc 2 469 8 discriminator 5
	lw	a5,-24(s0)
	bnez	a5,.L38
	.loc 2 469 32 discriminator 1
	li	a2,469
	lla	a1,__FUNCTION__.2910
	lla	a0,.LC0
	call	rt_assert_handler
...
.LFB30:
	...
	lw	a5,-36(s0)
	bnez	a5,.L43
	.loc 2 530 27 discriminator 1
	li	a2,530
	lla	a1,__FUNCTION__.2915
	lla	a0,.LC2
	call	rt_assert_handler
.L43:
	.loc 2 531 19
...
.LFB31:
	...
	lw	a5,-20(s0)
	bnez	a5,.L47
	.loc 2 565 27 discriminator 1
	li	a2,565
	lla	a1,__FUNCTION__.2919
	lla	a0,.LC2
	call	rt_assert_handler
.L47:
	.loc 2 567 15
...
.LBB4:
	...
	.loc 2 614 65
	beqz	a5,.L57
	.loc 2 614 98 discriminator 1
	lla	a1,__FUNCTION__.2932
	lla	a0,.LC3
	call	rt_kprintf
	.loc 2 614 179 discriminator 1
	li	a2,614
	lla	a1,__FUNCTION__.2932
	lla	a0,.LC4
	call	rt_assert_handler
.L57:
	.loc 2 614 226 discriminator 5
	lw	a0,-32(s0)
	call	rt_hw_interrupt_enable
.LBE4:
	.loc 2 617 5 discriminator 5
	call	rt_enter_critical
	.loc 2 620 15 discriminator 5
	lw	a5,-28(s0)
	lw	a5,4(a5)
	sw	a5,-20(s0)
	.loc 2 620 5 discriminator 5
	j	.L58
.L60:
	.loc 2 622 16
	lw	a5,-20(s0)
