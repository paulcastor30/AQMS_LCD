...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 21 "../rt-thread/src/components.c" 2
...
# 22 "../rt-thread/src/components.c" 2
...
# 180 "../rt-thread/src/components.c"
void main_thread_entry(void *parameter)
{
    ...
    rt_components_init();
# 199 "../rt-thread/src/components.c"
    main();
...
void rt_application_init(void)
{
    ...
    tid = rt_thread_create("main", main_thread_entry, 0,
                           2048, 10, 20);
    if (!(tid != 0)) { rt_assert_handler("tid != RT_NULL", __FUNCTION__, 214); };
