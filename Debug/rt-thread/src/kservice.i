...
#define TOO_SMALL(LEN) ((LEN) < LBLOCKSIZE)
    ...
    if (!((sizeof(rt_ubase_t)) == 2 || (sizeof(rt_ubase_t)) == 4 || (sizeof(rt_ubase_t)) == 8)) { rt_assert_handler("LBLOCKSIZE == 2 || LBLOCKSIZE == 4 || LBLOCKSIZE == 8", __FUNCTION__, 224); };
...
void rt_show_version(void)
{
    ...
    rt_kprintf(" / | \\     %d.%d.%d build %s %s\n",
               (rt_int32_t)5, (rt_int32_t)0, (rt_int32_t)1, "Jul 20 2023", "22:58:32");
...
__attribute__((weak)) int rt_vsnprintf(char *buf, rt_size_t size, const char *fmt, va_list args)
{
    ...
    for (; *fmt ; ++fmt)
    {
        ...
        else if (*fmt == '*')
        {
            ...
            field_width = 
# 1052 "../rt-thread/src/kservice.c" 3 4
                         __builtin_va_arg(
# 1052 "../rt-thread/src/kservice.c"
                         args
# 1052 "../rt-thread/src/kservice.c" 3 4
                         ,
# 1052 "../rt-thread/src/kservice.c"
...
# 1052 "../rt-thread/src/kservice.c"
        ...
        if (*fmt == '.')
        {
            ...
            else if (*fmt == '*')
            {
                ...
                precision = 
# 1074 "../rt-thread/src/kservice.c" 3 4
                           __builtin_va_arg(
# 1074 "../rt-thread/src/kservice.c"
                           args
# 1074 "../rt-thread/src/kservice.c" 3 4
                           ,
# 1074 "../rt-thread/src/kservice.c"
...
# 1074 "../rt-thread/src/kservice.c"
        ...
        case 'c':
            ...
            c = (rt_uint8_t)
# 1117 "../rt-thread/src/kservice.c" 3 4
                           __builtin_va_arg(
...
# 1117 "../rt-thread/src/kservice.c"
        ...
        case 's':
            s = 
# 1133 "../rt-thread/src/kservice.c" 3 4
               __builtin_va_arg(
...
# 1133 "../rt-thread/src/kservice.c"
        ...
        case 'p':
            ...
            str = print_number(str, end,
                               (unsigned long)
# 1182 "../rt-thread/src/kservice.c" 3 4
                                             __builtin_va_arg(
...
# 1248 "../rt-thread/src/kservice.c"
        ...
        {
            num = 
# 1251 "../rt-thread/src/kservice.c" 3 4
                 __builtin_va_arg(
...
# 1251 "../rt-thread/src/kservice.c"
        ...
        {
            num = (rt_uint16_t)
# 1255 "../rt-thread/src/kservice.c" 3 4
                              __builtin_va_arg(
...
# 1255 "../rt-thread/src/kservice.c"
        ...
        {
            num = (rt_uint32_t)
# 1263 "../rt-thread/src/kservice.c" 3 4
                              __builtin_va_arg(
...
# 1307 "../rt-thread/src/kservice.c" 3 4
   __builtin_va_start(
# 1307 "../rt-thread/src/kservice.c"
   args
# 1307 "../rt-thread/src/kservice.c" 3 4
   ,
# 1307 "../rt-thread/src/kservice.c"
...
# 1309 "../rt-thread/src/kservice.c" 3 4
   __builtin_va_end(
# 1309 "../rt-thread/src/kservice.c"
   args
# 1309 "../rt-thread/src/kservice.c" 3 4
   )
# 1309 "../rt-thread/src/kservice.c"
...
# 1346 "../rt-thread/src/kservice.c" 3 4
   __builtin_va_start(
# 1346 "../rt-thread/src/kservice.c"
   arg_ptr
# 1346 "../rt-thread/src/kservice.c" 3 4
   ,
# 1346 "../rt-thread/src/kservice.c"
...
# 1348 "../rt-thread/src/kservice.c" 3 4
   __builtin_va_end(
# 1348 "../rt-thread/src/kservice.c"
   arg_ptr
# 1348 "../rt-thread/src/kservice.c" 3 4
   )
# 1348 "../rt-thread/src/kservice.c"
...
;
# 1362 "../rt-thread/src/kservice.c"
rt_device_t rt_console_get_device(void)
{
    return _console_device;
}
;
# 1377 "../rt-thread/src/kservice.c"
rt_device_t rt_console_set_device(const char *name)
{
# 1400 "../rt-thread/src/kservice.c"
...
# 1475 "../rt-thread/src/kservice.c" 3 4
   __builtin_va_start(
# 1475 "../rt-thread/src/kservice.c"
   args
# 1475 "../rt-thread/src/kservice.c" 3 4
   ,
# 1475 "../rt-thread/src/kservice.c"
...
# 1499 "../rt-thread/src/kservice.c" 3 4
   __builtin_va_end(
# 1499 "../rt-thread/src/kservice.c"
   args
# 1499 "../rt-thread/src/kservice.c" 3 4
   )
# 1499 "../rt-thread/src/kservice.c"
...
static __inline void _heap_unlock(rt_base_t level)
{
    ...
    if (!(level == 0)) { rt_assert_handler("level == RT_EOK", __FUNCTION__, 1575); };
    if (rt_thread_self())
...
__attribute__((weak)) void rt_system_heap_init(void *begin_addr, void *end_addr)
{
    ...
    if (!(end_align > begin_align)) { rt_assert_handler("end_align > begin_align", __FUNCTION__, 1672); };
...
;
# 1713 "../rt-thread/src/kservice.c"
__attribute__((weak)) void *rt_realloc(void *ptr, rt_size_t newsize)
{
    rt_base_t level;
    void *nptr;
    ...
    nptr = rt_smem_realloc(system_heap, ptr, newsize);

    _heap_unlock(level);
    return nptr;
}
;
# 1741 "../rt-thread/src/kservice.c"
...
__attribute__((weak)) void rt_free(void *ptr)
{
    rt_base_t level;
