                                       ...
                                       int suspend_flag)
{
    ...
    default:
        if (!(0)) { rt_assert_handler("0", __FUNCTION__, 182); };
        break;
    }
...
rt_err_t rt_sem_init(rt_sem_t sem,
                     ...
                     rt_uint8_t flag)
{
    if (!(sem != 0)) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 319); };
    if (!(value < 0x10000U)) { rt_assert_handler("value < 0x10000U", __FUNCTION__, 320); };
    if (!((flag == 0x00) || (flag == 0x01))) { rt_assert_handler("(flag == RT_IPC_FLAG_FIFO) || (flag == RT_IPC_FLAG_PRIO)", __FUNCTION__, 321); };
...
rt_err_t rt_sem_detach(rt_sem_t sem)
{
    ...
    if (!(sem != 0)) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 361); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 362); };
    if (!(rt_object_is_systemobject(&sem->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&sem->parent.parent)", __FUNCTION__, 363); };
...
rt_sem_t rt_sem_create(const char *name, rt_uint32_t value, rt_uint8_t flag)
{
    ...
    if (!(value < 0x10000U)) { rt_assert_handler("value < 0x10000U", __FUNCTION__, 412); };
    if (!((flag == 0x00) || (flag == 0x01))) { rt_assert_handler("(flag == RT_IPC_FLAG_FIFO) || (flag == RT_IPC_FLAG_PRIO)", __FUNCTION__, 413); };

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 415); } } rt_hw_interrupt_enable(level); } while (0);
...
;
# 454 "../rt-thread/src/ipc.c"
rt_err_t rt_sem_delete(rt_sem_t sem)
{

    if (!(sem != 0)) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 457); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 458); };
    if (!(rt_object_is_systemobject(&sem->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&sem->parent.parent) == RT_FALSE", __FUNCTION__, 459); };

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 461); } } rt_hw_interrupt_enable(level); } while (0);
...
static rt_err_t _rt_sem_take(rt_sem_t sem, rt_int32_t timeout, int suspend_flag)
{
    ...
    if (!(sem != 0)) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 509); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 510); };

    do {if ((rt_object_trytake_hook) != 0) rt_object_trytake_hook (&(sem->parent.parent)); } while (0);


    do { if (sem->value == 0 && timeout != 0) { rt_bool_t interrupt_disabled; rt_base_t level; interrupt_disabled = rt_hw_interrupt_is_disabled(); level = rt_hw_interrupt_disable(); if (rt_critical_level() != 0) { rt_kprintf("Function[%s]: scheduler is not available\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 515); } } if (interrupt_disabled == 1) { rt_kprintf("Function[%s]: interrupt is disabled\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 515); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == 0) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 515); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 515); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } } while (0);
...
rt_err_t rt_sem_release(rt_sem_t sem)
{
    ...
    if (!(sem != 0)) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 651); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 652); };
    ...
    {
        if(sem->value < 
# 674 "../rt-thread/src/ipc.c" 3
                       (0xffff)
# 674 "../rt-thread/src/ipc.c"
                                       )
        {
            sem->value ++;
        }
...
rt_err_t rt_sem_control(rt_sem_t sem, int cmd, void *arg)
{
    ...
    if (!(sem != 0)) { rt_assert_handler("sem != RT_NULL", __FUNCTION__, 716); };
    if (!(rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore)) { rt_assert_handler("rt_object_get_type(&sem->parent.parent) == RT_Object_Class_Semaphore", __FUNCTION__, 717); };
...
rt_err_t rt_mutex_init(rt_mutex_t mutex, const char *name, rt_uint8_t flag)
{
    ...
    if (!(mutex != 0)) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 875); };
...
;
# 915 "../rt-thread/src/ipc.c"
rt_err_t rt_mutex_detach(rt_mutex_t mutex)
{
    rt_ubase_t level;


    if (!(mutex != 0)) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 920); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 921); };
    if (!(rt_object_is_systemobject(&mutex->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&mutex->parent.parent)", __FUNCTION__, 922); };
...
rt_mutex_t rt_mutex_create(const char *name, rt_uint8_t flag)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1071); } } rt_hw_interrupt_enable(level); } while (0);
...
rt_err_t rt_mutex_delete(rt_mutex_t mutex)
{
    ...
    if (!(mutex != 0)) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 1118); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 1119); };
    if (!(rt_object_is_systemobject(&mutex->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&mutex->parent.parent) == RT_FALSE", __FUNCTION__, 1120); };

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1122); } } rt_hw_interrupt_enable(level); } while (0);
...
static rt_err_t _rt_mutex_take(rt_mutex_t mutex, rt_int32_t timeout, int suspend_flag)
{
    ...
    do { if (1) { rt_bool_t interrupt_disabled; rt_base_t level; interrupt_disabled = rt_hw_interrupt_is_disabled(); level = rt_hw_interrupt_disable(); if (rt_critical_level() != 0) { rt_kprintf("Function[%s]: scheduler is not available\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1171); } } if (interrupt_disabled == 1) { rt_kprintf("Function[%s]: interrupt is disabled\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1171); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == 0) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1171); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1171); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } } while (0);


    if (!(mutex != 0)) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 1174); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 1175); };
...
rt_err_t rt_mutex_release(rt_mutex_t mutex)
{
    ...
    if (!(mutex != 0)) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 1411); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 1412); };

    need_schedule = 0;


    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == 0) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1417); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1417); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0);
...
;
# 1539 "../rt-thread/src/ipc.c"
rt_err_t rt_mutex_control(rt_mutex_t mutex, int cmd, void *arg)
{

    if (!(mutex != 0)) { rt_assert_handler("mutex != RT_NULL", __FUNCTION__, 1542); };
    if (!(rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex)) { rt_assert_handler("rt_object_get_type(&mutex->parent.parent) == RT_Object_Class_Mutex", __FUNCTION__, 1543); };

    return -1;
}
;
# 1592 "../rt-thread/src/ipc.c"
rt_err_t rt_event_init(rt_event_t event, const char *name, rt_uint8_t flag)
{

    if (!(event != 0)) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1595); };
    if (!((flag == 0x00) || (flag == 0x01))) { rt_assert_handler("(flag == RT_IPC_FLAG_FIFO) || (flag == RT_IPC_FLAG_PRIO)", __FUNCTION__, 1596); };
...
rt_err_t rt_event_detach(rt_event_t event)
{
    ...
    if (!(event != 0)) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1636); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 1637); };
    if (!(rt_object_is_systemobject(&event->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&event->parent.parent)", __FUNCTION__, 1638); };
...
;
# 1679 "../rt-thread/src/ipc.c"
rt_event_t rt_event_create(const char *name, rt_uint8_t flag)
{
    rt_event_t event;

    if (!((flag == 0x00) || (flag == 0x01))) { rt_assert_handler("(flag == RT_IPC_FLAG_FIFO) || (flag == RT_IPC_FLAG_PRIO)", __FUNCTION__, 1683); };

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1685); } } rt_hw_interrupt_enable(level); } while (0);
...
;
# 1724 "../rt-thread/src/ipc.c"
rt_err_t rt_event_delete(rt_event_t event)
{

    if (!(event != 0)) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1727); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 1728); };
    if (!(rt_object_is_systemobject(&event->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&event->parent.parent) == RT_FALSE", __FUNCTION__, 1729); };

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1731); } } rt_hw_interrupt_enable(level); } while (0);
...
rt_err_t rt_event_send(rt_event_t event, rt_uint32_t set)
{
    ...
    if (!(event != 0)) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1772); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 1773); };
                       ...
                       int suspend_flag)
{
    ...
    if (!(event != 0)) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 1906); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 1907); };


    do { if (1) { rt_bool_t interrupt_disabled; rt_base_t level; interrupt_disabled = rt_hw_interrupt_is_disabled(); level = rt_hw_interrupt_disable(); if (rt_critical_level() != 0) { rt_kprintf("Function[%s]: scheduler is not available\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1910); } } if (interrupt_disabled == 1) { rt_kprintf("Function[%s]: interrupt is disabled\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1910); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == 0) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1910); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1910); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } } while (0);
    ...
    else
    {
        ...
        if (!(0)) { rt_assert_handler("0", __FUNCTION__, 1941); };
    }
...
rt_err_t rt_event_control(rt_event_t event, int cmd, void *arg)
{
    ...
    if (!(event != 0)) { rt_assert_handler("event != RT_NULL", __FUNCTION__, 2073); };
    if (!(rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event)) { rt_assert_handler("rt_object_get_type(&event->parent.parent) == RT_Object_Class_Event", __FUNCTION__, 2074); };
...
rt_err_t rt_mb_init(rt_mailbox_t mb,
                    ...
                    rt_uint8_t flag)
{
    if (!(mb != 0)) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 2152); };
    if (!((flag == 0x00) || (flag == 0x01))) { rt_assert_handler("(flag == RT_IPC_FLAG_FIFO) || (flag == RT_IPC_FLAG_PRIO)", __FUNCTION__, 2153); };
...
;
# 2197 "../rt-thread/src/ipc.c"
rt_err_t rt_mb_detach(rt_mailbox_t mb)
{

    if (!(mb != 0)) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 2200); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 2201); };
    if (!(rt_object_is_systemobject(&mb->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&mb->parent.parent)", __FUNCTION__, 2202); };
...
;
# 2248 "../rt-thread/src/ipc.c"
rt_mailbox_t rt_mb_create(const char *name, rt_size_t size, rt_uint8_t flag)
{
    rt_mailbox_t mb;

    if (!((flag == 0x00) || (flag == 0x01))) { rt_assert_handler("(flag == RT_IPC_FLAG_FIFO) || (flag == RT_IPC_FLAG_PRIO)", __FUNCTION__, 2252); };

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2254); } } rt_hw_interrupt_enable(level); } while (0);
...
;
# 2307 "../rt-thread/src/ipc.c"
rt_err_t rt_mb_delete(rt_mailbox_t mb)
{

    if (!(mb != 0)) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 2310); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 2311); };
    if (!(rt_object_is_systemobject(&mb->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&mb->parent.parent) == RT_FALSE", __FUNCTION__, 2312); };

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2314); } } rt_hw_interrupt_enable(level); } while (0);
                         ...
                         int suspend_flag)
{
    ...
    if (!(mb != 0)) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 2368); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 2369); };


    do { if (timeout != 0) { rt_bool_t interrupt_disabled; rt_base_t level; interrupt_disabled = rt_hw_interrupt_is_disabled(); level = rt_hw_interrupt_disable(); if (rt_critical_level() != 0) { rt_kprintf("Function[%s]: scheduler is not available\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2372); } } if (interrupt_disabled == 1) { rt_kprintf("Function[%s]: interrupt is disabled\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2372); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == 0) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2372); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2372); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } } while (0);
    ...
    if(mb->entry < 
# 2467 "../rt-thread/src/ipc.c" 3
                  (0xffff)
# 2467 "../rt-thread/src/ipc.c"
                                 )
    {
...
;
# 2571 "../rt-thread/src/ipc.c"
rt_err_t rt_mb_urgent(rt_mailbox_t mb, rt_ubase_t value)
{
    rt_base_t level;


    if (!(mb != 0)) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 2576); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 2577); };
...
static rt_err_t _rt_mb_recv(rt_mailbox_t mb, rt_ubase_t *value, rt_int32_t timeout, int suspend_flag)
{
    ...
    if (!(mb != 0)) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 2660); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 2661); };


    do { if (timeout != 0) { rt_bool_t interrupt_disabled; rt_base_t level; interrupt_disabled = rt_hw_interrupt_is_disabled(); level = rt_hw_interrupt_disable(); if (rt_critical_level() != 0) { rt_kprintf("Function[%s]: scheduler is not available\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2664); } } if (interrupt_disabled == 1) { rt_kprintf("Function[%s]: interrupt is disabled\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2664); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == 0) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2664); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 2664); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } } while (0);
...
;
# 2823 "../rt-thread/src/ipc.c"
rt_err_t rt_mb_control(rt_mailbox_t mb, int cmd, void *arg)
{
    rt_base_t level;


    if (!(mb != 0)) { rt_assert_handler("mb != RT_NULL", __FUNCTION__, 2828); };
    if (!(rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox)) { rt_assert_handler("rt_object_get_type(&mb->parent.parent) == RT_Object_Class_MailBox", __FUNCTION__, 2829); };
                    ...
                    rt_uint8_t flag)
{
    ...
    if (!(mq != 0)) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 2921); };
    if (!((flag == 0x00) || (flag == 0x01))) { rt_assert_handler("(flag == RT_IPC_FLAG_FIFO) || (flag == RT_IPC_FLAG_PRIO)", __FUNCTION__, 2922); };
...
;
# 2989 "../rt-thread/src/ipc.c"
rt_err_t rt_mq_detach(rt_mq_t mq)
{

    if (!(mq != 0)) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 2992); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 2993); };
    if (!(rt_object_is_systemobject(&mq->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&mq->parent.parent)", __FUNCTION__, 2994); };
                     ...
                     rt_uint8_t flag)
{
    ...
    if (!((flag == 0x00) || (flag == 0x01))) { rt_assert_handler("(flag == RT_IPC_FLAG_FIFO) || (flag == RT_IPC_FLAG_PRIO)", __FUNCTION__, 3051); };

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 3053); } } rt_hw_interrupt_enable(level); } while (0);
...
;
# 3126 "../rt-thread/src/ipc.c"
rt_err_t rt_mq_delete(rt_mq_t mq)
{

    if (!(mq != 0)) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 3129); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 3130); };
    if (!(rt_object_is_systemobject(&mq->parent.parent) == 0)) { rt_assert_handler("rt_object_is_systemobject(&mq->parent.parent) == RT_FALSE", __FUNCTION__, 3131); };

    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 3133); } } rt_hw_interrupt_enable(level); } while (0);
                                 ...
                                 int suspend_flag)
{
    ...
    if (!(mq != 0)) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 3198); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 3199); };
    if (!(buffer != 0)) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 3200); };
    if (!(size != 0)) { rt_assert_handler("size != 0", __FUNCTION__, 3201); };


    do { if (timeout != 0) { rt_bool_t interrupt_disabled; rt_base_t level; interrupt_disabled = rt_hw_interrupt_is_disabled(); level = rt_hw_interrupt_disable(); if (rt_critical_level() != 0) { rt_kprintf("Function[%s]: scheduler is not available\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 3204); } } if (interrupt_disabled == 1) { rt_kprintf("Function[%s]: interrupt is disabled\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 3204); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == 0) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 3204); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 3204); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } } while (0);
    ...
    rt_memcpy(((struct rt_mq_message *) msg + 1), buffer, size);


    level = rt_hw_interrupt_disable();
# 3343 "../rt-thread/src/ipc.c"
    ...
    if(mq->entry < 
# 3356 "../rt-thread/src/ipc.c" 3
                  (0xffff)
# 3356 "../rt-thread/src/ipc.c"
                                 )
    {
...
rt_err_t rt_mq_urgent(rt_mq_t mq, const void *buffer, rt_size_t size)
{
    ...
    if (!(mq != 0)) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 3475); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 3476); };
    if (!(buffer != 0)) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 3477); };
    if (!(size != 0)) { rt_assert_handler("size != 0", __FUNCTION__, 3478); };
    ...
    if(mq->entry < 
# 3521 "../rt-thread/src/ipc.c" 3
                  (0xffff)
# 3521 "../rt-thread/src/ipc.c"
                                 )
    {
                              ...
                              int suspend_flag)
{
    ...
    if (!(mq != 0)) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 3597); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 3598); };
    if (!(buffer != 0)) { rt_assert_handler("buffer != RT_NULL", __FUNCTION__, 3599); };
    if (!(size != 0)) { rt_assert_handler("size != 0", __FUNCTION__, 3600); };


    do { if (timeout != 0) { rt_bool_t interrupt_disabled; rt_base_t level; interrupt_disabled = rt_hw_interrupt_is_disabled(); level = rt_hw_interrupt_disable(); if (rt_critical_level() != 0) { rt_kprintf("Function[%s]: scheduler is not available\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 3603); } } if (interrupt_disabled == 1) { rt_kprintf("Function[%s]: interrupt is disabled\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 3603); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_thread_self() == 0) { rt_kprintf("Function[%s] shall not be used before scheduler start\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 3603); } } do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 3603); } } rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } while (0); rt_hw_interrupt_enable(level); } } while (0);
    ...
    rt_memcpy(buffer, ((struct rt_mq_message *) msg + 1), len);
...
# 3796 "../rt-thread/src/ipc.c"
;
# 3811 "../rt-thread/src/ipc.c"
rt_err_t rt_mq_control(rt_mq_t mq, int cmd, void *arg)
{
    rt_base_t level;
    struct rt_mq_message *msg;
    ...
    if (!(mq != 0)) { rt_assert_handler("mq != RT_NULL", __FUNCTION__, 3817); };
    if (!(rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue)) { rt_assert_handler("rt_object_get_type(&mq->parent.parent) == RT_Object_Class_MessageQueue", __FUNCTION__, 3818); };
