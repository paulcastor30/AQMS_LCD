...
static void plug_holes(struct rt_small_mem *m, struct rt_small_mem_item *mem)
{
    ...
    if (!((rt_uint8_t *)mem >= m->heap_ptr)) { rt_assert_handler("(rt_uint8_t *)mem >= m->heap_ptr", __FUNCTION__, 133); };
    if (!((rt_uint8_t *)mem < (rt_uint8_t *)m->heap_end)) { rt_assert_handler("(rt_uint8_t *)mem < (rt_uint8_t *)m->heap_end", __FUNCTION__, 134); };


    nmem = (struct rt_small_mem_item *)&m->heap_ptr[mem->next];
    if (mem != nmem && !(((rt_base_t)(((struct rt_small_mem_item *)(nmem))->pool_ptr)) & (~((~(rt_size_t)0) - 1))) &&
    ...
    if (pmem != mem && !(((rt_base_t)(((struct rt_small_mem_item *)(pmem))->pool_ptr)) & (~((~(rt_size_t)0) - 1))))
    {
                     ...
                     rt_size_t size)
{
    ...
    mem->pool_ptr = ((((rt_base_t)(small_mem)) & ((~(rt_size_t)0) - 1)) | 0x0);
    ...
    small_mem->heap_end->pool_ptr = ((((rt_base_t)(small_mem)) & ((~(rt_size_t)0) - 1)) | 0x1);
...
rt_err_t rt_smem_detach(rt_smem_t m)
{
    if (!(m != 0)) { rt_assert_handler("m != RT_NULL", __FUNCTION__, 255); };
    if (!(rt_object_get_type(&m->parent) == RT_Object_Class_Memory)) { rt_assert_handler("rt_object_get_type(&m->parent) == RT_Object_Class_Memory", __FUNCTION__, 256); };
    if (!(rt_object_is_systemobject(&m->parent))) { rt_assert_handler("rt_object_is_systemobject(&m->parent)", __FUNCTION__, 257); };
...
void *rt_smem_alloc(rt_smem_t m, rt_size_t size)
{
    ...
    if (!(m != 0)) { rt_assert_handler("m != RT_NULL", __FUNCTION__, 289); };
    if (!(rt_object_get_type(&m->parent) == RT_Object_Class_Memory)) { rt_assert_handler("rt_object_get_type(&m->parent) == RT_Object_Class_Memory", __FUNCTION__, 290); };
    if (!(rt_object_is_systemobject(&m->parent))) { rt_assert_handler("rt_object_is_systemobject(&m->parent)", __FUNCTION__, 291); };
         ...
         ptr = ((struct rt_small_mem_item *)&small_mem->heap_ptr[ptr])->next)
    {
        ...
        if ((!(((rt_base_t)(((struct rt_small_mem_item *)(mem))->pool_ptr)) & (~((~(rt_size_t)0) - 1)))) && (mem->next - (ptr + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1)))) >= size)
        {
...
# 342 "../rt-thread/src/mem.c"
            ...
            mem->pool_ptr = ((((rt_base_t)(small_mem)) & ((~(rt_size_t)0) - 1)) | 0x1);
            ...
            if (mem == small_mem->lfree)
            {
                ...
                while ((((rt_base_t)(((struct rt_small_mem_item *)(small_mem->lfree))->pool_ptr)) & (~((~(rt_size_t)0) - 1))) && small_mem->lfree != small_mem->heap_end)
                    small_mem->lfree = (struct rt_small_mem_item *)&small_mem->heap_ptr[small_mem->lfree->next];

                if (!(((small_mem->lfree == small_mem->heap_end) || (!(((rt_base_t)(((struct rt_small_mem_item *)(small_mem->lfree))->pool_ptr)) & (~((~(rt_size_t)0) - 1))))))) { rt_assert_handler("((small_mem->lfree == small_mem->heap_end) || (!MEM_ISUSED(small_mem->lfree)))", __FUNCTION__, 392); };
            }
            if (!((rt_ubase_t)mem + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1)) + size <= (rt_ubase_t)small_mem->heap_end)) { rt_assert_handler("(rt_ubase_t)mem + SIZEOF_STRUCT_MEM + size <= (rt_ubase_t)small_mem->heap_end", __FUNCTION__, 394); };
            if (!((rt_ubase_t)((rt_uint8_t *)mem + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1))) % 8 == 0)) { rt_assert_handler("(rt_ubase_t)((rt_uint8_t *)mem + SIZEOF_STRUCT_MEM) % RT_ALIGN_SIZE == 0", __FUNCTION__, 395); };
            if (!((((rt_ubase_t)mem) & (8 - 1)) == 0)) { rt_assert_handler("(((rt_ubase_t)mem) & (RT_ALIGN_SIZE - 1)) == 0", __FUNCTION__, 396); };
...
void *rt_smem_realloc(rt_smem_t m, void *rmem, rt_size_t newsize)
{
    ...
    if (!(m != 0)) { rt_assert_handler("m != RT_NULL", __FUNCTION__, 430); };
    if (!(rt_object_get_type(&m->parent) == RT_Object_Class_Memory)) { rt_assert_handler("rt_object_get_type(&m->parent) == RT_Object_Class_Memory", __FUNCTION__, 431); };
    if (!(rt_object_is_systemobject(&m->parent))) { rt_assert_handler("rt_object_is_systemobject(&m->parent)", __FUNCTION__, 432); };
    ...
    if (!((((rt_ubase_t)rmem) & (8 - 1)) == 0)) { rt_assert_handler("(((rt_ubase_t)rmem) & (RT_ALIGN_SIZE - 1)) == 0", __FUNCTION__, 453); };
    if (!((rt_uint8_t *)rmem >= (rt_uint8_t *)small_mem->heap_ptr)) { rt_assert_handler("(rt_uint8_t *)rmem >= (rt_uint8_t *)small_mem->heap_ptr", __FUNCTION__, 454); };
    if (!((rt_uint8_t *)rmem < (rt_uint8_t *)small_mem->heap_end)) { rt_assert_handler("(rt_uint8_t *)rmem < (rt_uint8_t *)small_mem->heap_end", __FUNCTION__, 455); };
...
void rt_smem_free(void *rmem)
{
    ...
    if (!((((rt_ubase_t)rmem) & (8 - 1)) == 0)) { rt_assert_handler("(((rt_ubase_t)rmem) & (RT_ALIGN_SIZE - 1)) == 0", __FUNCTION__, 524); };


    mem = (struct rt_small_mem_item *)((rt_uint8_t *)rmem - (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1)));

    small_mem = ((struct rt_small_mem *)(((rt_base_t)(((struct rt_small_mem_item *)(mem))->pool_ptr)) & (((~(rt_size_t)0) - 1))));
    if (!(small_mem != 0)) { rt_assert_handler("small_mem != RT_NULL", __FUNCTION__, 530); };
    if (!((((rt_base_t)(((struct rt_small_mem_item *)(mem))->pool_ptr)) & (~((~(rt_size_t)0) - 1))))) { rt_assert_handler("MEM_ISUSED(mem)", __FUNCTION__, 531); };
    if (!(rt_object_get_type(&small_mem->parent.parent) == RT_Object_Class_Memory)) { rt_assert_handler("rt_object_get_type(&small_mem->parent.parent) == RT_Object_Class_Memory", __FUNCTION__, 532); };
    if (!(rt_object_is_systemobject(&small_mem->parent.parent))) { rt_assert_handler("rt_object_is_systemobject(&small_mem->parent.parent)", __FUNCTION__, 533); };
    if (!((rt_uint8_t *)rmem >= (rt_uint8_t *)small_mem->heap_ptr && (rt_uint8_t *)rmem < (rt_uint8_t *)small_mem->heap_end)) { rt_assert_handler("(rt_uint8_t *)rmem >= (rt_uint8_t *)small_mem->heap_ptr && (rt_uint8_t *)rmem < (rt_uint8_t *)small_mem->heap_end", __FUNCTION__,
                                                                    535
# 534 "../rt-thread/src/mem.c"
    ); }
                                                                     ;
    if (!(((struct rt_small_mem *)(((rt_base_t)(((struct rt_small_mem_item *)(&small_mem->heap_ptr[mem->next]))->pool_ptr)) & (((~(rt_size_t)0) - 1)))) == small_mem)) { rt_assert_handler("MEM_POOL(&small_mem->heap_ptr[mem->next]) == small_mem", __FUNCTION__, 536); };
