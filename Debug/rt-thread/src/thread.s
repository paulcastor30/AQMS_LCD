...
.LC0:
	...
	.align	2
.LC1:
	.string	"(thread->stat & RT_THREAD_SUSPEND_MASK) == RT_THREAD_SUSPEND_MASK"
	.align	2
.LC2:
...
.LFB23:
	...
	lw	a5,-20(s0)
	bnez	a5,.L8
	.loc 2 139 27 discriminator 1
	li	a2,139
	lla	a1,__FUNCTION__.2834
	lla	a0,.LC0
...
.LFE23:
	...
	.align	2
.LC3:
	.string	"priority < RT_THREAD_PRIORITY_MAX"
	.text
	.align	1
...
.LFB24:
	...
	li	a5,31
	bleu	a4,a5,.L12
	.loc 2 198 29 discriminator 1
	li	a2,198
	lla	a1,__FUNCTION__.2846
	lla	a0,.LC3
	call	rt_assert_handler
.L12:
	.loc 2 199 27
...
.LFB25:
	...
	lw	a5,-20(s0)
	bnez	a5,.L16
	.loc 2 328 27 discriminator 1
	li	a2,328
	lla	a1,__FUNCTION__.2858
	lla	a0,.LC0
	call	rt_assert_handler
.L16:
	.loc 2 329 8
...
.LFB28:
	...
	lw	a5,-36(s0)
	bnez	a5,.L28
	.loc 2 422 27 discriminator 1
	li	a2,422
	lla	a1,__FUNCTION__.2872
	lla	a0,.LC0
	call	rt_assert_handler
.L28:
	.loc 2 423 11
...
.LFB30:
	...
	lw	a5,-36(s0)
	bnez	a5,.L40
	.loc 2 535 27 discriminator 1
	li	a2,535
	lla	a1,__FUNCTION__.2889
	lla	a0,.LC0
	call	rt_assert_handler
.L40:
	.loc 2 536 11
...
.L50:
	...
	lw	a5,-20(s0)
	bnez	a5,.L52
	.loc 2 624 27 discriminator 1
	li	a2,624
	lla	a1,__FUNCTION__.2902
	lla	a0,.LC0
	call	rt_assert_handler
.L52:
	.loc 2 625 11
...
.L61:
.LBB4:
	.loc 2 628 87 discriminator 1
	call	rt_hw_interrupt_is_disabled
	sw	a0,-24(s0)
	.loc 2 628 126 discriminator 1
	call	rt_hw_interrupt_disable
	sw	a0,-28(s0)
	.loc 2 628 157 discriminator 1
	call	rt_critical_level
	mv	a5,a0
	.loc 2 628 156 discriminator 1
	beqz	a5,.L54
	.loc 2 628 185 discriminator 2
	lla	a1,__FUNCTION__.2902
	lla	a0,.LC8
	call	rt_kprintf
	.loc 2 628 269 discriminator 2
	li	a2,628
	lla	a1,__FUNCTION__.2902
	lla	a0,.LC9
	call	rt_assert_handler
.L54:
	.loc 2 628 319 discriminator 6
	lw	a4,-24(s0)
	li	a5,1
	bne	a4,a5,.L55
	.loc 2 628 347 discriminator 7
	lla	a1,__FUNCTION__.2902
	lla	a0,.LC10
	call	rt_kprintf
	.loc 2 628 426 discriminator 7
	li	a2,628
	lla	a1,__FUNCTION__.2902
	lla	a0,.LC9
	call	rt_assert_handler
.L55:
.LBB5:
	.loc 2 628 503 discriminator 11
	call	rt_hw_interrupt_disable
	sw	a0,-32(s0)
	.loc 2 628 534 discriminator 11
	call	rt_thread_self
	mv	a5,a0
	.loc 2 628 533 discriminator 11
	bnez	a5,.L56
	.loc 2 628 559 discriminator 12
	lla	a1,__FUNCTION__.2902
	lla	a0,.LC11
	call	rt_kprintf
	.loc 2 628 656 discriminator 12
	li	a2,628
	lla	a1,__FUNCTION__.2902
	lla	a0,.LC9
	call	rt_assert_handler
.L56:
.LBB6:
	.loc 2 628 733 discriminator 16
	call	rt_hw_interrupt_disable
	sw	a0,-36(s0)
	.loc 2 628 764 discriminator 16
	call	rt_interrupt_get_nest
	mv	a5,a0
	.loc 2 628 763 discriminator 16
	beqz	a5,.L57
	.loc 2 628 796 discriminator 17
	lla	a1,__FUNCTION__.2902
	lla	a0,.LC12
	call	rt_kprintf
	.loc 2 628 877 discriminator 17
	li	a2,628
	lla	a1,__FUNCTION__.2902
	lla	a0,.LC9
	call	rt_assert_handler
.L57:
	.loc 2 628 924 discriminator 21
	lw	a0,-36(s0)
	call	rt_hw_interrupt_enable
.LBE6:
	.loc 2 628 968 discriminator 21
	lw	a0,-32(s0)
	call	rt_hw_interrupt_enable
.LBE5:
	.loc 2 628 1012 discriminator 21
	lw	a0,-28(s0)
	call	rt_hw_interrupt_enable
.LBE4:
	.loc 2 631 13 discriminator 21
	call	rt_hw_interrupt_disable
	sw	a0,-40(s0)
	.loc 2 634 19 discriminator 21
	lw	a5,-20(s0)
	sw	zero,48(a5)
	.loc 2 637 11 discriminator 21
	li	a1,0
	lw	a0,-20(s0)
	call	rt_thread_suspend_with_flag
	sw	a0,-44(s0)
	.loc 2 640 8 discriminator 21
	lw	a5,-44(s0)
	bnez	a5,.L58
	.loc 2 642 9
	lw	a5,-20(s0)
...
.LFB36:
	...
	lw	a5,-36(s0)
	bnez	a5,.L75
	.loc 2 846 27 discriminator 1
	li	a2,846
	lla	a1,__FUNCTION__.2929
	lla	a0,.LC0
	call	rt_assert_handler
.L75:
	.loc 2 847 11
...
.LFB37:
	...
	lw	a5,-36(s0)
	bnez	a5,.L88
	.loc 2 945 27 discriminator 1
	li	a2,945
	lla	a1,__FUNCTION__.2941
	lla	a0,.LC0
	call	rt_assert_handler
.L88:
	lw	a4,-40(s0)
...
.L90:
	...
	j	.L92
.L93:
	.loc 2 958 21 discriminator 1
	li	a2,958
	lla	a1,__FUNCTION__.2941
	lla	a0,.LC9
	call	rt_assert_handler
	.loc 2 959 9 discriminator 1
	nop
.L92:
	.loc 2 961 34
	lw	a5,-36(s0)
...
.LFB38:
	...
	lw	a5,-36(s0)
	bnez	a5,.L95
	.loc 2 986 27 discriminator 1
	li	a2,986
	lla	a1,__FUNCTION__.2953
	lla	a0,.LC0
	call	rt_assert_handler
.L95:
	.loc 2 987 11
...
.LFB40:
	...
	lw	a5,-36(s0)
	bnez	a5,.L105
	.loc 2 1050 27 discriminator 1
	li	a2,1050
	lla	a1,__FUNCTION__.2961
	lla	a0,.LC0
	call	rt_assert_handler
.L105:
	.loc 2 1051 11
...
.LFE42:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.2834, @object
	.size	__FUNCTION__.2834, 16
__FUNCTION__.2834:
	.string	"_thread_timeout"
	.align	2
	.type	__FUNCTION__.2846, @object
	.size	__FUNCTION__.2846, 13
__FUNCTION__.2846:
	.string	"_thread_init"
	.align	2
	.type	__FUNCTION__.2858, @object
	.size	__FUNCTION__.2858, 15
__FUNCTION__.2858:
	.string	"rt_thread_init"
	.align	2
	.type	__FUNCTION__.2867, @object
	.size	__FUNCTION__.2867, 18
__FUNCTION__.2867:
	.string	"rt_thread_startup"
	.align	2
	.type	__FUNCTION__.2872, @object
	.size	__FUNCTION__.2872, 17
__FUNCTION__.2872:
	.string	"rt_thread_detach"
	.align	2
	.type	__FUNCTION__.2889, @object
	.size	__FUNCTION__.2889, 17
__FUNCTION__.2889:
	.string	"rt_thread_delete"
	.align	2
	.type	__FUNCTION__.2902, @object
	.size	__FUNCTION__.2902, 16
__FUNCTION__.2902:
	.string	"rt_thread_sleep"
	.align	2
	.type	__FUNCTION__.2917, @object
	.size	__FUNCTION__.2917, 22
__FUNCTION__.2917:
	.string	"rt_thread_delay_until"
	.align	2
	.type	__FUNCTION__.2929, @object
	.size	__FUNCTION__.2929, 18
__FUNCTION__.2929:
	.string	"rt_thread_control"
	.align	2
	.type	__FUNCTION__.2941, @object
	.size	__FUNCTION__.2941, 28
__FUNCTION__.2941:
	.string	"rt_thread_set_suspend_state"
	.align	2
	.type	__FUNCTION__.2953, @object
	.size	__FUNCTION__.2953, 28
__FUNCTION__.2953:
	.string	"rt_thread_suspend_with_flag"
	.align	2
	.type	__FUNCTION__.2961, @object
	.size	__FUNCTION__.2961, 17
__FUNCTION__.2961:
...
.Letext0:
	...
	.file 6 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\include/rtdef.h"
...
.Ldebug_macro0:
	...
	.4byte	.Ldebug_macro2
	.byte	0x4
	.file 10 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\include/rthw.h"
	.byte	0x3
	.byte	0x25
	.byte	0xa
	.byte	0x5
