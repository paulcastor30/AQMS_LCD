# 1 "../rt-thread/src/scheduler_up.c"
...
# 1 "<command-line>" 2
# 1 "../rt-thread/src/scheduler_up.c"
# 34 "../rt-thread/src/scheduler_up.c"
...
# 35 "../rt-thread/src/scheduler_up.c" 2
...
# 40 "../rt-thread/src/scheduler_up.c" 2
...
# 76 "../rt-thread/src/scheduler_up.c"
...
# 145 "../rt-thread/src/scheduler_up.c"
...
# 228 "../rt-thread/src/scheduler_up.c"
void rt_schedule(void)
{
    rt_base_t level;
    struct rt_thread *to_thread;
...
# 326 "../rt-thread/src/scheduler_up.c"
                    goto __exit;
                }
                else
                {
...
# 359 "../rt-thread/src/scheduler_up.c"
void rt_schedule_insert_thread(struct rt_thread *thread)
{
    rt_base_t level;

    if (!(thread != 0)) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 363); };
...
# 411 "../rt-thread/src/scheduler_up.c"
void rt_schedule_remove_thread(struct rt_thread *thread)
{
    rt_base_t level;

    if (!(thread != 0)) { rt_assert_handler("thread != RT_NULL", __FUNCTION__, 415); };
