...
.LFB19:
	.file 2 "../rt-thread/src/scheduler_up.c"
	.loc 2 77 1
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
...
.L19:
	...
	.loc 2 255 25
	bne	a4,a5,.L21
	.loc 2 255 109 discriminator 1
	lla	a5,rt_current_thread
	lw	a5,0(a5)
	lbu	a5,52(a5)
	.loc 2 255 116 discriminator 1
	andi	a5,a5,8
	.loc 2 255 88 discriminator 1
	bnez	a5,.L21
	.loc 2 257 31
	lla	a5,rt_current_thread
	lw	a5,0(a5)
...
.LFB25:
	...
	lw	a5,-36(s0)
	bnez	a5,.L30
	.loc 2 363 27 discriminator 1
	li	a2,363
	lla	a1,__FUNCTION__.2859
	lla	a0,.LC0
...
.LFB26:
	...
	lw	a5,-36(s0)
	bnez	a5,.L36
	.loc 2 415 27 discriminator 1
	li	a2,415
	lla	a1,__FUNCTION__.2865
	lla	a0,.LC0
	call	rt_assert_handler
.L36:
	.loc 2 418 13
...
.LFE29:
	...
	.section	.rodata
	.align	2
	.type	__FUNCTION__.2859, @object
	.size	__FUNCTION__.2859, 26
__FUNCTION__.2859:
	.string	"rt_schedule_insert_thread"
	.align	2
	.type	__FUNCTION__.2865, @object
	.size	__FUNCTION__.2865, 26
__FUNCTION__.2865:
...
.LASF1102:
	.string	"DBG_TAG \"kernel.scheduler\""
.LASF200:
...
.LASF1236:
	.string	"../rt-thread/src/scheduler_up.c"
.LASF874:
