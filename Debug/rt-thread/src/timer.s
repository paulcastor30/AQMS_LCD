...
.LC0:
	...
	.align	2
.LC1:
	.string	"timeout != RT_NULL"
	.align	2
.LC2:
	.string	"time < RT_TICK_MAX / 2"
	.text
	.align	1
	.globl	rt_timer_init
...
.LFB27:
	...
	lw	a5,-36(s0)
	bnez	a5,.L32
	.loc 2 383 26 discriminator 1
	li	a2,383
	lla	a1,__FUNCTION__.2881
	lla	a0,.LC0
	call	rt_assert_handler
.L32:
	.loc 2 384 11
...
.LFB29:
	...
	lw	a5,-36(s0)
	bnez	a5,.L62
	.loc 2 545 26 discriminator 1
	li	a2,545
	lla	a1,__FUNCTION__.2909
	lla	a0,.LC0
	call	rt_assert_handler
.L62:
	.loc 2 546 11
...
.LFE29:
	...
	.align	2
.LC6:
	.string	"(*(rt_tick_t *)arg) < RT_TICK_MAX / 2"
	.text
	.align	1
...
.LFB30:
	...
	lw	a5,-36(s0)
	bnez	a5,.L68
	.loc 2 581 26 discriminator 1
	li	a2,581
	lla	a1,__FUNCTION__.2916
	lla	a0,.LC0
	call	rt_assert_handler
.L68:
	.loc 2 582 11
...
__FUNCTION__.2866:
	...
	.size	__FUNCTION__.2876, 16
__FUNCTION__.2876:
	.string	"rt_timer_create"
	.align	2
	.type	__FUNCTION__.2881, @object
	.size	__FUNCTION__.2881, 16
__FUNCTION__.2881:
	.string	"rt_timer_delete"
	.align	2
	.type	__FUNCTION__.2892, @object
	.size	__FUNCTION__.2892, 15
__FUNCTION__.2892:
	.string	"rt_timer_start"
	.local	random_nr.2891
	.comm	random_nr.2891,4,4
	.align	2
	.type	__FUNCTION__.2909, @object
	.size	__FUNCTION__.2909, 14
__FUNCTION__.2909:
	.string	"rt_timer_stop"
	.align	2
	.type	__FUNCTION__.2916, @object
	.size	__FUNCTION__.2916, 17
__FUNCTION__.2916:
