...
# 20 "../rt-thread/src/object.c" 2
# 30 "../rt-thread/src/object.c"
                    ...
                    const char *name)
{
    ...
    if (!(information != 0)) { rt_assert_handler("information != RT_NULL", __FUNCTION__, 366); };
            ...
            node = node->next)
    {
        ...
        if (!(obj != object)) { rt_assert_handler("obj != object", __FUNCTION__, 381); };
    }
...
void rt_object_detach(rt_object_t object)
{
    ...
    if (!(object != 0)) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 429); };
...
rt_object_t rt_object_allocate(enum rt_object_class_type type, const char *name)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 465); } } rt_hw_interrupt_enable(level); } while (0);


    information = rt_object_get_information(type);
    if (!(information != 0)) { rt_assert_handler("information != RT_NULL", __FUNCTION__, 469); };
...
void rt_object_delete(rt_object_t object)
{
    ...
    if (!(object != 0)) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 530); };
    if (!(!(object->type & RT_Object_Class_Static))) { rt_assert_handler("!(object->type & RT_Object_Class_Static)", __FUNCTION__, 531); };
...
# 562 "../rt-thread/src/object.c"
rt_bool_t rt_object_is_systemobject(rt_object_t object)
{

    if (!(object != 0)) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 565); };
...
# 581 "../rt-thread/src/object.c"
rt_uint8_t rt_object_get_type(rt_object_t object)
{

    if (!(object != 0)) { rt_assert_handler("object != RT_NULL", __FUNCTION__, 584); };

    return object->type & ~RT_Object_Class_Static;
}
# 602 "../rt-thread/src/object.c"
rt_object_t rt_object_find(const char *name, rt_uint8_t type)
{
    ...
    do { rt_base_t level; level = rt_hw_interrupt_disable(); if (rt_interrupt_get_nest() != 0) { rt_kprintf("Function[%s] shall not be used in ISR\n", __FUNCTION__); if (!(0)) { rt_assert_handler("0", __FUNCTION__, 614); } } rt_hw_interrupt_enable(level); } while (0);
...
# 649 "../rt-thread/src/object.c"
rt_err_t rt_object_get_name(rt_object_t object, char *name, rt_uint8_t name_size)
{
    rt_err_t result = -10;
    if ((object != 0) && (name != 0) && (name_size != 0U))
    {
