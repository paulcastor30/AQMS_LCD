...
.Ltext0:
	...
	.align	1
	.globl	digitalPinToInterrupt
	.type	digitalPinToInterrupt, @function
digitalPinToInterrupt:
.LFB42:
	.file 1 "../packages/RTduino-latest/core/WInterrupts.c"
	.loc 1 26 1
	.cfi_startproc
	addi	sp,sp,-32
	...
	.cfi_endproc
.LFE42:
	.size	digitalPinToInterrupt, .-digitalPinToInterrupt
	.section	.rodata
	.align	2
.LC0:
	.string	"[E/RTduino.interrupts] "
	.align	2
.LC1:
	.string	"attachInterrupt mode parameter is illegal"
	.align	2
.LC2:
	.string	"\n"
	.text
...
.LASF6749:
	.string	"../packages/RTduino-latest/core/WInterrupts.c"
.LASF1868:
...
.LASF6556:
	.string	"DBG_TAG \"RTduino.interrupts\""
.LASF5912:
