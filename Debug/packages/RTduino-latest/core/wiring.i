# 1 "../packages/RTduino-latest/core/wiring.c"
...
# 1 "<command-line>" 2
# 1 "../packages/RTduino-latest/core/wiring.c"
# 15 "../packages/RTduino-latest/core/wiring.c"
# 1 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\packages\\RTduino-latest\\core/RTduino.h" 1
# 16 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\packages\\RTduino-latest\\core/RTduino.h"
#define __RTDUINO__ 
...
# 19 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\packages\\RTduino-latest\\core/RTduino.h" 2
# 37 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\packages\\RTduino-latest\\core/RTduino.h"
typedef struct
{
    const char* name;
    void (*setup)(void);
...
static __inline rtduino_loader_t rtduino_sketch_loader_create(const char* name, void (*setup)(void), void (*loop)(void))
{
    return rtduino_sketch_loader_create_stacksize_prio(name, setup, loop, 1536, 30);
}

static __inline rtduino_loader_t rtduino_sketch_loader_create_prio(const char* name, void (*setup)(void), void (*loop)(void), rt_uint8_t priority)
{
    return rtduino_sketch_loader_create_stacksize_prio(name, setup, loop, 1536, priority);
}

static __inline rtduino_loader_t rtduino_sketch_loader_create_stacksize(const char* name, void (*setup)(void), void (*loop)(void), rt_uint32_t stack_size)
{
    return rtduino_sketch_loader_create_stacksize_prio(name, setup, loop, stack_size, 30);
}

#define RTDUINO_SKETCH_LOADER_STACKSIZE_PRIO_INITLEVEL(name,setup,loop,stack_size,priority,init_level) static int _sketch_loader(void) { rtduino_sketch_loader_create_stacksize_prio(name, setup, loop, stack_size, priority); return 0; } init_level(_sketch_loader)
...
# 16 "../packages/RTduino-latest/core/wiring.c" 2
# 1 "../packages/RTduino-latest/core/wiring_private.h" 1
# 15 "../packages/RTduino-latest/core/wiring_private.h"
#define __WIRING_PRIVATE_H__ 

# 1 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\packages\\RTduino-latest\\core/Arduino.h" 1
# 18 "../packages/RTduino-latest/core/wiring_private.h" 2


extern const pin_map_t pin_map_table[];
# 39 "../packages/RTduino-latest/core/wiring_private.h"
#define RTDUINO_CHECK_PIN_LIMIT_RETURN(pin,value) 
# 17 "../packages/RTduino-latest/core/wiring.c" 2
...
#define RT_DBG_H__ 
# 41 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rt-thread\\include/rtdbg.h"
#define DBG_ENABLE 
...
# 24 "../packages/RTduino-latest/core/wiring.c" 2
...
{
# 49 "../packages/RTduino-latest/core/wiring.c"
    static rt_bool_t _low_accuracy_micros_warned = 0;
    if (_low_accuracy_micros_warned == 0)
    {
        do { rt_kprintf("[" "W" "/" "RTduino.wiring" "] "); rt_kprintf("Low accuracy micros()"); rt_kprintf("\n"); } while (0);
        _low_accuracy_micros_warned= 1;
    }
    return millis() * 1000;
