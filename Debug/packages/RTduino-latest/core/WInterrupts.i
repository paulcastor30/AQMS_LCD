# 1 "../packages/RTduino-latest/core/WInterrupts.c"
...
# 1 "<command-line>" 2
# 1 "../packages/RTduino-latest/core/WInterrupts.c"
# 14 "../packages/RTduino-latest/core/WInterrupts.c"
...
# 15 "../packages/RTduino-latest/core/WInterrupts.c" 2
...
# 18 "../packages/RTduino-latest/core/WInterrupts.c" 2
...
# 22 "../packages/RTduino-latest/core/WInterrupts.c" 2
...
void attachInterrupt(uint8_t interruptNum, void (*userFunc)(void), int mode)
{
    ...
    default:
        rt_mode = 0;
        do { rt_kprintf("[" "E" "/" "RTduino.interrupts" "] "); rt_kprintf("attachInterrupt mode parameter is illegal"); rt_kprintf("\n"); } while (0);
        break;
    }

    rt_pin_attach_irq(rt_pin, rt_mode, (void*)userFunc, 0);
