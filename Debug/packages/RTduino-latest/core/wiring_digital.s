...
.Ltext0:
	...
	.align	2
.LC0:
	.string	"mode == INPUT || mode == OUTPUT || mode == INPUT_PULLUP || mode == INPUT_PULLDOWN || mode == OUTPUT_OPEN_DRAIN"
	.align	2
.LC1:
	.string	"[W/RTduino.digital] "
	.align	2
.LC2:
	.string	"[pinMode] Pin %d was a %s device IO, but now it becomes a general-purpose IO."
	.align	2
.LC3:
	.string	"\n"
	.text
...
pinMode:
.LFB42:
	.file 1 "../packages/RTduino-latest/core/wiring_digital.c"
	.loc 1 25 1
	.cfi_startproc
	addi	sp,sp,-48
	...
	li	a5,1
	beq	a4,a5,.L2
	.loc 1 28 38 discriminator 2
	lbu	a4,-34(s0)
	li	a5,2
	beq	a4,a5,.L2
	.loc 1 28 53 discriminator 3
	lbu	a4,-34(s0)
	li	a5,3
	beq	a4,a5,.L2
	.loc 1 28 9 discriminator 4
	lbu	a4,-34(s0)
	li	a5,4
	beq	a4,a5,.L2
	.loc 1 28 87 discriminator 5
	li	a2,30
	lla	a1,__FUNCTION__.7090
	lla	a0,.LC0
...
.LFE44:
	...
	.section	.srodata,"a"
	.align	2
	.type	__FUNCTION__.7090, @object
	.size	__FUNCTION__.7090, 8
__FUNCTION__.7090:
	.string	"pinMode"
	.section	.rodata
	.align	2
	.type	__FUNCTION__.7102, @object
	.size	__FUNCTION__.7102, 13
__FUNCTION__.7102:
	.string	"digitalWrite"
	.text
.Letext0:
...
.LASF6556:
	.string	"DBG_TAG \"RTduino.digital\""
.LASF2700:
...
.LASF6744:
	.string	"../packages/RTduino-latest/core/wiring_digital.c"
.LASF3020:
