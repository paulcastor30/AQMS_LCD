...
u8x8_d_sh1122_powersave1_seq:
	...
	.text
	.align	1
	.type	u8x8_write_byte_to_16gr_device, @function
u8x8_write_byte_to_16gr_device:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1122.c"
	.loc 1 107 1
	.cfi_startproc
	addi	sp,sp,-32
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_write_byte_to_16gr_device, .-u8x8_write_byte_to_16gr_device
	.align	1
...
.LFB1:
	...
	bnez	a5,.L7
	.loc 1 138 2
	lla	a1,u8x8_d_sh1122_powersave0_seq
	lw	a0,-36(s0)
...
.L7:
	.loc 1 140 2
	lla	a1,u8x8_d_sh1122_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 141 7
	j	.L9
...
.L12:
	...
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_write_byte_to_16gr_device
	.loc 1 173 5
	lbu	a5,-18(s0)
	addi	a5,a5,-1
	sb	a5,-18(s0)
...
.L11:
	...
	addi	a5,a5,1
	sb	a5,-17(s0)
	.loc 1 162 27 discriminator 2
	lbu	a5,-19(s0)
	addi	a5,a5,1
	sb	a5,-19(s0)
.L10:
	.loc 1 162 7 discriminator 1
	lbu	a4,-19(s0)
	li	a5,7
	bleu	a4,a5,.L13
	.loc 1 180 7
...
.LFB2:
	...
	bne	a5,a4,.L18
	.loc 1 266 7
	lla	a1,u8x8_sh1122_256x64_display_info
	lw	a0,-20(s0)
...
.L16:
	...
	.loc 1 270 7
	lla	a1,u8x8_d_sh1122_256x64_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 271 7
	j	.L19
.L17:
	...
	bnez	a5,.L20
	.loc 1 275 2
	lla	a1,u8x8_d_sh1122_256x64_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 276 23
	lw	a5,-20(s0)
...
.L20:
	.loc 1 280 2
	lla	a1,u8x8_d_sh1122_256x64_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 281 23
	lw	a5,-20(s0)
...
.LASF922:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1122.c"
.LASF743:
	.string	"utf8_state"
.LASF803:
