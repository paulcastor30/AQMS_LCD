...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8g2_button.c"
	.loc 1 99 1
	.cfi_startproc
	addi	sp,sp,-64
...
.LBB2:
	...
	j	.L7
.L8:
	.loc 1 155 34 discriminator 3
	lhu	a4,-30(s0)
	lhu	a5,-20(s0)
	add	a5,a4,a5
	slli	a4,a5,16
	srli	a4,a4,16
	.loc 1 155 11 discriminator 3
	lhu	a5,-38(s0)
	add	a5,a4,a5
	slli	a1,a5,16
	srli	a1,a1,16
	.loc 1 155 61 discriminator 3
	lhu	a4,-34(s0)
	lhu	a5,-36(s0)
	add	a5,a4,a5
	slli	a4,a5,16
	srli	a4,a4,16
	.loc 1 155 64 discriminator 3
	lhu	a5,-22(s0)
	add	a5,a4,a5
	slli	a4,a5,16
	srli	a4,a4,16
	...
	lw	a0,-52(s0)
	call	u8g2_DrawHLine
	.loc 1 156 34 discriminator 3
	lhu	a4,-30(s0)
	lhu	a5,-32(s0)
	add	a5,a4,a5
	slli	a4,a5,16
	srli	a4,a4,16
	.loc 1 156 37 discriminator 3
	lhu	a5,-22(s0)
	add	a5,a4,a5
	slli	a4,a5,16
	srli	a4,a4,16
...
.L13:
	...
	.cfi_endproc
.LFE0:
	.size	u8g2_DrawButtonFrame, .-u8g2_DrawButtonFrame
	.align	1
...
.L16:
	...
	.cfi_endproc
.LFE1:
	.size	u8g2_DrawButtonUTF8, .-u8g2_DrawButtonUTF8
.Letext0:
...
.LASF3207:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8g2_button.c"
.LASF2971:
