...
u8x8_d_ssd1306_48x64_flip1_seq:
	...
	.text
	.align	1
	.type	u8x8_d_ssd1306_48x64_generic, @function
u8x8_d_ssd1306_48x64_generic:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1306_48x64.c"
	.loc 1 110 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 126 9
	lla	a1,u8x8_d_ssd1306_48x64_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 128 9
	lla	a1,u8x8_d_ssd1306_48x64_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 129 7
	j	.L10
.L2:
	...
	bnez	a5,.L11
	.loc 1 133 9
	lla	a1,u8x8_d_ssd1306_48x64_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 134 30
	lw	a5,-36(s0)
...
.L11:
	.loc 1 138 9
	lla	a1,u8x8_d_ssd1306_48x64_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 139 30
	lw	a5,-36(s0)
...
.L14:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_ssd1306_48x64_generic, .-u8x8_d_ssd1306_48x64_generic
	.section	.rodata
	.align	2
...
.LFB1:
	...
	bne	a4,a5,.L16
	.loc 1 204 5
	lla	a1,u8x8_ssd1306_48x64_display_info
	lw	a0,-20(s0)
...
.L16:
	...
	.loc 1 210 5
	lla	a1,u8x8_d_ssd1306_48x64_winstar_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 211 12
	li	a5,1
...
.L18:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1306_48x64_generic
	mv	a5,a0
.L17:
	.loc 1 214 1
	mv	a0,a5
...
.LASF920:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1306_48x64.c"
.LASF482:
	.string	"_VA_LIST_ "
.LASF92:
