...
u8x8_d_ssd1329_128x96_nhd_flip1_seq:
	...
	.comm	u8x8_ssd1329_8to32_dest_buf,32,4
	.text
	.align	1
	.type	u8x8_ssd1329_8to32, @function
u8x8_ssd1329_8to32:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1329.c"
	.loc 1 130 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L7:
	.loc 1 138 10
	lla	a5,u8x8_ssd1329_8to32_dest_buf
	sw	a5,-28(s0)
	.loc 1 139 10
	lbu	a5,-21(s0)
	lw	a4,-28(s0)
...
.L5:
	...
	lbu	a4,-17(s0)
	sb	a4,0(a5)
	.loc 1 150 11 discriminator 2
	lw	a5,-28(s0)
	addi	a5,a5,4
	sw	a5,-28(s0)
	.loc 1 151 9 discriminator 2
	lbu	a5,-18(s0)
	srli	a5,a5,1
	sb	a5,-18(s0)
...
.L3:
	...
	li	a5,7
	bleu	a4,a5,.L6
	.loc 1 136 23 discriminator 2
	lbu	a5,-21(s0)
	addi	a5,a5,1
	sb	a5,-21(s0)
.L2:
	.loc 1 136 3 discriminator 1
	lbu	a4,-21(s0)
	li	a5,3
	bleu	a4,a5,.L7
	.loc 1 156 10
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_ssd1329_8to32, .-u8x8_ssd1329_8to32
	.align	1
	.type	u8x8_d_ssd1329_128x96_generic, @function
...
.L16:
	...
	.loc 1 175 7
	lla	a1,u8x8_d_ssd1329_128x96_noname_init_seq
	lw	a0,-36(s0)
...
.L15:
	...
	bnez	a5,.L18
	.loc 1 179 2
	lla	a1,u8x8_d_ssd1329_128x96_nhd_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 182 7
	j	.L17
.L18:
	.loc 1 181 2
	lla	a1,u8x8_d_ssd1329_128x96_nhd_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 182 7
	j	.L17
.L14:
	...
	bnez	a5,.L20
	.loc 1 186 2
	lla	a1,u8x8_d_ssd1329_128x96_nhd_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 187 23
	lw	a5,-36(s0)
...
.L20:
	.loc 1 191 2
	lla	a1,u8x8_d_ssd1329_128x96_nhd_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 192 23
	lw	a5,-36(s0)
...
.L26:
	...
	.cfi_endproc
.LFE1:
	.size	u8x8_d_ssd1329_128x96_generic, .-u8x8_d_ssd1329_128x96_generic
	.section	.rodata
	.align	2
...
.LFB2:
	...
	bne	a4,a5,.L28
	.loc 1 292 7
	lla	a1,u8x8_ssd1329_128x96_display_info
	lw	a0,-20(s0)
...
.L28:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1329_128x96_generic
	mv	a5,a0
.L29:
	.loc 1 296 1
	mv	a0,a5
...
.LFE2:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_ssd1329_96x96_flip0_seq, @object
...
u8x8_d_ssd1329_96x96_flip0_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_d_ssd1329_96x96_flip1_seq, @object
...
u8x8_d_ssd1329_96x96_flip1_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_d_ssd1329_96x96_noname_init_seq, @object
...
u8x8_d_ssd1329_96x96_noname_init_seq:
	...
	.text
	.align	1
	.type	u8x8_d_ssd1329_96x96_generic, @function
u8x8_d_ssd1329_96x96_generic:
.LFB3:
	.loc 1 380 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L37:
	...
	call	u8x8_d_helper_display_init
	.loc 1 392 7
	lla	a1,u8x8_d_ssd1329_96x96_noname_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 393 7
	j	.L38
...
.L35:
	...
	bnez	a5,.L41
	.loc 1 403 2
	lla	a1,u8x8_d_ssd1329_96x96_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 404 23
	lw	a5,-36(s0)
...
.L41:
	.loc 1 408 2
	lla	a1,u8x8_d_ssd1329_96x96_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 409 23
	lw	a5,-36(s0)
...
.L47:
	...
	.cfi_endproc
.LFE3:
	.size	u8x8_d_ssd1329_96x96_generic, .-u8x8_d_ssd1329_96x96_generic
	.section	.rodata
	.align	2
	.type	u8x8_ssd1329_96x96_display_info, @object
...
.LFB4:
	...
	bne	a4,a5,.L49
	.loc 1 509 7
	lla	a1,u8x8_ssd1329_96x96_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 510 14
	li	a5,1
...
.L49:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1329_96x96_generic
	mv	a5,a0
.L50:
	.loc 1 513 1
	mv	a0,a5
	...
	.cfi_endproc
.LFE4:
	.size	u8x8_d_ssd1329_96x96_noname, .-u8x8_d_ssd1329_96x96_noname
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1329_96x96_flip0_seq
	.byte	0x14
	.4byte	.LASF918
	.byte	0x1
	.2byte	0x13d
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1329_96x96_flip1_seq
	.byte	0x14
	.4byte	.LASF919
	.byte	0x1
	.2byte	0x147
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1329_96x96_noname_init_seq
	.byte	0x14
	.4byte	.LASF920
	.byte	0x1
	.2byte	0x1e1
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_ssd1329_96x96_display_info
	.byte	0x15
	.4byte	.LASF924
	.byte	0x1
	.2byte	0x1f9
...
.LASF919:
	.string	"u8x8_d_ssd1329_96x96_noname_init_seq"
.LASF924:
	.string	"u8x8_d_ssd1329_96x96_noname"
.LASF21:
...
.LASF930:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1329.c"
.LASF893:
...
.LASF918:
	.string	"u8x8_d_ssd1329_96x96_flip1_seq"
.LASF857:
...
.LASF917:
	.string	"u8x8_d_ssd1329_96x96_flip0_seq"
.LASF271:
...
.LASF728:
	.string	"long double"
.LASF920:
	.string	"u8x8_ssd1329_96x96_display_info"
.LASF363:
	.string	"short"
.LASF596:
...
.LASF926:
	.string	"u8x8_d_ssd1329_96x96_generic"
.LASF191:
