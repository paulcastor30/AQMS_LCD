...
u8x8_d_ssd1306_72x40_flip1_seq:
	...
	.text
	.align	1
	.type	u8x8_d_ssd1306_72x40_generic, @function
u8x8_d_ssd1306_72x40_generic:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1306_72x40.c"
	.loc 1 156 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 172 2
	lla	a1,u8x8_d_ssd1306_72x40_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 174 2
	lla	a1,u8x8_d_ssd1306_72x40_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 175 7
	j	.L10
.L2:
	...
	bnez	a5,.L11
	.loc 1 179 2
	lla	a1,u8x8_d_ssd1306_72x40_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 180 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 184 2
	lla	a1,u8x8_d_ssd1306_72x40_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 185 23
	lw	a5,-36(s0)
...
.L14:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_ssd1306_72x40_generic, .-u8x8_d_ssd1306_72x40_generic
	.section	.rodata
	.align	2
...
.LFB1:
	...
	bne	a4,a5,.L16
	.loc 1 254 7
	lla	a1,u8x8_ssd1306_72x40_display_info
	lw	a0,-20(s0)
...
.L16:
	...
	.loc 1 260 7
	lla	a1,u8x8_d_ssd1306_72x40_er_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 261 14
	li	a5,1
...
.L18:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1306_72x40_generic
	mv	a5,a0
.L17:
	.loc 1 264 1
	mv	a0,a5
...
.LASF920:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1306_72x40.c"
.LASF171:
