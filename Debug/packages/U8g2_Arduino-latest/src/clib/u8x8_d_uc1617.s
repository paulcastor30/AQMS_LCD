...
u8x8_upscale_4bit:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1617.c"
	.loc 1 74 1
	.cfi_startproc
	addi	sp,sp,-48
...
.LFE0:
	...
	.comm	u8x8_uc1617_tile_half_buffer,8,4
	.align	1
	.type	u8x8_convert_tile_for_uc1617_lower4bit, @function
u8x8_convert_tile_for_uc1617_lower4bit:
.LFB1:
	.loc 1 90 1
	.cfi_startproc
	addi	sp,sp,-48
	...
	sw	a0,-36(s0)
	.loc 1 92 12
	lla	a5,u8x8_uc1617_tile_half_buffer
	sw	a5,-24(s0)
	.loc 1 94 10
	sb	zero,-17(s0)
	.loc 1 94 3
	j	.L4
.L5:
	.loc 1 96 35 discriminator 3
	lw	a5,-36(s0)
	addi	a4,a5,1
	sw	a4,-36(s0)
	.loc 1 96 15 discriminator 3
	lbu	a4,0(a5)
	.loc 1 96 10 discriminator 3
	lw	s1,-24(s0)
	addi	a5,s1,1
	sw	a5,-24(s0)
	.loc 1 96 15 discriminator 3
	mv	a0,a4
	call	u8x8_upscale_4bit
	mv	a5,a0
...
.L4:
	...
	.cfi_endproc
.LFE1:
	.size	u8x8_convert_tile_for_uc1617_lower4bit, .-u8x8_convert_tile_for_uc1617_lower4bit
	.align	1
	.type	u8x8_convert_tile_for_uc1617_upper4bit, @function
u8x8_convert_tile_for_uc1617_upper4bit:
.LFB2:
	.loc 1 102 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L8:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_convert_tile_for_uc1617_upper4bit, .-u8x8_convert_tile_for_uc1617_upper4bit
	.align	1
...
.L18:
	...
	sw	a5,-24(s0)
.L17:
	.loc 1 176 4 discriminator 1
	lw	a0,-24(s0)
	call	u8x8_convert_tile_for_uc1617_lower4bit
	mv	a5,a0
	mv	a2,a5
	li	a1,8
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 177 8 discriminator 1
	lw	a5,-24(s0)
	addi	a5,a5,8
	sw	a5,-24(s0)
...
.L19:
	...
	lw	a0,-24(s0)
	call	u8x8_convert_tile_for_uc1617_upper4bit
	mv	a5,a0
	mv	a2,a5
	li	a1,8
	lw	a0,-36(s0)
...
.L14:
	...
	bnez	a5,.L22
	.loc 1 209 2
	lla	a1,u8x8_d_uc1617_powersave0_seq
	lw	a0,-36(s0)
...
.L22:
	.loc 1 211 2
	lla	a1,u8x8_d_uc1617_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 212 7
	j	.L21
.L12:
	...
	bnez	a5,.L24
	.loc 1 216 2
	lla	a1,u8x8_d_uc1617_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 217 23
	lw	a5,-36(s0)
...
.L24:
	.loc 1 221 2
	lla	a1,u8x8_d_uc1617_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 222 23
	lw	a5,-36(s0)
...
.L29:
	.loc 1 313 2
	lla	a1,u8x8_uc1617_128x128_display_info
	lw	a0,-20(s0)
...
.L30:
	...
	.loc 1 317 2
	lla	a1,u8x8_d_uc1617_jlx128128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 318 2
	j	.L28
...
.LASF926:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1617.c"
.LASF25:
