...
.Ltext0:
	...
	.section	.srodata,"a"
	.align	2
	.type	u8x8_d_hd44102_init_seq, @object
...
u8x8_d_hd44102_init_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_d_hd44102_powersave0_seq, @object
...
u8x8_d_hd44102_powersave0_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_d_hd44102_powersave1_seq, @object
...
u8x8_hd44102_outy:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
	.loc 1 77 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L11:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_hd44102_outy, .-u8x8_hd44102_outy
	.section	.rodata
	.align	2
	.type	u8x8_hd44102_150x32_display_info, @object
...
.L15:
	.loc 1 185 7
	lla	a1,u8x8_hd44102_150x32_display_info
	lw	a0,-36(s0)
...
.LVL6:
	...
	lla	a1,u8x8_d_hd44102_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 194 13 discriminator 3
	lw	a5,-36(s0)
	lw	a4,12(a5)
...
.LVL8:
	...
	bnez	a5,.L23
	.loc 1 205 11
	lla	a1,u8x8_d_hd44102_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	j	.L24
.L23:
	.loc 1 209 11
	lla	a1,u8x8_d_hd44102_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
.L24:
...
.L26:
	...
	mv	a5,a0
	lw	a0,-36(s0)
	call	u8x8_hd44102_outy
	.loc 1 234 16 discriminator 1
	lbu	a5,-38(s0)
	addi	a5,a5,-1
	sb	a5,-38(s0)
	.loc 1 235 11 discriminator 1
	lbu	a4,-18(s0)
	lbu	a5,-19(s0)
	add	a5,a4,a5
	sb	a5,-18(s0)
...
.L28:
	...
	.cfi_endproc
.LFE1:
	.size	u8x8_d_t7932_150x32, .-u8x8_d_t7932_150x32
	.section	.rodata
	.align	2
	.type	u8x8_hd44102_100x64_display_info, @object
...
.L32:
	.loc 1 277 7
	lla	a1,u8x8_hd44102_100x64_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 278 7
	j	.L36
.L30:
	...
	j	.L37
.L38:
	.loc 1 284 13 discriminator 3
	lw	a5,-36(s0)
	lw	a4,12(a5)
	.loc 1 284 9 discriminator 3
	lbu	a5,-17(s0)
	li	a3,0
	mv	a2,a5
	li	a1,24
	...
	jalr	a4
.LVL10:
	.loc 1 285 9 discriminator 3
	lla	a1,u8x8_d_hd44102_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 286 13 discriminator 3
	lw	a5,-36(s0)
	lw	a5,12(a5)
	...
	jalr	a5
.LVL11:
	.loc 1 282 27 discriminator 3
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L37:
	.loc 1 282 7 discriminator 1
	lbu	a4,-17(s0)
	li	a5,3
	bleu	a4,a5,.L38
	.loc 1 289 7
...
.L41:
	...
	jalr	a5
.LVL13:
	.loc 1 292 27 discriminator 2
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L39:
	.loc 1 292 7 discriminator 1
	lbu	a4,-17(s0)
	li	a5,3
	bleu	a4,a5,.L42
	.loc 1 305 7
...
.L44:
	...
	lw	a0,-36(s0)
	call	u8x8_hd44102_outy
	.loc 1 328 18 discriminator 1
	lbu	a5,-38(s0)
	addi	a5,a5,-1
	sb	a5,-38(s0)
	.loc 1 329 13 discriminator 1
	lbu	a4,-18(s0)
	lbu	a5,-19(s0)
	add	a5,a4,a5
	sb	a5,-18(s0)
...
.L46:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_d_hd44102_100x64, .-u8x8_d_hd44102_100x64
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_hd44102_powersave0_seq
	.byte	0x13
	.4byte	.LASF912
	.byte	0x1
	.byte	0x36
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_hd44102_powersave1_seq
	.byte	0x13
	.4byte	.LASF913
	.byte	0x1
	.byte	0x97
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_hd44102_150x32_display_info
	.byte	0x13
	.4byte	.LASF914
	.byte	0x1
	.byte	0xf6
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_hd44102_100x64_display_info
	.byte	0x14
	.4byte	.LASF919
	.byte	0x1
	.2byte	0x10e
...
.LASF926:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
.LASF588:
...
.LASF314:
	.string	"USE_M_TIME 1"
.LASF913:
	.string	"u8x8_hd44102_150x32_display_info"
.LASF122:
...
.LASF370:
	.string	"__int20 +2"
.LASF912:
	.string	"u8x8_d_hd44102_powersave1_seq"
.LASF101:
...
.LASF911:
	.string	"u8x8_d_hd44102_powersave0_seq"
.LASF339:
...
.LASF730:
	.string	"display_info"
.LASF910:
	.string	"u8x8_d_hd44102_init_seq"
.LASF756:
...
.LASF322:
	.string	"__RTTHREAD__ "
.LASF914:
	.string	"u8x8_hd44102_100x64_display_info"
.LASF778:
	.string	"u8x8_char_cb"
.LASF561:
