...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1306_64x32.c"
	.loc 1 74 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 90 2
	lla	a1,u8x8_d_ssd1306_64x32_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 92 2
	lla	a1,u8x8_d_ssd1306_64x32_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 93 7
	j	.L10
.L2:
	...
	bnez	a5,.L11
	.loc 1 97 2
	lla	a1,u8x8_d_ssd1306_64x32_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 98 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 102 2
	lla	a1,u8x8_d_ssd1306_64x32_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 103 23
	lw	a5,-36(s0)
...
.LFB1:
	...
	bne	a4,a5,.L16
	.loc 1 202 7
	lla	a1,u8x8_ssd1306_64x32_display_info
	lw	a0,-20(s0)
...
.L16:
	...
	.loc 1 208 7
	lla	a1,u8x8_d_ssd1306_64x32_noname_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 209 14
	li	a5,1
...
.L18:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1306_64x32_generic
	mv	a5,a0
.L17:
	.loc 1 212 1
	mv	a0,a5
...
.L20:
	...
	call	u8x8_d_helper_display_init
	.loc 1 254 7
	lla	a1,u8x8_d_ssd1306_64x32_1f_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 255 14
	li	a5,1
...
.LASF923:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1306_64x32.c"
.LASF537:
	.string	"__need_NULL"
.LASF628:
