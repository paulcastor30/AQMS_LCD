...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8g2_circle.c"
	.loc 1 44 1
	.cfi_startproc
	addi	sp,sp,-32
...
.LFE0:
	...
	.align	1
	.type	u8g2_draw_circle, @function
u8g2_draw_circle:
.LFB1:
	.loc 1 75 1
	.cfi_startproc
...
.L8:
	...
	.cfi_endproc
.LFE1:
	.size	u8g2_draw_circle, .-u8g2_draw_circle
	.align	1
...
.L22:
	...
	.cfi_endproc
.LFE4:
	.size	u8g2_draw_disc, .-u8g2_draw_disc
	.align	1
	.globl	u8g2_DrawDisc
...
.LFE6:
	...
	.align	1
	.type	u8g2_draw_ellipse, @function
u8g2_draw_ellipse:
.LFB7:
	.loc 1 245 1
	.cfi_startproc
...
.L37:
	...
	lhu	a1,-18(s0)
	lw	a0,-52(s0)
	call	u8g2_draw_ellipse_section
	.loc 1 282 6
	lhu	a5,-20(s0)
	addi	a5,a5,1
	sh	a5,-20(s0)
...
.L38:
	...
	.cfi_endproc
.LFE7:
	.size	u8g2_draw_ellipse, .-u8g2_draw_ellipse
	.align	1
...
.LFE9:
	...
	.align	1
	.type	u8g2_draw_filled_ellipse, @function
...
.L52:
	...
	lhu	a1,-18(s0)
	lw	a0,-52(s0)
	call	u8g2_draw_filled_ellipse_section
	.loc 1 415 6
	lhu	a5,-20(s0)
	addi	a5,a5,1
	sh	a5,-20(s0)
...
.L53:
	...
	.cfi_endproc
.LFE10:
	.size	u8g2_draw_filled_ellipse, .-u8g2_draw_filled_ellipse
	.align	1
...
.LASF3223:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8g2_circle.c"
.LASF2974:
