...
u8x8_d_ssd1316_generic:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1316.c"
	.loc 1 80 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 98 2
	lla	a1,u8x8_d_ssd1316_128x32_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 100 2
	lla	a1,u8x8_d_ssd1316_128x32_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 101 7
	j	.L10
.L2:
	...
	bnez	a5,.L11
	.loc 1 105 2
	lla	a1,u8x8_d_ssd1316_128x32_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 106 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 110 2
	lla	a1,u8x8_d_ssd1316_128x32_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 111 23
	lw	a5,-36(s0)
...
.L7:
	...
	call	u8x8_cad_SendCmd
.L13:
	.loc 1 135 4 discriminator 1
	lw	a5,-44(s0)
	lbu	a5,4(a5)
	sb	a5,-18(s0)
	.loc 1 136 6 discriminator 1
	lw	a5,-44(s0)
	lw	a5,0(a5)
	sw	a5,-24(s0)
...
.L14:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_ssd1316_generic, .-u8x8_d_ssd1316_generic
	.section	.rodata
	.align	2
...
.L16:
	...
	.loc 1 227 7
	lla	a1,u8x8_d_ssd1316_128x32_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 228 7
	j	.L20
.L18:
	.loc 1 230 7
	lla	a1,u8x8_ssd1316_128x32_display_info
	lw	a0,-20(s0)
...
.LFE1:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_ssd1316_96x32_init_seq, @object
...
u8x8_d_ssd1316_96x32_init_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_ssd1316_96x32_display_info, @object
...
.L22:
	...
	call	u8x8_d_helper_display_init
	.loc 1 322 7
	lla	a1,u8x8_d_ssd1316_96x32_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 323 7
	j	.L26
.L24:
	.loc 1 325 7
	lla	a1,u8x8_ssd1316_96x32_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 326 7
	j	.L26
...
.L23:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_d_ssd1316_96x32, .-u8x8_d_ssd1316_96x32
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1316_96x32_init_seq
	.byte	0x14
	.4byte	.LASF917
	.byte	0x1
	.2byte	0x120
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_ssd1316_96x32_display_info
	.byte	0x15
	.4byte	.LASF921
	.byte	0x1
	.2byte	0x138
...
.LASF516:
	.string	"__size_t "
.LASF924:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1316.c"
.LASF410:
...
.LASF917:
	.string	"u8x8_ssd1316_96x32_display_info"
.LASF624:
...
.LASF916:
	.string	"u8x8_d_ssd1316_96x32_init_seq"
.LASF703:
