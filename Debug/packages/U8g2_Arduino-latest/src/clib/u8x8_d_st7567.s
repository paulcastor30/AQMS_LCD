...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7567.c"
	.loc 1 157 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L9:
	.loc 1 163 7
	lla	a1,u8x8_st7567_132x64_display_info
	lw	a0,-36(s0)
...
.L8:
	...
	.loc 1 167 7
	lla	a1,u8x8_d_st7567_132x64_init_seq
	lw	a0,-36(s0)
...
.L7:
	...
	bnez	a5,.L11
	.loc 1 171 2
	lla	a1,u8x8_d_st7567_132x64_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 174 7
	j	.L10
.L11:
	.loc 1 173 2
	lla	a1,u8x8_d_st7567_132x64_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 174 7
	j	.L10
.L6:
	...
	bnez	a5,.L13
	.loc 1 178 2
	lla	a1,u8x8_d_st7567_132x64_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 179 23
	lw	a5,-36(s0)
...
.L13:
	.loc 1 183 2
	lla	a1,u8x8_d_st7567_132x64_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 184 23
	lw	a5,-36(s0)
...
.L26:
	.loc 1 304 7
	lla	a1,u8x8_st7567_jlx12864_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 305 7
	j	.L27
.L25:
	...
	call	u8x8_d_helper_display_init
	.loc 1 308 7
	lla	a1,u8x8_st7567_jlx12864_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 309 7
	j	.L27
...
.LFE1:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_st7567_122x32_flip0_seq, @object
...
u8x8_d_st7567_122x32_flip0_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_d_st7567_122x32_flip1_seq, @object
...
u8x8_d_st7567_122x32_flip1_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_st7567_122x32_display_info, @object
...
u8x8_st7567_122x32_display_info:
	...
	.half	32
	.align	2
	.type	u8x8_st7567_122x32_init_seq, @object
...
.L43:
	.loc 1 467 7
	lla	a1,u8x8_st7567_122x32_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 468 7
	j	.L44
.L42:
	...
	call	u8x8_d_helper_display_init
	.loc 1 471 7
	lla	a1,u8x8_st7567_122x32_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 472 7
	j	.L44
...
.L40:
	...
	bnez	a5,.L47
	.loc 1 482 2
	lla	a1,u8x8_d_st7567_122x32_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 483 23
	lw	a5,-36(s0)
...
.L47:
	.loc 1 487 2
	lla	a1,u8x8_d_st7567_122x32_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 488 23
	lw	a5,-36(s0)
...
.L37:
	...
	sb	a5,-17(s0)
.L50:
	.loc 1 524 2 discriminator 1
	lbu	a5,-17(s0)
	lw	a2,-24(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 525 9 discriminator 1
	lbu	a5,-38(s0)
	addi	a5,a5,-1
	sb	a5,-38(s0)
	.loc 1 526 7 discriminator 1
	lbu	a5,-38(s0)
	bnez	a5,.L50
	.loc 1 528 7
	lw	a0,-36(s0)
...
.L51:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_d_st7567_122x32, .-u8x8_d_st7567_122x32
	.section	.rodata
	.align	2
...
.L59:
	.loc 1 631 7
	lla	a1,u8x8_st7567_enh_dg128064_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 632 7
	j	.L60
.L58:
	...
	call	u8x8_d_helper_display_init
	.loc 1 635 7
	lla	a1,u8x8_st7567_enh_dg128064_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 636 7
	j	.L60
...
.L54:
	...
	sb	a5,-17(s0)
.L64:
	.loc 1 676 2 discriminator 1
	lbu	a5,-17(s0)
	lw	a2,-24(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 677 9 discriminator 1
	lbu	a5,-38(s0)
	addi	a5,a5,-1
	sb	a5,-38(s0)
	.loc 1 678 7 discriminator 1
	lbu	a5,-38(s0)
	bnez	a5,.L64
	.loc 1 680 7
	lw	a0,-36(s0)
...
.L68:
	...
	bnez	a5,.L71
	.loc 1 698 2
	lla	a1,u8x8_d_st7567_n_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 699 23
	lw	a5,-20(s0)
...
.L71:
	.loc 1 703 2
	lla	a1,u8x8_d_st7567_n_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 704 23
	lw	a5,-20(s0)
...
.L74:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_st7567_enh_dg128064_generic
	mv	a5,a0
	j	.L73
.L70:
	.loc 1 710 10
...
.L76:
	.loc 1 718 7
	lla	a1,u8x8_st7567_enh_dg128064i_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 719 7
	j	.L79
...
.L92:
	.loc 1 809 7
	lla	a1,u8x8_st7567_64x32_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 810 7
	j	.L93
.L91:
	...
	call	u8x8_d_helper_display_init
	.loc 1 813 7
	lla	a1,u8x8_st7567_64x32_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 814 7
	j	.L93
...
.L86:
	...
	sb	a5,-17(s0)
.L99:
	.loc 1 866 2 discriminator 1
	lbu	a5,-17(s0)
	lw	a2,-24(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 867 9 discriminator 1
	lbu	a5,-38(s0)
	addi	a5,a5,-1
	sb	a5,-38(s0)
...
.L109:
	.loc 1 947 7
	lla	a1,u8x8_st7567_hem6432_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 948 25
	lw	a5,-36(s0)
...
.L108:
	...
	call	u8x8_d_helper_display_init
	.loc 1 952 7
	lla	a1,u8x8_st7567_hem6432_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 953 7
	j	.L110
...
.L103:
	...
	sb	a5,-17(s0)
.L116:
	.loc 1 1005 2 discriminator 1
	lbu	a5,-17(s0)
	lw	a2,-24(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 1006 9 discriminator 1
	lbu	a5,-38(s0)
	addi	a5,a5,-1
	sb	a5,-38(s0)
	.loc 1 1007 7 discriminator 1
	lbu	a5,-38(s0)
	bnez	a5,.L116
	.loc 1 1009 7
	lw	a0,-36(s0)
...
.L126:
	.loc 1 1092 7
	lla	a1,u8x8_st7567_os12864_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 1093 7
	j	.L127
.L125:
	...
	call	u8x8_d_helper_display_init
	.loc 1 1096 7
	lla	a1,u8x8_st7567_os12864_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 1097 7
	j	.L127
...
.L120:
	...
	sb	a5,-17(s0)
.L133:
	.loc 1 1149 2 discriminator 1
	lbu	a5,-17(s0)
	lw	a2,-24(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 1150 9 discriminator 1
	lbu	a5,-38(s0)
	addi	a5,a5,-1
	sb	a5,-38(s0)
...
.LFE8:
	...
	.section	.rodata
	.align	2
	.type	u8x8_st7567_132x32_display_info, @object
...
u8x8_st7567_132x32_display_info:
	...
	.half	32
	.align	2
	.type	u8x8_d_st7567_erc13232_init_seq, @object
...
.L143:
	.loc 1 1241 7
	lla	a1,u8x8_st7567_132x32_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 1242 7
	j	.L144
.L142:
	...
	call	u8x8_d_helper_display_init
	.loc 1 1245 7
	lla	a1,u8x8_d_st7567_erc13232_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 1246 7
	j	.L144
...
.L151:
	...
	.cfi_endproc
.LFE9:
	.size	u8x8_d_st7567_erc13232, .-u8x8_d_st7567_erc13232
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_st7567_122x32_flip0_seq
	.byte	0x14
	.4byte	.LASF921
	.byte	0x1
	.2byte	0x185
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_st7567_122x32_flip1_seq
	.byte	0x14
	.4byte	.LASF922
	.byte	0x1
	.2byte	0x18e
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_st7567_122x32_display_info
	.byte	0x14
	.4byte	.LASF923
	.byte	0x1
	.2byte	0x1a6
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_st7567_122x32_init_seq
	.byte	0x14
	.4byte	.LASF924
	.byte	0x1
	.2byte	0x21d
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_st7567_132x32_display_info
	.byte	0x14
	.4byte	.LASF934
	.byte	0x1
	.2byte	0x4af
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_st7567_erc13232_init_seq
	.byte	0x15
	.4byte	.LASF938
	.byte	0x1
	.2byte	0x4d2
...
.LASF947:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7567.c"
.LASF153:
...
.LASF933:
	.string	"u8x8_st7567_132x32_display_info"
.LASF362:
	.string	"char"
.LASF471:
...
.LASF923:
	.string	"u8x8_st7567_122x32_init_seq"
.LASF25:
...
.LASF922:
	.string	"u8x8_st7567_122x32_display_info"
.LASF645:
...
.LASF921:
	.string	"u8x8_d_st7567_122x32_flip1_seq"
.LASF888:
...
.LASF920:
	.string	"u8x8_d_st7567_122x32_flip0_seq"
.LASF388:
...
.LASF934:
	.string	"u8x8_d_st7567_erc13232_init_seq"
.LASF865:
