...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7586s_s028hn118a.c"
	.loc 1 74 97
	.cfi_startproc
	addi	sp,sp,-64
...
.L22:
	...
	.loc 1 233 5
	lla	a1,u8x8_d_st7586s_s028hn118a_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 234 5
	j	.L26
.L24:
	.loc 1 236 5
	lla	a1,u8x8_st7586s_s028hn118a_display_info
	lw	a0,-20(s0)
...
.L23:
	...
	bnez	a5,.L27
	.loc 1 241 8
	lla	a1,u8x8_d_st7586s_s028hn118a_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 242 29
	lw	a5,-20(s0)
...
.L27:
	.loc 1 246 7
	lla	a1,u8x8_d_st7586s_s028hn118a_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 247 28
	lw	a5,-20(s0)
...
.LASF537:
	.string	"NULL ((void *)0)"
.LASF3212:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7586s_s028hn118a.c"
.LASF342:
