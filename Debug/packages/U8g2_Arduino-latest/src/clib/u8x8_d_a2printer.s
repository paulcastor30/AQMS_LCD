...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_a2printer.c"
	.loc 1 55 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L13:
	...
	lw	a1,-24(s0)
	mv	a0,a5
	call	get_delay_in_milliseconds
	mv	a5,a0
	mv	a4,a5
	.loc 1 110 26 discriminator 3
	lhu	a5,-26(s0)
	add	a5,a4,a5
	sh	a5,-26(s0)
	.loc 1 111 8 discriminator 3
	lbu	a5,-27(s0)
	lw	a4,-24(s0)
	add	a5,a4,a5
	sw	a5,-24(s0)
	.loc 1 107 22 discriminator 3
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L12:
...
.L14:
	...
	li	a5,200
	bgtu	a4,a5,.L15
	.loc 1 119 6 discriminator 2
	lw	a5,-36(s0)
	lw	a4,20(a5)
	.loc 1 119 2 discriminator 2
	lhu	a5,-26(s0)
	andi	a5,a5,0xff
	li	a3,0
	mv	a2,a5
...
.LFB2:
	...
	bne	a4,a5,.L20
	.loc 1 170 7
	lla	a1,u8x8_a2printer_384x240_display_info
	lw	a0,-20(s0)
...
.LASF548:
	.string	"UCHAR_MAX"
.LASF714:
	.string	"LINE_EXTRA_8PIXEL_DELAY_MS 3"
.LASF272:
...
.LASF923:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_a2printer.c"
.LASF589:
	.string	"U8X8_PROGMEM "
.LASF228:
...
.LASF715:
	.string	"NO_OF_LINES_TO_SEND_WITHOUT_DELAY 1"
.LASF72:
