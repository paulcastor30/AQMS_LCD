...
u8x8_d_ssd1322_powersave1_seq:
	...
	.comm	u8x8_ssd1322_to32_dest_buf,32,4
	.text
	.align	1
	.type	u8x8_ssd1322_8to32, @function
u8x8_ssd1322_8to32:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1322.c"
	.loc 1 94 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L7:
	.loc 1 102 10
	lla	a5,u8x8_ssd1322_to32_dest_buf
	sw	a5,-28(s0)
	.loc 1 103 10
	lbu	a5,-21(s0)
	lw	a4,-28(s0)
...
.L4:
	...
	sb	a5,-17(s0)
.L5:
	.loc 1 113 13 discriminator 2
	lw	a5,-28(s0)
	lbu	a4,-17(s0)
	sb	a4,0(a5)
	.loc 1 114 11 discriminator 2
	lw	a5,-28(s0)
	addi	a5,a5,4
	sw	a5,-28(s0)
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_ssd1322_8to32, .-u8x8_ssd1322_8to32
	.align	1
	.type	u8x8_ssd1322_4to32, @function
u8x8_ssd1322_4to32:
.LFB1:
	.loc 1 124 1
	.cfi_startproc
...
.L10:
	...
	.cfi_endproc
.LFE1:
	.size	u8x8_ssd1322_4to32, .-u8x8_ssd1322_4to32
	.align	1
...
.LFB2:
	...
	bnez	a5,.L20
	.loc 1 168 2
	lla	a1,u8x8_d_ssd1322_powersave0_seq
	lw	a0,-36(s0)
...
.L20:
	.loc 1 170 2
	lla	a1,u8x8_d_ssd1322_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 171 7
	j	.L22
...
.L23:
	...
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 202 4 discriminator 1
	lbu	a5,-17(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 203 4 discriminator 1
	lbu	a5,-17(s0)
	addi	a5,a5,1
	andi	a5,a5,0xff
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 205 4 discriminator 1
	li	a1,92
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 207 4 discriminator 1
	lw	a1,-24(s0)
	lw	a0,-36(s0)
	call	u8x8_ssd1322_8to32
	mv	a5,a0
	mv	a2,a5
	li	a1,32
	lw	a0,-36(s0)
...
.LFB3:
	...
	bne	a5,a4,.L29
	.loc 1 308 7
	lla	a1,u8x8_ssd1322_256x64_display_info
	lw	a0,-20(s0)
...
.L27:
	...
	.loc 1 312 7
	lla	a1,u8x8_d_ssd1322_256x64_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 313 7
	j	.L30
.L28:
	...
	bnez	a5,.L31
	.loc 1 317 2
	lla	a1,u8x8_d_ssd1322_256x64_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 318 23
	lw	a5,-20(s0)
...
.L31:
	.loc 1 322 2
	lla	a1,u8x8_d_ssd1322_256x64_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 323 23
	lw	a5,-20(s0)
...
.LFE3:
	...
	.section	.rodata
	.align	2
	.type	u8x8_ssd1322_240x128_display_info, @object
...
u8x8_ssd1322_240x128_display_info:
	...
	.half	128
	.align	2
	.type	u8x8_d_ssd1322_240x128_init_seq, @object
...
.LFB4:
	...
	bne	a5,a4,.L37
	.loc 1 405 7
	lla	a1,u8x8_ssd1322_240x128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 406 7
	j	.L38
.L35:
	...
	call	u8x8_d_helper_display_init
	.loc 1 409 7
	lla	a1,u8x8_d_ssd1322_240x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 410 7
	j	.L38
...
.L41:
	...
	.cfi_endproc
.LFE4:
	.size	u8x8_d_ssd1322_240x128, .-u8x8_d_ssd1322_240x128
	.align	1
...
.L49:
	...
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 494 4 discriminator 1
	li	a1,92
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 495 4 discriminator 1
	lw	a1,-24(s0)
	lw	a0,-36(s0)
	call	u8x8_ssd1322_4to32
	mv	a5,a0
	mv	a2,a5
	li	a1,32
	lw	a0,-36(s0)
	...
	addi	a5,a5,4
	sw	a5,-24(s0)
	.loc 1 497 6 discriminator 1
	lbu	a5,-17(s0)
	addi	a5,a5,2
	sb	a5,-17(s0)
	.loc 1 499 4 discriminator 1
	li	a1,21
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 500 4 discriminator 1
	lbu	a5,-17(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 501 4 discriminator 1
	lbu	a5,-17(s0)
	addi	a5,a5,1
	andi	a5,a5,0xff
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 502 4 discriminator 1
	li	a1,92
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 503 4 discriminator 1
	lw	a1,-24(s0)
	lw	a0,-36(s0)
	call	u8x8_ssd1322_4to32
	mv	a5,a0
	...
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 504 8 discriminator 1
	lw	a5,-24(s0)
	addi	a5,a5,4
	sw	a5,-24(s0)
	.loc 1 505 6 discriminator 1
	lbu	a5,-17(s0)
	addi	a5,a5,2
	sb	a5,-17(s0)
	.loc 1 507 5 discriminator 1
	lbu	a5,-18(s0)
	addi	a5,a5,-1
	sb	a5,-18(s0)
	.loc 1 508 2 discriminator 1
	lbu	a5,-18(s0)
	bnez	a5,.L49
	.loc 1 511 9
	lbu	a5,-38(s0)
...
.LFB6:
	...
	bne	a5,a4,.L55
	.loc 1 629 7
	lla	a1,u8x8_ssd1322_128x64_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 630 7
	j	.L56
.L53:
	...
	call	u8x8_d_helper_display_init
	.loc 1 633 7
	lla	a1,u8x8_d_ssd1322_128x64_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 634 7
	j	.L56
.L54:
	...
	bnez	a5,.L57
	.loc 1 638 2
	lla	a1,u8x8_d_ssd1322_128x64_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 639 23
	lw	a5,-20(s0)
...
.L57:
	.loc 1 643 2
	lla	a1,u8x8_d_ssd1322_128x64_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 644 23
	lw	a5,-20(s0)
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_ssd1322_240x128_display_info
	.byte	0x14
	.4byte	.LASF918
	.byte	0x1
	.2byte	0x16c
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1322_240x128_init_seq
	.byte	0x14
	.4byte	.LASF919
	.byte	0x1
	.2byte	0x20b
...
.LASF918:
	.string	"u8x8_d_ssd1322_240x128_init_seq"
.LASF200:
...
.LASF917:
	.string	"u8x8_ssd1322_240x128_display_info"
.LASF694:
...
.LASF314:
	.string	"USE_M_TIME 1"
.LASF933:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1322.c"
.LASF122:
