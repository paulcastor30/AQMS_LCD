# 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
...
# 1 "<command-line>" 2
# 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
# 38 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
...
# 39 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 2
...
# 76 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
static void u8x8_hd44102_outy(u8x8_t *u8x8, uint8_t *data, uint8_t cnt, uint8_t page, uint8_t offset, uint8_t cs_none, uint8_t cs0, uint8_t cs1, uint8_t cs2)
{
  ...
  if ( pos < 50 && cnt > 0 )
  {
    ...
    u8x8->cad_cb(u8x8, 24, cs0, 
# 92 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                        ((void *)0)
# 92 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                            );
    u8x8_cad_SendCmd(u8x8, (page << 6) | pos );
    u8x8_cad_SendData(u8x8, data_cnt, data);
    u8x8->cad_cb(u8x8, 25, cs_none, 
# 95 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                          ((void *)0)
# 95 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                              );
  ...
  if ( pos < 100 && cnt > 0 )
  {
    ...
    u8x8->cad_cb(u8x8, 24, cs1, 
# 114 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                        ((void *)0)
# 114 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                            );
    u8x8_cad_SendCmd(u8x8, (page << 6) | (pos-50) );
    u8x8_cad_SendData(u8x8, data_cnt, data);
    u8x8->cad_cb(u8x8, 25, cs_none, 
# 117 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                          ((void *)0)
# 117 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                              );
  ...
  if ( pos < 150 && cnt > 0 )
  {
    ...
    u8x8->cad_cb(u8x8, 24, cs2, 
# 136 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                        ((void *)0)
# 136 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                            );
    u8x8_cad_SendCmd(u8x8, (page << 6) | (pos-100) );
    u8x8_cad_SendData(u8x8, data_cnt, data);
    u8x8->cad_cb(u8x8, 25, cs_none, 
# 139 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                          ((void *)0)
# 139 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                              );
...
uint8_t u8x8_d_t7932_150x32(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
    ...
    case 10:
      ...
      for( i = 0; i < 3; i++ )
      {
        u8x8->cad_cb(u8x8, 24, cs[i], 
# 192 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                              ((void *)0)
# 192 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                                  );
        u8x8_cad_SendSequence(u8x8, u8x8_d_hd44102_init_seq);
        u8x8->cad_cb(u8x8, 25, cs[3], 
# 194 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                            ((void *)0)
# 194 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                                );
      }
    ...
    case 11:
      ...
      {
        u8x8->cad_cb(u8x8, 24, cs[i], 
# 202 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                              ((void *)0)
# 202 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                                  );
        if ( arg_int == 0 )
        {
        ...
        u8x8->cad_cb(u8x8, 25, cs[3], 
# 211 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                            ((void *)0)
# 211 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                                );
      }
      break;
...
uint8_t u8x8_d_hd44102_100x64(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
    ...
    case 10:
      ...
      for( i = 0; i < 4; i++ )
      {
        u8x8->cad_cb(u8x8, 24, i, 
# 284 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                          ((void *)0)
# 284 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                              );
        u8x8_cad_SendSequence(u8x8, u8x8_d_hd44102_init_seq);
        u8x8->cad_cb(u8x8, 25, 7, 
# 286 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                        ((void *)0)
# 286 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                            );
      }
    ...
    case 11:
      ...
      {
        u8x8->cad_cb(u8x8, 24, i, 
# 294 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                          ((void *)0)
# 294 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                              );
        if ( arg_int == 0 )
        {
          u8x8_cad_SendSequence(u8x8, u8x8_d_hd44102_powersave0_seq);
        ...
        u8x8->cad_cb(u8x8, 25, 7, 
# 303 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c" 3 4
                                                        ((void *)0)
# 303 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_hd44102.c"
                                                            );
      }
      break;
