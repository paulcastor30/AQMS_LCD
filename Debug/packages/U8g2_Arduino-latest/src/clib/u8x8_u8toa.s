...
u8x8_u8toap:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_u8toa.c"
	.loc 1 41 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L3:
	...
	lbu	a5,-19(s0)
	bgeu	a4,a5,.L4
	.loc 1 54 11 discriminator 2
	lbu	a5,-17(s0)
	lw	a4,-36(s0)
	add	a5,a4,a5
	.loc 1 54 17 discriminator 2
	lbu	a4,-18(s0)
	sb	a4,0(a5)
...
.LASF861:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_u8toa.c"
.LASF74:
