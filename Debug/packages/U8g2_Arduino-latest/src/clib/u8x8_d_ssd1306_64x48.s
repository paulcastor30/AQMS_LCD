...
u8x8_d_ssd1306_64x48_flip1_seq:
	...
	.text
	.align	1
	.type	u8x8_d_ssd1306_64x48_generic, @function
u8x8_d_ssd1306_64x48_generic:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1306_64x48.c"
	.loc 1 106 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 122 2
	lla	a1,u8x8_d_ssd1306_64x48_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 124 2
	lla	a1,u8x8_d_ssd1306_64x48_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 125 7
	j	.L10
.L2:
	...
	bnez	a5,.L11
	.loc 1 129 2
	lla	a1,u8x8_d_ssd1306_64x48_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 130 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 134 2
	lla	a1,u8x8_d_ssd1306_64x48_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 135 23
	lw	a5,-36(s0)
...
.L14:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_ssd1306_64x48_generic, .-u8x8_d_ssd1306_64x48_generic
	.section	.rodata
	.align	2
...
.LFB1:
	...
	bne	a4,a5,.L16
	.loc 1 201 7
	lla	a1,u8x8_ssd1306_64x48_display_info
	lw	a0,-20(s0)
...
.L16:
	...
	.loc 1 207 7
	lla	a1,u8x8_d_ssd1306_64x48_er_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 208 14
	li	a5,1
...
.L18:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1306_64x48_generic
	mv	a5,a0
.L17:
	.loc 1 211 1
	mv	a0,a5
...
.LASF920:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1306_64x48.c"
.LASF516:
	.string	"__size_t "
.LASF410:
