...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1601.c"
	.loc 1 123 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L9:
	.loc 1 129 7
	lla	a1,u8x8_uc1601_128x32_display_info
	lw	a0,-36(s0)
...
.L8:
	...
	.loc 1 133 7
	lla	a1,u8x8_d_uc1601_128x32_init_seq
	lw	a0,-36(s0)
...
.L7:
	...
	bnez	a5,.L11
	.loc 1 137 2
	lla	a1,u8x8_d_uc1601_128x32_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 140 7
	j	.L10
.L11:
	.loc 1 139 2
	lla	a1,u8x8_d_uc1601_128x32_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 140 7
	j	.L10
.L6:
	...
	bnez	a5,.L13
	.loc 1 144 2
	lla	a1,u8x8_d_uc1601_128x32_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 145 23
	lw	a5,-36(s0)
...
.L13:
	.loc 1 149 2
	lla	a1,u8x8_d_uc1601_128x32_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 150 23
	lw	a5,-36(s0)
...
.LFE0:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_uc1601_128x64_init_seq, @object
...
u8x8_d_uc1601_128x64_init_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_uc1601_128x64_display_info, @object
...
.L25:
	.loc 1 245 7
	lla	a1,u8x8_uc1601_128x64_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 246 7
	j	.L26
.L24:
	...
	call	u8x8_d_helper_display_init
	.loc 1 249 7
	lla	a1,u8x8_d_uc1601_128x64_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 250 7
	j	.L26
...
.L32:
	...
	.cfi_endproc
.LFE1:
	.size	u8x8_d_uc1601_128x64, .-u8x8_d_uc1601_128x64
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_uc1601_128x64_init_seq
	.byte	0x13
	.4byte	.LASF917
	.byte	0x1
	.byte	0xd6
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_uc1601_128x64_display_info
	.byte	0x14
	.4byte	.LASF924
	.byte	0x1
	.byte	0xee
...
.LASF917:
	.string	"u8x8_uc1601_128x64_display_info"
.LASF44:
...
.LASF922:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1601.c"
.LASF880:
...
.LASF916:
	.string	"u8x8_d_uc1601_128x64_init_seq"
.LASF655:
