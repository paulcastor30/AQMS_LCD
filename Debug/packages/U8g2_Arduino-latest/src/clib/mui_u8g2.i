# 1 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
...
# 1 "<command-line>" 2
# 1 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
# 146 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
# 1 "../packages/U8g2_Arduino-latest/src/clib/mui.h" 1
# 75 "../packages/U8g2_Arduino-latest/src/clib/mui.h"
#define MUI_H 
...
# 78 "../packages/U8g2_Arduino-latest/src/clib/mui.h" 2
...
# 79 "../packages/U8g2_Arduino-latest/src/clib/mui.h" 2
...
# 11 "c:\\rt-threadstudio\\repo\\extract\\toolchain_support_packages\\wch\\risc-v-gcc-wch\\8.2.0\\riscv-none-embed\\include\\string.h" 2 3
...
# 12 "c:\\rt-threadstudio\\repo\\extract\\toolchain_support_packages\\wch\\risc-v-gcc-wch\\8.2.0\\riscv-none-embed\\include\\string.h" 2 3
...
# 13 "c:\\rt-threadstudio\\repo\\extract\\toolchain_support_packages\\wch\\risc-v-gcc-wch\\8.2.0\\riscv-none-embed\\include\\string.h" 2 3
...
# 80 "../packages/U8g2_Arduino-latest/src/clib/mui.h" 2
# 96 "../packages/U8g2_Arduino-latest/src/clib/mui.h"
...
# 118 "../packages/U8g2_Arduino-latest/src/clib/mui.h"
#define mui_pgm_read(adr) (*(const uint8_t *)(adr))
# 129 "../packages/U8g2_Arduino-latest/src/clib/mui.h"
...
# 138 "../packages/U8g2_Arduino-latest/src/clib/mui.h"
...
# 166 "../packages/U8g2_Arduino-latest/src/clib/mui.h"
...
# 147 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c" 2
# 1 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h" 1
# 59 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
#define U8G2_H 
...
# 114 "../packages/U8g2_Arduino-latest/src/clib/u8x8.h"
...
# 62 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h" 2
# 71 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
#define U8G2_16BIT 
# 97 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
#define U8G2_WITH_HVLINE_SPEED_OPTIMIZATION 
# 108 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
#define U8G2_WITH_INTERSECTION 
# 120 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
#define U8G2_WITH_CLIP_WINDOW_SUPPORT 
# 130 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
#define U8G2_WITH_FONT_ROTATION 
# 158 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
#define U8G2_WITH_UNICODE 
# 175 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
...
# 209 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
...
# 397 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
...
# 458 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
...
# 1585 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
...
# 1615 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
...
# 148 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c" 2
# 1 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.h" 1
# 66 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.h"
#define MUI_U8G2_H 
# 78 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.h"
...
# 152 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.h"
...
#define MUIF_U8G2_U8_MIN_MAX(id,valptr,min,max,muif) MUIF(id, MUIF_CFLAG_IS_CURSOR_SELECTABLE, (void *)((mui_u8g2_u8_min_max_t [] ) {{ (valptr) MUI_U8G2_COMMA (min) MUI_U8G2_COMMA (max)}}), (muif))
...
#define MUIF_U8G2_U8_MIN_MAX_STEP(id,valptr,min,max,step,flags,muif) MUIF(id, MUIF_CFLAG_IS_CURSOR_SELECTABLE, (void *)((mui_u8g2_u8_min_max_step_t [] ) {{ (valptr) MUI_U8G2_COMMA (min) MUI_U8G2_COMMA (max) MUI_U8G2_COMMA (step) MUI_U8G2_COMMA (flags) MUI_U8G2_COMMA (0) }}), (muif))
...
#define MUIF_U8G2_U8_MIN_MAX_STEP_WIDTH(id,valptr,min,max,step,width,flags,muif) MUIF(id, MUIF_CFLAG_IS_CURSOR_SELECTABLE, (void *)((mui_u8g2_u8_min_max_step_t [] ) {{ (valptr) MUI_U8G2_COMMA (min) MUI_U8G2_COMMA (max) MUI_U8G2_COMMA (step) MUI_U8G2_COMMA (flags) MUI_U8G2_COMMA (width) }}), (muif))
...
#define MUIF_U8G2_U16_LIST(id,valptr,dataptr,getcb,cntcb,muif) MUIF(id, MUIF_CFLAG_IS_CURSOR_SELECTABLE, (void *)((mui_u8g2_list_t [] ) {{ (valptr) MUI_U8G2_COMMA (dataptr) MUI_U8G2_COMMA (getcb) MUI_U8G2_COMMA (cntcb)}}), (muif))
...
# 149 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c" 2
# 186 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
...
{
  if ( text==
# 232 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c" 3 4
            ((void *)0)
# 232 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
                )
    text = "";
...
# 382 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
uint8_t mui_u8g2_set_font_style_function(mui_t *ui, uint8_t msg)
{
  if ( msg == 1 )
  {
...
# 400 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
uint8_t mui_u8g2_draw_text(mui_t *ui, uint8_t msg)
{
  switch(msg)
  {
...
# 455 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
uint8_t mui_u8g2_btn_goto_wm_fi(mui_t *ui, uint8_t msg)
{
  switch(msg)
  {
...
# 598 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
uint8_t mui_u8g2_btn_exit_wm_fi(mui_t *ui, uint8_t msg)
{
  switch(msg)
  {
    ...
    case 7:
      {
        ...
        if ( value != 
# 616 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c" 3 4
                     ((void *)0) 
# 616 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
                          )
          *value = ui->arg;
      }
      mui_SaveForm(ui);
...
static uint8_t mui_u8g2_u8_bar_mse_msg_handler(mui_t *ui, uint8_t msg) __attribute__((noinline));
...
static uint8_t mui_u8g2_u8_bar_mud_msg_handler(mui_t *ui, uint8_t msg) __attribute__((noinline));
...
static void mui_u8g2_u8_bar_draw_wm(mui_t *ui, uint8_t flags, uint8_t is_fixed_width) __attribute__((noinline));
static void mui_u8g2_u8_bar_draw_wm(mui_t *ui, uint8_t flags, uint8_t is_fixed_width)
{
  ...
  {
    u8g2_uint_t width = ((vmms)->width);

    w += (width<<scale);
    v = ((u8g2_long_t)(*value) * (u8g2_long_t)(width<<scale)) / (u8g2_long_t)max;
  }
...
# 1345 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
uint8_t mui_u8g2_u8_opt_line_wa_mse_pi(mui_t *ui, uint8_t msg)
{
...
# 1569 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
uint8_t mui_u8g2_u8_chkbox_wm_pi(mui_t *ui, uint8_t msg)
{
  u8g2_t *u8g2 = mui_get_U8g2(ui);
  u8g2_uint_t flags = 0;
...
uint8_t mui_u8g2_u8_opt_child_mse_common(mui_t *ui, uint8_t msg)
{
  ...
  switch(msg)
  {
    ...
    case 7:
      if ( value != 
# 1745 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c" 3 4
                   ((void *)0) 
# 1745 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
                        )
...
# 1905 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
uint8_t mui_u8g2_goto_data(mui_t *ui, uint8_t msg)
{
  switch(msg)
  {
...
static uint8_t mui_u8g2_u16_list_child_mse_common(mui_t *ui, uint8_t msg)
{
  ...
  switch(msg)
  {
    ...
    case 7:
      if ( selection != 
# 2155 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c" 3 4
                       ((void *)0) 
# 2155 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
                            )
...
uint8_t mui_u8g2_u16_list_goto_w1_pi(mui_t *ui, uint8_t msg)
{
  ...
  switch(msg)
  {
    ...
    case 7:
      if ( selection != 
# 2234 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c" 3 4
                       ((void *)0) 
# 2234 "../packages/U8g2_Arduino-latest/src/clib/mui_u8g2.c"
                            )
        *selection = pos;
