...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sed1330.c"
	.loc 1 69 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L2:
	...
	bnez	a5,.L5
	.loc 1 84 2
	lla	a1,u8x8_d_sed1330_powersave0_seq
	lw	a0,-36(s0)
...
.L5:
	.loc 1 86 2
	lla	a1,u8x8_d_sed1330_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 87 7
	j	.L7
...
.L9:
	...
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 102 2 discriminator 3
	li	a1,66
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 104 2 discriminator 3
	lbu	a5,-25(s0)
	lw	a2,-24(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 106 13 discriminator 3
	lw	a5,-36(s0)
	lw	a5,0(a5)
	.loc 1 106 27 discriminator 3
	lbu	a5,16(a5)
	mv	a4,a5
	.loc 1 106 6 discriminator 3
	lw	a5,-24(s0)
	add	a5,a5,a4
	sw	a5,-24(s0)
	.loc 1 107 11 discriminator 3
	lw	a5,-36(s0)
	lw	a5,0(a5)
...
.L13:
	.loc 1 237 7
	lla	a1,u8x8_sed1330_240x128_display_info
	lw	a0,-20(s0)
...
.L14:
	...
	.loc 1 241 7
	lla	a1,u8x8_d_sed1330_240x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 242 7
	j	.L16
...
.L21:
	...
	call	u8x8_d_helper_display_init
	.loc 1 259 7
	lla	a1,u8x8_d_rh8835_nhd_240128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 260 7
	j	.L23
...
.L27:
	.loc 1 341 7
	lla	a1,u8x8_sed1330_320x240_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 342 7
	j	.L30
.L28:
	...
	call	u8x8_d_helper_display_init
	.loc 1 345 7
	lla	a1,u8x8_d_sed1330_320x240_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 346 7
	j	.L30
...
.LFE3:
	...
	.section	.rodata
	.align	2
	.type	u8x8_sed1330_256x128_display_info, @object
	.size	u8x8_sed1330_256x128_display_info, 24
u8x8_sed1330_256x128_display_info:
	.byte	0
	.byte	1
	.byte	30
	.byte	10
	...
	.half	128
	.align	2
	.type	u8x8_d_sed1330_256x128_init_seq, @object
	.size	u8x8_d_sed1330_256x128_init_seq, 58
u8x8_d_sed1330_256x128_init_seq:
	.byte	-2
	.byte	100
	.byte	24
	.byte	-2
	...
	.text
	.align	1
	.globl	u8x8_d_sed1330_256x128
	.type	u8x8_d_sed1330_256x128, @function
...
.L34:
	.loc 1 428 7
	lla	a1,u8x8_sed1330_256x128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 429 7
	j	.L37
.L35:
	...
	call	u8x8_d_helper_display_init
	.loc 1 432 7
	lla	a1,u8x8_d_sed1330_256x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 433 7
	j	.L37
...
.L38:
	...
	.cfi_endproc
.LFE4:
	.size	u8x8_d_sed1330_256x128, .-u8x8_d_sed1330_256x128
	.section	.rodata
	.align	2
	.type	u8x8_sed1330_320x200_display_info, @object
	.size	u8x8_sed1330_320x200_display_info, 24
u8x8_sed1330_320x200_display_info:
	.byte	0
	.byte	1
	.byte	30
	.byte	10
	...
	.half	200
	.align	2
	.type	u8x8_d_sed1330_320x200_init_seq, @object
	.size	u8x8_d_sed1330_320x200_init_seq, 58
u8x8_d_sed1330_320x200_init_seq:
	.byte	-2
	.byte	100
	.byte	24
	.byte	-2
	...
	.text
	.align	1
	.globl	u8x8_d_sed1330_320x200
	.type	u8x8_d_sed1330_320x200, @function
...
.L41:
	.loc 1 522 7
	lla	a1,u8x8_sed1330_320x200_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 523 7
	j	.L44
.L42:
	...
	call	u8x8_d_helper_display_init
	.loc 1 526 7
	lla	a1,u8x8_d_sed1330_320x200_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 527 7
	j	.L44
...
.L45:
	...
	.cfi_endproc
.LFE5:
	.size	u8x8_d_sed1330_320x200, .-u8x8_d_sed1330_320x200
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_sed1330_256x128_display_info
	.byte	0x14
	.4byte	.LASF918
	.byte	0x1
	.2byte	0x181
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_sed1330_256x128_init_seq
	.byte	0x14
	.4byte	.LASF919
	.byte	0x1
	.2byte	0x1c4
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_sed1330_320x200_display_info
	.byte	0x14
	.4byte	.LASF920
	.byte	0x1
	.2byte	0x1dc
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_sed1330_320x200_init_seq
	.byte	0x15
	.4byte	.LASF924
	.byte	0x1
	.2byte	0x205
...
.LASF918:
	.string	"u8x8_d_sed1330_256x128_init_seq"
.LASF702:
...
.LASF919:
	.string	"u8x8_sed1330_320x200_display_info"
.LASF25:
...
.LASF917:
	.string	"u8x8_sed1330_256x128_display_info"
.LASF879:
...
.LASF920:
	.string	"u8x8_d_sed1330_320x200_init_seq"
.LASF636:
...
.LASF930:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sed1330.c"
.LASF814:
