...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1611.c"
	.loc 1 85 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L11:
	.loc 1 207 2
	lla	a1,u8x8_uc1611_240x64_display_info
	lw	a0,-20(s0)
...
.L9:
	...
	.loc 1 211 2
	lla	a1,u8x8_d_uc1611_ea_dogm240_init_seq
	lw	a0,-20(s0)
...
.L13:
	...
	bnez	a5,.L15
	.loc 1 215 4
	lla	a1,u8x8_d_uc1611s_powersave0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 218 2
	j	.L8
.L15:
	.loc 1 217 4
	lla	a1,u8x8_d_uc1611s_powersave1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 218 2
	j	.L8
.L14:
	...
	bnez	a5,.L17
	.loc 1 222 4
	lla	a1,u8x8_d_uc1611s_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 223 25
	lw	a5,-20(s0)
...
.L17:
	.loc 1 227 4
	lla	a1,u8x8_d_uc1611s_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 228 25
	lw	a5,-20(s0)
...
.L25:
	.loc 1 300 2
	lla	a1,u8x8_uc1611_240x128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 301 2
	j	.L22
.L23:
	...
	call	u8x8_d_helper_display_init
	.loc 1 304 2
	lla	a1,u8x8_d_uc1611_ea_dogxl240_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 305 2
	j	.L22
...
.L43:
	.loc 1 466 7
	lla	a1,u8x8_uc1611_ew50850_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 467 7
	j	.L51
.L42:
	...
	call	u8x8_d_helper_display_init
	.loc 1 470 7
	lla	a1,u8x8_d_uc1611_ew50850_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 471 7
	j	.L51
.L41:
	...
	bnez	a5,.L52
	.loc 1 474 2
	lla	a1,u8x8_d_uc1611_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 477 7
	j	.L51
.L52:
	.loc 1 476 2
	lla	a1,u8x8_d_uc1611_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 477 7
	j	.L51
.L40:
	...
	bnez	a5,.L54
	.loc 1 481 2
	lla	a1,u8x8_d_uc1611_alt_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 482 23
	lw	a5,-36(s0)
...
.L54:
	.loc 1 486 2
	lla	a1,u8x8_d_uc1611_alt_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 487 23
	lw	a5,-36(s0)
...
.L62:
	.loc 1 604 2
	lla	a1,u8x8_uc1611_cg160160_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 605 2
	j	.L59
.L60:
	...
	call	u8x8_d_helper_display_init
	.loc 1 608 2
	lla	a1,u8x8_d_uc1611_cg160160_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 609 2
	j	.L59
...
.LFE4:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_uc1611_ids4073_init_seq, @object
...
u8x8_d_uc1611_ids4073_init_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_uc1611_256x128_display_info, @object
...
.L80:
	.loc 1 739 7
	lla	a1,u8x8_uc1611_256x128_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 740 7
	j	.L83
.L79:
	...
	call	u8x8_d_helper_display_init
	.loc 1 743 7
	lla	a1,u8x8_d_uc1611_ids4073_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 744 7
	j	.L83
...
.L88:
	...
	.cfi_endproc
.LFE5:
	.size	u8x8_d_uc1611_ids4073, .-u8x8_d_uc1611_ids4073
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_uc1611_ids4073_init_seq
	.byte	0x14
	.4byte	.LASF927
	.byte	0x1
	.2byte	0x29a
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_uc1611_256x128_display_info
	.byte	0x15
	.4byte	.LASF931
	.byte	0x1
	.2byte	0x2b3
...
.LASF926:
	.string	"u8x8_d_uc1611_ids4073_init_seq"
.LASF684:
...
.LASF927:
	.string	"u8x8_uc1611_256x128_display_info"
.LASF218:
...
.LASF937:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1611.c"
.LASF388:
