...
u8g2_DrawUTF8Line:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8g2_selection_list.c"
	.loc 1 53 1
	.cfi_startproc
	addi	sp,sp,-48
...
.LFB3:
	...
	j	.L18
.L19:
	.loc 1 187 61 discriminator 3
	lw	a5,-40(s0)
	lbu	a4,2(a5)
	.loc 1 187 10 discriminator 3
	lbu	a5,-17(s0)
	add	a5,a4,a5
	andi	a3,a5,0xff
	lhu	a5,-42(s0)
	...
	lw	a1,-40(s0)
	lw	a0,-36(s0)
	call	u8g2_draw_selection_list_line
	mv	a5,a0
	mv	a4,a5
...
.LASF3216:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8g2_selection_list.c"
.LASF1155:
