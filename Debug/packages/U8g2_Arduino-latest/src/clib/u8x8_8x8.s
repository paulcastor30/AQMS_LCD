...
u8x8_SetFont:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_8x8.c"
	.loc 1 51 1
	.cfi_startproc
	addi	sp,sp,-32
...
.LFB1:
	...
	j	.L4
.L5:
	.loc 1 82 40 discriminator 3
	lw	a5,-36(s0)
	lw	a4,28(a5)
	.loc 1 82 18 discriminator 3
	lhu	a5,-20(s0)
	add	a4,a4,a5
	.loc 1 82 10 discriminator 3
	lbu	a5,-17(s0)
	lw	a3,-44(s0)
	add	a5,a3,a5
...
.L3:
	...
	j	.L7
.L8:
	.loc 1 90 10 discriminator 3
	lbu	a5,-17(s0)
	lw	a4,-44(s0)
	add	a5,a4,a5
	.loc 1 90 14 discriminator 3
	sb	zero,0(a5)
...
.L14:
	...
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_get_glyph_data
	.loc 1 120 7 discriminator 1
	addi	a4,s0,-28
	lbu	a2,-38(s0)
	lbu	a5,-17(s0)
	li	a3,1
	...
	lw	a0,-36(s0)
	call	u8x8_DrawTile
	.loc 1 121 11 discriminator 1
	lbu	a5,-18(s0)
	addi	a5,a5,1
	sb	a5,-18(s0)
	.loc 1 122 9 discriminator 1
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
...
.L19:
	...
	addi	a3,a5,1
	sw	a3,-40(s0)
	.loc 1 174 15 discriminator 1
	lbu	a4,0(a4)
	.loc 1 174 13 discriminator 1
	sb	a4,0(a5)
...
.LFE4:
	...
	.align	1
	.type	u8x8_draw_2x2_subglyph, @function
u8x8_draw_2x2_subglyph:
.LFB5:
	.loc 1 180 1
	.cfi_startproc
	addi	sp,sp,-64
...
.L22:
	...
	lbu	a5,-12(a5)
	mv	a0,a5
	call	u8x8_upscale_byte
	mv	a5,a0
	sh	a5,-20(s0)
	.loc 1 190 15 discriminator 3
	lhu	a5,-20(s0)
	srli	a5,a5,8
	slli	a4,a5,16
	srli	a4,a4,16
	...
	lbu	a5,-17(s0)
	.loc 1 191 15 discriminator 3
	lhu	a4,-20(s0)
	andi	a4,a4,0xff
	addi	a3,s0,-16
	add	a5,a3,a5
	sb	a4,-28(a5)
	.loc 1 187 24 discriminator 3
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L21:
	...
	.cfi_endproc
.LFE5:
	.size	u8x8_draw_2x2_subglyph, .-u8x8_draw_2x2_subglyph
	.align	1
...
.L24:
	...
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_draw_2x2_subglyph
	.loc 1 223 11 discriminator 1
	lbu	a5,-18(s0)
	addi	a5,a5,1
	sb	a5,-18(s0)
	.loc 1 224 9 discriminator 1
	lbu	a5,-17(s0)
	addi	a5,a5,2
	sb	a5,-17(s0)
...
.LFE6:
	...
	.align	1
	.type	u8x8_draw_1x2_subglyph, @function
...
.L28:
	...
	add	a5,a3,a5
	sb	a4,-20(a5)
	.loc 1 243 11 discriminator 3
	lbu	a5,-17(s0)
	.loc 1 243 15 discriminator 3
	lhu	a4,-20(s0)
	andi	a4,a4,0xff
	addi	a3,s0,-16
	add	a5,a3,a5
...
.L27:
	...
	.cfi_endproc
.LFE7:
	.size	u8x8_draw_1x2_subglyph, .-u8x8_draw_1x2_subglyph
	.align	1
...
.LASF938:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_8x8.c"
.LASF233:
