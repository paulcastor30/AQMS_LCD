...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ld7032_60x32.c"
	.loc 1 137 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L8:
	...
	.loc 1 149 7
	lla	a1,u8x8_d_ld7032_60x32_init_seq
	lw	a0,-36(s0)
...
.L7:
	...
	bnez	a5,.L10
	.loc 1 153 2
	lla	a1,u8x8_d_ld7032_60x32_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 156 7
	j	.L9
.L10:
	.loc 1 155 2
	lla	a1,u8x8_d_ld7032_60x32_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 156 7
	j	.L9
.L6:
	...
	bnez	a5,.L12
	.loc 1 160 2
	lla	a1,u8x8_d_ld7032_60x32_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 161 23
	lw	a5,-36(s0)
...
.L12:
	.loc 1 165 2
	lla	a1,u8x8_d_ld7032_60x32_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 166 23
	lw	a5,-36(s0)
...
.L16:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_ld7032_generic, .-u8x8_d_ld7032_generic
	.section	.rodata
	.align	2
...
.LFB1:
	...
	bne	a4,a5,.L18
	.loc 1 239 7
	lla	a1,u8x8_ld7032_60x32_display_info
	lw	a0,-20(s0)
...
.LFE1:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_ld7032_60x32_alt_init_seq, @object
...
.L21:
	...
	call	u8x8_d_helper_display_init
	.loc 1 296 7
	lla	a1,u8x8_d_ld7032_60x32_alt_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 297 14
	li	a5,1
...
.L22:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_d_ld7032_60x32_alt, .-u8x8_d_ld7032_60x32_alt
	.align	1
	.type	u8x8_d_ld7032_128_generic, @function
u8x8_d_ld7032_128_generic:
.LFB3:
	.loc 1 310 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L26:
	...
	call	u8x8_cad_SendCmd
.L38:
	.loc 1 369 4 discriminator 1
	lw	a5,-44(s0)
	lbu	a5,4(a5)
	sb	a5,-18(s0)
	.loc 1 370 6 discriminator 1
	lw	a5,-44(s0)
	lw	a5,0(a5)
	sw	a5,-24(s0)
	.loc 1 371 2 discriminator 1
	lbu	a5,-18(s0)
	slli	a5,a5,3
	andi	a5,a5,0xff
	lw	a2,-24(s0)
...
.L39:
	...
	.cfi_endproc
.LFE3:
	.size	u8x8_d_ld7032_128_generic, .-u8x8_d_ld7032_128_generic
	.section	.rodata
	.align	2
	.type	u8x8_ld7032_128x36_display_info, @object
	.size	u8x8_ld7032_128x36_display_info, 24
u8x8_ld7032_128x36_display_info:
	.byte	0
	.byte	1
	.byte	15
	.byte	20
	...
	.half	36
	.align	2
	.type	u8x8_d_ld7032_128x36_init_seq, @object
	.size	u8x8_d_ld7032_128x36_init_seq, 91
u8x8_d_ld7032_128x36_init_seq:
	.byte	24
	.byte	21
	.byte	20
	.byte	22
	...
	.text
	.align	1
	.globl	u8x8_d_ld7032_128x36
	.type	u8x8_d_ld7032_128x36, @function
...
.LFB4:
	...
	bne	a4,a5,.L41
	.loc 1 445 7
	lla	a1,u8x8_ld7032_128x36_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 446 14
	li	a5,1
...
.L41:
	...
	call	u8x8_d_helper_display_init
	.loc 1 452 7
	lla	a1,u8x8_d_ld7032_128x36_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 453 14
	li	a5,1
...
.L43:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ld7032_128_generic
	mv	a5,a0
.L42:
	.loc 1 457 1
	mv	a0,a5
	...
	.cfi_endproc
.LFE4:
	.size	u8x8_d_ld7032_128x36, .-u8x8_d_ld7032_128x36
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ld7032_60x32_alt_init_seq
	.byte	0x14
	.4byte	.LASF917
	.byte	0x1
	.2byte	0x180
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_ld7032_128x36_display_info
	.byte	0xf
	.4byte	0x9f
	.4byte	0xb92
	.byte	0x10
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ld7032_128x36_init_seq
	.byte	0x15
	.4byte	.LASF922
	.byte	0x1
	.2byte	0x1b9
...
.LASF926:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ld7032_60x32.c"
.LASF702:
...
.LASF916:
	.string	"u8x8_d_ld7032_60x32_alt_init_seq"
.LASF777:
	.string	"u8x8_msg_cb"
.LASF429:
...
.LASF743:
	.string	"utf8_state"
.LASF918:
	.string	"u8x8_d_ld7032_128x36_init_seq"
.LASF803:
...
.LASF552:
	.string	"CHAR_MAX"
.LASF923:
	.string	"u8x8_d_ld7032_60x32_alt"
.LASF647:
...
.LASF928:
	.string	"u8x8_d_ld7032_128_generic"
.LASF729:
	.string	"u8x8_t"
.LASF612:
...
.LASF737:
	.string	"font"
.LASF917:
	.string	"u8x8_ld7032_128x36_display_info"
.LASF280:
