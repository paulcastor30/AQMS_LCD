...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1638.c"
	.loc 1 81 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L9
	.loc 1 126 2
	lla	a1,u8x8_d_uc1638_powersave0_seq
	lw	a0,-36(s0)
...
.L9:
	.loc 1 128 2
	lla	a1,u8x8_d_uc1638_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 129 7
	j	.L8
.L2:
	...
	bnez	a5,.L11
	.loc 1 133 2
	lla	a1,u8x8_d_uc1638_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 134 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 138 2
	lla	a1,u8x8_d_uc1638_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 139 23
	lw	a5,-36(s0)
...
.L16:
	.loc 1 220 2
	lla	a1,u8x8_uc1638_160x128_display_info
	lw	a0,-20(s0)
...
.L17:
	...
	.loc 1 224 2
	lla	a1,u8x8_d_uc1638_160x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 225 2
	j	.L15
...
.LFE1:
	...
	.section	.rodata
	.align	2
	.type	u8x8_uc1638_192x96_display_info, @object
...
u8x8_uc1638_192x96_display_info:
	...
	.half	96
	.align	2
	.type	u8x8_d_uc1638_192x96_init_seq, @object
...
.L24:
	.loc 1 295 2
	lla	a1,u8x8_uc1638_192x96_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 296 2
	j	.L23
.L25:
	...
	call	u8x8_d_helper_display_init
	.loc 1 299 11
	lla	a1,u8x8_d_uc1638_192x96_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 300 2
	j	.L23
...
.L27:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_d_uc1638_192x96, .-u8x8_d_uc1638_192x96
	.section	.rodata
	.align	2
	.type	u8x8_uc1638_240x128_display_info, @object
...
u8x8_uc1638_240x128_display_info:
	...
	.half	128
	.align	2
	.type	u8x8_d_uc1638_240x128_init_seq, @object
...
.L32:
	.loc 1 368 2
	lla	a1,u8x8_uc1638_240x128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 369 2
	j	.L31
.L33:
	...
	call	u8x8_d_helper_display_init
	.loc 1 372 11
	lla	a1,u8x8_d_uc1638_240x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 373 2
	j	.L31
...
.L35:
	...
	.cfi_endproc
.LFE3:
	.size	u8x8_d_uc1638_240x128, .-u8x8_d_uc1638_240x128
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_uc1638_192x96_display_info
	.byte	0xf
	.4byte	0x9f
	.4byte	0xb6a
	.byte	0x10
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_uc1638_192x96_init_seq
	.byte	0x14
	.4byte	.LASF918
	.byte	0x1
	.2byte	0x137
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_uc1638_240x128_display_info
	.byte	0xf
	.4byte	0x9f
	.4byte	0xba5
	.byte	0x10
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_uc1638_240x128_init_seq
	.byte	0x15
	.4byte	.LASF923
	.byte	0x1
	.2byte	0x167
...
.LASF303:
	.string	"__riscv 1"
.LASF919:
	.string	"u8x8_d_uc1638_240x128_init_seq"
.LASF221:
...
.LASF916:
	.string	"u8x8_uc1638_192x96_display_info"
.LASF229:
...
.LASF927:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1638.c"
.LASF507:
	.string	"_SIZE_T_ "
.LASF816:
...
.LASF917:
	.string	"u8x8_d_uc1638_192x96_init_seq"
.LASF239:
...
.LASF918:
	.string	"u8x8_uc1638_240x128_display_info"
.LASF412:
