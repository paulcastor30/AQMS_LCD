...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_message.c"
	.loc 1 39 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L3:
	...
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_GetUTF8Len
	mv	a5,a0
	mv	a4,a5
	.loc 1 51 11 discriminator 3
	lbu	a5,-18(s0)
	add	a5,a4,a5
	sb	a5,-18(s0)
...
.L6:
	...
	mv	a5,a0
	mv	a4,a5
	.loc 1 72 6 discriminator 2
	lbu	a5,-20(s0)
	add	a5,a4,a5
	sb	a5,-20(s0)
	.loc 1 73 34 discriminator 2
	lw	a5,-36(s0)
	sb	zero,35(a5)
	.loc 1 74 8 discriminator 2
	lbu	a4,-37(s0)
	lbu	a5,-20(s0)
	lla	a3,.LC0
	mv	a2,a4
...
.LASF916:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_message.c"
.LASF399:
