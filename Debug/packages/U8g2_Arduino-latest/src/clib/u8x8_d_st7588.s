...
u8x8_d_st7588_128x64_powersave1_seq:
	...
	.text
	.align	1
	.type	u8x8_d_st7588_128x64_generic, @function
u8x8_d_st7588_128x64_generic:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7588.c"
	.loc 1 69 1
	.cfi_startproc
	addi	sp,sp,-48
	...
	bnez	a5,.L5
	.loc 1 87 2
	lla	a1,u8x8_d_st7588_128x64_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	j	.L6
.L5:
	.loc 1 89 2
	lla	a1,u8x8_d_st7588_128x64_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
.L6:
	.loc 1 92 16
...
.L14:
	...
	.loc 1 139 9 discriminator 1
	lbu	a5,-38(s0)
	addi	a5,a5,-1
	sb	a5,-38(s0)
	.loc 1 140 7 discriminator 1
	lbu	a5,-38(s0)
	bnez	a5,.L14
	.loc 1 142 7
	lw	a0,-36(s0)
...
.L15:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_st7588_128x64_generic, .-u8x8_d_st7588_128x64_generic
	.section	.rodata
	.align	2
...
.LFB1:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_st7588_128x64_generic
	mv	a5,a0
	.loc 1 225 6
	beqz	a5,.L17
	.loc 1 226 12
...
.L17:
	...
	sb	a4,36(a5)
	.loc 1 230 5
	lla	a1,u8x8_st7588_128x64_display_info
	lw	a0,-20(s0)
...
.L19:
	...
	.loc 1 236 5
	lla	a1,u8x8_d_st7588_128x64_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 237 12
	li	a5,1
...
.L20:
	...
	bnez	a5,.L22
	.loc 1 243 7
	lla	a1,u8x8_d_st7588_jlx12864_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 244 28
	lw	a5,-20(s0)
...
.L22:
	.loc 1 248 7
	lla	a1,u8x8_d_st7588_jlx12864_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 249 28
	lw	a5,-20(s0)
...
.LASF921:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7588.c"
.LASF298:
