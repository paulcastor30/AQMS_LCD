...
u8x8_d_sh1106_64x32_flip1_seq:
	...
	.text
	.align	1
	.type	u8x8_d_sh1106_64x32_generic, @function
u8x8_d_sh1106_64x32_generic:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1106_64x32.c"
	.loc 1 109 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 125 9
	lla	a1,u8x8_d_sh1106_64x32_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 127 9
	lla	a1,u8x8_d_sh1106_64x32_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 128 7
	j	.L10
.L2:
	...
	bnez	a5,.L11
	.loc 1 132 9
	lla	a1,u8x8_d_sh1106_64x32_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 133 30
	lw	a5,-36(s0)
...
.L11:
	.loc 1 137 9
	lla	a1,u8x8_d_sh1106_64x32_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 138 30
	lw	a5,-36(s0)
...
.L7:
	...
	call	u8x8_cad_SendCmd
.L13:
	.loc 1 160 4 discriminator 1
	lw	a5,-44(s0)
	lbu	a5,4(a5)
	sb	a5,-18(s0)
	.loc 1 161 6 discriminator 1
	lw	a5,-44(s0)
	lw	a5,0(a5)
	sw	a5,-24(s0)
...
.L14:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_sh1106_64x32_generic, .-u8x8_d_sh1106_64x32_generic
	.section	.rodata
	.align	2
...
.LFB1:
	...
	bne	a4,a5,.L16
	.loc 1 203 7
	lla	a1,u8x8_sh1106_64x32_display_info
	lw	a0,-20(s0)
...
.L16:
	...
	.loc 1 209 7
	lla	a1,u8x8_d_sh1106_64x32_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 210 14
	li	a5,1
...
.L18:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_sh1106_64x32_generic
	mv	a5,a0
.L17:
	.loc 1 213 1
	mv	a0,a5
...
.LASF733:
	.string	"cad_cb"
.LASF920:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1106_64x32.c"
.LASF223:
