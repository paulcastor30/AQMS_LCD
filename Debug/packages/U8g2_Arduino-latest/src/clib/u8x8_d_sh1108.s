...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1108.c"
	.loc 1 78 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 96 2
	lla	a1,u8x8_d_sh1108_noname_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 98 2
	lla	a1,u8x8_d_sh1108_noname_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 99 7
	j	.L10
.L2:
	...
	bnez	a5,.L11
	.loc 1 103 2
	lla	a1,u8x8_d_sh1108_160x160_noname_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 104 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 108 2
	lla	a1,u8x8_d_sh1108_160x160_noname_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 109 23
	lw	a5,-36(s0)
...
.L7:
	...
	call	u8x8_cad_SendArg
.L13:
	.loc 1 138 4 discriminator 1
	lw	a5,-44(s0)
	lbu	a5,4(a5)
	sb	a5,-18(s0)
	.loc 1 139 6 discriminator 1
	lw	a5,-44(s0)
	lw	a5,0(a5)
	sw	a5,-24(s0)
...
.L14:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_sh1108_generic, .-u8x8_d_sh1108_generic
	.section	.rodata
	.align	2
...
.L16:
	...
	.loc 1 214 7
	lla	a1,u8x8_d_sh1108_160x160_noname_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 215 7
	j	.L20
.L18:
	.loc 1 217 7
	lla	a1,u8x8_sh1108_160x160_noname_display_info
	lw	a0,-20(s0)
...
.LFE1:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_sh1108_128x160_noname_init_seq, @object
...
u8x8_d_sh1108_128x160_noname_init_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_sh1108_128x160_noname_display_info, @object
...
.L22:
	...
	call	u8x8_d_helper_display_init
	.loc 1 288 7
	lla	a1,u8x8_d_sh1108_128x160_noname_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 289 7
	j	.L26
.L24:
	.loc 1 291 7
	lla	a1,u8x8_sh1108_128x160_noname_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 292 7
	j	.L26
...
.L23:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_d_sh1108_128x160, .-u8x8_d_sh1108_128x160
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_sh1108_128x160_noname_init_seq
	.byte	0x13
	.4byte	.LASF917
	.byte	0x1
	.byte	0xfe
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_sh1108_128x160_noname_display_info
	.byte	0x14
	.4byte	.LASF921
	.byte	0x1
	.2byte	0x116
...
.LASF541:
	.string	"CHAR_BIT"
.LASF917:
	.string	"u8x8_sh1108_128x160_noname_display_info"
.LASF711:
...
.LASF924:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1108.c"
.LASF815:
...
.LASF916:
	.string	"u8x8_d_sh1108_128x160_noname_init_seq"
.LASF629:
