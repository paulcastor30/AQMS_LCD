# 1 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
...
# 1 "<command-line>" 2
# 1 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
# 75 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
...
# 76 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 2
# 85 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
#define MUI_DEBUG(...) 
...
# 128 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
...
# 182 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
...
# 275 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
...
# 328 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
...
static uint8_t mui_prepare_current_field(mui_t *ui)
{
  ...
  ui->uif = 
# 333 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
           ((void *)0)
# 333 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
               ;
  ui->dflags = 0;
  ui->id0 = 0;
  ui->id1 = 0;
...
# 420 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
...
{
  if ( ((ui)->current_form_fds != 
# 450 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
      ((void *)0)
# 450 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
      ) == 0 )
    return;

  ui->fds = ui->current_form_fds;
  ui->target_fds = 
# 454 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
                  ((void *)0)
# 454 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
                      ;
  ui->tmp_fds = 
# 455 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
               ((void *)0)
# 455 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
                   ;
...
fds_t *mui_find_form(mui_t *ui, uint8_t n)
{
  ...
  return 
# 484 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
        ((void *)0)
# 484 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
            ;
}
...
uint8_t mui_task_find_next_cursor_uif(mui_t *ui)
{
  ...
  {
    if ( ui->tmp_fds != 
# 564 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
                       ((void *)0) 
# 564 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
                            )
    {
      ui->target_fds = ui->fds;
      ui->tmp_fds = 
# 567 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
                   ((void *)0)
# 567 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
                       ;
      return 1;
    }
    if ( ui->fds == ui->cursor_focus_fds )
...
# 639 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
uint8_t mui_GetCurrentCursorFocusPosition(mui_t *ui)
{
...
void mui_next_field(mui_t *ui)
{
  ...
  if ( ui->target_fds == 
# 659 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
                        ((void *)0) 
# 659 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
                             )
  {
...
# 678 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
uint8_t mui_GetSelectableFieldTextOption(mui_t *ui, fds_t *fds, uint8_t nth_token)
{
...
void mui_EnterForm(mui_t *ui, fds_t *fds, uint8_t initial_cursor_position)
{
  ...
  ui->touch_focus_fds = 
# 731 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
                       ((void *)0)
# 731 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
                           ;
  ui->cursor_focus_fds = 
# 732 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
                        ((void *)0)
# 732 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
                            ;
...
{
  if ( ((ui)->current_form_fds != 
# 770 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
      ((void *)0)
# 770 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
      ) == 0 )
    return;

  mui_send_cursor_msg(ui, 8);
  ui->cursor_focus_fds = 
# 774 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
                        ((void *)0)
# 774 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
                            ;
  ...
  ui->current_form_fds = 
# 779 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
                        ((void *)0)
# 779 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
                            ;
}
...
uint8_t mui_GotoForm(mui_t *ui, uint8_t form_id, uint8_t initial_cursor_position)
{
  ...
  if ( fds == 
# 789 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
             ((void *)0) 
# 789 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
                  )
    return 0;
...
{
  if ( ((ui)->current_form_fds != 
# 798 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
      ((void *)0)
# 798 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
      ) == 0 )
    return;
...
{
  if ( ((ui)->current_form_fds != 
# 853 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
      ((void *)0)
# 853 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
      ) == 0 )
    return -1;
...
void mui_PrevField(mui_t *ui)
{
  do
  {
    ...
    ui->cursor_focus_fds = ui->target_fds;
    if ( ui->target_fds == 
# 891 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
                          ((void *)0) 
# 891 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
                               )
    {
...
# 914 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
void mui_SendSelectWithExecuteOnSelectFieldSearch(mui_t *ui)
{
  mui_loop_over_form(ui, mui_task_find_execute_on_select_field);
  if ( ui->target_fds != 
# 917 "../packages/U8g2_Arduino-latest/src/clib/mui.c" 3 4
                        ((void *)0) 
# 917 "../packages/U8g2_Arduino-latest/src/clib/mui.c"
                             )
  {
