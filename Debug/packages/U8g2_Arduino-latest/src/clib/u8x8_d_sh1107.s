...
u8x8_d_sh1107_64x128_noname_flip1_seq:
	...
	.text
	.align	1
	.type	u8x8_d_sh1107_HJR_OEL1M0201_generic, @function
u8x8_d_sh1107_HJR_OEL1M0201_generic:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c"
	.loc 1 74 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 92 2
	lla	a1,u8x8_d_sh1107_64x128_noname_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 94 2
	lla	a1,u8x8_d_sh1107_64x128_noname_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 95 7
	j	.L10
.L2:
	...
	bnez	a5,.L11
	.loc 1 99 2
	lla	a1,u8x8_d_sh1107_64x128_noname_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 100 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 104 2
	lla	a1,u8x8_d_sh1107_64x128_noname_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 105 23
	lw	a5,-36(s0)
...
.L14:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_sh1107_HJR_OEL1M0201_generic, .-u8x8_d_sh1107_HJR_OEL1M0201_generic
	.align	1
...
.L30:
	...
	.loc 1 305 7
	lla	a1,u8x8_d_sh1107_64x128_noname_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 306 7
	j	.L34
.L32:
	.loc 1 308 7
	lla	a1,u8x8_sh1107_64x128_noname_display_info
	lw	a0,-20(s0)
...
.L36:
	...
	call	u8x8_d_helper_display_init
	.loc 1 389 7
	lla	a1,u8x8_d_sh1107_seeed_96x96_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 390 7
	j	.L40
.L38:
	.loc 1 392 7
	lla	a1,u8x8_sh1107_seeed_96x96_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 393 7
	j	.L40
...
.LFE3:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_sh1107_HJR_OEL1M0201_96x96_init_seq, @object
...
.LFB4:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_sh1107_HJR_OEL1M0201_generic
	mv	a5,a0
	.loc 1 447 6
	beqz	a5,.L42
	.loc 1 448 12
...
.L42:
	...
	call	u8x8_d_helper_display_init
	.loc 1 454 7
	lla	a1,u8x8_d_sh1107_HJR_OEL1M0201_96x96_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 455 7
	j	.L46
...
.L43:
	...
	.cfi_endproc
.LFE4:
	.size	u8x8_d_sh1107_hjr_oel1m0201_96x96, .-u8x8_d_sh1107_hjr_oel1m0201_96x96
	.section	.rodata
	.align	2
...
.L48:
	...
	call	u8x8_d_helper_display_init
	.loc 1 535 7
	lla	a1,u8x8_d_sh1107_128x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 536 7
	j	.L52
.L50:
	.loc 1 538 7
	lla	a1,u8x8_sh1107_128x128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 539 7
	j	.L52
...
.LFE5:
	...
	.section	.rodata
	.align	2
	.type	u8x8_sh1107_128x80_display_info, @object
...
.L56:
	.loc 1 589 7
	lla	a1,u8x8_sh1107_128x80_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 590 7
	j	.L58
...
.L55:
	...
	.cfi_endproc
.LFE6:
	.size	u8x8_d_sh1107_128x80, .-u8x8_d_sh1107_128x80
	.section	.rodata
	.align	2
...
.L62:
	.loc 1 637 7
	lla	a1,u8x8_sh1107_pimoroni_128x128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 638 7
	j	.L64
...
.L68:
	.loc 1 691 7
	lla	a1,u8x8_seeed_128x128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 692 7
	j	.L70
...
.LFE8:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_sh1107_80x128_init_seq, @object
...
u8x8_d_sh1107_80x128_init_seq:
	...
	.text
	.align	1
	.type	u8x8_d_sh1107_TK078F288_generic, @function
u8x8_d_sh1107_TK078F288_generic:
.LFB9:
	.loc 1 738 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L77:
	...
	call	u8x8_cad_SendCmd
.L83:
	.loc 1 797 4 discriminator 1
	lw	a5,-44(s0)
	lbu	a5,4(a5)
	sb	a5,-18(s0)
	.loc 1 798 6 discriminator 1
	lw	a5,-44(s0)
	lw	a5,0(a5)
	sw	a5,-24(s0)
	.loc 1 799 2 discriminator 1
	lbu	a5,-18(s0)
	slli	a5,a5,3
	andi	a5,a5,0xff
	lw	a2,-24(s0)
	...
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 808 9 discriminator 1
	lbu	a5,-38(s0)
	addi	a5,a5,-1
	sb	a5,-38(s0)
	.loc 1 809 7 discriminator 1
	lbu	a5,-38(s0)
	bnez	a5,.L83
	.loc 1 811 7
	lw	a0,-36(s0)
...
.L84:
	...
	.cfi_endproc
.LFE9:
	.size	u8x8_d_sh1107_TK078F288_generic, .-u8x8_d_sh1107_TK078F288_generic
	.section	.rodata
	.align	2
	.type	u8x8_TK078F288_80x128_display_info, @object
...
.LFB10:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_sh1107_TK078F288_generic
	mv	a5,a0
	.loc 1 844 6
	beqz	a5,.L86
	.loc 1 845 12
...
.L86:
	...
	call	u8x8_d_helper_display_init
	.loc 1 851 7
	lla	a1,u8x8_d_sh1107_80x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 852 7
	j	.L90
.L88:
	.loc 1 854 7
	lla	a1,u8x8_TK078F288_80x128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 855 7
	j	.L90
...
.L87:
	...
	.cfi_endproc
.LFE10:
	.size	u8x8_d_sh1107_tk078f288_80x128, .-u8x8_d_sh1107_tk078f288_80x128
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_sh1107_HJR_OEL1M0201_96x96_init_seq
	.byte	0xf
	.4byte	0x9f
	.4byte	0xbbc
	.byte	0x10
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_sh1107_128x80_display_info
	.byte	0x14
	.4byte	.LASF922
	.byte	0x1
	.2byte	0x258
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_sh1107_80x128_init_seq
	.byte	0x14
	.4byte	.LASF925
	.byte	0x1
	.2byte	0x332
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_TK078F288_80x128_display_info
	.byte	0x15
	.4byte	.LASF929
	.byte	0x1
	.2byte	0x349
...
.LASF925:
	.string	"u8x8_TK078F288_80x128_display_info"
.LASF843:
...
.LASF937:
	.string	"u8x8_d_sh1107_TK078F288_generic"
.LASF130:
...
.LASF940:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c"
.LASF232:
...
.LASF929:
	.string	"u8x8_d_sh1107_tk078f288_80x128"
.LASF154:
...
.LASF942:
	.string	"u8x8_d_sh1107_HJR_OEL1M0201_generic"
.LASF927:
	.string	"arg_int"
.LASF45:
...
.LASF924:
	.string	"u8x8_d_sh1107_80x128_init_seq"
.LASF472:
...
.LASF361:
	.string	"unsigned"
.LASF918:
	.string	"u8x8_d_sh1107_HJR_OEL1M0201_96x96_init_seq"
.LASF761:
	.string	"sck_clock_hz"
.LASF862:
...
.LASF921:
	.string	"u8x8_sh1107_128x80_display_info"
.LASF62:
...
.LASF934:
	.string	"u8x8_d_sh1107_hjr_oel1m0201_96x96"
.LASF80:
