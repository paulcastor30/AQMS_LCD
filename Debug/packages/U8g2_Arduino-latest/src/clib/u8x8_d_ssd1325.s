...
u8x8_d_ssd1325_128x64_nhd_flip1_seq:
	...
	.comm	u8x8_ssd1325_8to32_dest_buf,32,4
	.text
	.align	1
	.type	u8x8_ssd1325_8to32, @function
u8x8_ssd1325_8to32:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1325.c"
	.loc 1 86 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L7:
	.loc 1 94 10
	lla	a5,u8x8_ssd1325_8to32_dest_buf
	sw	a5,-28(s0)
	.loc 1 95 10
	lbu	a5,-21(s0)
	lw	a4,-28(s0)
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_ssd1325_8to32, .-u8x8_ssd1325_8to32
	.align	1
...
.LFB1:
	...
	bnez	a5,.L13
	.loc 1 138 2
	lla	a1,u8x8_d_ssd1325_128x64_nhd_powersave0_seq
	lw	a0,-36(s0)
...
.L13:
	.loc 1 140 2
	lla	a1,u8x8_d_ssd1325_128x64_nhd_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 141 7
	j	.L15
...
.LFB2:
	...
	bne	a4,a5,.L22
	.loc 1 296 7
	lla	a1,u8x8_nhd_ssd1325_128x64_display_info
	lw	a0,-20(s0)
...
.L22:
	...
	.loc 1 302 7
	lla	a1,u8x8_d_ssd1325_128x64_nhd_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 303 14
	li	a5,1
...
.L24:
	...
	bnez	a5,.L26
	.loc 1 309 2
	lla	a1,u8x8_d_ssd1325_128x64_nhd_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 310 23
	lw	a5,-20(s0)
...
.L26:
	.loc 1 314 2
	lla	a1,u8x8_d_ssd1325_128x64_nhd_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 315 23
	lw	a5,-20(s0)
...
.L25:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1325_128x64_generic
	mv	a5,a0
.L23:
	.loc 1 320 1
	mv	a0,a5
...
.LFB3:
	...
	bne	a4,a5,.L29
	.loc 1 408 7
	lla	a1,u8x8_ssd0323_os128064_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 409 14
	li	a5,1
...
.L29:
	...
	call	u8x8_d_helper_display_init
	.loc 1 414 7
	lla	a1,u8x8_d_ssd0323_os128064_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 415 14
	li	a5,1
...
.L31:
	...
	bnez	a5,.L33
	.loc 1 421 2
	lla	a1,u8x8_d_ssd0323_os128064_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 422 23
	lw	a5,-20(s0)
...
.L33:
	.loc 1 426 2
	lla	a1,u8x8_d_ssd0323_os128064_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 427 23
	lw	a5,-20(s0)
...
.LASF928:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1325.c"
.LASF41:
