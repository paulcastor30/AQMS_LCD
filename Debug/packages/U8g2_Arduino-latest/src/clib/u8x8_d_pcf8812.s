...
u8x8_d_pcf8812_96x65_powersave1_seq:
	...
	.text
	.align	1
	.type	u8x8_d_pcf8812_96x65_generic, @function
u8x8_d_pcf8812_96x65_generic:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_pcf8812.c"
	.loc 1 82 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	.loc 1 94 7
	lla	a1,u8x8_d_pcf8812_96x65_init_seq
	lw	a0,-36(s0)
...
.L2:
	...
	bnez	a5,.L9
	.loc 1 98 2
	lla	a1,u8x8_d_pcf8812_96x65_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 101 7
	j	.L8
.L9:
	.loc 1 100 2
	lla	a1,u8x8_d_pcf8812_96x65_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 101 7
	j	.L8
...
.L12:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_pcf8812_96x65_generic, .-u8x8_d_pcf8812_96x65_generic
	.section	.rodata
	.align	2
...
.LFB1:
	...
	bne	a4,a5,.L14
	.loc 1 187 7
	lla	a1,u8x8_pcf8812_96x65_display_info
	lw	a0,-20(s0)
...
.L14:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_pcf8812_96x65_generic
	mv	a5,a0
.L15:
	.loc 1 191 1
	mv	a0,a5
...
.LASF918:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_pcf8812.c"
.LASF720:
	.string	"__uint32_t"
.LASF130:
