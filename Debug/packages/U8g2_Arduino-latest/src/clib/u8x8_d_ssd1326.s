...
u8x8_d_ssd1326_256x32_nhd_flip1_seq:
	...
	.comm	u8x8_ssd1326_8to32_dest_buf,32,4
	.text
	.align	1
	.type	u8x8_ssd1326_8to32, @function
u8x8_ssd1326_8to32:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1326.c"
	.loc 1 124 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L7:
	.loc 1 132 10
	lla	a5,u8x8_ssd1326_8to32_dest_buf
	sw	a5,-28(s0)
	.loc 1 133 10
	lbu	a5,-21(s0)
	lw	a4,-28(s0)
...
.L4:
	...
	sb	a5,-17(s0)
.L5:
	.loc 1 143 13 discriminator 2
	lw	a5,-28(s0)
	lbu	a4,-17(s0)
	sb	a4,0(a5)
	.loc 1 144 11 discriminator 2
	lw	a5,-28(s0)
	addi	a5,a5,4
	sw	a5,-28(s0)
	.loc 1 145 9 discriminator 2
	lbu	a5,-18(s0)
	srli	a5,a5,1
	sb	a5,-18(s0)
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_ssd1326_8to32, .-u8x8_ssd1326_8to32
	.align	1
	.type	u8x8_d_ssd1326_256x32_generic, @function
...
.L16:
	...
	.loc 1 169 7
	lla	a1,u8x8_d_ssd1326_er_256x32_init_seq
	lw	a0,-36(s0)
...
.L15:
	...
	bnez	a5,.L18
	.loc 1 173 2
	lla	a1,u8x8_d_ssd1326_256x32_nhd_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 176 7
	j	.L17
.L18:
	.loc 1 175 2
	lla	a1,u8x8_d_ssd1326_256x32_nhd_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 176 7
	j	.L17
.L14:
	...
	bnez	a5,.L20
	.loc 1 180 2
	lla	a1,u8x8_d_ssd1326_256x32_nhd_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 181 23
	lw	a5,-36(s0)
...
.L20:
	.loc 1 185 2
	lla	a1,u8x8_d_ssd1326_256x32_nhd_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 186 23
	lw	a5,-36(s0)
...
.L22:
	...
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 219 11 discriminator 1
	li	a1,117
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 220 11 discriminator 1
	lbu	a5,-25(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
...
.L24:
	...
	.cfi_endproc
.LFE1:
	.size	u8x8_d_ssd1326_256x32_generic, .-u8x8_d_ssd1326_256x32_generic
	.section	.rodata
	.align	2
...
.LFB2:
	...
	bne	a4,a5,.L26
	.loc 1 271 7
	lla	a1,u8x8_ssd1326_256x32_display_info
	lw	a0,-20(s0)
...
.L26:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1326_256x32_generic
	mv	a5,a0
.L27:
	.loc 1 275 1
	mv	a0,a5
...
.LASF922:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1326.c"
.LASF764:
