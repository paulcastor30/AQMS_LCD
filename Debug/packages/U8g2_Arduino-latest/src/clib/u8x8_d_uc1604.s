...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1604.c"
	.loc 1 77 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L9
	.loc 1 117 2
	lla	a1,u8x8_d_uc1604_powersave0_seq
	lw	a0,-36(s0)
...
.L9:
	.loc 1 119 2
	lla	a1,u8x8_d_uc1604_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 120 7
	j	.L8
.L2:
	...
	bnez	a5,.L11
	.loc 1 124 2
	lla	a1,u8x8_d_uc1604_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 125 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 129 2
	lla	a1,u8x8_d_uc1604_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 130 23
	lw	a5,-36(s0)
...
.L16:
	.loc 1 227 2
	lla	a1,u8x8_uc1604_192x64_display_info
	lw	a0,-20(s0)
...
.L17:
	...
	.loc 1 231 2
	lla	a1,u8x8_d_uc1604_jlx19264_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 232 2
	j	.L15
...
.LASF744:
	.string	"gpio_result"
.LASF920:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1604.c"
.LASF770:
	.string	"pixel_width"
.LASF688:
