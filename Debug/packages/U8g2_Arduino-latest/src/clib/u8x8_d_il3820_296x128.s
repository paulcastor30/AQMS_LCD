...
u8x8_il3820_296x128_display_info:
	...
	.text
	.align	1
	.type	u8x8_convert_tile_for_il3820, @function
u8x8_convert_tile_for_il3820:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_il3820_296x128.c"
	.loc 1 168 1
	.cfi_startproc
	addi	sp,sp,-48
	...
	j	.L2
.L3:
	.loc 1 175 19 discriminator 3
	lw	a5,-36(s0)
	addi	a4,a5,1
	sw	a4,-36(s0)
	.loc 1 175 17 discriminator 3
	lbu	a4,0(a5)
	.loc 1 175 10 discriminator 3
	lw	a5,-24(s0)
	addi	a3,a5,1
	sw	a3,-24(s0)
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_convert_tile_for_il3820, .-u8x8_convert_tile_for_il3820
	.align	1
...
.L7:
	...
	sw	a5,-24(s0)
.L6:
	.loc 1 214 7 discriminator 1
	lw	a0,-24(s0)
	call	u8x8_convert_tile_for_il3820
	mv	a5,a0
	mv	a2,a5
	li	a1,8
	lw	a0,-36(s0)
...
.LFB2:
	...
	call	u8x8_cad_SendMultipleArg
	.loc 1 249 7
	lla	a1,u8x8_d_il3820_exec_1000dly_seq
	lw	a0,-20(s0)
...
.L16:
	.loc 1 378 7
	lla	a1,u8x8_il3820_296x128_display_info
	lw	a0,-20(s0)
...
.L15:
	...
	.loc 1 383 7
	lla	a1,u8x8_d_il3820_296x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 385 7
	lla	a1,u8x8_d_il3820_296x128_powersave0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 386 7
	lw	a0,-20(s0)
	call	u8x8_d_il3820_first_init
	.loc 1 392 7
	j	.L17
.L14:
	.loc 1 394 10
...
.L18:
	.loc 1 397 2
	lla	a1,u8x8_d_il3820_296x128_powersave1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 398 7
	j	.L17
.L13:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_il3820_draw_tile
	.loc 1 401 7
	j	.L17
.L11:
	.loc 1 403 7
	lla	a1,u8x8_d_il3820_to_display_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 404 7
	j	.L17
...
.L27:
	...
	call	u8x8_d_helper_display_init
	.loc 1 522 7
	lla	a1,u8x8_d_il3820_v2_296x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 524 7
	lla	a1,u8x8_d_il3820_296x128_powersave0_seq
...
.L23:
	.loc 1 543 7
	lla	a1,u8x8_d_il3820_v2_to_display_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 544 7
	j	.L29
...
.LASF544:
	.string	"SCHAR_MIN"
.LASF928:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_il3820_296x128.c"
.LASF317:
