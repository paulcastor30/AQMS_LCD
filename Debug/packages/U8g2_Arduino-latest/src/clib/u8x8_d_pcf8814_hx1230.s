...
u8x8_d_hx1230_96x68_flip1_seq:
	...
	.text
	.align	1
	.type	u8x8_d_hx1230_96x68_generic, @function
u8x8_d_hx1230_96x68_generic:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_pcf8814_hx1230.c"
	.loc 1 99 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L8:
	...
	.loc 1 111 7
	lla	a1,u8x8_d_hx1230_96x68_init_seq
	lw	a0,-36(s0)
...
.L7:
	...
	bnez	a5,.L10
	.loc 1 115 2
	lla	a1,u8x8_d_hx1230_96x68_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 118 7
	j	.L9
.L10:
	.loc 1 117 2
	lla	a1,u8x8_d_hx1230_96x68_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 118 7
	j	.L9
.L6:
	...
	bnez	a5,.L12
	.loc 1 122 2
	lla	a1,u8x8_d_hx1230_96x68_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 123 23
	lw	a5,-36(s0)
...
.L12:
	.loc 1 127 2
	lla	a1,u8x8_d_hx1230_96x68_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 128 23
	lw	a5,-36(s0)
...
.L15:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_hx1230_96x68_generic, .-u8x8_d_hx1230_96x68_generic
	.section	.rodata
	.align	2
...
.LFB1:
	...
	bne	a4,a5,.L17
	.loc 1 192 7
	lla	a1,u8x8_hx1230_96x68_display_info
	lw	a0,-20(s0)
...
.L17:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_hx1230_96x68_generic
	mv	a5,a0
.L18:
	.loc 1 196 1
	mv	a0,a5
...
.LASF920:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_pcf8814_hx1230.c"
.LASF666:
