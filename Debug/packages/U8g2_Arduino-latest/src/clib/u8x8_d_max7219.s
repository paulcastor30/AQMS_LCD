...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_max7219.c"
	.loc 1 107 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L6:
	...
	sb	a5,-18(s0)
.L5:
	.loc 1 134 27 discriminator 1
	lw	a5,-36(s0)
	lw	a5,0(a5)
	.loc 1 134 41 discriminator 1
	lbu	a5,16(a5)
...
.L10:
	...
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 156 4 discriminator 3
	lw	a5,-24(s0)
	lbu	a5,0(a5)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 157 7 discriminator 3
	lw	a5,-24(s0)
	addi	a5,a5,1
	sw	a5,-24(s0)
	.loc 1 153 22 discriminator 3
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L9:
	.loc 1 153 2 discriminator 1
	lbu	a4,-17(s0)
	lbu	a5,-25(s0)
	bltu	a4,a5,.L10
	...
	lw	a0,-36(s0)
	call	u8x8_cad_EndTransfer
	.loc 1 150 27 discriminator 2
	lbu	a5,-18(s0)
	addi	a5,a5,1
	sb	a5,-18(s0)
.L8:
	.loc 1 150 7 discriminator 1
	lbu	a4,-18(s0)
	li	a5,7
	bleu	a4,a5,.L11
	.loc 1 162 7
...
.LFB1:
	...
	bne	a5,a4,.L17
	.loc 1 200 7
	lla	a1,u8x8_max7219_32x8_display_info
	lw	a0,-20(s0)
...
.L15:
	...
	.loc 1 204 7
	lla	a1,u8x8_d_max7219_init_seq
	lw	a0,-20(s0)
...
.L16:
	...
	bnez	a5,.L19
	.loc 1 208 2
	lla	a1,u8x8_d_max7219_powersave0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	j	.L20
.L19:
	.loc 1 210 2
	lla	a1,u8x8_d_max7219_powersave1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
.L20:
	.loc 1 211 14
...
.LFB2:
	...
	bne	a5,a4,.L24
	.loc 1 255 7
	lla	a1,u8x8_max7219_16x16_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 256 14
	li	a5,1
...
.LFB3:
	...
	bne	a5,a4,.L31
	.loc 1 302 7
	lla	a1,u8x8_max7219_8x8_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 303 14
	li	a5,1
...
.LFB4:
	...
	bne	a5,a4,.L38
	.loc 1 443 7
	lla	a1,u8x8_max7219_64x8_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 444 14
	li	a5,1
...
.L36:
	...
	call	u8x8_d_helper_display_init
	.loc 1 447 7
	lla	a1,u8x8_d_max7219_8_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 448 14
	li	a5,1
...
.L37:
	...
	bnez	a5,.L40
	.loc 1 451 2
	lla	a1,u8x8_d_max7219_8_powersave0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	j	.L41
.L40:
	.loc 1 453 2
	lla	a1,u8x8_d_max7219_8_powersave1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
.L41:
	.loc 1 454 14
...
.LASF928:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_max7219.c"
.LASF422:
