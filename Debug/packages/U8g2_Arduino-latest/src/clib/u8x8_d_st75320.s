...
u8x8_d_st75320_jlx320240_flip1_seq:
	...
	.text
	.align	1
	.type	u8x8_d_st75320_generic, @function
u8x8_d_st75320_generic:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st75320.c"
	.loc 1 84 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 103 2
	lla	a1,u8x8_d_st75320_jlx320240_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 105 2
	lla	a1,u8x8_d_st75320_jlx320240_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 106 7
	j	.L10
.L2:
	...
	bnez	a5,.L11
	.loc 1 110 2
	lla	a1,u8x8_d_st75320_jlx320240_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 111 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 115 2
	lla	a1,u8x8_d_st75320_jlx320240_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 116 23
	lw	a5,-36(s0)
...
.L15:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_st75320_generic, .-u8x8_d_st75320_generic
	.section	.rodata
	.align	2
...
.L17:
	...
	.loc 1 262 7
	lla	a1,u8x8_d_st75320_jlx320240_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 263 7
	j	.L21
.L19:
	.loc 1 265 7
	lla	a1,u8x8_st75320_jlx320240_display_info
	lw	a0,-20(s0)
...
.LASF719:
	.string	"long int"
.LASF920:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st75320.c"
.LASF132:
