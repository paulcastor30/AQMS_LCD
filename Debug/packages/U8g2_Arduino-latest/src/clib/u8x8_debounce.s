...
.Ltext0:
	...
	.align	1
	.type	u8x8_read_pin_state, @function
u8x8_read_pin_state:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_debounce.c"
	.loc 1 41 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L3:
	...
	lw	a0,-36(s0)
	call	u8x8_gpio_call
	.loc 1 53 22 discriminator 3
	lw	a5,-36(s0)
	lbu	a5,39(a5)
	slli	a5,a5,24
	srai	a5,a5,24
	.loc 1 53 36 discriminator 3
	andi	a5,a5,1
	slli	a4,a5,24
	srai	a4,a4,24
	.loc 1 53 15 discriminator 3
	lb	a5,-18(s0)
	or	a5,a4,a5
	slli	a5,a5,24
	srai	a5,a5,24
	sb	a5,-18(s0)
	.loc 1 46 23 discriminator 3
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_read_pin_state, .-u8x8_read_pin_state
	.align	1
	.type	u8x8_find_first_diff, @function
...
.L7:
	...
	.cfi_endproc
.LFE1:
	.size	u8x8_find_first_diff, .-u8x8_find_first_diff
	.align	1
...
.LASF911:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_debounce.c"
.LASF776:
