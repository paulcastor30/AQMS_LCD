...
u8x8_d_ssd1317_96x96_flip1_seq:
	...
	.text
	.align	1
	.type	u8x8_d_ssd1317_generic, @function
u8x8_d_ssd1317_generic:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1317.c"
	.loc 1 118 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 136 2
	lla	a1,u8x8_d_ssd1317_96x96_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 138 2
	lla	a1,u8x8_d_ssd1317_96x96_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 139 7
	j	.L10
.L2:
	...
	bnez	a5,.L11
	.loc 1 143 2
	lla	a1,u8x8_d_ssd1317_96x96_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 144 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 148 2
	lla	a1,u8x8_d_ssd1317_96x96_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 149 23
	lw	a5,-36(s0)
...
.L14:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_d_ssd1317_generic, .-u8x8_d_ssd1317_generic
	.section	.rodata
	.align	2
...
.L16:
	...
	.loc 1 232 7
	lla	a1,u8x8_d_ssd1317_96x96_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 233 7
	j	.L20
.L18:
	.loc 1 235 7
	lla	a1,u8x8_ssd1317_96x96_display_info
	lw	a0,-20(s0)
...
.LASF920:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1317.c"
.LASF541:
	.string	"CHAR_BIT"
.LASF711:
