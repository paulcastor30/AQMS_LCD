...
u8x8_uc1610_display_info:
	...
	.text
	.align	1
	.type	u8x8_convert_tile_for_uc1610, @function
u8x8_convert_tile_for_uc1610:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1610.c"
	.loc 1 191 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L3:
	...
	mv	a5,a0
	sh	a5,-26(s0)
	.loc 1 200 10 discriminator 3
	lw	a5,-24(s0)
	addi	a4,a5,1
	sw	a4,-24(s0)
	.loc 1 200 13 discriminator 3
	lhu	a4,-26(s0)
	andi	a4,a4,0xff
	sb	a4,0(a5)
	...
	srli	a5,a5,8
	sh	a5,-26(s0)
	.loc 1 202 10 discriminator 3
	lw	a5,-24(s0)
	addi	a4,a5,1
	sw	a4,-24(s0)
	.loc 1 202 13 discriminator 3
	lhu	a4,-26(s0)
	andi	a4,a4,0xff
	sb	a4,0(a5)
	.loc 1 197 23 discriminator 3
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_convert_tile_for_uc1610, .-u8x8_convert_tile_for_uc1610
	.align	1
...
.L13:
	.loc 1 214 7
	lla	a1,u8x8_uc1610_display_info
	lw	a0,-36(s0)
...
.L12:
	...
	.loc 1 218 7
	lla	a1,u8x8_d_uc1610_dogxl160_init_seq
	lw	a0,-36(s0)
...
.L11:
	...
	bnez	a5,.L15
	.loc 1 222 2
	lla	a1,u8x8_d_uc1610_dogxl160_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 225 7
	j	.L14
.L15:
	.loc 1 224 2
	lla	a1,u8x8_d_uc1610_dogxl160_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 225 7
	j	.L14
.L10:
	...
	bnez	a5,.L17
	.loc 1 229 2
	lla	a1,u8x8_d_uc1610_dogxl160_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 230 23
	lw	a5,-36(s0)
...
.L17:
	.loc 1 234 2
	lla	a1,u8x8_d_uc1610_dogxl160_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 235 23
	lw	a5,-36(s0)
...
.L20:
	...
	sw	a5,-24(s0)
.L19:
	.loc 1 278 4 discriminator 1
	lw	a0,-24(s0)
	call	u8x8_convert_tile_for_uc1610
	mv	a5,a0
	mv	a2,a5
	li	a1,16
	lw	a0,-36(s0)
...
.LASF922:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1610.c"
.LASF26:
