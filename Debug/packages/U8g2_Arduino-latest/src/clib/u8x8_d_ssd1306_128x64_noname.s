...
u8x8_d_sh1106_128x64_winstar_init_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_d_ssd1312_128x64_noname_init_seq, @object
...
u8x8_d_ssd1306_128x64_noname_flip1_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_d_ssd1312_128x64_noname_flip0_seq, @object
...
u8x8_d_ssd1312_128x64_noname_flip0_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_d_ssd1312_128x64_noname_flip1_seq, @object
...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1306_128x64_noname.c"
	.loc 1 255 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 273 2
	lla	a1,u8x8_d_ssd1306_128x64_noname_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 275 2
	lla	a1,u8x8_d_ssd1306_128x64_noname_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 276 7
	j	.L10
.L2:
	...
	bnez	a5,.L11
	.loc 1 280 2
	lla	a1,u8x8_d_ssd1306_128x64_noname_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 281 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 285 2
	lla	a1,u8x8_d_ssd1306_128x64_noname_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 286 23
	lw	a5,-36(s0)
...
.L13:
	...
	lbu	a5,4(a5)
	sb	a5,-18(s0)
	.loc 1 313 6 discriminator 1
	lw	a5,-44(s0)
	lw	a5,0(a5)
	sw	a5,-24(s0)
	.loc 1 314 2 discriminator 1
	lbu	a5,-18(s0)
	slli	a5,a5,3
	andi	a5,a5,0xff
	lw	a2,-24(s0)
...
.LFB1:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1306_sh1106_generic
	mv	a5,a0
	.loc 1 362 6
	beqz	a5,.L16
	.loc 1 363 12
...
.L16:
	...
	.loc 1 369 7
	lla	a1,u8x8_d_ssd1306_128x64_noname_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 370 7
	j	.L20
.L18:
	.loc 1 372 7
	lla	a1,u8x8_ssd1306_128x64_noname_display_info
	lw	a0,-20(s0)
...
.L23:
	...
	bnez	a5,.L26
	.loc 1 387 2
	lla	a1,u8x8_d_ssd1312_128x64_noname_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 388 23
	lw	a5,-20(s0)
...
.L26:
	.loc 1 392 2
	lla	a1,u8x8_d_ssd1312_128x64_noname_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 393 23
	lw	a5,-20(s0)
...
.L22:
	...
	call	u8x8_d_helper_display_init
	.loc 1 398 7
	lla	a1,u8x8_d_ssd1312_128x64_noname_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 399 7
	j	.L28
...
.L29:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_d_ssd1312_128x64_noname, .-u8x8_d_ssd1312_128x64_noname
	.align	1
...
.L32:
	...
	call	u8x8_d_helper_display_init
	.loc 1 422 7
	lla	a1,u8x8_d_ssd1306_128x64_vcomh0_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 423 7
	j	.L36
...
.L38:
	...
	call	u8x8_d_helper_display_init
	.loc 1 443 7
	lla	a1,u8x8_d_ssd1306_128x64_alt0_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 444 7
	j	.L42
...
.L46:
	.loc 1 494 7
	lla	a1,u8x8_sh1106_128x64_noname_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 495 7
	j	.L48
...
.L56:
	...
	call	u8x8_d_helper_display_init
	.loc 1 533 7
	lla	a1,u8x8_d_sh1106_128x64_winstar_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 534 7
	j	.L60
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1312_128x64_noname_init_seq
	.byte	0xf
	.4byte	0x9f
	.4byte	0xb31
	.byte	0x10
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1312_128x64_noname_flip0_seq
	.byte	0x13
	.4byte	.LASF920
	.byte	0x1
	.byte	0xf6
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1312_128x64_noname_flip1_seq
	.byte	0x14
	.4byte	.LASF921
	.byte	0x1
	.2byte	0x14f
...
.LASF919:
	.string	"u8x8_d_ssd1312_128x64_noname_flip0_seq"
.LASF291:
...
.LASF934:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1306_128x64_noname.c"
.LASF585:
...
.LASF519:
	.string	"__WCHAR_T__ "
.LASF920:
	.string	"u8x8_d_ssd1312_128x64_noname_flip1_seq"
.LASF795:
...
.LASF914:
	.string	"u8x8_d_ssd1312_128x64_noname_init_seq"
.LASF533:
	.string	"_BSD_WCHAR_T_"
.LASF722:
...
.LASF931:
	.string	"u8x8_d_ssd1312_128x64_noname"
.LASF482:
	.string	"_VA_LIST_ "
.LASF92:
