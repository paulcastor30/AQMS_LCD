...
u8sl_Next:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_selection_list.c"
	.loc 1 44 1
	.cfi_startproc
	addi	sp,sp,-32
...
.L20:
	...
	addi	a5,s0,-24
	lw	a3,-48(s0)
	lla	a2,u8x8_sl_string_line_cb
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_DrawSelectionList
.L28:
	.loc 1 156 13
	lw	a0,-36(s0)
...
.LASF744:
	.string	"gpio_result"
.LASF923:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_selection_list.c"
.LASF688:
