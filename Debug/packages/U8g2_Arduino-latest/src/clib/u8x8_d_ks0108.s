...
u8x8_ks0108_out:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ks0108.c"
	.loc 1 68 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L11:
	.loc 1 136 7
	lla	a1,u8x8_ks0108_128x64_display_info
	lw	a0,-36(s0)
...
.LVL4:
	.loc 1 154 2
	lla	a1,u8x8_d_ks0108_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 155 6
	lw	a5,-36(s0)
...
.LVL8:
	.loc 1 165 2
	lla	a1,u8x8_d_ks0108_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 166 6
	lw	a5,-36(s0)
...
.L26:
	.loc 1 246 7
	lla	a1,u8x8_ks0108_192x64_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 247 7
	j	.L30
...
.LASF922:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ks0108.c"
.LASF41:
