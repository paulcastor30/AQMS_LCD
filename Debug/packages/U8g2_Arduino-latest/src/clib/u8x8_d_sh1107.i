# 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c"
...
# 1 "<command-line>" 2
# 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c"
# 37 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c"
...
# 38 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c" 2
...
static uint8_t u8x8_d_sh1107_HJR_OEL1M0201_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 90 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c"
    case 11:
      if ( arg_int == 0 )
...
# 144 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c"
 arg_int--;
      } while( arg_int > 0 );
...
static uint8_t u8x8_d_sh1107_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 172 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c"
    case 11:
      if ( arg_int == 0 )
 u8x8_cad_SendSequence(u8x8, u8x8_d_sh1107_64x128_noname_powersave0_seq);
      else
 ...
 ptr = ((u8x8_tile_t *)arg_ptr)->tile_ptr;
 u8x8_cad_SendData(u8x8, c*8, ptr);
# 226 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c"
 arg_int--;
      } while( arg_int > 0 );
...
# 654 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c"
...
static uint8_t u8x8_d_sh1107_TK078F288_generic(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
  ...
  switch(msg)
  {
# 754 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c"
    case 11:
      if ( arg_int == 0 )
 u8x8_cad_SendSequence(u8x8, u8x8_d_sh1107_64x128_noname_powersave0_seq);
      else
 ...
 ptr = ((u8x8_tile_t *)arg_ptr)->tile_ptr;
 u8x8_cad_SendData(u8x8, c*8, ptr);
# 808 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_sh1107.c"
 arg_int--;
      } while( arg_int > 0 );
