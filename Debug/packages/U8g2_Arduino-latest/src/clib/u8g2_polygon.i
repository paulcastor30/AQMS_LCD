# 1 "../packages/U8g2_Arduino-latest/src/clib/u8g2_polygon.c"
...
# 9 "../packages/U8g2_Arduino-latest/src/clib/u8g2_polygon.c" 2
...
static void pg_hline(pg_struct *pg, u8g2_t *u8g2)
{
  ...
  if ( y < 0 )
    return;
  if ( y >= (pg_word_t)((u8g2)->height) )
    return;
  if ( x1 < x2 )
  {
    if ( x2 < 0 )
      return;
    if ( x1 >= (pg_word_t)((u8g2)->width) )
      return;
    if ( x1 < 0 )
      x1 = 0;
    if ( x2 >= (pg_word_t)((u8g2)->width) )
      x2 = ((u8g2)->width);
