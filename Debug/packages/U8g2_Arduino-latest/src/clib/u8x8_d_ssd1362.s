...
.Ltext0:
	...
	.section	.srodata,"a"
	.align	2
	.type	u8x8_d_ssd1362_powersave0_seq, @object
...
u8x8_d_ssd1362_powersave0_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_d_ssd1362_powersave1_seq, @object
...
u8x8_d_ssd1362_powersave1_seq:
	...
	.comm	u8x8_ssd1362_to32_dest_buf,32,4
	.text
	.align	1
	.type	u8x8_ssd1362_8to32, @function
u8x8_ssd1362_8to32:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1362.c"
	.loc 1 78 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L7:
	.loc 1 86 10
	lla	a5,u8x8_ssd1362_to32_dest_buf
	sw	a5,-28(s0)
	.loc 1 87 10
	lbu	a5,-21(s0)
	lw	a4,-28(s0)
...
.L4:
	...
	.loc 1 96 10
	beqz	a5,.L5
	.loc 1 96 20 discriminator 1
	lbu	a5,-17(s0)
	ori	a5,a5,15
	sb	a5,-17(s0)
.L5:
	.loc 1 97 13 discriminator 2
	lw	a5,-28(s0)
	lbu	a4,-17(s0)
	sb	a4,0(a5)
	.loc 1 98 11 discriminator 2
	lw	a5,-28(s0)
	addi	a5,a5,4
	sw	a5,-28(s0)
	.loc 1 99 9 discriminator 2
	lbu	a5,-18(s0)
	srli	a5,a5,1
	sb	a5,-18(s0)
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_ssd1362_8to32, .-u8x8_ssd1362_8to32
	.align	1
	.type	u8x8_ssd1362_8to24, @function
u8x8_ssd1362_8to24:
.LFB1:
	.loc 1 109 1
	.cfi_startproc
...
.L12:
	...
	sb	a5,-17(s0)
.L13:
	.loc 1 128 13 discriminator 2
	lw	a5,-28(s0)
	lbu	a4,-17(s0)
	sb	a4,0(a5)
	.loc 1 129 11 discriminator 2
	lw	a5,-28(s0)
	addi	a5,a5,3
	sw	a5,-28(s0)
...
.L10:
	...
	.cfi_endproc
.LFE1:
	.size	u8x8_ssd1362_8to24, .-u8x8_ssd1362_8to24
	.align	1
	.globl	u8x8_d_ssd1362_common
	.type	u8x8_d_ssd1362_common, @function
u8x8_d_ssd1362_common:
.LFB2:
	.loc 1 140 1
	.cfi_startproc
	addi	sp,sp,-48
	...
	bnez	a5,.L21
	.loc 1 157 2
	lla	a1,u8x8_d_ssd1362_powersave0_seq
	lw	a0,-36(s0)
...
.L21:
	.loc 1 159 2
	lla	a1,u8x8_d_ssd1362_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 160 7
	j	.L23
...
.L24:
	...
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 193 11 discriminator 1
	lw	a1,-24(s0)
	lw	a0,-36(s0)
	call	u8x8_ssd1362_8to32
	mv	a5,a0
	mv	a2,a5
	li	a1,32
	lw	a0,-36(s0)
...
.L26:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_d_ssd1362_common, .-u8x8_d_ssd1362_common
	.align	1
	.globl	u8x8_d_ssd1362_common_0_75
	.type	u8x8_d_ssd1362_common_0_75, @function
u8x8_d_ssd1362_common_0_75:
.LFB3:
	.loc 1 214 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L38:
	...
	.cfi_endproc
.LFE3:
	.size	u8x8_d_ssd1362_common_0_75, .-u8x8_d_ssd1362_common_0_75
	.section	.srodata
	.align	2
	.type	u8x8_d_ssd1362_256x64_flip0_seq, @object
...
u8x8_d_ssd1362_256x64_flip0_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_d_ssd1362_256x64_flip1_seq, @object
...
u8x8_d_ssd1362_256x64_flip1_seq:
	...
	.section	.rodata
	.align	2
	.type	u8x8_ssd1362_256x64_display_info, @object
...
u8x8_ssd1362_256x64_display_info:
	...
	.half	64
	.align	2
	.type	u8x8_d_ssd1362_256x64_init_seq, @object
...
.LFB4:
	...
	bne	a5,a4,.L42
	.loc 1 401 7
	lla	a1,u8x8_ssd1362_256x64_display_info
	lw	a0,-20(s0)
...
.L40:
	...
	.loc 1 405 7
	lla	a1,u8x8_d_ssd1362_256x64_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 406 7
	j	.L43
.L41:
	...
	bnez	a5,.L44
	.loc 1 410 2
	lla	a1,u8x8_d_ssd1362_256x64_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 411 23
	lw	a5,-20(s0)
...
.L44:
	.loc 1 415 2
	lla	a1,u8x8_d_ssd1362_256x64_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 416 23
	lw	a5,-20(s0)
...
.L46:
	...
	.cfi_endproc
.LFE4:
	.size	u8x8_d_ssd1362_256x64, .-u8x8_d_ssd1362_256x64
	.section	.rodata
	.align	2
	.type	u8x8_ssd1362_206x36_display_info, @object
...
u8x8_ssd1362_206x36_display_info:
	...
	.half	36
	.align	2
	.type	u8x8_d_ssd1362_206x36_init_seq, @object
...
.LFB5:
	...
	bne	a5,a4,.L50
	.loc 1 515 7
	lla	a1,u8x8_ssd1362_206x36_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 516 7
	j	.L51
.L48:
	...
	call	u8x8_d_helper_display_init
	.loc 1 519 7
	lla	a1,u8x8_d_ssd1362_206x36_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 520 7
	j	.L51
...
.L50:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1362_common_0_75
	mv	a5,a0
	j	.L54
.L51:
	.loc 1 537 10
...
.L54:
	...
	.cfi_endproc
.LFE5:
	.size	u8x8_d_ssd1362_206x36, .-u8x8_d_ssd1362_206x36
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1362_powersave0_seq
	.byte	0x13
	.4byte	.LASF911
	.byte	0x1
	.byte	0x3a
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1362_powersave1_seq
	.byte	0xf
	.4byte	0x93
	.4byte	0xae6
	.byte	0x10
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_ssd1362_to32_dest_buf
	.byte	0xf
	.4byte	0x9f
	.4byte	0xb08
	.byte	0x10
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1362_256x64_flip0_seq
	.byte	0x14
	.4byte	.LASF914
	.byte	0x1
	.2byte	0x133
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1362_256x64_flip1_seq
	.byte	0x14
	.4byte	.LASF915
	.byte	0x1
	.2byte	0x13a
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_ssd1362_256x64_display_info
	.byte	0xf
	.4byte	0x9f
	.4byte	0xb56
	.byte	0x10
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1362_256x64_init_seq
	.byte	0x14
	.4byte	.LASF917
	.byte	0x1
	.2byte	0x1ac
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_ssd1362_206x36_display_info
	.byte	0x14
	.4byte	.LASF918
	.byte	0x1
	.2byte	0x1c6
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1362_206x36_init_seq
	.byte	0x15
	.4byte	.LASF922
	.byte	0x1
	.2byte	0x1fe
...
.LASF928:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1362.c"
.LASF266:
...
.LASF911:
	.string	"u8x8_d_ssd1362_powersave1_seq"
.LASF835:
...
.LASF924:
	.string	"u8x8_d_ssd1362_common_0_75"
.LASF843:
...
.LASF912:
	.string	"u8x8_ssd1362_to32_dest_buf"
.LASF331:
	.string	"__NEWLIB__ 3"
.LASF307:
...
.LASF915:
	.string	"u8x8_ssd1362_256x64_display_info"
.LASF411:
...
.LASF914:
	.string	"u8x8_d_ssd1362_256x64_flip1_seq"
.LASF189:
...
.LASF910:
	.string	"u8x8_d_ssd1362_powersave0_seq"
.LASF82:
...
.LASF918:
	.string	"u8x8_d_ssd1362_206x36_init_seq"
.LASF74:
...
.LASF913:
	.string	"u8x8_d_ssd1362_256x64_flip0_seq"
.LASF635:
...
.LASF916:
	.string	"u8x8_d_ssd1362_256x64_init_seq"
.LASF620:
...
.LASF917:
	.string	"u8x8_ssd1362_206x36_display_info"
.LASF388:
