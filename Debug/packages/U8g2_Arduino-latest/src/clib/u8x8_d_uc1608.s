...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1608.c"
	.loc 1 73 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L9
	.loc 1 113 2
	lla	a1,u8x8_d_uc1608_powersave0_seq
	lw	a0,-36(s0)
...
.L9:
	.loc 1 115 2
	lla	a1,u8x8_d_uc1608_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 116 7
	j	.L8
.L2:
	...
	bnez	a5,.L11
	.loc 1 120 2
	lla	a1,u8x8_d_uc1608_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 121 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 125 2
	lla	a1,u8x8_d_uc1608_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 126 23
	lw	a5,-36(s0)
...
.L16:
	.loc 1 215 2
	lla	a1,u8x8_uc1608_240x64_display_info
	lw	a0,-20(s0)
...
.L17:
	...
	.loc 1 219 2
	lla	a1,u8x8_d_uc1608_erc24064_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 220 2
	j	.L15
...
.L24:
	.loc 1 297 2
	lla	a1,u8x8_uc1608_240x128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 298 2
	j	.L23
.L25:
	...
	call	u8x8_d_helper_display_init
	.loc 1 301 2
	lla	a1,u8x8_d_uc1608_240x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 302 2
	j	.L23
...
.L32:
	.loc 1 380 2
	lla	a1,u8x8_uc1608_erc240120_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 381 2
	j	.L31
.L33:
	...
	call	u8x8_d_helper_display_init
	.loc 1 384 2
	lla	a1,u8x8_d_uc1608_erc240120_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 385 2
	j	.L31
...
.LFB4:
	...
	bnez	a5,.L40
	.loc 1 481 2
	lla	a1,u8x8_d_uc1608_dem240064_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 482 23
	lw	a5,-20(s0)
...
.L40:
	.loc 1 486 2
	lla	a1,u8x8_d_uc1608_dem240064_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 487 23
	lw	a5,-20(s0)
...
.L44:
	.loc 1 501 2
	lla	a1,u8x8_uc1608_dem240064_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 502 2
	j	.L43
.L45:
	...
	call	u8x8_d_helper_display_init
	.loc 1 505 2
	lla	a1,u8x8_d_uc1608_dem240064_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 506 2
	j	.L43
...
.LASF932:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1608.c"
.LASF733:
	.string	"cad_cb"
.LASF492:
	.string	"_T_PTRDIFF "
