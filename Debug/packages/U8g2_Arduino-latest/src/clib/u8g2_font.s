...
u8g2_font_get_byte:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8g2_font.c"
	.loc 1 112 1
	.cfi_startproc
	addi	sp,sp,-32
...
.L62:
	...
	.cfi_endproc
.LFE14:
	.size	u8g2_font_2x_decode_len, .-u8g2_font_2x_decode_len
	.align	1
...
.L77:
	...
	sb	a5,-34(s0)
.L74:
	.loc 1 698 2 discriminator 1
	lbu	a5,-33(s0)
	li	a2,0
	mv	a1,a5
	lw	a0,-52(s0)
	call	u8g2_font_decode_len
	.loc 1 699 2 discriminator 1
	lbu	a5,-34(s0)
	li	a2,1
	mv	a1,a5
	lw	a0,-52(s0)
...
.L87:
	...
	sb	a5,-34(s0)
.L84:
	.loc 1 760 2 discriminator 1
	lbu	a5,-33(s0)
	li	a2,0
	mv	a1,a5
	lw	a0,-52(s0)
	call	u8g2_font_2x_decode_len
	.loc 1 761 2 discriminator 1
	lbu	a5,-34(s0)
	li	a2,1
	mv	a1,a5
	lw	a0,-52(s0)
...
.L83:
	...
	.cfi_endproc
.LFE17:
	.size	u8g2_font_2x_decode_glyph, .-u8g2_font_2x_decode_glyph
	.align	1
...
.L100:
	...
	add	a5,a5,a4
	sw	a5,-20(s0)
	.loc 1 832 11 discriminator 1
	li	a1,2
	lw	a0,-24(s0)
	call	u8g2_font_get_word
	mv	a5,a0
	sh	a5,-26(s0)
	.loc 1 833 27 discriminator 1
	lw	a5,-24(s0)
	addi	a5,a5,4
	sw	a5,-24(s0)
	.loc 1 834 5 discriminator 1
	lhu	a4,-26(s0)
	lhu	a5,-38(s0)
	bltu	a4,a5,.L100
.L103:
...
.LFE19:
	...
	.align	1
	.type	u8g2_font_2x_draw_glyph, @function
...
.LFB20:
	...
	lw	a1,-24(s0)
	lw	a0,-36(s0)
	call	u8g2_font_2x_decode_glyph
	mv	a5,a0
	.loc 1 892 8
	sh	a5,-18(s0)
.L110:
	...
	.cfi_endproc
.LFE20:
	.size	u8g2_font_2x_draw_glyph, .-u8g2_font_2x_draw_glyph
	.align	1
	.globl	u8g2_IsGlyph
...
.LVL4:
	...
	.cfi_endproc
.LFE25:
	.size	u8g2_DrawGlyphX2, .-u8g2_DrawGlyphX2
	.align	1
...
.L150:
	...
	.cfi_endproc
.LFE27:
	.size	u8g2_draw_string_2x, .-u8g2_draw_string_2x
	.align	1
	.globl	u8g2_DrawStr
...
.LFB29:
	...
	.cfi_endproc
.LFE29:
	.size	u8g2_DrawStrX2, .-u8g2_DrawStrX2
	.align	1
	.globl	u8g2_DrawUTF8
...
.LFB31:
	...
	.cfi_endproc
.LFE31:
	.size	u8g2_DrawUTF8X2, .-u8g2_DrawUTF8X2
	.align	1
...
.Letext0:
	...
	.file 5 "../packages/U8g2_Arduino-latest/src/clib/u8x8.h"
	.file 6 "../packages/U8g2_Arduino-latest/src/clib/u8g2.h"
...
.Ldebug_macro0:
	...
	.byte	0x3
	.4byte	.LASF315
	.file 7 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\rtconfig_preinc.h"
	.byte	0x3
	.byte	0x4
	.byte	0x7
	.byte	0x7
...
.LASF3247:
	.string	"u8g2_font_2x_draw_glyph"
.LASF675:
...
.LASF3251:
	.string	"u8g2_font_2x_decode_glyph"
.LASF1332:
...
.LASF3278:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8g2_font.c"
.LASF2211:
...
.LASF3256:
	.string	"u8g2_font_2x_decode_len"
.LASF50:
