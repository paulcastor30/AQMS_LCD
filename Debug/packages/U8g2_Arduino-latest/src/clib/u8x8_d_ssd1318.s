...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1318.c"
	.loc 1 173 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 191 2
	lla	a1,u8x8_d_ssd1318_128x96_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 193 2
	lla	a1,u8x8_d_ssd1318_128x96_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 194 7
	j	.L10
.L2:
	...
	bnez	a5,.L11
	.loc 1 198 2
	lla	a1,u8x8_d_ssd1318_128x96_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 199 23
	lw	a5,-36(s0)
...
.L11:
	.loc 1 203 2
	lla	a1,u8x8_d_ssd1318_128x96_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 204 23
	lw	a5,-36(s0)
...
.L16:
	...
	.loc 1 287 7
	lla	a1,u8x8_d_ssd1318_128x96_icp_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 288 7
	j	.L20
.L18:
	.loc 1 290 7
	lla	a1,u8x8_ssd1318_128x96_display_info
	lw	a0,-20(s0)
...
.L22:
	...
	call	u8x8_d_helper_display_init
	.loc 1 308 7
	lla	a1,u8x8_d_ssd1318_128x96_xcp_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 309 7
	j	.L26
...
.LASF923:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1318.c"
.LASF189:
