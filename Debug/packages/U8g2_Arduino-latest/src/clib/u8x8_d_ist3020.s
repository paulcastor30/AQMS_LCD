...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ist3020.c"
	.loc 1 135 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L9:
	.loc 1 141 7
	lla	a1,u8x8_ist3020_erc19264_display_info
	lw	a0,-36(s0)
...
.L8:
	...
	.loc 1 145 7
	lla	a1,u8x8_d_ist3020_erc19264_init_seq
	lw	a0,-36(s0)
...
.L7:
	...
	bnez	a5,.L11
	.loc 1 149 2
	lla	a1,u8x8_d_ist3020_erc19264_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 152 7
	j	.L10
.L11:
	.loc 1 151 2
	lla	a1,u8x8_d_ist3020_erc19264_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 152 7
	j	.L10
.L6:
	...
	bnez	a5,.L13
	.loc 1 156 2
	lla	a1,u8x8_d_ist3020_erc19264_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 157 23
	lw	a5,-36(s0)
...
.L13:
	.loc 1 161 2
	lla	a1,u8x8_d_ist3020_erc19264_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 162 23
	lw	a5,-36(s0)
...
.LASF920:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ist3020.c"
.LASF292:
