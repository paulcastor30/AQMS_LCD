...
u8g2_DrawLog:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8log_u8g2.c"
	.loc 1 52 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	lbu	a4,-22(s0)
	.loc 1 64 45 discriminator 3
	lw	a3,-44(s0)
	lbu	a3,4(a3)
	.loc 1 64 38 discriminator 3
	mul	a3,a4,a3
	.loc 1 64 53 discriminator 3
	lbu	a4,-21(s0)
	add	a4,a3,a4
	.loc 1 64 31 discriminator 3
	add	a5,a5,a4
	.loc 1 64 9 discriminator 3
	lbu	a5,0(a5)
	sb	a5,-23(s0)
	.loc 1 65 17 discriminator 3
	lbu	a5,-23(s0)
	slli	a3,a5,16
	srli	a3,a3,16
	lhu	a4,-20(s0)
	...
	add	a5,a4,a5
	sh	a5,-18(s0)
	.loc 1 62 48 discriminator 3
	lbu	a5,-21(s0)
	addi	a5,a5,1
	sb	a5,-21(s0)
.L3:
	.loc 1 62 34 discriminator 1
	lw	a5,-44(s0)
	lbu	a5,4(a5)
	.loc 1 62 5 discriminator 1
	lbu	a4,-21(s0)
	bltu	a4,a5,.L4
	.loc 1 67 22 discriminator 2
	lw	a5,-36(s0)
	lb	a5,166(a5)
	slli	a4,a5,16
	srai	a4,a4,16
	...
	slli	a5,a5,16
	srai	a5,a5,16
	.loc 1 67 41 discriminator 2
	sub	a5,a4,a5
	slli	a5,a5,16
	srai	a5,a5,16
	slli	a4,a5,16
	srli	a4,a4,16
	.loc 1 67 12 discriminator 2
	lhu	a5,-20(s0)
	add	a5,a4,a5
	sh	a5,-20(s0)
	.loc 1 68 20 discriminator 2
	lw	a5,-44(s0)
	lb	a5,17(a5)
	slli	a4,a5,16
	srli	a4,a4,16
	.loc 1 68 12 discriminator 2
	lhu	a5,-20(s0)
	add	a5,a4,a5
	sh	a5,-20(s0)
	.loc 1 59 47 discriminator 2
	lbu	a5,-22(s0)
	addi	a5,a5,1
	sb	a5,-22(s0)
.L2:
	.loc 1 59 32 discriminator 1
	lw	a5,-44(s0)
	lbu	a5,5(a5)
...
.LASF3215:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8log_u8g2.c"
.LASF1767:
