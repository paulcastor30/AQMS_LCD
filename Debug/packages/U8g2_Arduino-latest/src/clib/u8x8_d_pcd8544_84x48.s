...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_pcd8544_84x48.c"
	.loc 1 102 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L8:
	.loc 1 108 7
	lla	a1,u8x8_pcd8544_84x48_display_info
	lw	a0,-36(s0)
...
.L7:
	...
	.loc 1 112 7
	lla	a1,u8x8_d_pcd8544_84x48_init_seq
	lw	a0,-36(s0)
...
.L6:
	...
	bnez	a5,.L10
	.loc 1 116 2
	lla	a1,u8x8_d_pcd8544_84x48_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 119 7
	j	.L9
.L10:
	.loc 1 118 2
	lla	a1,u8x8_d_pcd8544_84x48_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 119 7
	j	.L9
...
.LASF918:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_pcd8544_84x48.c"
.LASF720:
	.string	"__uint32_t"
.LASF249:
