...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8g2_intersection.c"
	.loc 1 124 1
	.cfi_startproc
	addi	sp,sp,-32
...
.LFB1:
	...
	mv	a1,a5
	mv	a0,a4
	call	u8g2_is_intersection_decision_tree
	mv	a5,a0
	.loc 1 168 6
	bnez	a5,.L9
	.loc 1 169 12
...
.LASF974:
	.string	"U8G2_ALWAYS_INLINE __inline__ __attribute__((always_inline))"
.LASF620:
...
.LASF3198:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8g2_intersection.c"
.LASF1371:
