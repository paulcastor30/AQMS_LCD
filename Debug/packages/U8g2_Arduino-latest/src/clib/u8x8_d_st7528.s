...
u8x8_d_st7528_flip1_seq:
	...
	.comm	u8x8_st7528_8to32_dest_buf,32,4
	.text
	.align	1
	.type	u8x8_st7528_8to32, @function
u8x8_st7528_8to32:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7528.c"
	.loc 1 91 1
	.cfi_startproc
	addi	sp,sp,-48
	...
	sw	a1,-40(s0)
	.loc 1 95 8
	lla	a5,u8x8_st7528_8to32_dest_buf
	sw	a5,-24(s0)
	.loc 1 96 10
	sb	zero,-17(s0)
	.loc 1 96 3
...
.L3:
	...
	addi	a4,a5,1
	sw	a4,-24(s0)
	.loc 1 98 14 discriminator 3
	lw	a4,-40(s0)
	lbu	a4,0(a4)
	.loc 1 98 13 discriminator 3
	sb	a4,0(a5)
	...
	lw	a4,-40(s0)
	lbu	a4,0(a4)
	.loc 1 100 13 discriminator 3
	sb	a4,0(a5)
	.loc 1 101 10 discriminator 3
	lw	a5,-24(s0)
	addi	a4,a5,1
	sw	a4,-24(s0)
	.loc 1 101 14 discriminator 3
	lw	a4,-40(s0)
	lbu	a4,0(a4)
	.loc 1 101 13 discriminator 3
	sb	a4,0(a5)
	.loc 1 102 8 discriminator 3
	lw	a5,-40(s0)
	addi	a5,a5,1
	sw	a5,-40(s0)
	.loc 1 96 23 discriminator 3
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_st7528_8to32, .-u8x8_st7528_8to32
	.align	1
	.type	u8x8_d_st7528_generic, @function
u8x8_d_st7528_generic:
.LFB1:
	.loc 1 110 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L8:
	...
	bnez	a5,.L12
	.loc 1 127 2
	lla	a1,u8x8_d_st7528_powersave0_seq
	lw	a0,-36(s0)
...
.L12:
	.loc 1 129 2
	lla	a1,u8x8_d_st7528_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 130 7
	j	.L14
.L6:
	...
	bnez	a5,.L15
	.loc 1 134 2
	lla	a1,u8x8_d_st7528_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 135 23
	lw	a5,-36(s0)
...
.L15:
	.loc 1 139 2
	lla	a1,u8x8_d_st7528_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 140 23
	lw	a5,-36(s0)
...
.L17:
	...
	lw	a1,-24(s0)
	lw	a0,-36(s0)
	call	u8x8_st7528_8to32
	mv	a5,a0
	mv	a2,a5
	li	a1,32
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 173 8 discriminator 1
	lw	a5,-24(s0)
	addi	a5,a5,8
	sw	a5,-24(s0)
	.loc 1 174 6 discriminator 1
	lbu	a5,-17(s0)
	addi	a5,a5,8
	sb	a5,-17(s0)
...
.L19:
	...
	.cfi_endproc
.LFE1:
	.size	u8x8_d_st7528_generic, .-u8x8_d_st7528_generic
	.align	1
	.type	u8x8_d_st7528_graylevel_init, @function
u8x8_d_st7528_graylevel_init:
.LFB2:
	.loc 1 190 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L21:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_d_st7528_graylevel_init, .-u8x8_d_st7528_graylevel_init
	.section	.rodata
	.align	2
...
.LFB3:
	...
	bne	a4,a5,.L24
	.loc 1 295 7
	lla	a1,u8x8_st7528_160x100_display_info
	lw	a0,-20(s0)
...
.L24:
	...
	.loc 1 301 7
	lla	a1,u8x8_d_st7528_nhd_c160100_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 302 7
	li	a1,116
	lw	a0,-20(s0)
	call	u8x8_d_st7528_graylevel_init
	.loc 1 303 14
	li	a5,1
	j	.L25
.L26:
...
.LFE3:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_st7528_erc16064_init_seq, @object
...
u8x8_d_st7528_erc16064_init_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_st7528_erc16064_display_info, @object
...
.LFB4:
	...
	bne	a4,a5,.L28
	.loc 1 448 7
	lla	a1,u8x8_st7528_erc16064_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 449 14
	li	a5,1
...
.L28:
	...
	call	u8x8_d_helper_display_init
	.loc 1 454 7
	lla	a1,u8x8_d_st7528_erc16064_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 455 7
	li	a1,100
...
.L29:
	...
	.cfi_endproc
.LFE4:
	.size	u8x8_d_st7528_erc16064, .-u8x8_d_st7528_erc16064
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_st7528_erc16064_init_seq
	.byte	0x14
	.4byte	.LASF918
	.byte	0x1
	.2byte	0x1a2
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_st7528_erc16064_display_info
	.byte	0x15
	.4byte	.LASF922
	.byte	0x1
	.2byte	0x1bc
...
.LASF929:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7528.c"
.LASF537:
	.string	"__need_NULL"
.LASF628:
...
.LASF720:
	.string	"__uint32_t"
.LASF925:
	.string	"u8x8_d_st7528_graylevel_init"
.LASF249:
...
.LASF917:
	.string	"u8x8_d_st7528_erc16064_init_seq"
.LASF567:
...
.LASF918:
	.string	"u8x8_st7528_erc16064_display_info"
.LASF171:
