...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1305.c"
	.loc 1 77 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 115 2
	lla	a1,u8x8_d_ssd1305_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 117 2
	lla	a1,u8x8_d_ssd1305_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 118 7
	j	.L7
...
.L16:
	...
	bnez	a5,.L19
	.loc 1 205 2
	lla	a1,u8x8_d_ssd1305_128x32_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 206 23
	lw	a5,-20(s0)
...
.L19:
	.loc 1 210 2
	lla	a1,u8x8_d_ssd1305_128x32_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 211 23
	lw	a5,-20(s0)
...
.L15:
	...
	.loc 1 216 7
	lla	a1,u8x8_d_ssd1305_128x32_noname_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 217 7
	j	.L21
.L17:
	.loc 1 219 7
	lla	a1,u8x8_ssd1305_128x32_noname_display_info
	lw	a0,-20(s0)
...
.L28:
	.loc 1 346 7
	lla	a1,u8x8_ssd1305_128x32_adafruit_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 347 7
	j	.L32
...
.L37:
	...
	call	u8x8_d_helper_display_init
	.loc 1 444 7
	lla	a1,u8x8_d_ssd1305_128x64_adafruit_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 445 7
	j	.L43
.L39:
	.loc 1 447 7
	lla	a1,u8x8_ssd1305_128x64_adafruit_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 448 7
	j	.L43
...
.LFE3:
	...
	.section	.rodata
	.align	2
	.type	u8x8_ssd1305_128x64_raystar_display_info, @object
...
.L50:
	.loc 1 508 7
	lla	a1,u8x8_ssd1305_128x64_raystar_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 509 7
	j	.L54
...
.L47:
	...
	.cfi_endproc
.LFE4:
	.size	u8x8_d_ssd1305_128x64_raystar, .-u8x8_d_ssd1305_128x64_raystar
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_ssd1305_128x64_raystar_display_info
	.byte	0x15
	.4byte	.LASF923
	.byte	0x1
	.2byte	0x1e3
...
.LASF923:
	.string	"u8x8_d_ssd1305_128x64_raystar"
.LASF579:
...
.LASF928:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1305.c"
.LASF1:
...
.LASF919:
	.string	"u8x8_ssd1305_128x64_raystar_display_info"
.LASF905:
