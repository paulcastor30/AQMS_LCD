...
u8x8_d_ssd1327_winstar_96x64_flip1_seq:
	...
	.comm	u8x8_ssd1327_8to32_dest_buf,32,4
	.text
	.align	1
	.type	u8x8_ssd1327_8to32, @function
u8x8_ssd1327_8to32:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1327.c"
	.loc 1 98 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L7:
	.loc 1 106 10
	lla	a5,u8x8_ssd1327_8to32_dest_buf
	sw	a5,-28(s0)
	.loc 1 107 10
	lbu	a5,-21(s0)
	lw	a4,-28(s0)
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_ssd1327_8to32, .-u8x8_ssd1327_8to32
	.align	1
...
.LFB1:
	...
	bnez	a5,.L13
	.loc 1 149 2
	lla	a1,u8x8_d_ssd1327_96x96_powersave0_seq
	lw	a0,-36(s0)
...
.L13:
	.loc 1 151 2
	lla	a1,u8x8_d_ssd1327_96x96_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 152 7
	j	.L15
...
.L17:
	...
	sw	a5,-24(s0)
.L16:
	.loc 1 182 4 discriminator 1
	li	a1,21
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 183 4 discriminator 1
	lbu	a5,-17(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 184 4 discriminator 1
	lbu	a5,-17(s0)
	addi	a5,a5,3
	andi	a5,a5,0xff
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendArg
	.loc 1 187 4 discriminator 1
	lw	a1,-24(s0)
	lw	a0,-36(s0)
	call	u8x8_ssd1327_8to32
	mv	a5,a0
	mv	a2,a5
	li	a1,32
	lw	a0,-36(s0)
...
.LFB2:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1327_96x96_generic
	mv	a5,a0
	.loc 1 307 6
	beqz	a5,.L20
	.loc 1 308 12
...
.L20:
	...
	bne	a4,a5,.L22
	.loc 1 311 5
	lla	a1,u8x8_ssd1327_winstar_96x64_display_info
	lw	a0,-20(s0)
...
.L22:
	...
	.loc 1 317 5
	lla	a1,u8x8_d_ssd1327_winstar_96x64_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 318 12
	li	a5,1
...
.L23:
	...
	bnez	a5,.L25
	.loc 1 324 7
	lla	a1,u8x8_d_ssd1327_winstar_96x64_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 325 28
	lw	a5,-20(s0)
...
.L25:
	.loc 1 329 7
	lla	a1,u8x8_d_ssd1327_winstar_96x64_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 330 28
	lw	a5,-20(s0)
...
.L28:
	...
	bne	a4,a5,.L30
	.loc 1 434 5
	lla	a1,u8x8_ssd1327_96x96_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 435 12
	li	a5,1
...
.L30:
	...
	call	u8x8_d_helper_display_init
	.loc 1 440 5
	lla	a1,u8x8_d_ssd1327_96x96_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 441 12
	li	a5,1
...
.L31:
	...
	bnez	a5,.L33
	.loc 1 447 7
	lla	a1,u8x8_d_ssd1327_seeed_96x96_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 448 28
	lw	a5,-20(s0)
...
.L33:
	.loc 1 452 7
	lla	a1,u8x8_d_ssd1327_seeed_96x96_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 453 28
	lw	a5,-20(s0)
...
.L36:
	...
	bne	a4,a5,.L38
	.loc 1 555 5
	lla	a1,u8x8_ssd1327_ea_w128128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 556 12
	li	a5,1
...
.L38:
	...
	call	u8x8_d_helper_display_init
	.loc 1 561 5
	lla	a1,u8x8_d_ssd1327_ea_w128128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 562 12
	li	a5,1
...
.L39:
	...
	bnez	a5,.L41
	.loc 1 568 7
	lla	a1,u8x8_d_ssd1327_ea_w128128_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 569 28
	lw	a5,-20(s0)
...
.L41:
	.loc 1 573 7
	lla	a1,u8x8_d_ssd1327_ea_w128128_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 574 28
	lw	a5,-20(s0)
...
.L44:
	...
	bne	a4,a5,.L46
	.loc 1 696 5
	lla	a1,u8x8_ssd1327_128x128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 697 12
	li	a5,1
...
.L46:
	...
	call	u8x8_d_helper_display_init
	.loc 1 702 5
	lla	a1,u8x8_d_ssd1327_128x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 703 12
	li	a5,1
...
.L47:
	...
	bnez	a5,.L49
	.loc 1 709 7
	lla	a1,u8x8_d_ssd1327_128x128_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 710 28
	lw	a5,-20(s0)
...
.L49:
	.loc 1 714 7
	lla	a1,u8x8_d_ssd1327_128x128_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 715 28
	lw	a5,-20(s0)
...
.LFE5:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_ssd1327_zjy_128x128_init_seq, @object
...
.L54:
	...
	call	u8x8_d_helper_display_init
	.loc 1 794 5
	lla	a1,u8x8_d_ssd1327_zjy_128x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 795 12
	li	a5,1
...
.L53:
	...
	.cfi_endproc
.LFE6:
	.size	u8x8_d_ssd1327_zjy_128x128, .-u8x8_d_ssd1327_zjy_128x128
	.section	.rodata
	.align	2
...
.L62:
	...
	call	u8x8_d_helper_display_init
	.loc 1 879 5
	lla	a1,u8x8_d_ssd1327_ws_128x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 880 12
	li	a5,1
...
.L68:
	...
	bne	a4,a5,.L70
	.loc 1 1018 5
	lla	a1,u8x8_ssd1327_128x96_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 1019 12
	li	a5,1
...
.L70:
	...
	call	u8x8_d_helper_display_init
	.loc 1 1024 5
	lla	a1,u8x8_d_ssd1327_128x96_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 1025 12
	li	a5,1
...
.L71:
	...
	bnez	a5,.L73
	.loc 1 1031 7
	lla	a1,u8x8_d_ssd1327_128x96_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 1032 28
	lw	a5,-20(s0)
...
.L73:
	.loc 1 1036 7
	lla	a1,u8x8_d_ssd1327_128x96_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 1037 28
	lw	a5,-20(s0)
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1327_zjy_128x128_init_seq
	.byte	0xf
	.4byte	0x9f
	.4byte	0xc85
	.byte	0x10
...
.LASF929:
	.string	"u8x8_d_ssd1327_zjy_128x128_init_seq"
.LASF430:
...
.LASF940:
	.string	"u8x8_d_ssd1327_zjy_128x128"
.LASF592:
...
.LASF947:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1327.c"
.LASF213:
