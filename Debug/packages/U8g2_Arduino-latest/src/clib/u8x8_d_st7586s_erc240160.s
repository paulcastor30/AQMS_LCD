...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7586s_erc240160.c"
	.loc 1 171 93
	.cfi_startproc
	addi	sp,sp,-64
...
.L14:
	...
	slli	a5,a5,2
	sw	a5,-32(s0)
	.loc 1 198 23 discriminator 2
	lbu	a5,-25(s0)
	addi	a5,a5,1
	sb	a5,-25(s0)
.L11:
	.loc 1 198 7 discriminator 1
	lbu	a4,-25(s0)
	li	a5,3
	bleu	a4,a5,.L16
	.loc 1 217 7
...
.L8:
	...
	.loc 1 225 5
	lla	a1,u8x8_d_st7586s_erc240160_init_seq
	lw	a0,-52(s0)
...
.L9:
	.loc 1 228 5
	lla	a1,u8x8_st7586s_erc240160_display_info
	lw	a0,-52(s0)
...
.L6:
	...
	bnez	a5,.L19
	.loc 1 233 8
	lla	a1,u8x8_d_st7586s_erc240160_flip0_seq
	lw	a0,-52(s0)
	call	u8x8_cad_SendSequence
	.loc 1 234 29
	lw	a5,-52(s0)
...
.L19:
	.loc 1 238 7
	lla	a1,u8x8_d_st7586s_erc240160_flip1_seq
	lw	a0,-52(s0)
	call	u8x8_cad_SendSequence
	.loc 1 239 28
	lw	a5,-52(s0)
...
.LASF3212:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7586s_erc240160.c"
.LASF2054:
