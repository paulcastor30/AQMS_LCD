...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1309.c"
	.loc 1 75 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	...
	bnez	a5,.L8
	.loc 1 111 2
	lla	a1,u8x8_d_ssd1309_powersave0_seq
	lw	a0,-36(s0)
...
.L8:
	.loc 1 113 2
	lla	a1,u8x8_d_ssd1309_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 114 7
	j	.L7
...
.L16:
	...
	bnez	a5,.L19
	.loc 1 206 2
	lla	a1,u8x8_d_ssd1309_128x64_flip0_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 207 23
	lw	a5,-20(s0)
...
.L19:
	.loc 1 211 2
	lla	a1,u8x8_d_ssd1309_128x64_flip1_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 212 23
	lw	a5,-20(s0)
...
.L15:
	...
	.loc 1 217 7
	lla	a1,u8x8_d_ssd1309_128x64_noname_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 218 7
	j	.L21
.L17:
	.loc 1 220 7
	lla	a1,u8x8_ssd1309_128x64_noname2_display_info
	lw	a0,-20(s0)
...
.L28:
	.loc 1 282 7
	lla	a1,u8x8_ssd1309_128x64_noname0_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 283 7
	j	.L32
...
.LFE2:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_ssd1309_102x64_ea_oleds102_init_seq, @object
...
u8x8_d_ssd1309_102x64_ea_oleds102_init_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_ssd1309_102x64_ea_oleds102_display_info, @object
...
.L40:
	...
	call	u8x8_d_helper_display_init
	.loc 1 366 7
	lla	a1,u8x8_d_ssd1309_102x64_ea_oleds102_init_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 367 7
	j	.L44
.L41:
	.loc 1 369 7
	lla	a1,u8x8_ssd1309_102x64_ea_oleds102_display_info
	lw	a0,-36(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 370 7
	j	.L44
...
.L47:
	...
	.cfi_endproc
.LFE3:
	.size	u8x8_d_ssd1306_102x64_ea_oleds102, .-u8x8_d_ssd1306_102x64_ea_oleds102
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_ssd1309_102x64_ea_oleds102_init_seq
	.byte	0x14
	.4byte	.LASF918
	.byte	0x1
	.2byte	0x141
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_ssd1309_102x64_ea_oleds102_display_info
	.byte	0x15
	.4byte	.LASF922
	.byte	0x1
	.2byte	0x159
...
.LASF922:
	.string	"u8x8_d_ssd1306_102x64_ea_oleds102"
.LASF14:
...
.LASF917:
	.string	"u8x8_d_ssd1309_102x64_ea_oleds102_init_seq"
.LASF385:
	.string	"__LEAST32 \"l\""
.LASF378:
	.string	"__INT64 \"ll\""
...
.LASF926:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1309.c"
.LASF331:
	.string	"__NEWLIB__ 3"
.LASF307:
...
.LASF918:
	.string	"u8x8_ssd1309_102x64_ea_oleds102_display_info"
.LASF382:
	.string	"__FAST64 \"ll\""
.LASF12:
