...
u8x8_d_ssd1606_to_display_seq:
	...
	.text
	.align	1
	.type	u8x8_convert_tile_for_ssd1606, @function
u8x8_convert_tile_for_ssd1606:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1606_172x72.c"
	.loc 1 209 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	u8x8_convert_tile_for_ssd1606, .-u8x8_convert_tile_for_ssd1606
	.align	1
...
.L7:
	...
	sw	a5,-24(s0)
.L6:
	.loc 1 269 7 discriminator 1
	lw	a0,-24(s0)
	call	u8x8_convert_tile_for_ssd1606
	mv	a5,a0
	mv	a2,a5
	li	a1,16
	lw	a0,-36(s0)
...
.LFE1:
	...
	.align	1
	.type	u8x8_d_ssd1606_172x72_generic, @function
...
.L16:
	...
	.loc 1 294 7
	lla	a1,u8x8_d_ssd1606_172x72_gde021a1_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 300 7
	lw	a0,-20(s0)
	call	u8x8_FillDisplay
	.loc 1 302 7
	lw	a0,-20(s0)
...
.L12:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1606_draw_tile
	.loc 1 349 7
	j	.L17
.L10:
	.loc 1 351 7
	lla	a1,u8x8_d_ssd1606_to_display_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 352 7
	j	.L17
...
.L18:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_d_ssd1606_172x72_generic, .-u8x8_d_ssd1606_172x72_generic
	.section	.rodata
	.align	2
...
.LFB3:
	...
	bne	a4,a5,.L21
	.loc 1 388 7
	lla	a1,u8x8_ssd1606_172x72_display_info
	lw	a0,-20(s0)
...
.L21:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1606_172x72_generic
	mv	a5,a0
.L22:
	.loc 1 392 1
	mv	a0,a5
...
.LASF922:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1606_172x72.c"
.LASF713:
