...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7920.c"
	.loc 1 83 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L2:
	...
	bnez	a5,.L6
	.loc 1 99 2
	lla	a1,u8x8_d_st7920_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 102 7
	j	.L5
.L6:
	.loc 1 101 2
	lla	a1,u8x8_d_st7920_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 102 7
	j	.L5
...
.L10:
	...
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 138 4 discriminator 3
	lw	a5,-44(s0)
	lbu	a5,4(a5)
	sb	a5,-25(s0)
	.loc 1 141 2 discriminator 3
	lbu	a5,-25(s0)
	lw	a2,-24(s0)
	mv	a1,a5
	lw	a0,-36(s0)
	call	u8x8_cad_SendData
	.loc 1 142 6 discriminator 3
	lbu	a5,-25(s0)
	lw	a4,-24(s0)
	add	a5,a4,a5
	sw	a5,-24(s0)
	.loc 1 133 27 discriminator 3
	lbu	a5,-19(s0)
	addi	a5,a5,1
	sb	a5,-19(s0)
.L9:
...
.LFE0:
	...
	.section	.rodata
	.align	2
	.type	u8x8_st7920_144x32_display_info, @object
	.size	u8x8_st7920_144x32_display_info, 24
u8x8_st7920_144x32_display_info:
	.byte	1
	.byte	0
	.byte	5
	.byte	5
	...
	.text
	.align	1
	.globl	u8x8_d_st7920_144x32
	.type	u8x8_d_st7920_144x32, @function
...
.LFB1:
	...
	bne	a4,a5,.L13
	.loc 1 190 7
	lla	a1,u8x8_st7920_144x32_display_info
	lw	a0,-20(s0)
...
.L15:
	...
	.cfi_endproc
.LFE1:
	.size	u8x8_d_st7920_144x32, .-u8x8_d_st7920_144x32
	.section	.rodata
	.align	2
	.type	u8x8_st7920_160x32_display_info, @object
...
.LFB2:
	...
	bne	a4,a5,.L17
	.loc 1 240 7
	lla	a1,u8x8_st7920_160x32_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 241 7
	nop
...
.L19:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_d_st7920_160x32, .-u8x8_d_st7920_160x32
	.section	.rodata
	.align	2
...
.LFB3:
	...
	bne	a4,a5,.L21
	.loc 1 282 7
	lla	a1,u8x8_st7920_192x32_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 283 7
	nop
...
.LFB4:
	...
	bne	a4,a5,.L25
	.loc 1 323 7
	lla	a1,u8x8_st7920_128x64_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 324 7
	nop
...
.LFE4:
	...
	.section	.rodata
	.align	2
	.type	u8x8_st7920_256x32_display_info, @object
...
.LFB5:
	...
	bne	a4,a5,.L29
	.loc 1 366 4
	lla	a1,u8x8_st7920_256x32_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 367 4
	nop
...
.L31:
	...
	.cfi_endproc
.LFE5:
	.size	u8x8_d_st7920_256x32, .-u8x8_d_st7920_256x32
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_st7920_144x32_display_info
	.byte	0x13
	.4byte	.LASF914
	.byte	0x1
	.byte	0xd1
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_st7920_160x32_display_info
	.byte	0x13
	.4byte	.LASF915
	.byte	0x1
	.byte	0xfb
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_st7920_256x32_display_info
	.byte	0x15
	.4byte	.LASF921
	.byte	0x1
	.2byte	0x169
...
.LASF913:
	.string	"u8x8_st7920_144x32_display_info"
.LASF28:
...
.LASF917:
	.string	"u8x8_st7920_256x32_display_info"
.LASF898:
...
.LASF719:
	.string	"long int"
.LASF927:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7920.c"
.LASF922:
...
.LASF914:
	.string	"u8x8_st7920_160x32_display_info"
.LASF599:
