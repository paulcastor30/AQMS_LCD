...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1701_mini12864.c"
	.loc 1 128 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L9:
	.loc 1 134 7
	lla	a1,u8x8_uc1701_display_info
	lw	a0,-36(s0)
...
.L8:
	...
	.loc 1 138 7
	lla	a1,u8x8_d_uc1701_mini12864_init_seq
	lw	a0,-36(s0)
...
.L7:
	...
	bnez	a5,.L11
	.loc 1 142 2
	lla	a1,u8x8_d_uc1701_mini12864_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 145 7
	j	.L10
.L11:
	.loc 1 144 2
	lla	a1,u8x8_d_uc1701_mini12864_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 145 7
	j	.L10
.L6:
	...
	bnez	a5,.L13
	.loc 1 149 2
	lla	a1,u8x8_d_uc1701_mini12864_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 150 23
	lw	a5,-36(s0)
...
.L13:
	.loc 1 154 2
	lla	a1,u8x8_d_uc1701_mini12864_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 155 23
	lw	a5,-36(s0)
...
.LASF920:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_uc1701_mini12864.c"
.LASF115:
