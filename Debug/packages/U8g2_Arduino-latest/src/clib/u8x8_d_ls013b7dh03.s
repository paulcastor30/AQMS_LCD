...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ls013b7dh03.c"
	.loc 1 71 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L4:
	.loc 1 77 7
	lla	a1,u8x8_ls013b7dh03_128x128_display_info
	lw	a0,-36(s0)
...
.L7:
	...
	j	.L9
.L10:
	.loc 1 106 43 discriminator 3
	lbu	a4,-25(s0)
	lbu	a5,-17(s0)
	add	a5,a4,a5
	andi	a5,a5,0xff
	.loc 1 106 51 discriminator 3
	srli	a5,a5,7
	andi	a5,a5,0xff
	slli	a4,a5,24
	srai	a4,a4,24
	.loc 1 106 69 discriminator 3
	lbu	a3,-25(s0)
	lbu	a5,-17(s0)
	add	a5,a3,a5
	andi	a5,a5,0xff
	.loc 1 106 77 discriminator 3
	srai	a5,a5,5
	slli	a5,a5,24
	srai	a5,a5,24
	andi	a5,a5,2
	slli	a5,a5,24
	srai	a5,a5,24
	.loc 1 106 57 discriminator 3
	or	a5,a4,a5
	slli	a4,a5,24
	srai	a4,a4,24
	.loc 1 106 95 discriminator 3
	lbu	a3,-25(s0)
	lbu	a5,-17(s0)
	add	a5,a3,a5
	andi	a5,a5,0xff
	.loc 1 106 103 discriminator 3
	srai	a5,a5,3
	slli	a5,a5,24
	srai	a5,a5,24
	andi	a5,a5,4
	slli	a5,a5,24
	srai	a5,a5,24
	.loc 1 106 83 discriminator 3
	or	a5,a4,a5
	slli	a4,a5,24
	srai	a4,a4,24
	.loc 1 106 121 discriminator 3
	lbu	a3,-25(s0)
	lbu	a5,-17(s0)
	add	a5,a3,a5
	andi	a5,a5,0xff
	.loc 1 106 129 discriminator 3
	srai	a5,a5,1
	slli	a5,a5,24
	srai	a5,a5,24
	andi	a5,a5,8
	slli	a5,a5,24
	srai	a5,a5,24
	.loc 1 106 109 discriminator 3
	or	a5,a4,a5
	slli	a4,a5,24
	srai	a4,a4,24
	.loc 1 106 147 discriminator 3
	lbu	a3,-25(s0)
	lbu	a5,-17(s0)
	add	a5,a3,a5
	andi	a5,a5,0xff
	.loc 1 106 155 discriminator 3
	slli	a5,a5,1
	slli	a5,a5,24
	srai	a5,a5,24
	andi	a5,a5,16
	slli	a5,a5,24
	srai	a5,a5,24
	.loc 1 106 135 discriminator 3
	or	a5,a4,a5
	slli	a4,a5,24
	srai	a4,a4,24
	.loc 1 106 173 discriminator 3
	lbu	a3,-25(s0)
	lbu	a5,-17(s0)
	add	a5,a3,a5
	andi	a5,a5,0xff
	.loc 1 106 181 discriminator 3
	slli	a5,a5,3
	slli	a5,a5,24
	srai	a5,a5,24
	andi	a5,a5,32
	slli	a5,a5,24
	srai	a5,a5,24
	.loc 1 106 161 discriminator 3
	or	a5,a4,a5
	slli	a4,a5,24
	srai	a4,a4,24
	.loc 1 106 199 discriminator 3
	lbu	a3,-25(s0)
	lbu	a5,-17(s0)
	add	a5,a3,a5
	andi	a5,a5,0xff
	.loc 1 106 207 discriminator 3
	slli	a5,a5,5
	slli	a5,a5,24
	srai	a5,a5,24
	andi	a5,a5,64
	slli	a5,a5,24
	srai	a5,a5,24
	.loc 1 106 187 discriminator 3
	or	a5,a4,a5
	slli	a4,a5,24
	srai	a4,a4,24
	.loc 1 106 225 discriminator 3
	lbu	a3,-25(s0)
	lbu	a5,-17(s0)
	add	a5,a3,a5
	andi	a5,a5,0xff
	.loc 1 106 233 discriminator 3
	slli	a5,a5,7
	.loc 1 106 213 discriminator 3
	slli	a5,a5,24
	srai	a5,a5,24
	or	a5,a4,a5
	slli	a5,a5,24
	...
	.loc 1 108 9 discriminator 3
	li	a1,0
	lw	a0,-36(s0)
	call	u8x8_cad_SendCmd
	.loc 1 110 13 discriminator 3
	lbu	a5,-26(s0)
	lw	a4,-24(s0)
	add	a5,a4,a5
	sw	a5,-24(s0)
	.loc 1 104 27 discriminator 3
	lbu	a5,-17(s0)
	addi	a5,a5,1
	sb	a5,-17(s0)
.L9:
...
.LFB1:
	...
	bne	a4,a5,.L14
	.loc 1 153 7
	lla	a1,u8x8_ls027b7dh01_400x240_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 154 7
	nop
...
.L14:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ls013b7dh03_128x128
	mv	a5,a0
.L16:
	.loc 1 159 1
	mv	a0,a5
...
.LFE1:
	...
	.section	.rodata
	.align	2
	.type	u8x8_ls027b7dh01_m0_400x240_display_info, @object
...
.LFB2:
	...
	bne	a4,a5,.L18
	.loc 1 189 7
	lla	a1,u8x8_ls027b7dh01_m0_400x240_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 190 7
	nop
...
.L20:
	...
	.cfi_endproc
.LFE2:
	.size	u8x8_d_ls027b7dh01_m0_400x240, .-u8x8_d_ls027b7dh01_m0_400x240
	.section	.rodata
	.align	2
...
.LFB3:
	...
	bne	a4,a5,.L22
	.loc 1 226 7
	lla	a1,u8x8_ls013b7dh05_144x168_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 227 7
	nop
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_ls027b7dh01_m0_400x240_display_info
	.byte	0x13
	.4byte	.LASF917
	.byte	0x1
	.byte	0xc6
...
.LASF713:
	.string	"SWAP8(a) ((((a) & 0x80) >> 7) | (((a) & 0x40) >> 5) | (((a) & 0x20) >> 3) | (((a) & 0x10) >> 1) | (((a) & 0x08) << 1) | (((a) & 0x04) << 3) | (((a) & 0x02) << 5) | (((a) & 0x01) << 7))"
.LASF130:
...
.LASF715:
	.string	"LS013B7DH03_CMD_ALL_CLEAR (0x04)"
.LASF393:
...
.LASF735:
	.string	"next_cb"
.LASF922:
	.string	"u8x8_d_ls027b7dh01_m0_400x240"
.LASF490:
	.string	"_PTRDIFF_T "
.LASF461:
...
.LASF737:
	.string	"cad_cb"
.LASF925:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ls013b7dh03.c"
.LASF492:
	.string	"_T_PTRDIFF "
.LASF223:
...
.LASF714:
	.string	"LS013B7DH03_CMD_UPDATE (0x01)"
.LASF568:
	.string	"LONG_MAX"
.LASF748:
	.string	"gpio_result"
...
.LASF716:
	.string	"LS013B7DH03_VAL_TRAILER (0x00)"
.LASF412:
...
.LASF916:
	.string	"u8x8_ls027b7dh01_m0_400x240_display_info"
.LASF648:
