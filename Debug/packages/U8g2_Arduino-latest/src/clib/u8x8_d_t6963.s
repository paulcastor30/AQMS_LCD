...
u8x8_d_t6963_common:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_t6963.c"
	.loc 1 60 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L2:
	...
	bnez	a5,.L5
	.loc 1 75 2
	lla	a1,u8x8_d_t6963_powersave0_seq
	lw	a0,-36(s0)
...
.L5:
	.loc 1 77 2
	lla	a1,u8x8_d_t6963_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 78 7
	j	.L7
...
.L9:
	...
	lbu	a5,16(a5)
	mv	a4,a5
	.loc 1 109 6 discriminator 3
	lw	a5,-24(s0)
	add	a5,a5,a4
	sw	a5,-24(s0)
	.loc 1 110 11 discriminator 3
	lw	a5,-36(s0)
	lw	a5,0(a5)
...
.L13:
	.loc 1 194 7
	lla	a1,u8x8_t6963_240x128_display_info
	lw	a0,-20(s0)
...
.L14:
	...
	.loc 1 198 7
	lla	a1,u8x8_d_t6963_240x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 199 7
	j	.L16
...
.L20:
	.loc 1 279 7
	lla	a1,u8x8_t6963_240x64_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 280 7
	j	.L23
.L21:
	...
	call	u8x8_d_helper_display_init
	.loc 1 283 7
	lla	a1,u8x8_d_t6963_240x64_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 284 7
	j	.L23
...
.L27:
	.loc 1 365 7
	lla	a1,u8x8_t6963_256x64_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 366 7
	j	.L30
.L28:
	...
	call	u8x8_d_helper_display_init
	.loc 1 369 7
	lla	a1,u8x8_d_t6963_256x64_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 370 7
	j	.L30
...
.L34:
	.loc 1 448 7
	lla	a1,u8x8_t6963_128x64_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 449 7
	j	.L37
.L35:
	...
	call	u8x8_d_helper_display_init
	.loc 1 452 7
	lla	a1,u8x8_d_t6963_128x64_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 453 7
	j	.L37
...
.L41:
	.loc 1 530 7
	lla	a1,u8x8_t6963_160x80_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 531 7
	j	.L44
.L42:
	...
	call	u8x8_d_helper_display_init
	.loc 1 534 7
	lla	a1,u8x8_d_t6963_160x80_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 535 7
	j	.L44
...
.LASF932:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_t6963.c"
.LASF689:
