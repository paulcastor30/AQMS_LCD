...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1306_128x32.c"
	.loc 1 106 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L8:
	...
	.loc 1 118 7
	lla	a1,u8x8_d_ssd1306_128x32_univision_init_seq
	lw	a0,-36(s0)
...
.L7:
	...
	bnez	a5,.L10
	.loc 1 122 2
	lla	a1,u8x8_d_ssd1306_128x32_univision_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 125 7
	j	.L9
.L10:
	.loc 1 124 2
	lla	a1,u8x8_d_ssd1306_128x32_univision_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 125 7
	j	.L9
.L6:
	...
	bnez	a5,.L12
	.loc 1 129 2
	lla	a1,u8x8_d_ssd1306_128x32_univision_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 130 23
	lw	a5,-36(s0)
...
.L12:
	.loc 1 134 2
	lla	a1,u8x8_d_ssd1306_128x32_univision_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 135 23
	lw	a5,-36(s0)
...
.LFB1:
	...
	bne	a4,a5,.L17
	.loc 1 208 7
	lla	a1,u8x8_ssd1306_128x32_univision_display_info
	lw	a0,-20(s0)
...
.L17:
	...
	mv	a1,a5
	lw	a0,-20(s0)
	call	u8x8_d_ssd1306_128x32_generic
	mv	a5,a0
.L18:
	.loc 1 212 1
	mv	a0,a5
...
.LFB2:
	...
	bne	a4,a5,.L20
	.loc 1 248 7
	lla	a1,u8x8_ssd1306_128x32_winstar_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 249 14
	li	a5,1
...
.LFE2:
	...
	.section	.rodata
	.align	2
	.type	u8x8_d_sh1106_128x32_visionox_init_seq, @object
...
u8x8_d_sh1106_128x32_visionox_init_seq:
	...
	.byte	-1
	.align	2
	.type	u8x8_d_sh1106_128x32_visionox_display_info, @object
...
.LFB3:
	...
	bne	a4,a5,.L23
	.loc 1 312 7
	lla	a1,u8x8_d_sh1106_128x32_visionox_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 313 14
	li	a5,1
...
.L23:
	...
	call	u8x8_d_helper_display_init
	.loc 1 319 7
	lla	a1,u8x8_d_sh1106_128x32_visionox_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
.L25:
	.loc 1 322 12
...
.L24:
	...
	.cfi_endproc
.LFE3:
	.size	u8x8_d_sh1106_128x32_visionox, .-u8x8_d_sh1106_128x32_visionox
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_sh1106_128x32_visionox_init_seq
	.byte	0x14
	.4byte	.LASF919
	.byte	0x1
	.2byte	0x11b
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_sh1106_128x32_visionox_display_info
	.byte	0x15
	.4byte	.LASF923
	.byte	0x1
	.2byte	0x134
...
.LASF927:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ssd1306_128x32.c"
.LASF477:
...
.LASF743:
	.string	"i2c_started"
.LASF919:
	.string	"u8x8_d_sh1106_128x32_visionox_display_info"
.LASF100:
...
.LASF923:
	.string	"u8x8_d_sh1106_128x32_visionox"
.LASF703:
...
.LASF918:
	.string	"u8x8_d_sh1106_128x32_visionox_init_seq"
.LASF78:
