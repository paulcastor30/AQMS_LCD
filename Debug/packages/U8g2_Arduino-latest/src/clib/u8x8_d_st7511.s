...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7511.c"
	.loc 1 127 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L9:
	.loc 1 133 7
	lla	a1,u8x8_st7511_320x240_display_info
	lw	a0,-36(s0)
...
.L8:
	...
	.loc 1 137 7
	lla	a1,u8x8_d_st7511_320x240_init_seq
	lw	a0,-36(s0)
...
.L7:
	...
	bnez	a5,.L11
	.loc 1 141 2
	lla	a1,u8x8_d_st7511_320x240_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 144 7
	j	.L10
.L11:
	.loc 1 143 2
	lla	a1,u8x8_d_st7511_320x240_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 144 7
	j	.L10
.L6:
	...
	bnez	a5,.L13
	.loc 1 148 2
	lla	a1,u8x8_d_st7511_320x240_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 149 23
	lw	a5,-36(s0)
...
.L13:
	.loc 1 153 2
	lla	a1,u8x8_d_st7511_320x240_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 154 23
	lw	a5,-36(s0)
...
.LASF920:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_st7511.c"
.LASF817:
