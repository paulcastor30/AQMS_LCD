...
reverse_byte:
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_lc7981.c"
	.loc 1 71 1
	.cfi_startproc
	addi	sp,sp,-32
...
.L8:
	...
	j	.L6
.L7:
	.loc 1 126 44 discriminator 3
	lw	a5,-24(s0)
	addi	a4,a5,1
	sw	a4,-24(s0)
	.loc 1 126 4 discriminator 3
	lbu	a5,0(a5)
	mv	a0,a5
	call	reverse_byte
	mv	a5,a0
...
.L10:
	...
	.cfi_endproc
.LFE1:
	.size	u8x8_d_lc7981_common, .-u8x8_d_lc7981_common
	.section	.rodata
	.align	2
...
.L13:
	.loc 1 241 2
	lla	a1,u8x8_lc7981_160x80_display_info
	lw	a0,-20(s0)
...
.L14:
	...
	.loc 1 245 2
	lla	a1,u8x8_d_lc7981_160x80_init_seq
	lw	a0,-20(s0)
...
.L21:
	.loc 1 313 2
	lla	a1,u8x8_lc7981_160x160_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 314 2
	j	.L20
.L22:
	...
	call	u8x8_d_helper_display_init
	.loc 1 317 2
	lla	a1,u8x8_d_lc7981_160x160_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 318 2
	j	.L20
...
.L29:
	.loc 1 385 2
	lla	a1,u8x8_lc7981_240x128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 386 2
	j	.L28
.L30:
	...
	call	u8x8_d_helper_display_init
	.loc 1 389 2
	lla	a1,u8x8_d_lc7981_240x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 390 2
	j	.L28
...
.L37:
	.loc 1 458 2
	lla	a1,u8x8_lc7981_240x64_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 459 2
	j	.L36
.L38:
	...
	call	u8x8_d_helper_display_init
	.loc 1 462 2
	lla	a1,u8x8_d_lc7981_240x64_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 463 2
	j	.L36
...
.LFE5:
	...
	.section	.rodata
	.align	2
	.type	u8x8_lc7981_128x128_display_info, @object
...
u8x8_lc7981_128x128_display_info:
	...
	.half	128
	.align	2
	.type	u8x8_d_lc7981_128x128_init_seq, @object
...
.L45:
	.loc 1 530 2
	lla	a1,u8x8_lc7981_128x128_display_info
	lw	a0,-20(s0)
	call	u8x8_d_helper_display_setup_memory
	.loc 1 531 2
	j	.L44
.L46:
	...
	call	u8x8_d_helper_display_init
	.loc 1 534 2
	lla	a1,u8x8_d_lc7981_128x128_init_seq
	lw	a0,-20(s0)
	call	u8x8_cad_SendSequence
	.loc 1 535 2
	j	.L44
...
.L48:
	...
	.cfi_endproc
.LFE6:
	.size	u8x8_d_lc7981_128x128, .-u8x8_d_lc7981_128x128
.Letext0:
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_lc7981_128x128_display_info
	.byte	0x14
	.4byte	.LASF919
	.byte	0x1
	.2byte	0x1f6
	...
	.byte	0x5
	.byte	0x3
	.4byte	u8x8_d_lc7981_128x128_init_seq
	.byte	0x15
	.4byte	.LASF923
	.byte	0x1
	.2byte	0x209
...
.LASF742:
	.string	"i2c_started"
.LASF929:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_lc7981.c"
.LASF100:
...
.LASF749:
	.string	"pins"
.LASF918:
	.string	"u8x8_lc7981_128x128_display_info"
.LASF212:
...
.LASF379:
	.string	"__FAST8 "
.LASF919:
	.string	"u8x8_d_lc7981_128x128_init_seq"
.LASF131:
