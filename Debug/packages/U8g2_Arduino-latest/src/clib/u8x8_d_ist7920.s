...
.LFB0:
	.file 1 "../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ist7920.c"
	.loc 1 136 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L9:
	.loc 1 142 7
	lla	a1,u8x8_ist7920_128x128_display_info
	lw	a0,-36(s0)
...
.L8:
	...
	.loc 1 146 7
	lla	a1,u8x8_d_ist7920_128x128_init_seq
	lw	a0,-36(s0)
...
.L7:
	...
	bnez	a5,.L11
	.loc 1 150 2
	lla	a1,u8x8_d_ist7920_128x128_powersave0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 153 7
	j	.L10
.L11:
	.loc 1 152 2
	lla	a1,u8x8_d_ist7920_128x128_powersave1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 153 7
	j	.L10
.L6:
	...
	bnez	a5,.L13
	.loc 1 157 2
	lla	a1,u8x8_d_ist7920_128x128_flip0_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 158 23
	lw	a5,-36(s0)
...
.L13:
	.loc 1 162 2
	lla	a1,u8x8_d_ist7920_128x128_flip1_seq
	lw	a0,-36(s0)
	call	u8x8_cad_SendSequence
	.loc 1 163 23
	lw	a5,-36(s0)
...
.LASF920:
	.string	"../packages/U8g2_Arduino-latest/src/clib/u8x8_d_ist7920.c"
.LASF607:
