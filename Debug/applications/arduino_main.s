...
mq135_sensor:
	...
	.align	2
.LC0:
	.string	"Paul Rodolf P Castor"
	.align	2
.LC1:
	.string	"CH32V208W-R0   IAQMS"
	.align	2
.LC2:
	.string	"System  Initializing"
	.align	2
.LC3:
	.string	"."
	.align	2
...
setup:
.LFB270:
	.file 1 "../applications/arduino_main.cpp"
	.loc 1 17 1
	.cfi_startproc
	addi	sp,sp,-32
	...
	.loc 1 19 13
	lla	a0,lcd
	call	_ZN17LiquidCrystal_I2C4initEv
	.loc 1 22 18
	lla	a0,lcd
...
.LBB2:
	...
	sw	zero,-20(s0)
.L3:
	.loc 1 30 23 discriminator 3
	lw	a4,-20(s0)
	li	a5,19
	bgt	a4,a5,.L2
	.loc 1 32 18 discriminator 2
	lla	a1,.LC3
	lla	a0,lcd
	call	_ZN5Print5printEPKc
	.loc 1 30 5 discriminator 2
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
	j	.L3
...
.LFB276:
	...
	addi	a5,a5,-1
	bne	a4,a5,.L13
	.loc 1 14 34 is_stmt 1
	li	a3,4
	li	a2,20
	li	a1,39
	lla	a0,lcd
	call	_ZN17LiquidCrystal_I2CC1Ehhh
	.loc 1 15 24
	li	a1,21
	lla	a0,mq135_sensor
	call	_ZN5MQ135C1Eh
...
.Letext0:
	...
	.file 25 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\packages\\RTduino-latest\\libraries\\buildin\\Wire/Wire.h"
	.file 26 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\packages\\RTduino-latest\\libraries\\user\\MQ135-master/MQ135.h"
	.file 27 "<built-in>"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 121 "C:\\RT-ThreadStudio\\workspace\\AQMS_LCD\\packages\\RTduino-latest\\libraries\\user\\LiquidCrystal_I2C-master/LiquidCrystal_I2C.h"
	.byte	0x3
	.byte	0xb
	.byte	0x79
	.byte	0x5
...
.Ldebug_macro100:
	...
	.4byte	.LASF6931
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.MQ135.h.17.960a8a057d958a228f66f59c3af1ab7a,comdat
.Ldebug_macro101:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF7229:
	.string	"../applications/arduino_main.cpp"
.LASF1203:
